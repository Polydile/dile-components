...
The `dile-tabler-badge` Custom Element displays an icon combined with text inside a pill-shaped badge container. It's perfect for status indicators, labels, and other badge-like UI elements.
...
----------------|-------------|---------
--dile-tabler-badge-color | Badge background color | --dile-primary-color or #f3f3ae
--dile-tabler-badge-on-color | Text and icon color | --dile-on-primary-color or #303030
--dile-tabler-badge-font-size | Text size | 0.8rem
--dile-tabler-badge-font-weight | Text weight | 500
--dile-tabler-badge-gap | Space between icon and text | 0.5rem
--dile-tabler-badge-padding | Inner spacing | 0.375rem 0.75rem
--dile-tabler-badge-border-radius | Border radius (pill shape) | 9999px
--dile-tabler-badge-border-width | Border thickness | 0px
--dile-tabler-badge-border-color | Border color | transparent
--dile-tabler-badge-transition-duration | Animation duration | 0.3s
--dile-tabler-badge-icon-size | Icon size | 18px

### Variant-Specific Properties

Custom property | Description | Default
----------------|-------------|---------
--dile-tabler-badge-primary | Primary variant background | --dile-primary-color
--dile-tabler-badge-on-primary | Primary variant text/icon color | --dile-on-primary-color
--dile-tabler-badge-secondary | Secondary variant background | --dile-secondary-color
--dile-tabler-badge-on-secondary | Secondary variant text/icon color | --dile-on-secondary-color
--dile-tabler-badge-success | Success variant background | --dile-alert-success-color
--dile-tabler-badge-on-success | Success variant text/icon color | --dile-on-alert-color
--dile-tabler-badge-warning | Warning variant background | --dile-alert-warning-color
--dile-tabler-badge-on-warning | Warning variant text/icon color | --dile-on-alert-color
--dile-tabler-badge-error | Error variant background | --dile-alert-error-color
--dile-tabler-badge-on-error | Error variant text/icon color | --dile-on-alert-color
--dile-tabler-badge-danger | Danger variant background | --dile-danger-color
--dile-tabler-badge-on-danger | Danger variant text/icon color | --dile-on-danger-color
--dile-tabler-badge-soft | Soft variant background | #2a7a9f
--dile-tabler-badge-on-soft | Soft variant text/icon color | #ffffff
