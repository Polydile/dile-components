...
export class DemoBoardGamesCrudFiltersAlwaysVisible extends LitElement {
  static styles = [
    css`
      :host {
        display: block;
...
if (!customElements.get('demo-board-game-crud-filters-always-visible')) {
  customElements.define('demo-board-game-crud-filters-always-visible', DemoBoardGamesCrudFiltersAlwaysVisible);
}
