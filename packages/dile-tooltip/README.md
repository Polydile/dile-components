...
```
<dile-tooltip text="text" tooltiptext="tooltiptext" position="top|left|right|bottom" arrow fadeIn ></dile-tooltip>
```
...
- **text**: This property sets the text of the component.
- **tooltiptext**: This property sets the text that will be displayed when the mouse hover the element.
