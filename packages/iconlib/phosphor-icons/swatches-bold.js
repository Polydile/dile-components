...
export class DileIconlibSwatchesBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-swatches-bold')) {
  customElements.define('dile-phosphor-icon-swatches-bold', DileIconlibSwatchesBold);
}
