...
export class DileIconlibFileCBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-c-bold')) {
  customElements.define('dile-phosphor-icon-file-c-bold', DileIconlibFileCBold);
}
