...
export class DileIconlibSoccerBallFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-soccer-ball-fill')) {
  customElements.define('dile-phosphor-icon-soccer-ball-fill', DileIconlibSoccerBallFill);
}
