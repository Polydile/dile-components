...
export class DileIconlibFileXlsFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-xls-fill')) {
  customElements.define('dile-phosphor-icon-file-xls-fill', DileIconlibFileXlsFill);
}
