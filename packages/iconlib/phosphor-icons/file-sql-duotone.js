...
export class DileIconlibFileSqlDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-sql-duotone')) {
  customElements.define('dile-phosphor-icon-file-sql-duotone', DileIconlibFileSqlDuotone);
}
