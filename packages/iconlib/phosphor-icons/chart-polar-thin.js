...
export class DileIconlibChartPolarThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-chart-polar-thin')) {
  customElements.define('dile-phosphor-icon-chart-polar-thin', DileIconlibChartPolarThin);
}
