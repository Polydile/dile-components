...
export class DileIconlibMediumLogoBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-medium-logo-bold')) {
  customElements.define('dile-phosphor-icon-medium-logo-bold', DileIconlibMediumLogoBold);
}
