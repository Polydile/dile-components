...
export class DileIconlibFileVideoLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-video-light')) {
  customElements.define('dile-phosphor-icon-file-video-light', DileIconlibFileVideoLight);
}
