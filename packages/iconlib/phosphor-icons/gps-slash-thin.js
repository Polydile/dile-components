...
export class DileIconlibGpsSlashThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-gps-slash-thin')) {
  customElements.define('dile-phosphor-icon-gps-slash-thin', DileIconlibGpsSlashThin);
}
