...
export class DileIconlibSnowflakeFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-snowflake-fill')) {
  customElements.define('dile-phosphor-icon-snowflake-fill', DileIconlibSnowflakeFill);
}
