...
export class DileIconlibSplitVertical extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-split-vertical')) {
  customElements.define('dile-phosphor-icon-split-vertical', DileIconlibSplitVertical);
}
