...
export class DileIconlibPizza extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-pizza')) {
  customElements.define('dile-phosphor-icon-pizza', DileIconlibPizza);
}
