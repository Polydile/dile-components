...
export class DileIconlibBoulesLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-boules-light')) {
  customElements.define('dile-phosphor-icon-boules-light', DileIconlibBoulesLight);
}
