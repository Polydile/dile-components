...
export class DileIconlibLockKeyOpen extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-lock-key-open')) {
  customElements.define('dile-phosphor-icon-lock-key-open', DileIconlibLockKeyOpen);
}
