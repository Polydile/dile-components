...
export class DileIconlibSprayBottle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-spray-bottle')) {
  customElements.define('dile-phosphor-icon-spray-bottle', DileIconlibSprayBottle);
}
