...
export class DileIconlibUserSoundLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-user-sound-light')) {
  customElements.define('dile-phosphor-icon-user-sound-light', DileIconlibUserSoundLight);
}
