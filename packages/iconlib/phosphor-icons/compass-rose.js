...
export class DileIconlibCompassRose extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-compass-rose')) {
  customElements.define('dile-phosphor-icon-compass-rose', DileIconlibCompassRose);
}
