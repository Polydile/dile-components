...
export class DileIconlibExamBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-exam-bold')) {
  customElements.define('dile-phosphor-icon-exam-bold', DileIconlibExamBold);
}
