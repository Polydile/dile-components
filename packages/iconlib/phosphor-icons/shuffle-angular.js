...
export class DileIconlibShuffleAngular extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-shuffle-angular')) {
  customElements.define('dile-phosphor-icon-shuffle-angular', DileIconlibShuffleAngular);
}
