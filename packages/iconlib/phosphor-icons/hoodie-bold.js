...
export class DileIconlibHoodieBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-hoodie-bold')) {
  customElements.define('dile-phosphor-icon-hoodie-bold', DileIconlibHoodieBold);
}
