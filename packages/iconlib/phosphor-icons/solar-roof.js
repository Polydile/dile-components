...
export class DileIconlibSolarRoof extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-solar-roof')) {
  customElements.define('dile-phosphor-icon-solar-roof', DileIconlibSolarRoof);
}
