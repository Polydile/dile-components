...
export class DileIconlibBoulesThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-boules-thin')) {
  customElements.define('dile-phosphor-icon-boules-thin', DileIconlibBoulesThin);
}
