...
export class DileIconlibNetworkLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-network-light')) {
  customElements.define('dile-phosphor-icon-network-light', DileIconlibNetworkLight);
}
