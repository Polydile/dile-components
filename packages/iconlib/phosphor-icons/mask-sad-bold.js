...
export class DileIconlibMaskSadBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-mask-sad-bold')) {
  customElements.define('dile-phosphor-icon-mask-sad-bold', DileIconlibMaskSadBold);
}
