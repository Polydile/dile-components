...
export class DileIconlibNutThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-nut-thin')) {
  customElements.define('dile-phosphor-icon-nut-thin', DileIconlibNutThin);
}
