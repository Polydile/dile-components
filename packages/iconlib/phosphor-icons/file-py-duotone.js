...
export class DileIconlibFilePyDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-py-duotone')) {
  customElements.define('dile-phosphor-icon-file-py-duotone', DileIconlibFilePyDuotone);
}
