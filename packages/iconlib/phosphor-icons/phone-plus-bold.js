...
export class DileIconlibPhonePlusBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-phone-plus-bold')) {
  customElements.define('dile-phosphor-icon-phone-plus-bold', DileIconlibPhonePlusBold);
}
