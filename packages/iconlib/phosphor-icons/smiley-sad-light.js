...
export class DileIconlibSmileySadLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-smiley-sad-light')) {
  customElements.define('dile-phosphor-icon-smiley-sad-light', DileIconlibSmileySadLight);
}
