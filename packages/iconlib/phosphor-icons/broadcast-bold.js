...
export class DileIconlibBroadcastBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-broadcast-bold')) {
  customElements.define('dile-phosphor-icon-broadcast-bold', DileIconlibBroadcastBold);
}
