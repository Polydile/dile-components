...
export class DileIconlibMarkerCircle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-marker-circle')) {
  customElements.define('dile-phosphor-icon-marker-circle', DileIconlibMarkerCircle);
}
