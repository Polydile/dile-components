...
export class DileIconlibBulldozerBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-bulldozer-bold')) {
  customElements.define('dile-phosphor-icon-bulldozer-bold', DileIconlibBulldozerBold);
}
