...
export class DileIconlibTrayLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-tray-light')) {
  customElements.define('dile-phosphor-icon-tray-light', DileIconlibTrayLight);
}
