...
export class DileIconlibFishSimple extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-fish-simple')) {
  customElements.define('dile-phosphor-icon-fish-simple', DileIconlibFishSimple);
}
