...
export class DileIconlibFileCppFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-cpp-fill')) {
  customElements.define('dile-phosphor-icon-file-cpp-fill', DileIconlibFileCppFill);
}
