...
export class DileIconlibSubtitlesLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-subtitles-light')) {
  customElements.define('dile-phosphor-icon-subtitles-light', DileIconlibSubtitlesLight);
}
