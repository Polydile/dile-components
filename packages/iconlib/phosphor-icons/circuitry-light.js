...
export class DileIconlibCircuitryLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-circuitry-light')) {
  customElements.define('dile-phosphor-icon-circuitry-light', DileIconlibCircuitryLight);
}
