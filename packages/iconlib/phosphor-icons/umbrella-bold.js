...
export class DileIconlibUmbrellaBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-umbrella-bold')) {
  customElements.define('dile-phosphor-icon-umbrella-bold', DileIconlibUmbrellaBold);
}
