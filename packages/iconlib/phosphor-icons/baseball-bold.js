...
export class DileIconlibBaseballBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-baseball-bold')) {
  customElements.define('dile-phosphor-icon-baseball-bold', DileIconlibBaseballBold);
}
