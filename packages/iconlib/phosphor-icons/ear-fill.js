...
export class DileIconlibEarFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-ear-fill')) {
  customElements.define('dile-phosphor-icon-ear-fill', DileIconlibEarFill);
}
