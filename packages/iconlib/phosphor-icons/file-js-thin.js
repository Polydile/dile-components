...
export class DileIconlibFileJsThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-js-thin')) {
  customElements.define('dile-phosphor-icon-file-js-thin', DileIconlibFileJsThin);
}
