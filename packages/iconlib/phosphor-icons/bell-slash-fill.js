...
export class DileIconlibBellSlashFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-bell-slash-fill')) {
  customElements.define('dile-phosphor-icon-bell-slash-fill', DileIconlibBellSlashFill);
}
