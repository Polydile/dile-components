...
export class DileIconlibHandWithdraw extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-hand-withdraw')) {
  customElements.define('dile-phosphor-icon-hand-withdraw', DileIconlibHandWithdraw);
}
