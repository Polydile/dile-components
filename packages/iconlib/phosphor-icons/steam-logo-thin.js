...
export class DileIconlibSteamLogoThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-steam-logo-thin')) {
  customElements.define('dile-phosphor-icon-steam-logo-thin', DileIconlibSteamLogoThin);
}
