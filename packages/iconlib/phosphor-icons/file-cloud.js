...
export class DileIconlibFileCloud extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-cloud')) {
  customElements.define('dile-phosphor-icon-file-cloud', DileIconlibFileCloud);
}
