...
export class DileIconlibTipJarBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-tip-jar-bold')) {
  customElements.define('dile-phosphor-icon-tip-jar-bold', DileIconlibTipJarBold);
}
