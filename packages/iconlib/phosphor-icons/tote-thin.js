...
export class DileIconlibToteThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-tote-thin')) {
  customElements.define('dile-phosphor-icon-tote-thin', DileIconlibToteThin);
}
