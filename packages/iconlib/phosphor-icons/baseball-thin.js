...
export class DileIconlibBaseballThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-baseball-thin')) {
  customElements.define('dile-phosphor-icon-baseball-thin', DileIconlibBaseballThin);
}
