...
export class DileIconlibPokerChipBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-poker-chip-bold')) {
  customElements.define('dile-phosphor-icon-poker-chip-bold', DileIconlibPokerChipBold);
}
