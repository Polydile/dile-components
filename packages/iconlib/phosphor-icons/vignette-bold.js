...
export class DileIconlibVignetteBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-vignette-bold')) {
  customElements.define('dile-phosphor-icon-vignette-bold', DileIconlibVignetteBold);
}
