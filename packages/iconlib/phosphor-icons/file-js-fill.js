...
export class DileIconlibFileJsFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-js-fill')) {
  customElements.define('dile-phosphor-icon-file-js-fill', DileIconlibFileJsFill);
}
