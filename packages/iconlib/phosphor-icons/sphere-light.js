...
export class DileIconlibSphereLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-sphere-light')) {
  customElements.define('dile-phosphor-icon-sphere-light', DileIconlibSphereLight);
}
