...
export class DileIconlibKeyholeThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-keyhole-thin')) {
  customElements.define('dile-phosphor-icon-keyhole-thin', DileIconlibKeyholeThin);
}
