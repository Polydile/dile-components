...
export class DileIconlibFileRsLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-rs-light')) {
  customElements.define('dile-phosphor-icon-file-rs-light', DileIconlibFileRsLight);
}
