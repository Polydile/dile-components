...
export class DileIconlibEyedropperBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-eyedropper-bold')) {
  customElements.define('dile-phosphor-icon-eyedropper-bold', DileIconlibEyedropperBold);
}
