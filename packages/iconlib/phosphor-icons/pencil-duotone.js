...
export class DileIconlibPencilDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-pencil-duotone')) {
  customElements.define('dile-phosphor-icon-pencil-duotone', DileIconlibPencilDuotone);
}
