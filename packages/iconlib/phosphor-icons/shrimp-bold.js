...
export class DileIconlibShrimpBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-shrimp-bold')) {
  customElements.define('dile-phosphor-icon-shrimp-bold', DileIconlibShrimpBold);
}
