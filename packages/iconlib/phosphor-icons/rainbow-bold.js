...
export class DileIconlibRainbowBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-rainbow-bold')) {
  customElements.define('dile-phosphor-icon-rainbow-bold', DileIconlibRainbowBold);
}
