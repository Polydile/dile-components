...
export class DileIconlibGraphicsCard extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-graphics-card')) {
  customElements.define('dile-phosphor-icon-graphics-card', DileIconlibGraphicsCard);
}
