...
export class DileIconlibFilePyFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-py-fill')) {
  customElements.define('dile-phosphor-icon-file-py-fill', DileIconlibFilePyFill);
}
