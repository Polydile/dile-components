...
export class DileIconlibPokerChipThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-poker-chip-thin')) {
  customElements.define('dile-phosphor-icon-poker-chip-thin', DileIconlibPokerChipThin);
}
