...
export class DileIconlibLifebuoyBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-lifebuoy-bold')) {
  customElements.define('dile-phosphor-icon-lifebuoy-bold', DileIconlibLifebuoyBold);
}
