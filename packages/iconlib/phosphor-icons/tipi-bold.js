...
export class DileIconlibTipiBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-tipi-bold')) {
  customElements.define('dile-phosphor-icon-tipi-bold', DileIconlibTipiBold);
}
