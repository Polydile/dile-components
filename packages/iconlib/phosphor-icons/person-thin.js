...
export class DileIconlibPersonThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-person-thin')) {
  customElements.define('dile-phosphor-icon-person-thin', DileIconlibPersonThin);
}
