...
export class DileIconlibBellSlashBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-bell-slash-bold')) {
  customElements.define('dile-phosphor-icon-bell-slash-bold', DileIconlibBellSlashBold);
}
