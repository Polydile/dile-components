...
export class DileIconlibPantsBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-pants-bold')) {
  customElements.define('dile-phosphor-icon-pants-bold', DileIconlibPantsBold);
}
