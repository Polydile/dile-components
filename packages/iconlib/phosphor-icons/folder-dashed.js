...
export class DileIconlibFolderDashed extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-folder-dashed')) {
  customElements.define('dile-phosphor-icon-folder-dashed', DileIconlibFolderDashed);
}
