...
export class DileIconlibWaveSineBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-wave-sine-bold')) {
  customElements.define('dile-phosphor-icon-wave-sine-bold', DileIconlibWaveSineBold);
}
