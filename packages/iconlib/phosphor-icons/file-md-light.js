...
export class DileIconlibFileMdLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-md-light')) {
  customElements.define('dile-phosphor-icon-file-md-light', DileIconlibFileMdLight);
}
