...
export class DileIconlibVolleyballFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-volleyball-fill')) {
  customElements.define('dile-phosphor-icon-volleyball-fill', DileIconlibVolleyballFill);
}
