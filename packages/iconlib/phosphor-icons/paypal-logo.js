...
export class DileIconlibPaypalLogo extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-paypal-logo')) {
  customElements.define('dile-phosphor-icon-paypal-logo', DileIconlibPaypalLogo);
}
