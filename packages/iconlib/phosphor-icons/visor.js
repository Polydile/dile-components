...
export class DileIconlibVisor extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-visor')) {
  customElements.define('dile-phosphor-icon-visor', DileIconlibVisor);
}
