...
export class DileIconlibGavelThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-gavel-thin')) {
  customElements.define('dile-phosphor-icon-gavel-thin', DileIconlibGavelThin);
}
