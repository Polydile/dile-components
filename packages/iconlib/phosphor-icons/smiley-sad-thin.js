...
export class DileIconlibSmileySadThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-smiley-sad-thin')) {
  customElements.define('dile-phosphor-icon-smiley-sad-thin', DileIconlibSmileySadThin);
}
