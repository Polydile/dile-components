...
export class DileIconlibFileSql extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-sql')) {
  customElements.define('dile-phosphor-icon-file-sql', DileIconlibFileSql);
}
