...
export class DileIconlibHospitalBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-hospital-bold')) {
  customElements.define('dile-phosphor-icon-hospital-bold', DileIconlibHospitalBold);
}
