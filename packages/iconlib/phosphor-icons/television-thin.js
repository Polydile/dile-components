...
export class DileIconlibTelevisionThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-television-thin')) {
  customElements.define('dile-phosphor-icon-television-thin', DileIconlibTelevisionThin);
}
