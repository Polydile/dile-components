...
export class DileIconlibHoodie extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-hoodie')) {
  customElements.define('dile-phosphor-icon-hoodie', DileIconlibHoodie);
}
