...
export class DileIconlibDeskBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-desk-bold')) {
  customElements.define('dile-phosphor-icon-desk-bold', DileIconlibDeskBold);
}
