...
export class DileIconlibSmileyWinkThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-smiley-wink-thin')) {
  customElements.define('dile-phosphor-icon-smiley-wink-thin', DileIconlibSmileyWinkThin);
}
