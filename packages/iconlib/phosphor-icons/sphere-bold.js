...
export class DileIconlibSphereBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-sphere-bold')) {
  customElements.define('dile-phosphor-icon-sphere-bold', DileIconlibSphereBold);
}
