...
export class DileIconlibReceiptXBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-receipt-x-bold')) {
  customElements.define('dile-phosphor-icon-receipt-x-bold', DileIconlibReceiptXBold);
}
