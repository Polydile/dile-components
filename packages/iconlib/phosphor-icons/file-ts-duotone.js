...
export class DileIconlibFileTsDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-ts-duotone')) {
  customElements.define('dile-phosphor-icon-file-ts-duotone', DileIconlibFileTsDuotone);
}
