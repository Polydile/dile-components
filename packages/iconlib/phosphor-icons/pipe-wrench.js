...
export class DileIconlibPipeWrench extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-pipe-wrench')) {
  customElements.define('dile-phosphor-icon-pipe-wrench', DileIconlibPipeWrench);
}
