...
export class DileIconlibFileRs extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-rs')) {
  customElements.define('dile-phosphor-icon-file-rs', DileIconlibFileRs);
}
