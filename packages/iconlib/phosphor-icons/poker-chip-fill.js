...
export class DileIconlibPokerChipFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-poker-chip-fill')) {
  customElements.define('dile-phosphor-icon-poker-chip-fill', DileIconlibPokerChipFill);
}
