...
export class DileIconlibLighthouse extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-lighthouse')) {
  customElements.define('dile-phosphor-icon-lighthouse', DileIconlibLighthouse);
}
