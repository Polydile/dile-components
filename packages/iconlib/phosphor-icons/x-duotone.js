...
export class DileIconlibXDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-x-duotone')) {
  customElements.define('dile-phosphor-icon-x-duotone', DileIconlibXDuotone);
}
