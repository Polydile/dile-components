...
export class DileIconlibChartPolarBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-chart-polar-bold')) {
  customElements.define('dile-phosphor-icon-chart-polar-bold', DileIconlibChartPolarBold);
}
