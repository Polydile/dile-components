...
export class DileIconlibMaskSadFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-mask-sad-fill')) {
  customElements.define('dile-phosphor-icon-mask-sad-fill', DileIconlibMaskSadFill);
}
