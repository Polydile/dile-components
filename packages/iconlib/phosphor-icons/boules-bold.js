...
export class DileIconlibBoulesBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-boules-bold')) {
  customElements.define('dile-phosphor-icon-boules-bold', DileIconlibBoulesBold);
}
