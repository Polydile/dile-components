...
export class DileIconlibWavesFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-waves-fill')) {
  customElements.define('dile-phosphor-icon-waves-fill', DileIconlibWavesFill);
}
