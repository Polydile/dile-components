...
export class DileIconlibTriangle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-triangle')) {
  customElements.define('dile-phosphor-icon-triangle', DileIconlibTriangle);
}
