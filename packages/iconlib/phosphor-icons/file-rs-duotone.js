...
export class DileIconlibFileRsDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-rs-duotone')) {
  customElements.define('dile-phosphor-icon-file-rs-duotone', DileIconlibFileRsDuotone);
}
