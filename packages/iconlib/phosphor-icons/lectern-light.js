...
export class DileIconlibLecternLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-lectern-light')) {
  customElements.define('dile-phosphor-icon-lectern-light', DileIconlibLecternLight);
}
