...
export class DileIconlibFileTsBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-ts-bold')) {
  customElements.define('dile-phosphor-icon-file-ts-bold', DileIconlibFileTsBold);
}
