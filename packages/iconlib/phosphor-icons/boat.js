...
export class DileIconlibBoat extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-boat')) {
  customElements.define('dile-phosphor-icon-boat', DileIconlibBoat);
}
