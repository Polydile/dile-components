...
export class DileIconlibSpinnerGapFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-spinner-gap-fill')) {
  customElements.define('dile-phosphor-icon-spinner-gap-fill', DileIconlibSpinnerGapFill);
}
