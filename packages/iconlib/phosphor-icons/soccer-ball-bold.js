...
export class DileIconlibSoccerBallBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-soccer-ball-bold')) {
  customElements.define('dile-phosphor-icon-soccer-ball-bold', DileIconlibSoccerBallBold);
}
