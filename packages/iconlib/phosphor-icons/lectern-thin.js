...
export class DileIconlibLecternThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-lectern-thin')) {
  customElements.define('dile-phosphor-icon-lectern-thin', DileIconlibLecternThin);
}
