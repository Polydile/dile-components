...
export class DileIconlibChefHatBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-chef-hat-bold')) {
  customElements.define('dile-phosphor-icon-chef-hat-bold', DileIconlibChefHatBold);
}
