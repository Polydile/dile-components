...
export class DileIconlibFileMdFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-md-fill')) {
  customElements.define('dile-phosphor-icon-file-md-fill', DileIconlibFileMdFill);
}
