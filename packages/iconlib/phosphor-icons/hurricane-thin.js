...
export class DileIconlibHurricaneThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-hurricane-thin')) {
  customElements.define('dile-phosphor-icon-hurricane-thin', DileIconlibHurricaneThin);
}
