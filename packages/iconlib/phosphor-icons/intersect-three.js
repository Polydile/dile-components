...
export class DileIconlibIntersectThree extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-intersect-three')) {
  customElements.define('dile-phosphor-icon-intersect-three', DileIconlibIntersectThree);
}
