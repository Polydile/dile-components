...
export class DileIconlibExcludeLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-exclude-light')) {
  customElements.define('dile-phosphor-icon-exclude-light', DileIconlibExcludeLight);
}
