...
export class DileIconlibGitlabLogoFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-gitlab-logo-fill')) {
  customElements.define('dile-phosphor-icon-gitlab-logo-fill', DileIconlibGitlabLogoFill);
}
