...
export class DileIconlibFalloutShelter extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-fallout-shelter')) {
  customElements.define('dile-phosphor-icon-fallout-shelter', DileIconlibFalloutShelter);
}
