...
export class DileIconlibSmileyNervous extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-smiley-nervous')) {
  customElements.define('dile-phosphor-icon-smiley-nervous', DileIconlibSmileyNervous);
}
