...
export class DileIconlibSpiralThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-spiral-thin')) {
  customElements.define('dile-phosphor-icon-spiral-thin', DileIconlibSpiralThin);
}
