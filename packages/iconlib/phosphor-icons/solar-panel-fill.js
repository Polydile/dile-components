...
export class DileIconlibSolarPanelFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-solar-panel-fill')) {
  customElements.define('dile-phosphor-icon-solar-panel-fill', DileIconlibSolarPanelFill);
}
