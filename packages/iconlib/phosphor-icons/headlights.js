...
export class DileIconlibHeadlights extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-headlights')) {
  customElements.define('dile-phosphor-icon-headlights', DileIconlibHeadlights);
}
