...
export class DileIconlibPhoneList extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-phone-list')) {
  customElements.define('dile-phosphor-icon-phone-list', DileIconlibPhoneList);
}
