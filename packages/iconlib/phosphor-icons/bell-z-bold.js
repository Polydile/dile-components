...
export class DileIconlibBellZBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-bell-z-bold')) {
  customElements.define('dile-phosphor-icon-bell-z-bold', DileIconlibBellZBold);
}
