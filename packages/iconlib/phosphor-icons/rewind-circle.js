...
export class DileIconlibRewindCircle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-rewind-circle')) {
  customElements.define('dile-phosphor-icon-rewind-circle', DileIconlibRewindCircle);
}
