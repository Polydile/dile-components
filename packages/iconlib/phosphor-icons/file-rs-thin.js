...
export class DileIconlibFileRsThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-rs-thin')) {
  customElements.define('dile-phosphor-icon-file-rs-thin', DileIconlibFileRsThin);
}
