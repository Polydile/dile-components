...
export class DileIconlibFileCThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-c-thin')) {
  customElements.define('dile-phosphor-icon-file-c-thin', DileIconlibFileCThin);
}
