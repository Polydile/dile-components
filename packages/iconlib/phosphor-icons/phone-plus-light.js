...
export class DileIconlibPhonePlusLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-phone-plus-light')) {
  customElements.define('dile-phosphor-icon-phone-plus-light', DileIconlibPhonePlusLight);
}
