...
export class DileIconlibPanoramaBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-panorama-bold')) {
  customElements.define('dile-phosphor-icon-panorama-bold', DileIconlibPanoramaBold);
}
