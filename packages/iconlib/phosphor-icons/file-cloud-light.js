...
export class DileIconlibFileCloudLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-cloud-light')) {
  customElements.define('dile-phosphor-icon-file-cloud-light', DileIconlibFileCloudLight);
}
