...
export class DileIconlibSmiley extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-smiley')) {
  customElements.define('dile-phosphor-icon-smiley', DileIconlibSmiley);
}
