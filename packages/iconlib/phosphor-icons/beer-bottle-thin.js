...
export class DileIconlibBeerBottleThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-beer-bottle-thin')) {
  customElements.define('dile-phosphor-icon-beer-bottle-thin', DileIconlibBeerBottleThin);
}
