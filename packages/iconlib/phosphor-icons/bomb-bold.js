...
export class DileIconlibBombBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-bomb-bold')) {
  customElements.define('dile-phosphor-icon-bomb-bold', DileIconlibBombBold);
}
