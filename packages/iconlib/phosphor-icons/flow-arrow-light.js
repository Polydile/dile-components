...
export class DileIconlibFlowArrowLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-flow-arrow-light')) {
  customElements.define('dile-phosphor-icon-flow-arrow-light', DileIconlibFlowArrowLight);
}
