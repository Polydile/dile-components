...
export class DileIconlibFlowArrowThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-flow-arrow-thin')) {
  customElements.define('dile-phosphor-icon-flow-arrow-thin', DileIconlibFlowArrowThin);
}
