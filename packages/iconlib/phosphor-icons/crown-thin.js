...
export class DileIconlibCrownThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-crown-thin')) {
  customElements.define('dile-phosphor-icon-crown-thin', DileIconlibCrownThin);
}
