...
export class DileIconlibUserGearLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-user-gear-light')) {
  customElements.define('dile-phosphor-icon-user-gear-light', DileIconlibUserGearLight);
}
