...
export class DileIconlibFileJpgFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-jpg-fill')) {
  customElements.define('dile-phosphor-icon-file-jpg-fill', DileIconlibFileJpgFill);
}
