...
export class DileIconlibGitlabLogo extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-gitlab-logo')) {
  customElements.define('dile-phosphor-icon-gitlab-logo', DileIconlibGitlabLogo);
}
