...
export class DileIconlibToteBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-tote-bold')) {
  customElements.define('dile-phosphor-icon-tote-bold', DileIconlibToteBold);
}
