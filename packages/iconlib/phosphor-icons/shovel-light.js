...
export class DileIconlibShovelLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-shovel-light')) {
  customElements.define('dile-phosphor-icon-shovel-light', DileIconlibShovelLight);
}
