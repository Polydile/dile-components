...
export class DileIconlibScanSmiley extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-scan-smiley')) {
  customElements.define('dile-phosphor-icon-scan-smiley', DileIconlibScanSmiley);
}
