...
export class DileIconlibBeachBallThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-beach-ball-thin')) {
  customElements.define('dile-phosphor-icon-beach-ball-thin', DileIconlibBeachBallThin);
}
