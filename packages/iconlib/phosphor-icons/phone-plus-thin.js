...
export class DileIconlibPhonePlusThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-phone-plus-thin')) {
  customElements.define('dile-phosphor-icon-phone-plus-thin', DileIconlibPhonePlusThin);
}
