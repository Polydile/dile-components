...
export class DileIconlibMemoryBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-memory-bold')) {
  customElements.define('dile-phosphor-icon-memory-bold', DileIconlibMemoryBold);
}
