...
export class DileIconlibFilePyBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-py-bold')) {
  customElements.define('dile-phosphor-icon-file-py-bold', DileIconlibFilePyBold);
}
