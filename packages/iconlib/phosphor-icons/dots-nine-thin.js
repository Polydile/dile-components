...
export class DileIconlibDotsNineThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-dots-nine-thin')) {
  customElements.define('dile-phosphor-icon-dots-nine-thin', DileIconlibDotsNineThin);
}
