...
export class DileIconlibFilePngFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-png-fill')) {
  customElements.define('dile-phosphor-icon-file-png-fill', DileIconlibFilePngFill);
}
