...
export class DileIconlibPenDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-pen-duotone')) {
  customElements.define('dile-phosphor-icon-pen-duotone', DileIconlibPenDuotone);
}
