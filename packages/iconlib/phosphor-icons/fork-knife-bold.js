...
export class DileIconlibForkKnifeBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-fork-knife-bold')) {
  customElements.define('dile-phosphor-icon-fork-knife-bold', DileIconlibForkKnifeBold);
}
