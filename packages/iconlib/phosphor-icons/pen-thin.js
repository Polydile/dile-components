...
export class DileIconlibPenThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-pen-thin')) {
  customElements.define('dile-phosphor-icon-pen-thin', DileIconlibPenThin);
}
