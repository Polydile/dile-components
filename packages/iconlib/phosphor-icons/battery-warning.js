...
export class DileIconlibBatteryWarning extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-battery-warning')) {
  customElements.define('dile-phosphor-icon-battery-warning', DileIconlibBatteryWarning);
}
