...
export class DileIconlibUserMinusBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-user-minus-bold')) {
  customElements.define('dile-phosphor-icon-user-minus-bold', DileIconlibUserMinusBold);
}
