...
export class DileIconlibMoonStarsBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-moon-stars-bold')) {
  customElements.define('dile-phosphor-icon-moon-stars-bold', DileIconlibMoonStarsBold);
}
