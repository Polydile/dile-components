...
export class DileIconlibEngineFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-engine-fill')) {
  customElements.define('dile-phosphor-icon-engine-fill', DileIconlibEngineFill);
}
