...
export class DileIconlibBasketballBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-basketball-bold')) {
  customElements.define('dile-phosphor-icon-basketball-bold', DileIconlibBasketballBold);
}
