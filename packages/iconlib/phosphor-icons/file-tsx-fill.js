...
export class DileIconlibFileTsxFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-tsx-fill')) {
  customElements.define('dile-phosphor-icon-file-tsx-fill', DileIconlibFileTsxFill);
}
