...
export class DileIconlibFileCsvLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-csv-light')) {
  customElements.define('dile-phosphor-icon-file-csv-light', DileIconlibFileCsvLight);
}
