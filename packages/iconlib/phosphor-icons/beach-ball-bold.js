...
export class DileIconlibBeachBallBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-beach-ball-bold')) {
  customElements.define('dile-phosphor-icon-beach-ball-bold', DileIconlibBeachBallBold);
}
