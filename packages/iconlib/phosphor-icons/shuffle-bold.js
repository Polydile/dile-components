...
export class DileIconlibShuffleBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-shuffle-bold')) {
  customElements.define('dile-phosphor-icon-shuffle-bold', DileIconlibShuffleBold);
}
