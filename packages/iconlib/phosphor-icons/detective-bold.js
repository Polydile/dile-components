...
export class DileIconlibDetectiveBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-detective-bold')) {
  customElements.define('dile-phosphor-icon-detective-bold', DileIconlibDetectiveBold);
}
