...
export class DileIconlibArrowsOutLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-arrows-out-light')) {
  customElements.define('dile-phosphor-icon-arrows-out-light', DileIconlibArrowsOutLight);
}
