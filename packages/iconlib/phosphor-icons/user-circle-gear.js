...
export class DileIconlibUserCircleGear extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-user-circle-gear')) {
  customElements.define('dile-phosphor-icon-user-circle-gear', DileIconlibUserCircleGear);
}
