...
export class DileIconlibNyTimesLogo extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-ny-times-logo')) {
  customElements.define('dile-phosphor-icon-ny-times-logo', DileIconlibNyTimesLogo);
}
