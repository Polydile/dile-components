...
export class DileIconlibPenNibThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-pen-nib-thin')) {
  customElements.define('dile-phosphor-icon-pen-nib-thin', DileIconlibPenNibThin);
}
