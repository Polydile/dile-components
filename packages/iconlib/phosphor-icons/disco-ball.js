...
export class DileIconlibDiscoBall extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-disco-ball')) {
  customElements.define('dile-phosphor-icon-disco-ball', DileIconlibDiscoBall);
}
