...
export class DileIconlibPhoneListBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-phone-list-bold')) {
  customElements.define('dile-phosphor-icon-phone-list-bold', DileIconlibPhoneListBold);
}
