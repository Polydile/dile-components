...
export class DileIconlibFileRsFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-rs-fill')) {
  customElements.define('dile-phosphor-icon-file-rs-fill', DileIconlibFileRsFill);
}
