...
export class DileIconlibDropHalfLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-drop-half-light')) {
  customElements.define('dile-phosphor-icon-drop-half-light', DileIconlibDropHalfLight);
}
