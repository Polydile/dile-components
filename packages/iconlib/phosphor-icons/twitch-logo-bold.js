...
export class DileIconlibTwitchLogoBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-twitch-logo-bold')) {
  customElements.define('dile-phosphor-icon-twitch-logo-bold', DileIconlibTwitchLogoBold);
}
