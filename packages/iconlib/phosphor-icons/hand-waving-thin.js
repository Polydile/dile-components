...
export class DileIconlibHandWavingThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-hand-waving-thin')) {
  customElements.define('dile-phosphor-icon-hand-waving-thin', DileIconlibHandWavingThin);
}
