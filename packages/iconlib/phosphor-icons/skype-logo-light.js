...
export class DileIconlibSkypeLogoLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-skype-logo-light')) {
  customElements.define('dile-phosphor-icon-skype-logo-light', DileIconlibSkypeLogoLight);
}
