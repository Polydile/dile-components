...
export class DileIconlibBeachBall extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-beach-ball')) {
  customElements.define('dile-phosphor-icon-beach-ball', DileIconlibBeachBall);
}
