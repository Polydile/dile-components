...
export class DileIconlibTildeDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-tilde-duotone')) {
  customElements.define('dile-phosphor-icon-tilde-duotone', DileIconlibTildeDuotone);
}
