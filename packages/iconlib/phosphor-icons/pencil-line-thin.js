...
export class DileIconlibPencilLineThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-pencil-line-thin')) {
  customElements.define('dile-phosphor-icon-pencil-line-thin', DileIconlibPencilLineThin);
}
