...
export class DileIconlibChecksDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-checks-duotone')) {
  customElements.define('dile-phosphor-icon-checks-duotone', DileIconlibChecksDuotone);
}
