...
export class DileIconlibOctagonDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-octagon-duotone')) {
  customElements.define('dile-phosphor-icon-octagon-duotone', DileIconlibOctagonDuotone);
}
