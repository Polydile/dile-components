...
export class DileIconlibFileCppThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-cpp-thin')) {
  customElements.define('dile-phosphor-icon-file-cpp-thin', DileIconlibFileCppThin);
}
