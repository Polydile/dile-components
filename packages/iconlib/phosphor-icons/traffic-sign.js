...
export class DileIconlibTrafficSign extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-traffic-sign')) {
  customElements.define('dile-phosphor-icon-traffic-sign', DileIconlibTrafficSign);
}
