...
export class DileIconlibTrolleyFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-trolley-fill')) {
  customElements.define('dile-phosphor-icon-trolley-fill', DileIconlibTrolleyFill);
}
