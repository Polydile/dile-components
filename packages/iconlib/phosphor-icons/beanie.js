...
export class DileIconlibBeanie extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-beanie')) {
  customElements.define('dile-phosphor-icon-beanie', DileIconlibBeanie);
}
