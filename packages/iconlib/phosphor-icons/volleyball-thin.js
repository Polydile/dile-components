...
export class DileIconlibVolleyballThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-volleyball-thin')) {
  customElements.define('dile-phosphor-icon-volleyball-thin', DileIconlibVolleyballThin);
}
