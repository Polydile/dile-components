...
export class DileIconlibFileRsBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-rs-bold')) {
  customElements.define('dile-phosphor-icon-file-rs-bold', DileIconlibFileRsBold);
}
