...
export class DileIconlibCloudSlashBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-cloud-slash-bold')) {
  customElements.define('dile-phosphor-icon-cloud-slash-bold', DileIconlibCloudSlashBold);
}
