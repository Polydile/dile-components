...
export class DileIconlibDropDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-drop-duotone')) {
  customElements.define('dile-phosphor-icon-drop-duotone', DileIconlibDropDuotone);
}
