...
export class DileIconlibNeedle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-needle')) {
  customElements.define('dile-phosphor-icon-needle', DileIconlibNeedle);
}
