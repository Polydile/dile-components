...
export class DileIconlibCloudXDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-cloud-x-duotone')) {
  customElements.define('dile-phosphor-icon-cloud-x-duotone', DileIconlibCloudXDuotone);
}
