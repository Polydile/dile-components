...
export class DileIconlibSteamLogo extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-steam-logo')) {
  customElements.define('dile-phosphor-icon-steam-logo', DileIconlibSteamLogo);
}
