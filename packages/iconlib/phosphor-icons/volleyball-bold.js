...
export class DileIconlibVolleyballBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-volleyball-bold')) {
  customElements.define('dile-phosphor-icon-volleyball-bold', DileIconlibVolleyballBold);
}
