...
export class DileIconlibMopedFront extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-moped-front')) {
  customElements.define('dile-phosphor-icon-moped-front', DileIconlibMopedFront);
}
