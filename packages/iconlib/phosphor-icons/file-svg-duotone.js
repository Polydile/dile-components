...
export class DileIconlibFileSvgDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-svg-duotone')) {
  customElements.define('dile-phosphor-icon-file-svg-duotone', DileIconlibFileSvgDuotone);
}
