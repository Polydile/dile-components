...
export class DileIconlibFlameDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-flame-duotone')) {
  customElements.define('dile-phosphor-icon-flame-duotone', DileIconlibFlameDuotone);
}
