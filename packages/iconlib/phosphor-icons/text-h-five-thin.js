...
export class DileIconlibTextHFiveThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-text-h-five-thin')) {
  customElements.define('dile-phosphor-icon-text-h-five-thin', DileIconlibTextHFiveThin);
}
