...
export class DileIconlibLockKeyDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-lock-key-duotone')) {
  customElements.define('dile-phosphor-icon-lock-key-duotone', DileIconlibLockKeyDuotone);
}
