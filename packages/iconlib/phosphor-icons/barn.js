...
export class DileIconlibBarn extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-barn')) {
  customElements.define('dile-phosphor-icon-barn', DileIconlibBarn);
}
