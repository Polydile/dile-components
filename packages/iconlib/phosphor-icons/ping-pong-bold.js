...
export class DileIconlibPingPongBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-ping-pong-bold')) {
  customElements.define('dile-phosphor-icon-ping-pong-bold', DileIconlibPingPongBold);
}
