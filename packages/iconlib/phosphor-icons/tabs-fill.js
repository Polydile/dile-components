...
export class DileIconlibTabsFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-tabs-fill')) {
  customElements.define('dile-phosphor-icon-tabs-fill', DileIconlibTabsFill);
}
