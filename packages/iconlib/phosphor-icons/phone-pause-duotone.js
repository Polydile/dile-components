...
export class DileIconlibPhonePauseDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-phone-pause-duotone')) {
  customElements.define('dile-phosphor-icon-phone-pause-duotone', DileIconlibPhonePauseDuotone);
}
