...
export class DileIconlibBasketballThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-basketball-thin')) {
  customElements.define('dile-phosphor-icon-basketball-thin', DileIconlibBasketballThin);
}
