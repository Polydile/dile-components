...
export class DileIconlibDiceSixLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-dice-six-light')) {
  customElements.define('dile-phosphor-icon-dice-six-light', DileIconlibDiceSixLight);
}
