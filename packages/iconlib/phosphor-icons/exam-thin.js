...
export class DileIconlibExamThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-exam-thin')) {
  customElements.define('dile-phosphor-icon-exam-thin', DileIconlibExamThin);
}
