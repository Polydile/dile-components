...
export class DileIconlibSoccerBallThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-soccer-ball-thin')) {
  customElements.define('dile-phosphor-icon-soccer-ball-thin', DileIconlibSoccerBallThin);
}
