...
export class DileIconlibDropHalfThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-drop-half-thin')) {
  customElements.define('dile-phosphor-icon-drop-half-thin', DileIconlibDropHalfThin);
}
