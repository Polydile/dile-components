...
export class DileIconlibShovelThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-shovel-thin')) {
  customElements.define('dile-phosphor-icon-shovel-thin', DileIconlibShovelThin);
}
