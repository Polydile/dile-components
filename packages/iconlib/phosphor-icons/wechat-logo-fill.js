...
export class DileIconlibWechatLogoFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-wechat-logo-fill')) {
  customElements.define('dile-phosphor-icon-wechat-logo-fill', DileIconlibWechatLogoFill);
}
