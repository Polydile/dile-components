...
export class DileIconlibLastfmLogoThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-lastfm-logo-thin')) {
  customElements.define('dile-phosphor-icon-lastfm-logo-thin', DileIconlibLastfmLogoThin);
}
