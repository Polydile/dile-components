...
export class DileIconlibDrop extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-drop')) {
  customElements.define('dile-phosphor-icon-drop', DileIconlibDrop);
}
