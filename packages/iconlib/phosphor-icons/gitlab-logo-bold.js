...
export class DileIconlibGitlabLogoBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-gitlab-logo-bold')) {
  customElements.define('dile-phosphor-icon-gitlab-logo-bold', DileIconlibGitlabLogoBold);
}
