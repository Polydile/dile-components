...
export class DileIconlibFileXLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-x-light')) {
  customElements.define('dile-phosphor-icon-file-x-light', DileIconlibFileXLight);
}
