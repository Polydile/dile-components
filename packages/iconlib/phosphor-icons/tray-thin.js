...
export class DileIconlibTrayThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-tray-thin')) {
  customElements.define('dile-phosphor-icon-tray-thin', DileIconlibTrayThin);
}
