...
export class DileIconlibBrainThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-brain-thin')) {
  customElements.define('dile-phosphor-icon-brain-thin', DileIconlibBrainThin);
}
