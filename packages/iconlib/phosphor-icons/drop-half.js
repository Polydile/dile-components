...
export class DileIconlibDropHalf extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-drop-half')) {
  customElements.define('dile-phosphor-icon-drop-half', DileIconlibDropHalf);
}
