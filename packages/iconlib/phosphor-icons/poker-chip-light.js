...
export class DileIconlibPokerChipLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-poker-chip-light')) {
  customElements.define('dile-phosphor-icon-poker-chip-light', DileIconlibPokerChipLight);
}
