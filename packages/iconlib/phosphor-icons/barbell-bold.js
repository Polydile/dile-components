...
export class DileIconlibBarbellBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-barbell-bold')) {
  customElements.define('dile-phosphor-icon-barbell-bold', DileIconlibBarbellBold);
}
