...
export class DileIconlibPhoneTransfer extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-phone-transfer')) {
  customElements.define('dile-phosphor-icon-phone-transfer', DileIconlibPhoneTransfer);
}
