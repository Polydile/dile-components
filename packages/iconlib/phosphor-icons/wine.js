...
export class DileIconlibWine extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-wine')) {
  customElements.define('dile-phosphor-icon-wine', DileIconlibWine);
}
