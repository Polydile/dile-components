...
export class DileIconlibCricket extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-cricket')) {
  customElements.define('dile-phosphor-icon-cricket', DileIconlibCricket);
}
