...
export class DileIconlibJarLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-jar-light')) {
  customElements.define('dile-phosphor-icon-jar-light', DileIconlibJarLight);
}
