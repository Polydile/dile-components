...
export class DileIconlibFileJsxFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-jsx-fill')) {
  customElements.define('dile-phosphor-icon-file-jsx-fill', DileIconlibFileJsxFill);
}
