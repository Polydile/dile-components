...
export class DileIconlibBellZDuotone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-bell-z-duotone')) {
  customElements.define('dile-phosphor-icon-bell-z-duotone', DileIconlibBellZDuotone);
}
