...
export class DileIconlibTipJarLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-tip-jar-light')) {
  customElements.define('dile-phosphor-icon-tip-jar-light', DileIconlibTipJarLight);
}
