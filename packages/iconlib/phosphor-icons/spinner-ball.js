...
export class DileIconlibSpinnerBall extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-spinner-ball')) {
  customElements.define('dile-phosphor-icon-spinner-ball', DileIconlibSpinnerBall);
}
