...
export class DileIconlibPhoneListThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-phone-list-thin')) {
  customElements.define('dile-phosphor-icon-phone-list-thin', DileIconlibPhoneListThin);
}
