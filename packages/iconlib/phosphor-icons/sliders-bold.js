...
export class DileIconlibSlidersBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-sliders-bold')) {
  customElements.define('dile-phosphor-icon-sliders-bold', DileIconlibSlidersBold);
}
