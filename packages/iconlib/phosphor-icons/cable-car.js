...
export class DileIconlibCableCar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-cable-car')) {
  customElements.define('dile-phosphor-icon-cable-car', DileIconlibCableCar);
}
