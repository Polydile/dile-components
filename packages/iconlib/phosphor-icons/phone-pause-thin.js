...
export class DileIconlibPhonePauseThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-phone-pause-thin')) {
  customElements.define('dile-phosphor-icon-phone-pause-thin', DileIconlibPhonePauseThin);
}
