...
export class DileIconlibFileJsBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-js-bold')) {
  customElements.define('dile-phosphor-icon-file-js-bold', DileIconlibFileJsBold);
}
