...
export class DileIconlibPipe extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-pipe')) {
  customElements.define('dile-phosphor-icon-pipe', DileIconlibPipe);
}
