...
export class DileIconlibWebcamSlash extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-webcam-slash')) {
  customElements.define('dile-phosphor-icon-webcam-slash', DileIconlibWebcamSlash);
}
