...
export class DileIconlibUmbrellaThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-umbrella-thin')) {
  customElements.define('dile-phosphor-icon-umbrella-thin', DileIconlibUmbrellaThin);
}
