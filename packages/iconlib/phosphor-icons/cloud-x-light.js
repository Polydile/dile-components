...
export class DileIconlibCloudXLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-cloud-x-light')) {
  customElements.define('dile-phosphor-icon-cloud-x-light', DileIconlibCloudXLight);
}
