...
export class DileIconlibFilePyLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-py-light')) {
  customElements.define('dile-phosphor-icon-file-py-light', DileIconlibFilePyLight);
}
