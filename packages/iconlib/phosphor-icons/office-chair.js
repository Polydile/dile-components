...
export class DileIconlibOfficeChair extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-office-chair')) {
  customElements.define('dile-phosphor-icon-office-chair', DileIconlibOfficeChair);
}
