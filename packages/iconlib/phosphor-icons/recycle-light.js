...
export class DileIconlibRecycleLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-recycle-light')) {
  customElements.define('dile-phosphor-icon-recycle-light', DileIconlibRecycleLight);
}
