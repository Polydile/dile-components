...
export class DileIconlibStool extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-stool')) {
  customElements.define('dile-phosphor-icon-stool', DileIconlibStool);
}
