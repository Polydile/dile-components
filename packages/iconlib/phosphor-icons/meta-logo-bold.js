...
export class DileIconlibMetaLogoBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-meta-logo-bold')) {
  customElements.define('dile-phosphor-icon-meta-logo-bold', DileIconlibMetaLogoBold);
}
