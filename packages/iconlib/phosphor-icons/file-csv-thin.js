...
export class DileIconlibFileCsvThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-file-csv-thin')) {
  customElements.define('dile-phosphor-icon-file-csv-thin', DileIconlibFileCsvThin);
}
