...
export class DileIconlibSphereThin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-sphere-thin')) {
  customElements.define('dile-phosphor-icon-sphere-thin', DileIconlibSphereThin);
}
