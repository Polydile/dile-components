...
export class DileIconlibTrainBold extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-train-bold')) {
  customElements.define('dile-phosphor-icon-train-bold', DileIconlibTrainBold);
}
