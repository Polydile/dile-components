...
export class DileIconlibBaseballLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-baseball-light')) {
  customElements.define('dile-phosphor-icon-baseball-light', DileIconlibBaseballLight);
}
