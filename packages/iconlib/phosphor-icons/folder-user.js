...
export class DileIconlibFolderUser extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-folder-user')) {
  customElements.define('dile-phosphor-icon-folder-user', DileIconlibFolderUser);
}
