...
export class DileIconlibBoules extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-boules')) {
  customElements.define('dile-phosphor-icon-boules', DileIconlibBoules);
}
