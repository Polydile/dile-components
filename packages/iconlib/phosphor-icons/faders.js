...
export class DileIconlibFaders extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-faders')) {
  customElements.define('dile-phosphor-icon-faders', DileIconlibFaders);
}
