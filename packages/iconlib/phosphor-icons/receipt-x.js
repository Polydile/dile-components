...
export class DileIconlibReceiptX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-receipt-x')) {
  customElements.define('dile-phosphor-icon-receipt-x', DileIconlibReceiptX);
}
