...
export class DileIconlibBugDroidLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-bug-droid-light')) {
  customElements.define('dile-phosphor-icon-bug-droid-light', DileIconlibBugDroidLight);
}
