...
export class DileIconlibMoneyWavyFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-phosphor-icon-money-wavy-fill')) {
  customElements.define('dile-phosphor-icon-money-wavy-fill', DileIconlibMoneyWavyFill);
}
