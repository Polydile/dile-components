...
export class DileIconlibHandbagLine extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-remixicon-icon-handbag-line')) {
  customElements.define('dile-remixicon-icon-handbag-line', DileIconlibHandbagLine);
}
