...
export class DileIconlibSubwayLine extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-remixicon-icon-subway-line')) {
  customElements.define('dile-remixicon-icon-subway-line', DileIconlibSubwayLine);
}
