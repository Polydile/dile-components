...
export class DileIconlibCloudy2Line extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-remixicon-icon-cloudy-2-line')) {
  customElements.define('dile-remixicon-icon-cloudy-2-line', DileIconlibCloudy2Line);
}
