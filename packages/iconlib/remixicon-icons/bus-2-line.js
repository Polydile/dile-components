...
export class DileIconlibBus2Line extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-remixicon-icon-bus-2-line')) {
  customElements.define('dile-remixicon-icon-bus-2-line', DileIconlibBus2Line);
}
