...
export class DileIconlibHeartLine extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-remixicon-icon-heart-line')) {
  customElements.define('dile-remixicon-icon-heart-line', DileIconlibHeartLine);
}
