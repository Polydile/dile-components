...
export class DileIconlibExchange2Line extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-remixicon-icon-exchange-2-line')) {
  customElements.define('dile-remixicon-icon-exchange-2-line', DileIconlibExchange2Line);
}
