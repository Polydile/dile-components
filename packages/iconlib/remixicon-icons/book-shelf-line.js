...
export class DileIconlibBookShelfLine extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-remixicon-icon-book-shelf-line')) {
  customElements.define('dile-remixicon-icon-book-shelf-line', DileIconlibBookShelfLine);
}
