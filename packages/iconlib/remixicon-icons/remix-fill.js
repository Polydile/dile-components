...
export class DileIconlibRemixFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-remixicon-icon-remix-fill')) {
  customElements.define('dile-remixicon-icon-remix-fill', DileIconlibRemixFill);
}
