...
export class DileIconlibAirplayLine extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-remixicon-icon-airplay-line')) {
  customElements.define('dile-remixicon-icon-airplay-line', DileIconlibAirplayLine);
}
