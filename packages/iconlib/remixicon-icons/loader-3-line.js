...
export class DileIconlibLoader3Line extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-remixicon-icon-loader-3-line')) {
  customElements.define('dile-remixicon-icon-loader-3-line', DileIconlibLoader3Line);
}
