...
export class DileIconlibTestTubeLine extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-remixicon-icon-test-tube-line')) {
  customElements.define('dile-remixicon-icon-test-tube-line', DileIconlibTestTubeLine);
}
