...
export class DileIconlibReplay10Fill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-remixicon-icon-replay-10-fill')) {
  customElements.define('dile-remixicon-icon-replay-10-fill', DileIconlibReplay10Fill);
}
