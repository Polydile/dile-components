...
export class DileIconlibMailCloseFill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-remixicon-icon-mail-close-fill')) {
  customElements.define('dile-remixicon-icon-mail-close-fill', DileIconlibMailCloseFill);
}
