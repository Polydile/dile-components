...
export class DileIconlibEmotionLine extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-remixicon-icon-emotion-line')) {
  customElements.define('dile-remixicon-icon-emotion-line', DileIconlibEmotionLine);
}
