...
export class DileIconlibHazeLine extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-remixicon-icon-haze-line')) {
  customElements.define('dile-remixicon-icon-haze-line', DileIconlibHazeLine);
}
