...
export class DileIconlibCss extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-css')) {
  customElements.define('dile-material-icon-css', DileIconlibCss);
}
