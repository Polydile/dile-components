...
export class DileIconlibExplore extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-explore')) {
  customElements.define('dile-material-icon-explore', DileIconlibExplore);
}
