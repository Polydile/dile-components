...
export class DileIconlibPanToolAlt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-pan-tool-alt')) {
  customElements.define('dile-material-icon-pan-tool-alt', DileIconlibPanToolAlt);
}
