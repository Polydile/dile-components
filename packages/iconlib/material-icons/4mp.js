...
export class DileIconlib4mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-4mp')) {
  customElements.define('dile-material-icon-4mp', DileIconlib4mp);
}
