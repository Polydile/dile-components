...
export class DileIconlibThumbUpAlt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-thumb-up-alt')) {
  customElements.define('dile-material-icon-thumb-up-alt', DileIconlibThumbUpAlt);
}
