...
export class DileIconlibSubtitlesOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-subtitles-off')) {
  customElements.define('dile-material-icon-subtitles-off', DileIconlibSubtitlesOff);
}
