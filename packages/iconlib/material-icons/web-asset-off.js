...
export class DileIconlibWebAssetOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-web-asset-off')) {
  customElements.define('dile-material-icon-web-asset-off', DileIconlibWebAssetOff);
}
