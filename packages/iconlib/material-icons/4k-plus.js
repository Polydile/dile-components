...
export class DileIconlib4kPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-4k-plus')) {
  customElements.define('dile-material-icon-4k-plus', DileIconlib4kPlus);
}
