...
export class DileIconlibPianoOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-piano-off')) {
  customElements.define('dile-material-icon-piano-off', DileIconlibPianoOff);
}
