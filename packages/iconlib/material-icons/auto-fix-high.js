...
export class DileIconlibAutoFixHigh extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-auto-fix-high')) {
  customElements.define('dile-material-icon-auto-fix-high', DileIconlibAutoFixHigh);
}
