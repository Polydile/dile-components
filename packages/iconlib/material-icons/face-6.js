...
export class DileIconlibFace6 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-face-6')) {
  customElements.define('dile-material-icon-face-6', DileIconlibFace6);
}
