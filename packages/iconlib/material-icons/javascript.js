...
export class DileIconlibJavascript extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-javascript')) {
  customElements.define('dile-material-icon-javascript', DileIconlibJavascript);
}
