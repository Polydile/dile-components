...
export class DileIconlibAddCard extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-add-card')) {
  customElements.define('dile-material-icon-add-card', DileIconlibAddCard);
}
