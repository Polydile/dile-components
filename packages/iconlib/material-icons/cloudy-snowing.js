...
export class DileIconlibCloudySnowing extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-cloudy-snowing')) {
  customElements.define('dile-material-icon-cloudy-snowing', DileIconlibCloudySnowing);
}
