...
export class DileIconlibDirectionsBoat extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-directions-boat')) {
  customElements.define('dile-material-icon-directions-boat', DileIconlibDirectionsBoat);
}
