...
export class DileIconlibPodcasts extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-podcasts')) {
  customElements.define('dile-material-icon-podcasts', DileIconlibPodcasts);
}
