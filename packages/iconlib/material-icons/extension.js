...
export class DileIconlibExtension extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-extension')) {
  customElements.define('dile-material-icon-extension', DileIconlibExtension);
}
