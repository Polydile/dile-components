...
export class DileIconlibSpeakerPhone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-speaker-phone')) {
  customElements.define('dile-material-icon-speaker-phone', DileIconlibSpeakerPhone);
}
