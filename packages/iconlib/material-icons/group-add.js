...
export class DileIconlibGroupAdd extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-group-add')) {
  customElements.define('dile-material-icon-group-add', DileIconlibGroupAdd);
}
