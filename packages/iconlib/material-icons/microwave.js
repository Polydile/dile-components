...
export class DileIconlibMicrowave extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-microwave')) {
  customElements.define('dile-material-icon-microwave', DileIconlibMicrowave);
}
