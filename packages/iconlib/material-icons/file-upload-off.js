...
export class DileIconlibFileUploadOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-file-upload-off')) {
  customElements.define('dile-material-icon-file-upload-off', DileIconlibFileUploadOff);
}
