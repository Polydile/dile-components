...
export class DileIconlibTask extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-task')) {
  customElements.define('dile-material-icon-task', DileIconlibTask);
}
