...
export class DileIconlibWifi2Bar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-wifi-2-bar')) {
  customElements.define('dile-material-icon-wifi-2-bar', DileIconlibWifi2Bar);
}
