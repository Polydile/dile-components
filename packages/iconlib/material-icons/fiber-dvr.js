...
export class DileIconlibFiberDvr extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-fiber-dvr')) {
  customElements.define('dile-material-icon-fiber-dvr', DileIconlibFiberDvr);
}
