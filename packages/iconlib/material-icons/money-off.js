...
export class DileIconlibMoneyOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-money-off')) {
  customElements.define('dile-material-icon-money-off', DileIconlibMoneyOff);
}
