...
export class DileIconlibPerson3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-person-3')) {
  customElements.define('dile-material-icon-person-3', DileIconlibPerson3);
}
