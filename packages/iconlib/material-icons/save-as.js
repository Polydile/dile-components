...
export class DileIconlibSaveAs extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-save-as')) {
  customElements.define('dile-material-icon-save-as', DileIconlibSaveAs);
}
