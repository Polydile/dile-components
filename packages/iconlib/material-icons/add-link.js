...
export class DileIconlibAddLink extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-add-link')) {
  customElements.define('dile-material-icon-add-link', DileIconlibAddLink);
}
