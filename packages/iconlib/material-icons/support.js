...
export class DileIconlibSupport extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-support')) {
  customElements.define('dile-material-icon-support', DileIconlibSupport);
}
