...
export class DileIconlibMultipleStop extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-multiple-stop')) {
  customElements.define('dile-material-icon-multiple-stop', DileIconlibMultipleStop);
}
