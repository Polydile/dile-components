...
export class DileIconlibGrading extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-grading')) {
  customElements.define('dile-material-icon-grading', DileIconlibGrading);
}
