...
export class DileIconlibFmdGood extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-fmd-good')) {
  customElements.define('dile-material-icon-fmd-good', DileIconlibFmdGood);
}
