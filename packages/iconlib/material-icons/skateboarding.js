...
export class DileIconlibSkateboarding extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-skateboarding')) {
  customElements.define('dile-material-icon-skateboarding', DileIconlibSkateboarding);
}
