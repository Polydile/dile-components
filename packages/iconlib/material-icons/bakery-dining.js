...
export class DileIconlibBakeryDining extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-bakery-dining')) {
  customElements.define('dile-material-icon-bakery-dining', DileIconlibBakeryDining);
}
