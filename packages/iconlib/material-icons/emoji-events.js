...
export class DileIconlibEmojiEvents extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-emoji-events')) {
  customElements.define('dile-material-icon-emoji-events', DileIconlibEmojiEvents);
}
