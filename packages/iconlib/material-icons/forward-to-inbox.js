...
export class DileIconlibForwardToInbox extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-forward-to-inbox')) {
  customElements.define('dile-material-icon-forward-to-inbox', DileIconlibForwardToInbox);
}
