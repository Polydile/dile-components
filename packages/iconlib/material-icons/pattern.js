...
export class DileIconlibPattern extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-pattern')) {
  customElements.define('dile-material-icon-pattern', DileIconlibPattern);
}
