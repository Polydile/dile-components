...
export class DileIconlibStars extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-stars')) {
  customElements.define('dile-material-icon-stars', DileIconlibStars);
}
