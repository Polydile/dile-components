...
export class DileIconlibShop2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-shop-2')) {
  customElements.define('dile-material-icon-shop-2', DileIconlibShop2);
}
