...
export class DileIconlib15mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-15mp')) {
  customElements.define('dile-material-icon-15mp', DileIconlib15mp);
}
