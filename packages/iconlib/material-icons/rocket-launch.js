...
export class DileIconlibRocketLaunch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-rocket-launch')) {
  customElements.define('dile-material-icon-rocket-launch', DileIconlibRocketLaunch);
}
