...
export class DileIconlibMore extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-more')) {
  customElements.define('dile-material-icon-more', DileIconlibMore);
}
