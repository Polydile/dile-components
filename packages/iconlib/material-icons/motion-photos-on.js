...
export class DileIconlibMotionPhotosOn extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-motion-photos-on')) {
  customElements.define('dile-material-icon-motion-photos-on', DileIconlibMotionPhotosOn);
}
