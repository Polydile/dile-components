...
export class DileIconlibRowing extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-rowing')) {
  customElements.define('dile-material-icon-rowing', DileIconlibRowing);
}
