...
export class DileIconlibScreenRotation extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-screen-rotation')) {
  customElements.define('dile-material-icon-screen-rotation', DileIconlibScreenRotation);
}
