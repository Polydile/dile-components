...
export class DileIconlibPhoneDisabled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-phone-disabled')) {
  customElements.define('dile-material-icon-phone-disabled', DileIconlibPhoneDisabled);
}
