...
export class DileIconlibHdrAutoSelect extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-hdr-auto-select')) {
  customElements.define('dile-material-icon-hdr-auto-select', DileIconlibHdrAutoSelect);
}
