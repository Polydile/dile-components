...
export class DileIconlibCast extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-cast')) {
  customElements.define('dile-material-icon-cast', DileIconlibCast);
}
