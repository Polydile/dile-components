...
export class DileIconlibCampaign extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-campaign')) {
  customElements.define('dile-material-icon-campaign', DileIconlibCampaign);
}
