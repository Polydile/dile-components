...
export class DileIconlibEventAvailable extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-event-available')) {
  customElements.define('dile-material-icon-event-available', DileIconlibEventAvailable);
}
