...
export class DileIconlibWorkspaces extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-workspaces')) {
  customElements.define('dile-material-icon-workspaces', DileIconlibWorkspaces);
}
