...
export class DileIconlibPhoneIphone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-phone-iphone')) {
  customElements.define('dile-material-icon-phone-iphone', DileIconlibPhoneIphone);
}
