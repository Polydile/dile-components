...
export class DileIconlibDomainDisabled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-domain-disabled')) {
  customElements.define('dile-material-icon-domain-disabled', DileIconlibDomainDisabled);
}
