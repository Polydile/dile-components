...
export class DileIconlibBrightness5 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-brightness-5')) {
  customElements.define('dile-material-icon-brightness-5', DileIconlibBrightness5);
}
