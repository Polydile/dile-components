...
export class DileIconlib17mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-17mp')) {
  customElements.define('dile-material-icon-17mp', DileIconlib17mp);
}
