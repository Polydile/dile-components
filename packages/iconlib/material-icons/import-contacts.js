...
export class DileIconlibImportContacts extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-import-contacts')) {
  customElements.define('dile-material-icon-import-contacts', DileIconlibImportContacts);
}
