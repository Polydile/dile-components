...
export class DileIconlibApartment extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-apartment')) {
  customElements.define('dile-material-icon-apartment', DileIconlibApartment);
}
