...
export class DileIconlibThumbDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-thumb-down')) {
  customElements.define('dile-material-icon-thumb-down', DileIconlibThumbDown);
}
