...
export class DileIconlibAcUnit extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-ac-unit')) {
  customElements.define('dile-material-icon-ac-unit', DileIconlibAcUnit);
}
