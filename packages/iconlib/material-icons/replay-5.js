...
export class DileIconlibReplay5 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-replay-5')) {
  customElements.define('dile-material-icon-replay-5', DileIconlibReplay5);
}
