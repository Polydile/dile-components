...
export class DileIconlibQrCodeScanner extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-qr-code-scanner')) {
  customElements.define('dile-material-icon-qr-code-scanner', DileIconlibQrCodeScanner);
}
