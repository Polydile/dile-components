...
export class DileIconlibDevicesOther extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-devices-other')) {
  customElements.define('dile-material-icon-devices-other', DileIconlibDevicesOther);
}
