...
export class DileIconlibGridOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-grid-off')) {
  customElements.define('dile-material-icon-grid-off', DileIconlibGridOff);
}
