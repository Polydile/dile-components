...
export class DileIconlibRouter extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-router')) {
  customElements.define('dile-material-icon-router', DileIconlibRouter);
}
