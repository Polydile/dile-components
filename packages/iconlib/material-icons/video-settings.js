...
export class DileIconlibVideoSettings extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-video-settings')) {
  customElements.define('dile-material-icon-video-settings', DileIconlibVideoSettings);
}
