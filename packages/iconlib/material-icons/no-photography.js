...
export class DileIconlibNoPhotography extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-no-photography')) {
  customElements.define('dile-material-icon-no-photography', DileIconlibNoPhotography);
}
