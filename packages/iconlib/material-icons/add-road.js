...
export class DileIconlibAddRoad extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-add-road')) {
  customElements.define('dile-material-icon-add-road', DileIconlibAddRoad);
}
