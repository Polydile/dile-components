...
export class DileIconlib16mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-16mp')) {
  customElements.define('dile-material-icon-16mp', DileIconlib16mp);
}
