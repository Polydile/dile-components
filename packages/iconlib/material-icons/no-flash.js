...
export class DileIconlibNoFlash extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-no-flash')) {
  customElements.define('dile-material-icon-no-flash', DileIconlibNoFlash);
}
