...
export class DileIconlibLeakAdd extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-leak-add')) {
  customElements.define('dile-material-icon-leak-add', DileIconlibLeakAdd);
}
