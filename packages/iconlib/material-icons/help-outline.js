...
export class DileIconlibHelpOutline extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-help-outline')) {
  customElements.define('dile-material-icon-help-outline', DileIconlibHelpOutline);
}
