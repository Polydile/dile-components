...
export class DileIconlibCameraswitch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-cameraswitch')) {
  customElements.define('dile-material-icon-cameraswitch', DileIconlibCameraswitch);
}
