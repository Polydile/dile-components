...
export class DileIconlibSpoke extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-spoke')) {
  customElements.define('dile-material-icon-spoke', DileIconlibSpoke);
}
