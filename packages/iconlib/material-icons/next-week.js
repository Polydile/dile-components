...
export class DileIconlibNextWeek extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-next-week')) {
  customElements.define('dile-material-icon-next-week', DileIconlibNextWeek);
}
