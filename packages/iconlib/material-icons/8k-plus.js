...
export class DileIconlib8kPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-8k-plus')) {
  customElements.define('dile-material-icon-8k-plus', DileIconlib8kPlus);
}
