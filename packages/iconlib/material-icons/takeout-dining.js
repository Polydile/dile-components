...
export class DileIconlibTakeoutDining extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-takeout-dining')) {
  customElements.define('dile-material-icon-takeout-dining', DileIconlibTakeoutDining);
}
