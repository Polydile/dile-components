...
export class DileIconlibSports extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sports')) {
  customElements.define('dile-material-icon-sports', DileIconlibSports);
}
