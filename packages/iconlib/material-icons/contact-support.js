...
export class DileIconlibContactSupport extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-contact-support')) {
  customElements.define('dile-material-icon-contact-support', DileIconlibContactSupport);
}
