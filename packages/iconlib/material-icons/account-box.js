...
export class DileIconlibAccountBox extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-account-box')) {
  customElements.define('dile-material-icon-account-box', DileIconlibAccountBox);
}
