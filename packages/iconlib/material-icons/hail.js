...
export class DileIconlibHail extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-hail')) {
  customElements.define('dile-material-icon-hail', DileIconlibHail);
}
