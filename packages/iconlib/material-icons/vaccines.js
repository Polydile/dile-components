...
export class DileIconlibVaccines extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-vaccines')) {
  customElements.define('dile-material-icon-vaccines', DileIconlibVaccines);
}
