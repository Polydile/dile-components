...
export class DileIconlibDeviceHub extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-device-hub')) {
  customElements.define('dile-material-icon-device-hub', DileIconlibDeviceHub);
}
