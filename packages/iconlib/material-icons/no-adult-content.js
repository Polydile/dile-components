...
export class DileIconlibNoAdultContent extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-no-adult-content')) {
  customElements.define('dile-material-icon-no-adult-content', DileIconlibNoAdultContent);
}
