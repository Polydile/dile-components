...
export class DileIconlibElderlyWoman extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-elderly-woman')) {
  customElements.define('dile-material-icon-elderly-woman', DileIconlibElderlyWoman);
}
