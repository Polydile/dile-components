...
export class DileIconlibRequestQuote extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-request-quote')) {
  customElements.define('dile-material-icon-request-quote', DileIconlibRequestQuote);
}
