...
export class DileIconlibConveyorBelt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-conveyor-belt')) {
  customElements.define('dile-material-icon-conveyor-belt', DileIconlibConveyorBelt);
}
