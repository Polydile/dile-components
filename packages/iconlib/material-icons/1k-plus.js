...
export class DileIconlib1kPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-1k-plus')) {
  customElements.define('dile-material-icon-1k-plus', DileIconlib1kPlus);
}
