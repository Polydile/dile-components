...
export class DileIconlibWatchOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-watch-off')) {
  customElements.define('dile-material-icon-watch-off', DileIconlibWatchOff);
}
