...
export class DileIconlibAddBusiness extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-add-business')) {
  customElements.define('dile-material-icon-add-business', DileIconlibAddBusiness);
}
