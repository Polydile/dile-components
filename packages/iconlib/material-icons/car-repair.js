...
export class DileIconlibCarRepair extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-car-repair')) {
  customElements.define('dile-material-icon-car-repair', DileIconlibCarRepair);
}
