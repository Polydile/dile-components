...
export class DileIconlibSortByAlpha extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sort-by-alpha')) {
  customElements.define('dile-material-icon-sort-by-alpha', DileIconlibSortByAlpha);
}
