...
export class DileIconlibNearbyOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-nearby-off')) {
  customElements.define('dile-material-icon-nearby-off', DileIconlibNearbyOff);
}
