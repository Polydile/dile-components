...
export class DileIconlibPeopleOutline extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-people-outline')) {
  customElements.define('dile-material-icon-people-outline', DileIconlibPeopleOutline);
}
