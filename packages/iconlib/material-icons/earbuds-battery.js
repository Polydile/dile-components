...
export class DileIconlibEarbudsBattery extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-earbuds-battery')) {
  customElements.define('dile-material-icon-earbuds-battery', DileIconlibEarbudsBattery);
}
