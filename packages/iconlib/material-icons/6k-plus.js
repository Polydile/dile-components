...
export class DileIconlib6kPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-6k-plus')) {
  customElements.define('dile-material-icon-6k-plus', DileIconlib6kPlus);
}
