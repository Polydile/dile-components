...
export class DileIconlibPreview extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-preview')) {
  customElements.define('dile-material-icon-preview', DileIconlibPreview);
}
