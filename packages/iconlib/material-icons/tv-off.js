...
export class DileIconlibTvOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-tv-off')) {
  customElements.define('dile-material-icon-tv-off', DileIconlibTvOff);
}
