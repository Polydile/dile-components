...
export class DileIconlib123 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-123')) {
  customElements.define('dile-material-icon-123', DileIconlib123);
}
