...
export class DileIconlibZoomOutMap extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-zoom-out-map')) {
  customElements.define('dile-material-icon-zoom-out-map', DileIconlibZoomOutMap);
}
