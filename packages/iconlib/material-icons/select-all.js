...
export class DileIconlibSelectAll extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-select-all')) {
  customElements.define('dile-material-icon-select-all', DileIconlibSelectAll);
}
