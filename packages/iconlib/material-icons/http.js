...
export class DileIconlibHttp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-http')) {
  customElements.define('dile-material-icon-http', DileIconlibHttp);
}
