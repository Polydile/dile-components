...
export class DileIconlibSensorWindow extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sensor-window')) {
  customElements.define('dile-material-icon-sensor-window', DileIconlibSensorWindow);
}
