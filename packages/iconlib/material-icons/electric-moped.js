...
export class DileIconlibElectricMoped extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-electric-moped')) {
  customElements.define('dile-material-icon-electric-moped', DileIconlibElectricMoped);
}
