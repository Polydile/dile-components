...
export class DileIconlibSource extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-source')) {
  customElements.define('dile-material-icon-source', DileIconlibSource);
}
