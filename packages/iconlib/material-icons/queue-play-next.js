...
export class DileIconlibQueuePlayNext extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-queue-play-next')) {
  customElements.define('dile-material-icon-queue-play-next', DileIconlibQueuePlayNext);
}
