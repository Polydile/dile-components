...
export class DileIconlibRuleFolder extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-rule-folder')) {
  customElements.define('dile-material-icon-rule-folder', DileIconlibRuleFolder);
}
