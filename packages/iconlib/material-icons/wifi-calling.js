...
export class DileIconlibWifiCalling extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-wifi-calling')) {
  customElements.define('dile-material-icon-wifi-calling', DileIconlibWifiCalling);
}
