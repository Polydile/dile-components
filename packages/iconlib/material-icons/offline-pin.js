...
export class DileIconlibOfflinePin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-offline-pin')) {
  customElements.define('dile-material-icon-offline-pin', DileIconlibOfflinePin);
}
