...
export class DileIconlibPlayLesson extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-play-lesson')) {
  customElements.define('dile-material-icon-play-lesson', DileIconlibPlayLesson);
}
