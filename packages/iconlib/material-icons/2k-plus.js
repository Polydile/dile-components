...
export class DileIconlib2kPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-2k-plus')) {
  customElements.define('dile-material-icon-2k-plus', DileIconlib2kPlus);
}
