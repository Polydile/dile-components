...
export class DileIconlibBorderVertical extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-border-vertical')) {
  customElements.define('dile-material-icon-border-vertical', DileIconlibBorderVertical);
}
