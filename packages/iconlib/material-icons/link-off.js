...
export class DileIconlibLinkOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-link-off')) {
  customElements.define('dile-material-icon-link-off', DileIconlibLinkOff);
}
