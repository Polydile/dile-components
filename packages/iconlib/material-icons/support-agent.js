...
export class DileIconlibSupportAgent extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-support-agent')) {
  customElements.define('dile-material-icon-support-agent', DileIconlibSupportAgent);
}
