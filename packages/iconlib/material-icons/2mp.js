...
export class DileIconlib2mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-2mp')) {
  customElements.define('dile-material-icon-2mp', DileIconlib2mp);
}
