...
export class DileIconlibRule extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-rule')) {
  customElements.define('dile-material-icon-rule', DileIconlibRule);
}
