...
export class DileIconlibQuiz extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-quiz')) {
  customElements.define('dile-material-icon-quiz', DileIconlibQuiz);
}
