...
export class DileIconlibDinnerDining extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-dinner-dining')) {
  customElements.define('dile-material-icon-dinner-dining', DileIconlibDinnerDining);
}
