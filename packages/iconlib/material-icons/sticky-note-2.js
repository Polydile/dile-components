...
export class DileIconlibStickyNote2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sticky-note-2')) {
  customElements.define('dile-material-icon-sticky-note-2', DileIconlibStickyNote2);
}
