...
export class DileIconlibIron extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-iron')) {
  customElements.define('dile-material-icon-iron', DileIconlibIron);
}
