...
export class DileIconlib9kPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-9k-plus')) {
  customElements.define('dile-material-icon-9k-plus', DileIconlib9kPlus);
}
