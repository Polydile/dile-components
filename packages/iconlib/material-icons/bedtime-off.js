...
export class DileIconlibBedtimeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-bedtime-off')) {
  customElements.define('dile-material-icon-bedtime-off', DileIconlibBedtimeOff);
}
