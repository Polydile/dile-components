...
export class DileIconlibSetMeal extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-set-meal')) {
  customElements.define('dile-material-icon-set-meal', DileIconlibSetMeal);
}
