...
export class DileIconlibManageSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-manage-search')) {
  customElements.define('dile-material-icon-manage-search', DileIconlibManageSearch);
}
