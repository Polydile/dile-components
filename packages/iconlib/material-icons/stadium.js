...
export class DileIconlibStadium extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-stadium')) {
  customElements.define('dile-material-icon-stadium', DileIconlibStadium);
}
