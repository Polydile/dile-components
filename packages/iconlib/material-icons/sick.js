...
export class DileIconlibSick extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sick')) {
  customElements.define('dile-material-icon-sick', DileIconlibSick);
}
