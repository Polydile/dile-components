...
export class DileIconlibAppShortcut extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-app-shortcut')) {
  customElements.define('dile-material-icon-app-shortcut', DileIconlibAppShortcut);
}
