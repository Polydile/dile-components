...
export class DileIconlibMicExternalOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-mic-external-off')) {
  customElements.define('dile-material-icon-mic-external-off', DileIconlibMicExternalOff);
}
