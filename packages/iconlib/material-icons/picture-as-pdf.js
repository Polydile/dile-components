...
export class DileIconlibPictureAsPdf extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-picture-as-pdf')) {
  customElements.define('dile-material-icon-picture-as-pdf', DileIconlibPictureAsPdf);
}
