...
export class DileIconlibFactCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-fact-check')) {
  customElements.define('dile-material-icon-fact-check', DileIconlibFactCheck);
}
