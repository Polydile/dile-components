...
export class DileIconlibPhoneCallback extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-phone-callback')) {
  customElements.define('dile-material-icon-phone-callback', DileIconlibPhoneCallback);
}
