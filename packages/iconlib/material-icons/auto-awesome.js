...
export class DileIconlibAutoAwesome extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-auto-awesome')) {
  customElements.define('dile-material-icon-auto-awesome', DileIconlibAutoAwesome);
}
