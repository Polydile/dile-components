...
export class DileIconlibOutgoingMail extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-outgoing-mail')) {
  customElements.define('dile-material-icon-outgoing-mail', DileIconlibOutgoingMail);
}
