...
export class DileIconlibFavoriteBorder extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-favorite-border')) {
  customElements.define('dile-material-icon-favorite-border', DileIconlibFavoriteBorder);
}
