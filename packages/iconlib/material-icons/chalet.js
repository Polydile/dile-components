...
export class DileIconlibChalet extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-chalet')) {
  customElements.define('dile-material-icon-chalet', DileIconlibChalet);
}
