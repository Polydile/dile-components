...
export class DileIconlibPersonOutline extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-person-outline')) {
  customElements.define('dile-material-icon-person-outline', DileIconlibPersonOutline);
}
