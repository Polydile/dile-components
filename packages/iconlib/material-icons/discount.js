...
export class DileIconlibDiscount extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-discount')) {
  customElements.define('dile-material-icon-discount', DileIconlibDiscount);
}
