...
export class DileIconlibQueryBuilder extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-query-builder')) {
  customElements.define('dile-material-icon-query-builder', DileIconlibQueryBuilder);
}
