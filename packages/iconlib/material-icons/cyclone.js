...
export class DileIconlibCyclone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-cyclone')) {
  customElements.define('dile-material-icon-cyclone', DileIconlibCyclone);
}
