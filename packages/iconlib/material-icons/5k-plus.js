...
export class DileIconlib5kPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-5k-plus')) {
  customElements.define('dile-material-icon-5k-plus', DileIconlib5kPlus);
}
