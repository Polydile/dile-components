...
export class DileIconlibEmergencyShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-emergency-share')) {
  customElements.define('dile-material-icon-emergency-share', DileIconlibEmergencyShare);
}
