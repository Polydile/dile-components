...
export class DileIconlibCo2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-co2')) {
  customElements.define('dile-material-icon-co2', DileIconlibCo2);
}
