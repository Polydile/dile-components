...
export class DileIconlibUnpublished extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-unpublished')) {
  customElements.define('dile-material-icon-unpublished', DileIconlibUnpublished);
}
