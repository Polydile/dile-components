...
export class DileIconlibHearing extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-hearing')) {
  customElements.define('dile-material-icon-hearing', DileIconlibHearing);
}
