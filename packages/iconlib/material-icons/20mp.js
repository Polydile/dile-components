...
export class DileIconlib20mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-20mp')) {
  customElements.define('dile-material-icon-20mp', DileIconlib20mp);
}
