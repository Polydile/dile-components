...
export class DileIconlib9mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-9mp')) {
  customElements.define('dile-material-icon-9mp', DileIconlib9mp);
}
