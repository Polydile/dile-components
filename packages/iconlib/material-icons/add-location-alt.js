...
export class DileIconlibAddLocationAlt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-add-location-alt')) {
  customElements.define('dile-material-icon-add-location-alt', DileIconlibAddLocationAlt);
}
