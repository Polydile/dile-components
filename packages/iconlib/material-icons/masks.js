...
export class DileIconlibMasks extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-masks')) {
  customElements.define('dile-material-icon-masks', DileIconlibMasks);
}
