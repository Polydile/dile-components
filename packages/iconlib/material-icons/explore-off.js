...
export class DileIconlibExploreOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-explore-off')) {
  customElements.define('dile-material-icon-explore-off', DileIconlibExploreOff);
}
