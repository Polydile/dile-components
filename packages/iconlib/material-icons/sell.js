...
export class DileIconlibSell extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sell')) {
  customElements.define('dile-material-icon-sell', DileIconlibSell);
}
