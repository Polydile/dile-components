...
export class DileIconlibContactless extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-contactless')) {
  customElements.define('dile-material-icon-contactless', DileIconlibContactless);
}
