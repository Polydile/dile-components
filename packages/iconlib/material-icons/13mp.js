...
export class DileIconlib13mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-13mp')) {
  customElements.define('dile-material-icon-13mp', DileIconlib13mp);
}
