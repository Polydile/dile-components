...
export class DileIconlib3gMobiledata extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-3g-mobiledata')) {
  customElements.define('dile-material-icon-3g-mobiledata', DileIconlib3gMobiledata);
}
