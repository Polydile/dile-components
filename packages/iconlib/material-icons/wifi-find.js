...
export class DileIconlibWifiFind extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-wifi-find')) {
  customElements.define('dile-material-icon-wifi-find', DileIconlibWifiFind);
}
