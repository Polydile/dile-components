...
export class DileIconlibSignalWifiOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-signal-wifi-off')) {
  customElements.define('dile-material-icon-signal-wifi-off', DileIconlibSignalWifiOff);
}
