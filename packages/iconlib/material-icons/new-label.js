...
export class DileIconlibNewLabel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-new-label')) {
  customElements.define('dile-material-icon-new-label', DileIconlibNewLabel);
}
