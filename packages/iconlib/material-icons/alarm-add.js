...
export class DileIconlibAlarmAdd extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-alarm-add')) {
  customElements.define('dile-material-icon-alarm-add', DileIconlibAlarmAdd);
}
