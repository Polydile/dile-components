...
export class DileIconlibBlinds extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-blinds')) {
  customElements.define('dile-material-icon-blinds', DileIconlibBlinds);
}
