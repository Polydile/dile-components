...
export class DileIconlibLunchDining extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-lunch-dining')) {
  customElements.define('dile-material-icon-lunch-dining', DileIconlibLunchDining);
}
