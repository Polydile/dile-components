...
export class DileIconlibSportsFootball extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sports-football')) {
  customElements.define('dile-material-icon-sports-football', DileIconlibSportsFootball);
}
