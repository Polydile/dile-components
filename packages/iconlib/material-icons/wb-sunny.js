...
export class DileIconlibWbSunny extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-wb-sunny')) {
  customElements.define('dile-material-icon-wb-sunny', DileIconlibWbSunny);
}
