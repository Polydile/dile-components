...
export class DileIconlibAdb extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-adb')) {
  customElements.define('dile-material-icon-adb', DileIconlibAdb);
}
