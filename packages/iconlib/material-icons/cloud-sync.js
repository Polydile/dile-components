...
export class DileIconlibCloudSync extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-cloud-sync')) {
  customElements.define('dile-material-icon-cloud-sync', DileIconlibCloudSync);
}
