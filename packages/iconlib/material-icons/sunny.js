...
export class DileIconlibSunny extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sunny')) {
  customElements.define('dile-material-icon-sunny', DileIconlibSunny);
}
