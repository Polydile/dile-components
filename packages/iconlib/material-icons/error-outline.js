...
export class DileIconlibErrorOutline extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-error-outline')) {
  customElements.define('dile-material-icon-error-outline', DileIconlibErrorOutline);
}
