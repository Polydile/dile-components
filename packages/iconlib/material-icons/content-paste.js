...
export class DileIconlibContentPaste extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-content-paste')) {
  customElements.define('dile-material-icon-content-paste', DileIconlibContentPaste);
}
