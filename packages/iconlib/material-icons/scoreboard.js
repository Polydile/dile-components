...
export class DileIconlibScoreboard extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-scoreboard')) {
  customElements.define('dile-material-icon-scoreboard', DileIconlibScoreboard);
}
