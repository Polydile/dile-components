...
export class DileIconlibAttachment extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-attachment')) {
  customElements.define('dile-material-icon-attachment', DileIconlibAttachment);
}
