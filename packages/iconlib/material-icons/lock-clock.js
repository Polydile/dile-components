...
export class DileIconlibLockClock extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-lock-clock')) {
  customElements.define('dile-material-icon-lock-clock', DileIconlibLockClock);
}
