...
export class DileIconlib6mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-6mp')) {
  customElements.define('dile-material-icon-6mp', DileIconlib6mp);
}
