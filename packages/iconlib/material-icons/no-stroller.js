...
export class DileIconlibNoStroller extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-no-stroller')) {
  customElements.define('dile-material-icon-no-stroller', DileIconlibNoStroller);
}
