...
export class DileIconlibAbc extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-abc')) {
  customElements.define('dile-material-icon-abc', DileIconlibAbc);
}
