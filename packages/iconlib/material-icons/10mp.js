...
export class DileIconlib10mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-10mp')) {
  customElements.define('dile-material-icon-10mp', DileIconlib10mp);
}
