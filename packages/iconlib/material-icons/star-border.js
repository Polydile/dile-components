...
export class DileIconlibStarBorder extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-star-border')) {
  customElements.define('dile-material-icon-star-border', DileIconlibStarBorder);
}
