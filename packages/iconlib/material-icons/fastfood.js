...
export class DileIconlibFastfood extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-fastfood')) {
  customElements.define('dile-material-icon-fastfood', DileIconlibFastfood);
}
