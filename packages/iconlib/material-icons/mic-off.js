...
export class DileIconlibMicOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-mic-off')) {
  customElements.define('dile-material-icon-mic-off', DileIconlibMicOff);
}
