...
export class DileIconlibMerge extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-merge')) {
  customElements.define('dile-material-icon-merge', DileIconlibMerge);
}
