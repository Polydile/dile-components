...
export class DileIconlibTagFaces extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-tag-faces')) {
  customElements.define('dile-material-icon-tag-faces', DileIconlibTagFaces);
}
