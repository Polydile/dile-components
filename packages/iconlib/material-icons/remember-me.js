...
export class DileIconlibRememberMe extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-remember-me')) {
  customElements.define('dile-material-icon-remember-me', DileIconlibRememberMe);
}
