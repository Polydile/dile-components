...
export class DileIconlibAccountBalance extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-account-balance')) {
  customElements.define('dile-material-icon-account-balance', DileIconlibAccountBalance);
}
