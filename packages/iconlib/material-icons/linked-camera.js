...
export class DileIconlibLinkedCamera extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-linked-camera')) {
  customElements.define('dile-material-icon-linked-camera', DileIconlibLinkedCamera);
}
