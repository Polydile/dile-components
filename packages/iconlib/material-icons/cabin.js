...
export class DileIconlibCabin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-cabin')) {
  customElements.define('dile-material-icon-cabin', DileIconlibCabin);
}
