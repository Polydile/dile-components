...
export class DileIconlibRunCircle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-run-circle')) {
  customElements.define('dile-material-icon-run-circle', DileIconlibRunCircle);
}
