...
export class DileIconlibWifiOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-wifi-off')) {
  customElements.define('dile-material-icon-wifi-off', DileIconlibWifiOff);
}
