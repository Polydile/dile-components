...
export class DileIconlibEditCalendar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-edit-calendar')) {
  customElements.define('dile-material-icon-edit-calendar', DileIconlibEditCalendar);
}
