...
export class DileIconlibOutbox extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-outbox')) {
  customElements.define('dile-material-icon-outbox', DileIconlibOutbox);
}
