...
export class DileIconlibPersonRemove extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-person-remove')) {
  customElements.define('dile-material-icon-person-remove', DileIconlibPersonRemove);
}
