...
export class DileIconlibSportsBaseball extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sports-baseball')) {
  customElements.define('dile-material-icon-sports-baseball', DileIconlibSportsBaseball);
}
