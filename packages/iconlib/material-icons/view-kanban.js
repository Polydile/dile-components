...
export class DileIconlibViewKanban extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-view-kanban')) {
  customElements.define('dile-material-icon-view-kanban', DileIconlibViewKanban);
}
