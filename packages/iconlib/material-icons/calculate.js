...
export class DileIconlibCalculate extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-calculate')) {
  customElements.define('dile-material-icon-calculate', DileIconlibCalculate);
}
