...
export class DileIconlibFilterAlt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-filter-alt')) {
  customElements.define('dile-material-icon-filter-alt', DileIconlibFilterAlt);
}
