...
export class DileIconlibJoinFull extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-join-full')) {
  customElements.define('dile-material-icon-join-full', DileIconlibJoinFull);
}
