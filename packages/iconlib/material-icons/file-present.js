...
export class DileIconlibFilePresent extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-file-present')) {
  customElements.define('dile-material-icon-file-present', DileIconlibFilePresent);
}
