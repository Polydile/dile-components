...
export class DileIconlibMicExternalOn extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-mic-external-on')) {
  customElements.define('dile-material-icon-mic-external-on', DileIconlibMicExternalOn);
}
