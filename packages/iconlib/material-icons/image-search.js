...
export class DileIconlibImageSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-image-search')) {
  customElements.define('dile-material-icon-image-search', DileIconlibImageSearch);
}
