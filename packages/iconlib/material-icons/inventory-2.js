...
export class DileIconlibInventory2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-inventory-2')) {
  customElements.define('dile-material-icon-inventory-2', DileIconlibInventory2);
}
