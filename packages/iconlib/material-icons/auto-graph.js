...
export class DileIconlibAutoGraph extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-auto-graph')) {
  customElements.define('dile-material-icon-auto-graph', DileIconlibAutoGraph);
}
