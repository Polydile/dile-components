...
export class DileIconlib3kPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-3k-plus')) {
  customElements.define('dile-material-icon-3k-plus', DileIconlib3kPlus);
}
