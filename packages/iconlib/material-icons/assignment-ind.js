...
export class DileIconlibAssignmentInd extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-assignment-ind')) {
  customElements.define('dile-material-icon-assignment-ind', DileIconlibAssignmentInd);
}
