...
export class DileIconlibLiving extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-living')) {
  customElements.define('dile-material-icon-living', DileIconlibLiving);
}
