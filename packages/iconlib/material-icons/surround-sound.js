...
export class DileIconlibSurroundSound extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-surround-sound')) {
  customElements.define('dile-material-icon-surround-sound', DileIconlibSurroundSound);
}
