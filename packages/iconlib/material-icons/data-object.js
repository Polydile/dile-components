...
export class DileIconlibDataObject extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-data-object')) {
  customElements.define('dile-material-icon-data-object', DileIconlibDataObject);
}
