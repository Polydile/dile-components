...
export class DileIconlibUpdate extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-update')) {
  customElements.define('dile-material-icon-update', DileIconlibUpdate);
}
