...
export class DileIconlibSnowmobile extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-snowmobile')) {
  customElements.define('dile-material-icon-snowmobile', DileIconlibSnowmobile);
}
