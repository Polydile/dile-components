...
export class DileIconlibEmojiSymbols extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-emoji-symbols')) {
  customElements.define('dile-material-icon-emoji-symbols', DileIconlibEmojiSymbols);
}
