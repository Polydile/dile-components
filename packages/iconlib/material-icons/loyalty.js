...
export class DileIconlibLoyalty extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-loyalty')) {
  customElements.define('dile-material-icon-loyalty', DileIconlibLoyalty);
}
