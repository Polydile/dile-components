...
export class DileIconlibTimer10Select extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-timer-10-select')) {
  customElements.define('dile-material-icon-timer-10-select', DileIconlibTimer10Select);
}
