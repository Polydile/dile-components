...
export class DileIconlibNoteAlt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-note-alt')) {
  customElements.define('dile-material-icon-note-alt', DileIconlibNoteAlt);
}
