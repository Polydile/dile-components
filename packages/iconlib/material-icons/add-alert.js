...
export class DileIconlibAddAlert extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-add-alert')) {
  customElements.define('dile-material-icon-add-alert', DileIconlibAddAlert);
}
