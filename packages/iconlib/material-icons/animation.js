...
export class DileIconlibAnimation extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-animation')) {
  customElements.define('dile-material-icon-animation', DileIconlibAnimation);
}
