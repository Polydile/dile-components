...
export class DileIconlibPhonePaused extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-phone-paused')) {
  customElements.define('dile-material-icon-phone-paused', DileIconlibPhonePaused);
}
