...
export class DileIconlibDownloading extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-downloading')) {
  customElements.define('dile-material-icon-downloading', DileIconlibDownloading);
}
