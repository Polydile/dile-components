...
export class DileIconlibAssignmentLate extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-assignment-late')) {
  customElements.define('dile-material-icon-assignment-late', DileIconlibAssignmentLate);
}
