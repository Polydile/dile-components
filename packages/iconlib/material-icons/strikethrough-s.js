...
export class DileIconlibStrikethroughS extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-strikethrough-s')) {
  customElements.define('dile-material-icon-strikethrough-s', DileIconlibStrikethroughS);
}
