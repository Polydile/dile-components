...
export class DileIconlibTopic extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-topic')) {
  customElements.define('dile-material-icon-topic', DileIconlibTopic);
}
