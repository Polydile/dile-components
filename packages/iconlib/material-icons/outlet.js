...
export class DileIconlibOutlet extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-outlet')) {
  customElements.define('dile-material-icon-outlet', DileIconlibOutlet);
}
