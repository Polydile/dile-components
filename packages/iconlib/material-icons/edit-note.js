...
export class DileIconlibEditNote extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-edit-note')) {
  customElements.define('dile-material-icon-edit-note', DileIconlibEditNote);
}
