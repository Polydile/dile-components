...
export class DileIconlibThumbsUpDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-thumbs-up-down')) {
  customElements.define('dile-material-icon-thumbs-up-down', DileIconlibThumbsUpDown);
}
