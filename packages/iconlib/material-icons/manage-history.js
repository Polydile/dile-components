...
export class DileIconlibManageHistory extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-manage-history')) {
  customElements.define('dile-material-icon-manage-history', DileIconlibManageHistory);
}
