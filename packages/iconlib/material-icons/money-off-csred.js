...
export class DileIconlibMoneyOffCsred extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-money-off-csred')) {
  customElements.define('dile-material-icon-money-off-csred', DileIconlibMoneyOffCsred);
}
