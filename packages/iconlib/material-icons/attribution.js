...
export class DileIconlibAttribution extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-attribution')) {
  customElements.define('dile-material-icon-attribution', DileIconlibAttribution);
}
