...
export class DileIconlib21mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-21mp')) {
  customElements.define('dile-material-icon-21mp', DileIconlib21mp);
}
