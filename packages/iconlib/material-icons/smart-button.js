...
export class DileIconlibSmartButton extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-smart-button')) {
  customElements.define('dile-material-icon-smart-button', DileIconlibSmartButton);
}
