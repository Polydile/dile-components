...
export class DileIconlibMarkAsUnread extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-mark-as-unread')) {
  customElements.define('dile-material-icon-mark-as-unread', DileIconlibMarkAsUnread);
}
