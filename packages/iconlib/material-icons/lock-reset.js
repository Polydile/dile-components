...
export class DileIconlibLockReset extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-lock-reset')) {
  customElements.define('dile-material-icon-lock-reset', DileIconlibLockReset);
}
