...
export class DileIconlibArchitecture extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-architecture')) {
  customElements.define('dile-material-icon-architecture', DileIconlibArchitecture);
}
