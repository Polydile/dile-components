...
export class DileIconlibMoveUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-move-up')) {
  customElements.define('dile-material-icon-move-up', DileIconlibMoveUp);
}
