...
export class DileIconlibSyncDisabled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sync-disabled')) {
  customElements.define('dile-material-icon-sync-disabled', DileIconlibSyncDisabled);
}
