...
export class DileIconlibSportsTennis extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sports-tennis')) {
  customElements.define('dile-material-icon-sports-tennis', DileIconlibSportsTennis);
}
