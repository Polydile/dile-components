...
export class DileIconlibAod extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-aod')) {
  customElements.define('dile-material-icon-aod', DileIconlibAod);
}
