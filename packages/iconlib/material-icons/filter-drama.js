...
export class DileIconlibFilterDrama extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-filter-drama')) {
  customElements.define('dile-material-icon-filter-drama', DileIconlibFilterDrama);
}
