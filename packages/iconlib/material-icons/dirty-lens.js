...
export class DileIconlibDirtyLens extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-dirty-lens')) {
  customElements.define('dile-material-icon-dirty-lens', DileIconlibDirtyLens);
}
