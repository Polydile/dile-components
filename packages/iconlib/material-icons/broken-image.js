...
export class DileIconlibBrokenImage extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-broken-image')) {
  customElements.define('dile-material-icon-broken-image', DileIconlibBrokenImage);
}
