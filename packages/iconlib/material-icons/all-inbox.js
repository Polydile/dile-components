...
export class DileIconlibAllInbox extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-all-inbox')) {
  customElements.define('dile-material-icon-all-inbox', DileIconlibAllInbox);
}
