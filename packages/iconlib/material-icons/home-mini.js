...
export class DileIconlibHomeMini extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-home-mini')) {
  customElements.define('dile-material-icon-home-mini', DileIconlibHomeMini);
}
