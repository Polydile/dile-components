...
export class DileIconlibInvertColors extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-invert-colors')) {
  customElements.define('dile-material-icon-invert-colors', DileIconlibInvertColors);
}
