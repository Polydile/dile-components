...
export class DileIconlib11mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-11mp')) {
  customElements.define('dile-material-icon-11mp', DileIconlib11mp);
}
