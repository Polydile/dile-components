...
export class DileIconlibTableBar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-table-bar')) {
  customElements.define('dile-material-icon-table-bar', DileIconlibTableBar);
}
