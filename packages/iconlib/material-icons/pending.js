...
export class DileIconlibPending extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-pending')) {
  customElements.define('dile-material-icon-pending', DileIconlibPending);
}
