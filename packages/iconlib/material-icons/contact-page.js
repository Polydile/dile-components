...
export class DileIconlibContactPage extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-contact-page')) {
  customElements.define('dile-material-icon-contact-page', DileIconlibContactPage);
}
