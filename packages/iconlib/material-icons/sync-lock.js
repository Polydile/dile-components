...
export class DileIconlibSyncLock extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sync-lock')) {
  customElements.define('dile-material-icon-sync-lock', DileIconlibSyncLock);
}
