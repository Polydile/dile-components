...
export class DileIconlibInfoOutline extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-info-outline')) {
  customElements.define('dile-material-icon-info-outline', DileIconlibInfoOutline);
}
