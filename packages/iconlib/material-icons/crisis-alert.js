...
export class DileIconlibCrisisAlert extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-crisis-alert')) {
  customElements.define('dile-material-icon-crisis-alert', DileIconlibCrisisAlert);
}
