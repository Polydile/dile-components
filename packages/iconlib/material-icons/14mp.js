...
export class DileIconlib14mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-14mp')) {
  customElements.define('dile-material-icon-14mp', DileIconlib14mp);
}
