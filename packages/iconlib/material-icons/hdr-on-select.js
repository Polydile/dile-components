...
export class DileIconlibHdrOnSelect extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-hdr-on-select')) {
  customElements.define('dile-material-icon-hdr-on-select', DileIconlibHdrOnSelect);
}
