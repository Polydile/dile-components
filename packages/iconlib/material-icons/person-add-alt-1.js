...
export class DileIconlibPersonAddAlt1 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-person-add-alt-1')) {
  customElements.define('dile-material-icon-person-add-alt-1', DileIconlibPersonAddAlt1);
}
