...
export class DileIconlibDewPoint extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-dew-point')) {
  customElements.define('dile-material-icon-dew-point', DileIconlibDewPoint);
}
