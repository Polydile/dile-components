...
export class DileIconlib24mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-24mp')) {
  customElements.define('dile-material-icon-24mp', DileIconlib24mp);
}
