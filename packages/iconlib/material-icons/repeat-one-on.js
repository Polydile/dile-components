...
export class DileIconlibRepeatOneOn extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-repeat-one-on')) {
  customElements.define('dile-material-icon-repeat-one-on', DileIconlibRepeatOneOn);
}
