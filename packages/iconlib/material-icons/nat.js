...
export class DileIconlibNat extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-nat')) {
  customElements.define('dile-material-icon-nat', DileIconlibNat);
}
