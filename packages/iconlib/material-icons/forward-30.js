...
export class DileIconlibForward30 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-forward-30')) {
  customElements.define('dile-material-icon-forward-30', DileIconlibForward30);
}
