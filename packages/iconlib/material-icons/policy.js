...
export class DileIconlibPolicy extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-policy')) {
  customElements.define('dile-material-icon-policy', DileIconlibPolicy);
}
