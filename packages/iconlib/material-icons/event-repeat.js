...
export class DileIconlibEventRepeat extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-event-repeat')) {
  customElements.define('dile-material-icon-event-repeat', DileIconlibEventRepeat);
}
