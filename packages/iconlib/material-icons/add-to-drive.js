...
export class DileIconlibAddToDrive extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-add-to-drive')) {
  customElements.define('dile-material-icon-add-to-drive', DileIconlibAddToDrive);
}
