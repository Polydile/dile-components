...
export class DileIconlibForward5 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-forward-5')) {
  customElements.define('dile-material-icon-forward-5', DileIconlibForward5);
}
