...
export class DileIconlibPersonOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-person-off')) {
  customElements.define('dile-material-icon-person-off', DileIconlibPersonOff);
}
