...
export class DileIconlibDataSaverOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-data-saver-off')) {
  customElements.define('dile-material-icon-data-saver-off', DileIconlibDataSaverOff);
}
