...
export class DileIconlibHowToVote extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-how-to-vote')) {
  customElements.define('dile-material-icon-how-to-vote', DileIconlibHowToVote);
}
