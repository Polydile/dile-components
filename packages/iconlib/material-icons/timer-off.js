...
export class DileIconlibTimerOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-timer-off')) {
  customElements.define('dile-material-icon-timer-off', DileIconlibTimerOff);
}
