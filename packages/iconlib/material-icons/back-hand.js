...
export class DileIconlibBackHand extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-back-hand')) {
  customElements.define('dile-material-icon-back-hand', DileIconlibBackHand);
}
