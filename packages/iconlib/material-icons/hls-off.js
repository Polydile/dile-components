...
export class DileIconlibHlsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-hls-off')) {
  customElements.define('dile-material-icon-hls-off', DileIconlibHlsOff);
}
