...
export class DileIconlibHub extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-hub')) {
  customElements.define('dile-material-icon-hub', DileIconlibHub);
}
