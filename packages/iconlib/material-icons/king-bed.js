...
export class DileIconlibKingBed extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-king-bed')) {
  customElements.define('dile-material-icon-king-bed', DileIconlibKingBed);
}
