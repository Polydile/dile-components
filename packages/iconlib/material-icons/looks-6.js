...
export class DileIconlibLooks6 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-looks-6')) {
  customElements.define('dile-material-icon-looks-6', DileIconlibLooks6);
}
