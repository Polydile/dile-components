...
export class DileIconlibCastle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-castle')) {
  customElements.define('dile-material-icon-castle', DileIconlibCastle);
}
