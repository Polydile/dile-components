...
export class DileIconlibVapeFree extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-vape-free')) {
  customElements.define('dile-material-icon-vape-free', DileIconlibVapeFree);
}
