...
export class DileIconlibFilterListAlt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-filter-list-alt')) {
  customElements.define('dile-material-icon-filter-list-alt', DileIconlibFilterListAlt);
}
