...
export class DileIconlibRawOn extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-raw-on')) {
  customElements.define('dile-material-icon-raw-on', DileIconlibRawOn);
}
