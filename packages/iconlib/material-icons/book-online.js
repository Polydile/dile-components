...
export class DileIconlibBookOnline extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-book-online')) {
  customElements.define('dile-material-icon-book-online', DileIconlibBookOnline);
}
