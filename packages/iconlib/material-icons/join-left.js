...
export class DileIconlibJoinLeft extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-join-left')) {
  customElements.define('dile-material-icon-join-left', DileIconlibJoinLeft);
}
