...
export class DileIconlib60fps extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-60fps')) {
  customElements.define('dile-material-icon-60fps', DileIconlib60fps);
}
