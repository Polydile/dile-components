...
export class DileIconlibVideoStable extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-video-stable')) {
  customElements.define('dile-material-icon-video-stable', DileIconlibVideoStable);
}
