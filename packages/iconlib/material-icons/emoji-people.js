...
export class DileIconlibEmojiPeople extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-emoji-people')) {
  customElements.define('dile-material-icon-emoji-people', DileIconlibEmojiPeople);
}
