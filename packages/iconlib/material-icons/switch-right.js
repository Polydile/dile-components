...
export class DileIconlibSwitchRight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-switch-right')) {
  customElements.define('dile-material-icon-switch-right', DileIconlibSwitchRight);
}
