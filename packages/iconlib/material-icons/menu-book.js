...
export class DileIconlibMenuBook extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-menu-book')) {
  customElements.define('dile-material-icon-menu-book', DileIconlibMenuBook);
}
