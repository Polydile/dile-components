...
export class DileIconlibEditRoad extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-edit-road')) {
  customElements.define('dile-material-icon-edit-road', DileIconlibEditRoad);
}
