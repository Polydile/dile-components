...
export class DileIconlibBrightness4 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-brightness-4')) {
  customElements.define('dile-material-icon-brightness-4', DileIconlibBrightness4);
}
