...
export class DileIconlibPhoneLocked extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-phone-locked')) {
  customElements.define('dile-material-icon-phone-locked', DileIconlibPhoneLocked);
}
