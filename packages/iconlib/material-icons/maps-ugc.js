...
export class DileIconlibMapsUgc extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-maps-ugc')) {
  customElements.define('dile-material-icon-maps-ugc', DileIconlibMapsUgc);
}
