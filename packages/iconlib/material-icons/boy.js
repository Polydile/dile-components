...
export class DileIconlibBoy extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-boy')) {
  customElements.define('dile-material-icon-boy', DileIconlibBoy);
}
