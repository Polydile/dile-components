...
export class DileIconlibMyLocation extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-my-location')) {
  customElements.define('dile-material-icon-my-location', DileIconlibMyLocation);
}
