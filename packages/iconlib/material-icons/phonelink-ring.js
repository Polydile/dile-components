...
export class DileIconlibPhonelinkRing extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-phonelink-ring')) {
  customElements.define('dile-material-icon-phonelink-ring', DileIconlibPhonelinkRing);
}
