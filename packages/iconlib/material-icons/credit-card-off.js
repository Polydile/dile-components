...
export class DileIconlibCreditCardOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-credit-card-off')) {
  customElements.define('dile-material-icon-credit-card-off', DileIconlibCreditCardOff);
}
