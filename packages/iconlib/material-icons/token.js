...
export class DileIconlibToken extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-token')) {
  customElements.define('dile-material-icon-token', DileIconlibToken);
}
