...
export class DileIconlibPaid extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-paid')) {
  customElements.define('dile-material-icon-paid', DileIconlibPaid);
}
