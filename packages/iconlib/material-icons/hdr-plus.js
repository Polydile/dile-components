...
export class DileIconlibHdrPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-hdr-plus')) {
  customElements.define('dile-material-icon-hdr-plus', DileIconlibHdrPlus);
}
