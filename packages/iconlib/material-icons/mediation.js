...
export class DileIconlibMediation extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-mediation')) {
  customElements.define('dile-material-icon-mediation', DileIconlibMediation);
}
