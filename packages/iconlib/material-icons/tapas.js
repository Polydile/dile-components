...
export class DileIconlibTapas extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-tapas')) {
  customElements.define('dile-material-icon-tapas', DileIconlibTapas);
}
