...
export class DileIconlibTroubleshoot extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-troubleshoot')) {
  customElements.define('dile-material-icon-troubleshoot', DileIconlibTroubleshoot);
}
