...
export class DileIconlibBorderClear extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-border-clear')) {
  customElements.define('dile-material-icon-border-clear', DileIconlibBorderClear);
}
