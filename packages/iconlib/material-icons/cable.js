...
export class DileIconlibCable extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-cable')) {
  customElements.define('dile-material-icon-cable', DileIconlibCable);
}
