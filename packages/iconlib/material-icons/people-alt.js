...
export class DileIconlibPeopleAlt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-people-alt')) {
  customElements.define('dile-material-icon-people-alt', DileIconlibPeopleAlt);
}
