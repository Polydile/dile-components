...
export class DileIconlibCrueltyFree extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-cruelty-free')) {
  customElements.define('dile-material-icon-cruelty-free', DileIconlibCrueltyFree);
}
