...
export class DileIconlibDataUsage extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-data-usage')) {
  customElements.define('dile-material-icon-data-usage', DileIconlibDataUsage);
}
