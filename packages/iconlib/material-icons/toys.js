...
export class DileIconlibToys extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-toys')) {
  customElements.define('dile-material-icon-toys', DileIconlibToys);
}
