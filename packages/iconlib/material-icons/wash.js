...
export class DileIconlibWash extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-wash')) {
  customElements.define('dile-material-icon-wash', DileIconlibWash);
}
