...
export class DileIconlibRequestPage extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-request-page')) {
  customElements.define('dile-material-icon-request-page', DileIconlibRequestPage);
}
