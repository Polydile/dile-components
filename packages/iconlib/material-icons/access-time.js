...
export class DileIconlibAccessTime extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-access-time')) {
  customElements.define('dile-material-icon-access-time', DileIconlibAccessTime);
}
