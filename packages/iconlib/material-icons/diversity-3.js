...
export class DileIconlibDiversity3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-diversity-3')) {
  customElements.define('dile-material-icon-diversity-3', DileIconlibDiversity3);
}
