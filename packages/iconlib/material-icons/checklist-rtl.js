...
export class DileIconlibChecklistRtl extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-checklist-rtl')) {
  customElements.define('dile-material-icon-checklist-rtl', DileIconlibChecklistRtl);
}
