...
export class DileIconlib7kPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-7k-plus')) {
  customElements.define('dile-material-icon-7k-plus', DileIconlib7kPlus);
}
