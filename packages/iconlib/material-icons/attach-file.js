...
export class DileIconlibAttachFile extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-attach-file')) {
  customElements.define('dile-material-icon-attach-file', DileIconlibAttachFile);
}
