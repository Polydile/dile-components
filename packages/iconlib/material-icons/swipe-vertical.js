...
export class DileIconlibSwipeVertical extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-swipe-vertical')) {
  customElements.define('dile-material-icon-swipe-vertical', DileIconlibSwipeVertical);
}
