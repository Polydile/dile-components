...
export class DileIconlibPinEnd extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-pin-end')) {
  customElements.define('dile-material-icon-pin-end', DileIconlibPinEnd);
}
