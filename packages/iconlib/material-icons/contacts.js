...
export class DileIconlibContacts extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-contacts')) {
  customElements.define('dile-material-icon-contacts', DileIconlibContacts);
}
