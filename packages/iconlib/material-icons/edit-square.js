...
export class DileIconlibEditSquare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-edit-square')) {
  customElements.define('dile-material-icon-edit-square', DileIconlibEditSquare);
}
