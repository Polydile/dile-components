...
export class DileIconlibWbTwilight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-wb-twilight')) {
  customElements.define('dile-material-icon-wb-twilight', DileIconlibWbTwilight);
}
