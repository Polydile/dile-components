...
export class DileIconlibVerified extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-verified')) {
  customElements.define('dile-material-icon-verified', DileIconlibVerified);
}
