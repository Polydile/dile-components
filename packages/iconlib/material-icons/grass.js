...
export class DileIconlibGrass extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-grass')) {
  customElements.define('dile-material-icon-grass', DileIconlibGrass);
}
