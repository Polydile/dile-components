...
export class DileIconlibNoTransfer extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-no-transfer')) {
  customElements.define('dile-material-icon-no-transfer', DileIconlibNoTransfer);
}
