...
export class DileIconlibHighlightOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-highlight-off')) {
  customElements.define('dile-material-icon-highlight-off', DileIconlibHighlightOff);
}
