...
export class DileIconlibSensors extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sensors')) {
  customElements.define('dile-material-icon-sensors', DileIconlibSensors);
}
