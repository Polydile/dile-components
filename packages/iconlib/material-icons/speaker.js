...
export class DileIconlibSpeaker extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-speaker')) {
  customElements.define('dile-material-icon-speaker', DileIconlibSpeaker);
}
