...
export class DileIconlibLibraryMusic extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-library-music')) {
  customElements.define('dile-material-icon-library-music', DileIconlibLibraryMusic);
}
