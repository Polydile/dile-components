...
export class DileIconlibLocalMall extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-local-mall')) {
  customElements.define('dile-material-icon-local-mall', DileIconlibLocalMall);
}
