...
export class DileIconlibSledding extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sledding')) {
  customElements.define('dile-material-icon-sledding', DileIconlibSledding);
}
