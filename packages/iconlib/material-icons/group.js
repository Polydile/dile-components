...
export class DileIconlibGroup extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-group')) {
  customElements.define('dile-material-icon-group', DileIconlibGroup);
}
