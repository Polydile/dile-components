...
export class DileIconlibLockOutline extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-lock-outline')) {
  customElements.define('dile-material-icon-lock-outline', DileIconlibLockOutline);
}
