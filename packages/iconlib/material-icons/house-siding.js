...
export class DileIconlibHouseSiding extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-house-siding')) {
  customElements.define('dile-material-icon-house-siding', DileIconlibHouseSiding);
}
