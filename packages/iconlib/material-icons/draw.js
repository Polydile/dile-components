...
export class DileIconlibDraw extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-draw')) {
  customElements.define('dile-material-icon-draw', DileIconlibDraw);
}
