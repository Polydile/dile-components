...
export class DileIconlibAttachEmail extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-attach-email')) {
  customElements.define('dile-material-icon-attach-email', DileIconlibAttachEmail);
}
