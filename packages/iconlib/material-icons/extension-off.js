...
export class DileIconlibExtensionOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-extension-off')) {
  customElements.define('dile-material-icon-extension-off', DileIconlibExtensionOff);
}
