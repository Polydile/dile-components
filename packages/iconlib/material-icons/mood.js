...
export class DileIconlibMood extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-mood')) {
  customElements.define('dile-material-icon-mood', DileIconlibMood);
}
