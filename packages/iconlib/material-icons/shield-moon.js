...
export class DileIconlibShieldMoon extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-shield-moon')) {
  customElements.define('dile-material-icon-shield-moon', DileIconlibShieldMoon);
}
