...
export class DileIconlibDeblur extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-deblur')) {
  customElements.define('dile-material-icon-deblur', DileIconlibDeblur);
}
