...
export class DileIconlibLocalLibrary extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-local-library')) {
  customElements.define('dile-material-icon-local-library', DileIconlibLocalLibrary);
}
