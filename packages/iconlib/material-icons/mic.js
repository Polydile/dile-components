...
export class DileIconlibMic extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-mic')) {
  customElements.define('dile-material-icon-mic', DileIconlibMic);
}
