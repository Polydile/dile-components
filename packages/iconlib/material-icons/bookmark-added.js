...
export class DileIconlibBookmarkAdded extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-bookmark-added')) {
  customElements.define('dile-material-icon-bookmark-added', DileIconlibBookmarkAdded);
}
