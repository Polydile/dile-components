...
export class DileIconlibHistoryEdu extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-history-edu')) {
  customElements.define('dile-material-icon-history-edu', DileIconlibHistoryEdu);
}
