...
export class DileIconlibAlarmOn extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-alarm-on')) {
  customElements.define('dile-material-icon-alarm-on', DileIconlibAlarmOn);
}
