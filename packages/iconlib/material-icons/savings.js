...
export class DileIconlibSavings extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-savings')) {
  customElements.define('dile-material-icon-savings', DileIconlibSavings);
}
