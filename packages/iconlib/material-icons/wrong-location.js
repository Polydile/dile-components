...
export class DileIconlibWrongLocation extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-wrong-location')) {
  customElements.define('dile-material-icon-wrong-location', DileIconlibWrongLocation);
}
