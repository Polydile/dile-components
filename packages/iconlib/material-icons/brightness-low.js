...
export class DileIconlibBrightnessLow extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-brightness-low')) {
  customElements.define('dile-material-icon-brightness-low', DileIconlibBrightnessLow);
}
