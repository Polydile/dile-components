...
export class DileIconlibPrintDisabled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-print-disabled')) {
  customElements.define('dile-material-icon-print-disabled', DileIconlibPrintDisabled);
}
