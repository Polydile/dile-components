...
export class DileIconlibReplay10 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-replay-10')) {
  customElements.define('dile-material-icon-replay-10', DileIconlibReplay10);
}
