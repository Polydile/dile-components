...
export class DileIconlibHeadsetOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-headset-off')) {
  customElements.define('dile-material-icon-headset-off', DileIconlibHeadsetOff);
}
