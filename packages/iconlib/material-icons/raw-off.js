...
export class DileIconlibRawOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-raw-off')) {
  customElements.define('dile-material-icon-raw-off', DileIconlibRawOff);
}
