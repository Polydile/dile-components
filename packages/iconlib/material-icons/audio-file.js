...
export class DileIconlibAudioFile extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-audio-file')) {
  customElements.define('dile-material-icon-audio-file', DileIconlibAudioFile);
}
