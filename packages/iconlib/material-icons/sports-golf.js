...
export class DileIconlibSportsGolf extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sports-golf')) {
  customElements.define('dile-material-icon-sports-golf', DileIconlibSportsGolf);
}
