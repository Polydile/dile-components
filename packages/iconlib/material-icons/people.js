...
export class DileIconlibPeople extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-people')) {
  customElements.define('dile-material-icon-people', DileIconlibPeople);
}
