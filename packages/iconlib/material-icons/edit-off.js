...
export class DileIconlibEditOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-edit-off')) {
  customElements.define('dile-material-icon-edit-off', DileIconlibEditOff);
}
