...
export class DileIconlibWifiChannel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-wifi-channel')) {
  customElements.define('dile-material-icon-wifi-channel', DileIconlibWifiChannel);
}
