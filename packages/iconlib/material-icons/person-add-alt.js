...
export class DileIconlibPersonAddAlt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-person-add-alt')) {
  customElements.define('dile-material-icon-person-add-alt', DileIconlibPersonAddAlt);
}
