...
export class DileIconlib7mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-7mp')) {
  customElements.define('dile-material-icon-7mp', DileIconlib7mp);
}
