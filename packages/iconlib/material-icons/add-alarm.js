...
export class DileIconlibAddAlarm extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-add-alarm')) {
  customElements.define('dile-material-icon-add-alarm', DileIconlibAddAlarm);
}
