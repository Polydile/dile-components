...
export class DileIconlibTimelapse extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-timelapse')) {
  customElements.define('dile-material-icon-timelapse', DileIconlibTimelapse);
}
