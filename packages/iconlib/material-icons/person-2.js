...
export class DileIconlibPerson2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-person-2')) {
  customElements.define('dile-material-icon-person-2', DileIconlibPerson2);
}
