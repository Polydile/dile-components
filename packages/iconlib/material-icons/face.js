...
export class DileIconlibFace extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-face')) {
  customElements.define('dile-material-icon-face', DileIconlibFace);
}
