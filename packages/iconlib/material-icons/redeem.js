...
export class DileIconlibRedeem extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-redeem')) {
  customElements.define('dile-material-icon-redeem', DileIconlibRedeem);
}
