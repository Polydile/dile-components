...
export class DileIconlibCelebration extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-celebration')) {
  customElements.define('dile-material-icon-celebration', DileIconlibCelebration);
}
