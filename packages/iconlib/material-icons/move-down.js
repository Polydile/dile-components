...
export class DileIconlibMoveDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-move-down')) {
  customElements.define('dile-material-icon-move-down', DileIconlibMoveDown);
}
