...
export class DileIconlib19mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-19mp')) {
  customElements.define('dile-material-icon-19mp', DileIconlib19mp);
}
