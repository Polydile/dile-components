...
export class DileIconlibGppBad extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-gpp-bad')) {
  customElements.define('dile-material-icon-gpp-bad', DileIconlibGppBad);
}
