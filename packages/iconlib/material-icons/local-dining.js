...
export class DileIconlibLocalDining extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-local-dining')) {
  customElements.define('dile-material-icon-local-dining', DileIconlibLocalDining);
}
