...
export class DileIconlibSummarize extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-summarize')) {
  customElements.define('dile-material-icon-summarize', DileIconlibSummarize);
}
