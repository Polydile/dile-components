...
export class DileIconlibPersonSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-person-search')) {
  customElements.define('dile-material-icon-person-search', DileIconlibPersonSearch);
}
