...
export class DileIconlibOutbond extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-outbond')) {
  customElements.define('dile-material-icon-outbond', DileIconlibOutbond);
}
