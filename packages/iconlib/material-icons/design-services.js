...
export class DileIconlibDesignServices extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-design-services')) {
  customElements.define('dile-material-icon-design-services', DileIconlibDesignServices);
}
