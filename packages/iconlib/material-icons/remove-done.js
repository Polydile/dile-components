...
export class DileIconlibRemoveDone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-remove-done')) {
  customElements.define('dile-material-icon-remove-done', DileIconlibRemoveDone);
}
