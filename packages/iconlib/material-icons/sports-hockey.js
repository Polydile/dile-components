...
export class DileIconlibSportsHockey extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sports-hockey')) {
  customElements.define('dile-material-icon-sports-hockey', DileIconlibSportsHockey);
}
