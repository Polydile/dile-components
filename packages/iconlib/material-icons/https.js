...
export class DileIconlibHttps extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-https')) {
  customElements.define('dile-material-icon-https', DileIconlibHttps);
}
