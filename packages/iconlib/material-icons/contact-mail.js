...
export class DileIconlibContactMail extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-contact-mail')) {
  customElements.define('dile-material-icon-contact-mail', DileIconlibContactMail);
}
