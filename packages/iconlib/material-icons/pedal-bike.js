...
export class DileIconlibPedalBike extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-pedal-bike')) {
  customElements.define('dile-material-icon-pedal-bike', DileIconlibPedalBike);
}
