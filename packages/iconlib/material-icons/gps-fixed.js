...
export class DileIconlibGpsFixed extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-gps-fixed')) {
  customElements.define('dile-material-icon-gps-fixed', DileIconlibGpsFixed);
}
