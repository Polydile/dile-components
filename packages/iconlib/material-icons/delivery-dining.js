...
export class DileIconlibDeliveryDining extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-delivery-dining')) {
  customElements.define('dile-material-icon-delivery-dining', DileIconlibDeliveryDining);
}
