...
export class DileIconlibDirectionsCar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-directions-car')) {
  customElements.define('dile-material-icon-directions-car', DileIconlibDirectionsCar);
}
