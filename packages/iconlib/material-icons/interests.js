...
export class DileIconlibInterests extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-interests')) {
  customElements.define('dile-material-icon-interests', DileIconlibInterests);
}
