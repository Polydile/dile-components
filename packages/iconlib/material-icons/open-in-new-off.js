...
export class DileIconlibOpenInNewOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-open-in-new-off')) {
  customElements.define('dile-material-icon-open-in-new-off', DileIconlibOpenInNewOff);
}
