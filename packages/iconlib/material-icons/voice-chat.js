...
export class DileIconlibVoiceChat extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-voice-chat')) {
  customElements.define('dile-material-icon-voice-chat', DileIconlibVoiceChat);
}
