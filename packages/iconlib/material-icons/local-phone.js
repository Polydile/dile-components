...
export class DileIconlibLocalPhone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-local-phone')) {
  customElements.define('dile-material-icon-local-phone', DileIconlibLocalPhone);
}
