...
export class DileIconlibWbIridescent extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-wb-iridescent')) {
  customElements.define('dile-material-icon-wb-iridescent', DileIconlibWbIridescent);
}
