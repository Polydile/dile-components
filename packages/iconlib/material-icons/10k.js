...
export class DileIconlib10k extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-10k')) {
  customElements.define('dile-material-icon-10k', DileIconlib10k);
}
