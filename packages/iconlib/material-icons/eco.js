...
export class DileIconlibEco extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-eco')) {
  customElements.define('dile-material-icon-eco', DileIconlibEco);
}
