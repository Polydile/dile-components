...
export class DileIconlibPhonelinkSetup extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-phonelink-setup')) {
  customElements.define('dile-material-icon-phonelink-setup', DileIconlibPhonelinkSetup);
}
