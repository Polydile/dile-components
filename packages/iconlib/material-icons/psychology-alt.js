...
export class DileIconlibPsychologyAlt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-psychology-alt')) {
  customElements.define('dile-material-icon-psychology-alt', DileIconlibPsychologyAlt);
}
