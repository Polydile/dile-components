...
export class DileIconlibNoMealsOuline extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-no-meals-ouline')) {
  customElements.define('dile-material-icon-no-meals-ouline', DileIconlibNoMealsOuline);
}
