...
export class DileIconlibHdrOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-hdr-off')) {
  customElements.define('dile-material-icon-hdr-off', DileIconlibHdrOff);
}
