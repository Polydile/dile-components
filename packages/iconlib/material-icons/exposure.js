...
export class DileIconlibExposure extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-exposure')) {
  customElements.define('dile-material-icon-exposure', DileIconlibExposure);
}
