...
export class DileIconlibAssignment extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-assignment')) {
  customElements.define('dile-material-icon-assignment', DileIconlibAssignment);
}
