...
export class DileIconlibScreenShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-screen-share')) {
  customElements.define('dile-material-icon-screen-share', DileIconlibScreenShare);
}
