...
export class DileIconlibEmojiFlags extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-emoji-flags')) {
  customElements.define('dile-material-icon-emoji-flags', DileIconlibEmojiFlags);
}
