...
export class DileIconlib5mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-5mp')) {
  customElements.define('dile-material-icon-5mp', DileIconlib5mp);
}
