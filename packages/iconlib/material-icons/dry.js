...
export class DileIconlibDry extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-dry')) {
  customElements.define('dile-material-icon-dry', DileIconlibDry);
}
