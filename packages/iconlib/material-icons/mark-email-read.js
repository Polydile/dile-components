...
export class DileIconlibMarkEmailRead extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-mark-email-read')) {
  customElements.define('dile-material-icon-mark-email-read', DileIconlibMarkEmailRead);
}
