...
export class DileIconlib23mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-23mp')) {
  customElements.define('dile-material-icon-23mp', DileIconlib23mp);
}
