...
export class DileIconlibWorkHistory extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-work-history')) {
  customElements.define('dile-material-icon-work-history', DileIconlibWorkHistory);
}
