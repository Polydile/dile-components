...
export class DileIconlibAddTask extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-add-task')) {
  customElements.define('dile-material-icon-add-task', DileIconlibAddTask);
}
