...
export class DileIconlibUpdateDisabled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-update-disabled')) {
  customElements.define('dile-material-icon-update-disabled', DileIconlibUpdateDisabled);
}
