...
export class DileIconlib30fpsSelect extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-30fps-select')) {
  customElements.define('dile-material-icon-30fps-select', DileIconlib30fpsSelect);
}
