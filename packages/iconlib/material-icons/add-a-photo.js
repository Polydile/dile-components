...
export class DileIconlibAddAPhoto extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-add-a-photo')) {
  customElements.define('dile-material-icon-add-a-photo', DileIconlibAddAPhoto);
}
