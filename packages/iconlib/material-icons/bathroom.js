...
export class DileIconlibBathroom extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-bathroom')) {
  customElements.define('dile-material-icon-bathroom', DileIconlibBathroom);
}
