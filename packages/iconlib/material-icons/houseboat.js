...
export class DileIconlibHouseboat extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-houseboat')) {
  customElements.define('dile-material-icon-houseboat', DileIconlibHouseboat);
}
