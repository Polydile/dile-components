...
export class DileIconlibBedroomParent extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-bedroom-parent')) {
  customElements.define('dile-material-icon-bedroom-parent', DileIconlibBedroomParent);
}
