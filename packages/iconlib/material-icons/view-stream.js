...
export class DileIconlibViewStream extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-view-stream')) {
  customElements.define('dile-material-icon-view-stream', DileIconlibViewStream);
}
