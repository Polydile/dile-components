...
export class DileIconlibBackupTable extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-backup-table')) {
  customElements.define('dile-material-icon-backup-table', DileIconlibBackupTable);
}
