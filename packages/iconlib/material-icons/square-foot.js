...
export class DileIconlibSquareFoot extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-square-foot')) {
  customElements.define('dile-material-icon-square-foot', DileIconlibSquareFoot);
}
