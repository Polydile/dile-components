...
export class DileIconlibLooks3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-looks-3')) {
  customElements.define('dile-material-icon-looks-3', DileIconlibLooks3);
}
