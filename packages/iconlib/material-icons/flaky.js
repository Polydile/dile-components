...
export class DileIconlibFlaky extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-flaky')) {
  customElements.define('dile-material-icon-flaky', DileIconlibFlaky);
}
