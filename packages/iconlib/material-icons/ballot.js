...
export class DileIconlibBallot extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-ballot')) {
  customElements.define('dile-material-icon-ballot', DileIconlibBallot);
}
