...
export class DileIconlibRestaurantMenu extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-restaurant-menu')) {
  customElements.define('dile-material-icon-restaurant-menu', DileIconlibRestaurantMenu);
}
