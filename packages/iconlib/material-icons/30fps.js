...
export class DileIconlib30fps extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-30fps')) {
  customElements.define('dile-material-icon-30fps', DileIconlib30fps);
}
