...
export class DileIconlibDynamicFeed extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-dynamic-feed')) {
  customElements.define('dile-material-icon-dynamic-feed', DileIconlibDynamicFeed);
}
