...
export class DileIconlibHelpCenter extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-help-center')) {
  customElements.define('dile-material-icon-help-center', DileIconlibHelpCenter);
}
