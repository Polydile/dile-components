...
export class DileIconlibPersonPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-person-pin')) {
  customElements.define('dile-material-icon-person-pin', DileIconlibPersonPin);
}
