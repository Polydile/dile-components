...
export class DileIconlibGroups extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-groups')) {
  customElements.define('dile-material-icon-groups', DileIconlibGroups);
}
