...
export class DileIconlibNoMeals extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-no-meals')) {
  customElements.define('dile-material-icon-no-meals', DileIconlibNoMeals);
}
