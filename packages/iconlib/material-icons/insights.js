...
export class DileIconlibInsights extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-insights')) {
  customElements.define('dile-material-icon-insights', DileIconlibInsights);
}
