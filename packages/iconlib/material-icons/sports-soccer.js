...
export class DileIconlibSportsSoccer extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-sports-soccer')) {
  customElements.define('dile-material-icon-sports-soccer', DileIconlibSportsSoccer);
}
