...
export class DileIconlibNoFood extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-no-food')) {
  customElements.define('dile-material-icon-no-food', DileIconlibNoFood);
}
