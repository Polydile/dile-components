...
export class DileIconlibShareLocation extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-share-location')) {
  customElements.define('dile-material-icon-share-location', DileIconlibShareLocation);
}
