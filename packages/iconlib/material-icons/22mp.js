...
export class DileIconlib22mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-22mp')) {
  customElements.define('dile-material-icon-22mp', DileIconlib22mp);
}
