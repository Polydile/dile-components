...
export class DileIconlibPestControl extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-pest-control')) {
  customElements.define('dile-material-icon-pest-control', DileIconlibPestControl);
}
