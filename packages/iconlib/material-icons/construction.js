...
export class DileIconlibConstruction extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-construction')) {
  customElements.define('dile-material-icon-construction', DileIconlibConstruction);
}
