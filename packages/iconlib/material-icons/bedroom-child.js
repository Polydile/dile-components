...
export class DileIconlibBedroomChild extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-bedroom-child')) {
  customElements.define('dile-material-icon-bedroom-child', DileIconlibBedroomChild);
}
