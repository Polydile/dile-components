...
export class DileIconlib8mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-8mp')) {
  customElements.define('dile-material-icon-8mp', DileIconlib8mp);
}
