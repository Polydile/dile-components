...
export class DileIconlibExposureZero extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-exposure-zero')) {
  customElements.define('dile-material-icon-exposure-zero', DileIconlibExposureZero);
}
