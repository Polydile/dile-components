...
export class DileIconlibRssFeed extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-rss-feed')) {
  customElements.define('dile-material-icon-rss-feed', DileIconlibRssFeed);
}
