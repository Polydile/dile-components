...
export class DileIconlib3mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-3mp')) {
  customElements.define('dile-material-icon-3mp', DileIconlib3mp);
}
