...
export class DileIconlibUsbOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-usb-off')) {
  customElements.define('dile-material-icon-usb-off', DileIconlibUsbOff);
}
