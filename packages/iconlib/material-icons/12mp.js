...
export class DileIconlib12mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-12mp')) {
  customElements.define('dile-material-icon-12mp', DileIconlib12mp);
}
