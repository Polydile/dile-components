...
export class DileIconlib18mp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-18mp')) {
  customElements.define('dile-material-icon-18mp', DileIconlib18mp);
}
