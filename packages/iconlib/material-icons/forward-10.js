...
export class DileIconlibForward10 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-forward-10')) {
  customElements.define('dile-material-icon-forward-10', DileIconlibForward10);
}
