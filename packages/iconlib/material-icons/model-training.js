...
export class DileIconlibModelTraining extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-model-training')) {
  customElements.define('dile-material-icon-model-training', DileIconlibModelTraining);
}
