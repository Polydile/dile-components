...
export class DileIconlibLight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-material-icon-light')) {
  customElements.define('dile-material-icon-light', DileIconlibLight);
}
