...
export class DileIconlibFileCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-cog')) {
  customElements.define('dile-lucide-icon-file-cog', DileIconlibFileCog);
}
