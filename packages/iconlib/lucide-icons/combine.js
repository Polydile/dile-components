...
export class DileIconlibCombine extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-combine')) {
  customElements.define('dile-lucide-icon-combine', DileIconlibCombine);
}
