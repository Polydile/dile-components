...
export class DileIconlibChevronsDownUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-chevrons-down-up')) {
  customElements.define('dile-lucide-icon-chevrons-down-up', DileIconlibChevronsDownUp);
}
