...
export class DileIconlibScanHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-scan-heart')) {
  customElements.define('dile-lucide-icon-scan-heart', DileIconlibScanHeart);
}
