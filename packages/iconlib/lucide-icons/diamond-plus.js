...
export class DileIconlibDiamondPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-diamond-plus')) {
  customElements.define('dile-lucide-icon-diamond-plus', DileIconlibDiamondPlus);
}
