...
export class DileIconlibTentTree extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-tent-tree')) {
  customElements.define('dile-lucide-icon-tent-tree', DileIconlibTentTree);
}
