...
export class DileIconlibPlugZap extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-plug-zap')) {
  customElements.define('dile-lucide-icon-plug-zap', DileIconlibPlugZap);
}
