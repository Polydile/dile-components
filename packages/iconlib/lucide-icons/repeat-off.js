...
export class DileIconlibRepeatOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-repeat-off')) {
  customElements.define('dile-lucide-icon-repeat-off', DileIconlibRepeatOff);
}
