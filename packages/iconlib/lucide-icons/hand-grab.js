...
export class DileIconlibHandGrab extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-hand-grab')) {
  customElements.define('dile-lucide-icon-hand-grab', DileIconlibHandGrab);
}
