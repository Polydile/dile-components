...
export class DileIconlibLocateOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-locate-off')) {
  customElements.define('dile-lucide-icon-locate-off', DileIconlibLocateOff);
}
