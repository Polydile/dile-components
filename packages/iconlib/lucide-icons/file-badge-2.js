...
export class DileIconlibFileBadge2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-badge-2')) {
  customElements.define('dile-lucide-icon-file-badge-2', DileIconlibFileBadge2);
}
