...
export class DileIconlibShieldMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-shield-minus')) {
  customElements.define('dile-lucide-icon-shield-minus', DileIconlibShieldMinus);
}
