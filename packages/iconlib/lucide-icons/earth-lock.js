...
export class DileIconlibEarthLock extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-earth-lock')) {
  customElements.define('dile-lucide-icon-earth-lock', DileIconlibEarthLock);
}
