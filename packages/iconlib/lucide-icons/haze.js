...
export class DileIconlibHaze extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-haze')) {
  customElements.define('dile-lucide-icon-haze', DileIconlibHaze);
}
