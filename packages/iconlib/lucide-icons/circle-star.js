...
export class DileIconlibCircleStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-circle-star')) {
  customElements.define('dile-lucide-icon-circle-star', DileIconlibCircleStar);
}
