...
export class DileIconlibMapPinX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-map-pin-x')) {
  customElements.define('dile-lucide-icon-map-pin-x', DileIconlibMapPinX);
}
