...
export class DileIconlibMusic2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-music-2')) {
  customElements.define('dile-lucide-icon-music-2', DileIconlibMusic2);
}
