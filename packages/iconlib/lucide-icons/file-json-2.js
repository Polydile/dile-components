...
export class DileIconlibFileJson2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-json-2')) {
  customElements.define('dile-lucide-icon-file-json-2', DileIconlibFileJson2);
}
