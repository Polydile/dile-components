...
export class DileIconlibFileMusic extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-music')) {
  customElements.define('dile-lucide-icon-file-music', DileIconlibFileMusic);
}
