...
export class DileIconlibFileCheckCorner extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-check-corner')) {
  customElements.define('dile-lucide-icon-file-check-corner', DileIconlibFileCheckCorner);
}
