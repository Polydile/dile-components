...
export class DileIconlibRabbit extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-rabbit')) {
  customElements.define('dile-lucide-icon-rabbit', DileIconlibRabbit);
}
