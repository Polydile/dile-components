...
export class DileIconlibBlocks extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-blocks')) {
  customElements.define('dile-lucide-icon-blocks', DileIconlibBlocks);
}
