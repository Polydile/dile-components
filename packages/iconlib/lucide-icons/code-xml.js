...
export class DileIconlibCodeXml extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-code-xml')) {
  customElements.define('dile-lucide-icon-code-xml', DileIconlibCodeXml);
}
