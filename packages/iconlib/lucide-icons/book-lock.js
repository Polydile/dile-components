...
export class DileIconlibBookLock extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-book-lock')) {
  customElements.define('dile-lucide-icon-book-lock', DileIconlibBookLock);
}
