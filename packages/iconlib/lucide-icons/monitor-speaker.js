...
export class DileIconlibMonitorSpeaker extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-monitor-speaker')) {
  customElements.define('dile-lucide-icon-monitor-speaker', DileIconlibMonitorSpeaker);
}
