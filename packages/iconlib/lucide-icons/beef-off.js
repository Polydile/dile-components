...
export class DileIconlibBeefOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-beef-off')) {
  customElements.define('dile-lucide-icon-beef-off', DileIconlibBeefOff);
}
