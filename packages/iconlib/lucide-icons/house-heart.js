...
export class DileIconlibHouseHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-house-heart')) {
  customElements.define('dile-lucide-icon-house-heart', DileIconlibHouseHeart);
}
