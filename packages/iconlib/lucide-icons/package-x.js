...
export class DileIconlibPackageX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-package-x')) {
  customElements.define('dile-lucide-icon-package-x', DileIconlibPackageX);
}
