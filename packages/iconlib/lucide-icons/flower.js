...
export class DileIconlibFlower extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-flower')) {
  customElements.define('dile-lucide-icon-flower', DileIconlibFlower);
}
