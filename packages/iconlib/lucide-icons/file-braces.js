...
export class DileIconlibFileBraces extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-braces')) {
  customElements.define('dile-lucide-icon-file-braces', DileIconlibFileBraces);
}
