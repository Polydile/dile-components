...
export class DileIconlibEyeDashed extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-eye-dashed')) {
  customElements.define('dile-lucide-icon-eye-dashed', DileIconlibEyeDashed);
}
