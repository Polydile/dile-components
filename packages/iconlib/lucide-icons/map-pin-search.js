...
export class DileIconlibMapPinSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-map-pin-search')) {
  customElements.define('dile-lucide-icon-map-pin-search', DileIconlibMapPinSearch);
}
