...
export class DileIconlibNutOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-nut-off')) {
  customElements.define('dile-lucide-icon-nut-off', DileIconlibNutOff);
}
