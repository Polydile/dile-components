...
export class DileIconlibLampCeiling extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-lamp-ceiling')) {
  customElements.define('dile-lucide-icon-lamp-ceiling', DileIconlibLampCeiling);
}
