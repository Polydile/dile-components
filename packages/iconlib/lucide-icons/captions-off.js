...
export class DileIconlibCaptionsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-captions-off')) {
  customElements.define('dile-lucide-icon-captions-off', DileIconlibCaptionsOff);
}
