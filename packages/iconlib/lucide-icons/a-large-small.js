...
export class DileIconlibALargeSmall extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-a-large-small')) {
  customElements.define('dile-lucide-icon-a-large-small', DileIconlibALargeSmall);
}
