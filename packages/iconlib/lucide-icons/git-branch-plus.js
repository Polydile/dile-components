...
export class DileIconlibGitBranchPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-git-branch-plus')) {
  customElements.define('dile-lucide-icon-git-branch-plus', DileIconlibGitBranchPlus);
}
