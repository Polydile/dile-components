...
export class DileIconlibPocketKnife extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-pocket-knife')) {
  customElements.define('dile-lucide-icon-pocket-knife', DileIconlibPocketKnife);
}
