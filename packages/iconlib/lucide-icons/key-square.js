...
export class DileIconlibKeySquare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-key-square')) {
  customElements.define('dile-lucide-icon-key-square', DileIconlibKeySquare);
}
