...
export class DileIconlibLocate extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-locate')) {
  customElements.define('dile-lucide-icon-locate', DileIconlibLocate);
}
