...
export class DileIconlibSignalZero extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-signal-zero')) {
  customElements.define('dile-lucide-icon-signal-zero', DileIconlibSignalZero);
}
