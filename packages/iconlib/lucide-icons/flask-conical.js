...
export class DileIconlibFlaskConical extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-flask-conical')) {
  customElements.define('dile-lucide-icon-flask-conical', DileIconlibFlaskConical);
}
