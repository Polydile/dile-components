...
export class DileIconlibBottleWine extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-bottle-wine')) {
  customElements.define('dile-lucide-icon-bottle-wine', DileIconlibBottleWine);
}
