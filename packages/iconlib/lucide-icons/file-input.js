...
export class DileIconlibFileInput extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-input')) {
  customElements.define('dile-lucide-icon-file-input', DileIconlibFileInput);
}
