...
export class DileIconlibSpeech extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-speech')) {
  customElements.define('dile-lucide-icon-speech', DileIconlibSpeech);
}
