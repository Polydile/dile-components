...
export class DileIconlibWavesArrowDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-waves-arrow-down')) {
  customElements.define('dile-lucide-icon-waves-arrow-down', DileIconlibWavesArrowDown);
}
