...
export class DileIconlibUserRoundCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-user-round-cog')) {
  customElements.define('dile-lucide-icon-user-round-cog', DileIconlibUserRoundCog);
}
