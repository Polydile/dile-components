...
export class DileIconlibPencilSparkles extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-pencil-sparkles')) {
  customElements.define('dile-lucide-icon-pencil-sparkles', DileIconlibPencilSparkles);
}
