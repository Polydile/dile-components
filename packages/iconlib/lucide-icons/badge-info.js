...
export class DileIconlibBadgeInfo extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-badge-info')) {
  customElements.define('dile-lucide-icon-badge-info', DileIconlibBadgeInfo);
}
