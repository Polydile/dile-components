...
export class DileIconlibPenLine extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-pen-line')) {
  customElements.define('dile-lucide-icon-pen-line', DileIconlibPenLine);
}
