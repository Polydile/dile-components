...
export class DileIconlibBrushCleaning extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-brush-cleaning')) {
  customElements.define('dile-lucide-icon-brush-cleaning', DileIconlibBrushCleaning);
}
