...
export class DileIconlibAstroid extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-astroid')) {
  customElements.define('dile-lucide-icon-astroid', DileIconlibAstroid);
}
