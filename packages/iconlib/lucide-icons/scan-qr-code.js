...
export class DileIconlibScanQrCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-scan-qr-code')) {
  customElements.define('dile-lucide-icon-scan-qr-code', DileIconlibScanQrCode);
}
