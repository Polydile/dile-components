...
export class DileIconlibCloudDrizzle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-cloud-drizzle')) {
  customElements.define('dile-lucide-icon-cloud-drizzle', DileIconlibCloudDrizzle);
}
