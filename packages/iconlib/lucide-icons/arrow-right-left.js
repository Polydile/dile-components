...
export class DileIconlibArrowRightLeft extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-arrow-right-left')) {
  customElements.define('dile-lucide-icon-arrow-right-left', DileIconlibArrowRightLeft);
}
