...
export class DileIconlibCupSoda extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-cup-soda')) {
  customElements.define('dile-lucide-icon-cup-soda', DileIconlibCupSoda);
}
