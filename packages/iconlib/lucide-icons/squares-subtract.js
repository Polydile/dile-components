...
export class DileIconlibSquaresSubtract extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-squares-subtract')) {
  customElements.define('dile-lucide-icon-squares-subtract', DileIconlibSquaresSubtract);
}
