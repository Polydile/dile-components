...
export class DileIconlibFolderInput extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-folder-input')) {
  customElements.define('dile-lucide-icon-folder-input', DileIconlibFolderInput);
}
