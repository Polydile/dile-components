...
export class DileIconlibHandHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-hand-heart')) {
  customElements.define('dile-lucide-icon-hand-heart', DileIconlibHandHeart);
}
