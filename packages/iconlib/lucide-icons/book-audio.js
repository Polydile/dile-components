...
export class DileIconlibBookAudio extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-book-audio')) {
  customElements.define('dile-lucide-icon-book-audio', DileIconlibBookAudio);
}
