...
export class DileIconlibHeadphoneOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-headphone-off')) {
  customElements.define('dile-lucide-icon-headphone-off', DileIconlibHeadphoneOff);
}
