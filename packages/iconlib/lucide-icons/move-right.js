...
export class DileIconlibMoveRight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-move-right')) {
  customElements.define('dile-lucide-icon-move-right', DileIconlibMoveRight);
}
