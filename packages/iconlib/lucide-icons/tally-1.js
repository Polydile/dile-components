...
export class DileIconlibTally1 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-tally-1')) {
  customElements.define('dile-lucide-icon-tally-1', DileIconlibTally1);
}
