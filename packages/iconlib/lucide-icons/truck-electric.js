...
export class DileIconlibTruckElectric extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-truck-electric')) {
  customElements.define('dile-lucide-icon-truck-electric', DileIconlibTruckElectric);
}
