...
export class DileIconlibPointerOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-pointer-off')) {
  customElements.define('dile-lucide-icon-pointer-off', DileIconlibPointerOff);
}
