...
export class DileIconlibStickyNoteCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-sticky-note-check')) {
  customElements.define('dile-lucide-icon-sticky-note-check', DileIconlibStickyNoteCheck);
}
