...
export class DileIconlibDiameter extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-diameter')) {
  customElements.define('dile-lucide-icon-diameter', DileIconlibDiameter);
}
