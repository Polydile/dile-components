...
export class DileIconlibCopySlash extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-copy-slash')) {
  customElements.define('dile-lucide-icon-copy-slash', DileIconlibCopySlash);
}
