...
export class DileIconlibFileClock extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-clock')) {
  customElements.define('dile-lucide-icon-file-clock', DileIconlibFileClock);
}
