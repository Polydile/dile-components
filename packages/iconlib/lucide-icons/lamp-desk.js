...
export class DileIconlibLampDesk extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-lamp-desk')) {
  customElements.define('dile-lucide-icon-lamp-desk', DileIconlibLampDesk);
}
