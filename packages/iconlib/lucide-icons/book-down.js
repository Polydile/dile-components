...
export class DileIconlibBookDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-book-down')) {
  customElements.define('dile-lucide-icon-book-down', DileIconlibBookDown);
}
