...
export class DileIconlibFolderArchive extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-folder-archive')) {
  customElements.define('dile-lucide-icon-folder-archive', DileIconlibFolderArchive);
}
