...
export class DileIconlibListStart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-list-start')) {
  customElements.define('dile-lucide-icon-list-start', DileIconlibListStart);
}
