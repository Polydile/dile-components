...
export class DileIconlibPlaneLanding extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-plane-landing')) {
  customElements.define('dile-lucide-icon-plane-landing', DileIconlibPlaneLanding);
}
