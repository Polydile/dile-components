...
export class DileIconlibTvMinimalPlay extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-tv-minimal-play')) {
  customElements.define('dile-lucide-icon-tv-minimal-play', DileIconlibTvMinimalPlay);
}
