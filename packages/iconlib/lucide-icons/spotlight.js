...
export class DileIconlibSpotlight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-spotlight')) {
  customElements.define('dile-lucide-icon-spotlight', DileIconlibSpotlight);
}
