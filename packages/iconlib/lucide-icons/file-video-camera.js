...
export class DileIconlibFileVideoCamera extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-video-camera')) {
  customElements.define('dile-lucide-icon-file-video-camera', DileIconlibFileVideoCamera);
}
