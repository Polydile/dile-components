...
export class DileIconlibLayers2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-layers-2')) {
  customElements.define('dile-lucide-icon-layers-2', DileIconlibLayers2);
}
