...
export class DileIconlibVibrateOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-vibrate-off')) {
  customElements.define('dile-lucide-icon-vibrate-off', DileIconlibVibrateOff);
}
