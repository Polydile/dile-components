...
export class DileIconlibBadgeCent extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-badge-cent')) {
  customElements.define('dile-lucide-icon-badge-cent', DileIconlibBadgeCent);
}
