...
export class DileIconlibBookmarkCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-bookmark-check')) {
  customElements.define('dile-lucide-icon-bookmark-check', DileIconlibBookmarkCheck);
}
