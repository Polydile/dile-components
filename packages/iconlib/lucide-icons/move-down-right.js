...
export class DileIconlibMoveDownRight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-move-down-right')) {
  customElements.define('dile-lucide-icon-move-down-right', DileIconlibMoveDownRight);
}
