...
export class DileIconlibBrickWallFire extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-brick-wall-fire')) {
  customElements.define('dile-lucide-icon-brick-wall-fire', DileIconlibBrickWallFire);
}
