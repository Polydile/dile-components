...
export class DileIconlibWebhook extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-webhook')) {
  customElements.define('dile-lucide-icon-webhook', DileIconlibWebhook);
}
