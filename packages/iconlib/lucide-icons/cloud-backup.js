...
export class DileIconlibCloudBackup extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-cloud-backup')) {
  customElements.define('dile-lucide-icon-cloud-backup', DileIconlibCloudBackup);
}
