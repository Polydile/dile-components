...
export class DileIconlibSnail extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-snail')) {
  customElements.define('dile-lucide-icon-snail', DileIconlibSnail);
}
