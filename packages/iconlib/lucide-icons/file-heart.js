...
export class DileIconlibFileHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-heart')) {
  customElements.define('dile-lucide-icon-file-heart', DileIconlibFileHeart);
}
