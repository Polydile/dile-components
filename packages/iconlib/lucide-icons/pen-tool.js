...
export class DileIconlibPenTool extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-pen-tool')) {
  customElements.define('dile-lucide-icon-pen-tool', DileIconlibPenTool);
}
