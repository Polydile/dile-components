...
export class DileIconlibBrainCircuit extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-brain-circuit')) {
  customElements.define('dile-lucide-icon-brain-circuit', DileIconlibBrainCircuit);
}
