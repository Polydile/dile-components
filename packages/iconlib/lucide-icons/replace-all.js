...
export class DileIconlibReplaceAll extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-replace-all')) {
  customElements.define('dile-lucide-icon-replace-all', DileIconlibReplaceAll);
}
