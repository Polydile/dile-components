...
export class DileIconlibShieldUser extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-shield-user')) {
  customElements.define('dile-lucide-icon-shield-user', DileIconlibShieldUser);
}
