...
export class DileIconlibTreePine extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-tree-pine')) {
  customElements.define('dile-lucide-icon-tree-pine', DileIconlibTreePine);
}
