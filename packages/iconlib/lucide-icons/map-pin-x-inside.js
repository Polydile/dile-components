...
export class DileIconlibMapPinXInside extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-map-pin-x-inside')) {
  customElements.define('dile-lucide-icon-map-pin-x-inside', DileIconlibMapPinXInside);
}
