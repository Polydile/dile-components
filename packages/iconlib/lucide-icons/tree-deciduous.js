...
export class DileIconlibTreeDeciduous extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-tree-deciduous')) {
  customElements.define('dile-lucide-icon-tree-deciduous', DileIconlibTreeDeciduous);
}
