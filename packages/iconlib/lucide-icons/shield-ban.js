...
export class DileIconlibShieldBan extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-shield-ban')) {
  customElements.define('dile-lucide-icon-shield-ban', DileIconlibShieldBan);
}
