...
export class DileIconlibFolderOutput extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-folder-output')) {
  customElements.define('dile-lucide-icon-folder-output', DileIconlibFolderOutput);
}
