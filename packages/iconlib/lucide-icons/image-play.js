...
export class DileIconlibImagePlay extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-image-play')) {
  customElements.define('dile-lucide-icon-image-play', DileIconlibImagePlay);
}
