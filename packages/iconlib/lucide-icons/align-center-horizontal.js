...
if (!customElements.get('dile-lucide-icon-align-center-horizontal')) {
  customElements.define('dile-lucide-icon-align-center-horizontal', DileIconlibAlignCenterHorizontal);
}
