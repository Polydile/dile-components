...
export class DileIconlibCloudSunRain extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-cloud-sun-rain')) {
  customElements.define('dile-lucide-icon-cloud-sun-rain', DileIconlibCloudSunRain);
}
