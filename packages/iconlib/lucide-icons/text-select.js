...
export class DileIconlibTextSelect extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-text-select')) {
  customElements.define('dile-lucide-icon-text-select', DileIconlibTextSelect);
}
