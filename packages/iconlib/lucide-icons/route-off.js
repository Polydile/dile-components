...
export class DileIconlibRouteOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-route-off')) {
  customElements.define('dile-lucide-icon-route-off', DileIconlibRouteOff);
}
