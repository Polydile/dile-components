...
export class DileIconlibPiano extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-piano')) {
  customElements.define('dile-lucide-icon-piano', DileIconlibPiano);
}
