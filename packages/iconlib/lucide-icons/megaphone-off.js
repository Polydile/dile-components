...
export class DileIconlibMegaphoneOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-megaphone-off')) {
  customElements.define('dile-lucide-icon-megaphone-off', DileIconlibMegaphoneOff);
}
