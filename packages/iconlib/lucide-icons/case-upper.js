...
export class DileIconlibCaseUpper extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-case-upper')) {
  customElements.define('dile-lucide-icon-case-upper', DileIconlibCaseUpper);
}
