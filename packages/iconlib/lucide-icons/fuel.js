...
export class DileIconlibFuel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-fuel')) {
  customElements.define('dile-lucide-icon-fuel', DileIconlibFuel);
}
