...
export class DileIconlibRefreshCcwDot extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-refresh-ccw-dot')) {
  customElements.define('dile-lucide-icon-refresh-ccw-dot', DileIconlibRefreshCcwDot);
}
