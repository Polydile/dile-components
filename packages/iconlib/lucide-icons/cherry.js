...
export class DileIconlibCherry extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-cherry')) {
  customElements.define('dile-lucide-icon-cherry', DileIconlibCherry);
}
