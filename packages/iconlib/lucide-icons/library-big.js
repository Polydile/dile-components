...
export class DileIconlibLibraryBig extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-library-big')) {
  customElements.define('dile-lucide-icon-library-big', DileIconlibLibraryBig);
}
