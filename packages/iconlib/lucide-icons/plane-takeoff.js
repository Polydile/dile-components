...
export class DileIconlibPlaneTakeoff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-plane-takeoff')) {
  customElements.define('dile-lucide-icon-plane-takeoff', DileIconlibPlaneTakeoff);
}
