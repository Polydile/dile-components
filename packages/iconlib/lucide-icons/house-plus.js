...
export class DileIconlibHousePlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-house-plus')) {
  customElements.define('dile-lucide-icon-house-plus', DileIconlibHousePlus);
}
