...
export class DileIconlibBookType extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-book-type')) {
  customElements.define('dile-lucide-icon-book-type', DileIconlibBookType);
}
