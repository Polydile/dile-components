...
if (!customElements.get('dile-lucide-icon-align-center-vertical')) {
  customElements.define('dile-lucide-icon-align-center-vertical', DileIconlibAlignCenterVertical);
}
