...
export class DileIconlibBookKey extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-book-key')) {
  customElements.define('dile-lucide-icon-book-key', DileIconlibBookKey);
}
