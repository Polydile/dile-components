...
export class DileIconlibMapPinMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-map-pin-minus')) {
  customElements.define('dile-lucide-icon-map-pin-minus', DileIconlibMapPinMinus);
}
