...
export class DileIconlibMoonStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-moon-star')) {
  customElements.define('dile-lucide-icon-moon-star', DileIconlibMoonStar);
}
