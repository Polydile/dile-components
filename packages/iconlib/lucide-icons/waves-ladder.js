...
export class DileIconlibWavesLadder extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-waves-ladder')) {
  customElements.define('dile-lucide-icon-waves-ladder', DileIconlibWavesLadder);
}
