...
export class DileIconlibLampWallUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-lamp-wall-up')) {
  customElements.define('dile-lucide-icon-lamp-wall-up', DileIconlibLampWallUp);
}
