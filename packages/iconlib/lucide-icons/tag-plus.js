...
export class DileIconlibTagPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-tag-plus')) {
  customElements.define('dile-lucide-icon-tag-plus', DileIconlibTagPlus);
}
