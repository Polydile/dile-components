...
export class DileIconlibArrowUpToLine extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-arrow-up-to-line')) {
  customElements.define('dile-lucide-icon-arrow-up-to-line', DileIconlibArrowUpToLine);
}
