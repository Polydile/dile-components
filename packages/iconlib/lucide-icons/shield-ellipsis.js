...
export class DileIconlibShieldEllipsis extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-shield-ellipsis')) {
  customElements.define('dile-lucide-icon-shield-ellipsis', DileIconlibShieldEllipsis);
}
