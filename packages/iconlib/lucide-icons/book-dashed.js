...
export class DileIconlibBookDashed extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-book-dashed')) {
  customElements.define('dile-lucide-icon-book-dashed', DileIconlibBookDashed);
}
