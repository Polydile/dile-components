...
export class DileIconlibShrink extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-shrink')) {
  customElements.define('dile-lucide-icon-shrink', DileIconlibShrink);
}
