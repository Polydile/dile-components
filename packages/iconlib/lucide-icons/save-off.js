...
export class DileIconlibSaveOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-save-off')) {
  customElements.define('dile-lucide-icon-save-off', DileIconlibSaveOff);
}
