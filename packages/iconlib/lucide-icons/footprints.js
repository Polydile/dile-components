...
export class DileIconlibFootprints extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-footprints')) {
  customElements.define('dile-lucide-icon-footprints', DileIconlibFootprints);
}
