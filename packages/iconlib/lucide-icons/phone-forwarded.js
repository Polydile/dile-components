...
export class DileIconlibPhoneForwarded extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-phone-forwarded')) {
  customElements.define('dile-lucide-icon-phone-forwarded', DileIconlibPhoneForwarded);
}
