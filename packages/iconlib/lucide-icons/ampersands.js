...
export class DileIconlibAmpersands extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-ampersands')) {
  customElements.define('dile-lucide-icon-ampersands', DileIconlibAmpersands);
}
