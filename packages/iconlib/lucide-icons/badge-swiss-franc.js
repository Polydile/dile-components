...
export class DileIconlibBadgeSwissFranc extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-badge-swiss-franc')) {
  customElements.define('dile-lucide-icon-badge-swiss-franc', DileIconlibBadgeSwissFranc);
}
