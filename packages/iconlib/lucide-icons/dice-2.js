...
export class DileIconlibDice2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-dice-2')) {
  customElements.define('dile-lucide-icon-dice-2', DileIconlibDice2);
}
