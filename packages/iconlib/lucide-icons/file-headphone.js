...
export class DileIconlibFileHeadphone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-headphone')) {
  customElements.define('dile-lucide-icon-file-headphone', DileIconlibFileHeadphone);
}
