...
export class DileIconlibCirclePile extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-circle-pile')) {
  customElements.define('dile-lucide-icon-circle-pile', DileIconlibCirclePile);
}
