...
export class DileIconlibLayersPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-layers-plus')) {
  customElements.define('dile-lucide-icon-layers-plus', DileIconlibLayersPlus);
}
