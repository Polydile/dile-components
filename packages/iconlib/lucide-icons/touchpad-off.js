...
export class DileIconlibTouchpadOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-touchpad-off')) {
  customElements.define('dile-lucide-icon-touchpad-off', DileIconlibTouchpadOff);
}
