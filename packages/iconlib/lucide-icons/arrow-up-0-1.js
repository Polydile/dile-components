...
export class DileIconlibArrowUp01 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-arrow-up-0-1')) {
  customElements.define('dile-lucide-icon-arrow-up-0-1', DileIconlibArrowUp01);
}
