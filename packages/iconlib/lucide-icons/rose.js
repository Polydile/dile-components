...
export class DileIconlibRose extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-rose')) {
  customElements.define('dile-lucide-icon-rose', DileIconlibRose);
}
