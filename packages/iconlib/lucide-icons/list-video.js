...
export class DileIconlibListVideo extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-list-video')) {
  customElements.define('dile-lucide-icon-list-video', DileIconlibListVideo);
}
