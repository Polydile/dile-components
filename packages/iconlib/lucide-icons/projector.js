...
export class DileIconlibProjector extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-projector')) {
  customElements.define('dile-lucide-icon-projector', DileIconlibProjector);
}
