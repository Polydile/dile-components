...
export class DileIconlibDrone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-drone')) {
  customElements.define('dile-lucide-icon-drone', DileIconlibDrone);
}
