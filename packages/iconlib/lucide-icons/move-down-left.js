...
export class DileIconlibMoveDownLeft extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-move-down-left')) {
  customElements.define('dile-lucide-icon-move-down-left', DileIconlibMoveDownLeft);
}
