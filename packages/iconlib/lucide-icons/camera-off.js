...
export class DileIconlibCameraOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-camera-off')) {
  customElements.define('dile-lucide-icon-camera-off', DileIconlibCameraOff);
}
