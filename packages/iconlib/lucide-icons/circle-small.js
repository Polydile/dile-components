...
export class DileIconlibCircleSmall extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-circle-small')) {
  customElements.define('dile-lucide-icon-circle-small', DileIconlibCircleSmall);
}
