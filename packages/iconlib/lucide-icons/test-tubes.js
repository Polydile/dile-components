...
export class DileIconlibTestTubes extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-test-tubes')) {
  customElements.define('dile-lucide-icon-test-tubes', DileIconlibTestTubes);
}
