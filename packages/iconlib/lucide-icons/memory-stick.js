...
export class DileIconlibMemoryStick extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-memory-stick')) {
  customElements.define('dile-lucide-icon-memory-stick', DileIconlibMemoryStick);
}
