...
export class DileIconlibDiamondMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-diamond-minus')) {
  customElements.define('dile-lucide-icon-diamond-minus', DileIconlibDiamondMinus);
}
