...
export class DileIconlibBanknoteX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-banknote-x')) {
  customElements.define('dile-lucide-icon-banknote-x', DileIconlibBanknoteX);
}
