...
export class DileIconlibHouseWifi extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-house-wifi')) {
  customElements.define('dile-lucide-icon-house-wifi', DileIconlibHouseWifi);
}
