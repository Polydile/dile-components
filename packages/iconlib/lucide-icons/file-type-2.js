...
export class DileIconlibFileType2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-type-2')) {
  customElements.define('dile-lucide-icon-file-type-2', DileIconlibFileType2);
}
