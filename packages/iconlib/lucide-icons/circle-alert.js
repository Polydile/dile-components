...
export class DileIconlibCircleAlert extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-circle-alert')) {
  customElements.define('dile-lucide-icon-circle-alert', DileIconlibCircleAlert);
}
