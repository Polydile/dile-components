...
export class DileIconlibPlug2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-plug-2')) {
  customElements.define('dile-lucide-icon-plug-2', DileIconlibPlug2);
}
