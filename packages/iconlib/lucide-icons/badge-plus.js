...
export class DileIconlibBadgePlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-badge-plus')) {
  customElements.define('dile-lucide-icon-badge-plus', DileIconlibBadgePlus);
}
