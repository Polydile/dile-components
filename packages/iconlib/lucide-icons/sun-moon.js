...
export class DileIconlibSunMoon extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-sun-moon')) {
  customElements.define('dile-lucide-icon-sun-moon', DileIconlibSunMoon);
}
