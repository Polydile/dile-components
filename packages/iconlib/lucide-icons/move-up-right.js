...
export class DileIconlibMoveUpRight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-move-up-right')) {
  customElements.define('dile-lucide-icon-move-up-right', DileIconlibMoveUpRight);
}
