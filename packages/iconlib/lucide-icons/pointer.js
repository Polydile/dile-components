...
export class DileIconlibPointer extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-pointer')) {
  customElements.define('dile-lucide-icon-pointer', DileIconlibPointer);
}
