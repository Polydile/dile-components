...
export class DileIconlibBookCopy extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-book-copy')) {
  customElements.define('dile-lucide-icon-book-copy', DileIconlibBookCopy);
}
