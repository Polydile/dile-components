...
export class DileIconlibImageOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-image-off')) {
  customElements.define('dile-lucide-icon-image-off', DileIconlibImageOff);
}
