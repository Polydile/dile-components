...
export class DileIconlibSquareStack extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-square-stack')) {
  customElements.define('dile-lucide-icon-square-stack', DileIconlibSquareStack);
}
