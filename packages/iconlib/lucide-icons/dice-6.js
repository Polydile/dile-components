...
export class DileIconlibDice6 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-dice-6')) {
  customElements.define('dile-lucide-icon-dice-6', DileIconlibDice6);
}
