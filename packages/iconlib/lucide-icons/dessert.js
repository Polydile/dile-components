...
export class DileIconlibDessert extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-dessert')) {
  customElements.define('dile-lucide-icon-dessert', DileIconlibDessert);
}
