...
export class DileIconlibDrama extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-drama')) {
  customElements.define('dile-lucide-icon-drama', DileIconlibDrama);
}
