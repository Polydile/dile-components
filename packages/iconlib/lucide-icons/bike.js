...
export class DileIconlibBike extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-bike')) {
  customElements.define('dile-lucide-icon-bike', DileIconlibBike);
}
