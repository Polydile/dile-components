...
export class DileIconlibMilk extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-milk')) {
  customElements.define('dile-lucide-icon-milk', DileIconlibMilk);
}
