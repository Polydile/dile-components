...
export class DileIconlibMapPinHouse extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-map-pin-house')) {
  customElements.define('dile-lucide-icon-map-pin-house', DileIconlibMapPinHouse);
}
