...
export class DileIconlibPhoneOutgoing extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-phone-outgoing')) {
  customElements.define('dile-lucide-icon-phone-outgoing', DileIconlibPhoneOutgoing);
}
