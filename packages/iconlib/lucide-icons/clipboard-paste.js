...
export class DileIconlibClipboardPaste extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-clipboard-paste')) {
  customElements.define('dile-lucide-icon-clipboard-paste', DileIconlibClipboardPaste);
}
