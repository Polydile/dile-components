...
export class DileIconlibMoveDiagonal2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-move-diagonal-2')) {
  customElements.define('dile-lucide-icon-move-diagonal-2', DileIconlibMoveDiagonal2);
}
