...
export class DileIconlibSquarePlay extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-square-play')) {
  customElements.define('dile-lucide-icon-square-play', DileIconlibSquarePlay);
}
