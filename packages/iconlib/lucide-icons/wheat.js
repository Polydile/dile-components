...
export class DileIconlibWheat extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-wheat')) {
  customElements.define('dile-lucide-icon-wheat', DileIconlibWheat);
}
