...
export class DileIconlibMilkOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-milk-off')) {
  customElements.define('dile-lucide-icon-milk-off', DileIconlibMilkOff);
}
