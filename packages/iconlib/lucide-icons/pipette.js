...
export class DileIconlibPipette extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-pipette')) {
  customElements.define('dile-lucide-icon-pipette', DileIconlibPipette);
}
