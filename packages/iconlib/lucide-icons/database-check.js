...
export class DileIconlibDatabaseCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-database-check')) {
  customElements.define('dile-lucide-icon-database-check', DileIconlibDatabaseCheck);
}
