...
export class DileIconlibBadgeAlert extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-badge-alert')) {
  customElements.define('dile-lucide-icon-badge-alert', DileIconlibBadgeAlert);
}
