...
export class DileIconlibRollerCoaster extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-roller-coaster')) {
  customElements.define('dile-lucide-icon-roller-coaster', DileIconlibRollerCoaster);
}
