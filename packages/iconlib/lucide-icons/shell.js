...
export class DileIconlibShell extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-shell')) {
  customElements.define('dile-lucide-icon-shell', DileIconlibShell);
}
