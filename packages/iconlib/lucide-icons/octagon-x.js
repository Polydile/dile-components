...
export class DileIconlibOctagonX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-octagon-x')) {
  customElements.define('dile-lucide-icon-octagon-x', DileIconlibOctagonX);
}
