...
export class DileIconlibBadgeX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-badge-x')) {
  customElements.define('dile-lucide-icon-badge-x', DileIconlibBadgeX);
}
