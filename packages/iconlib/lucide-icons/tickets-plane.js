...
export class DileIconlibTicketsPlane extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-tickets-plane')) {
  customElements.define('dile-lucide-icon-tickets-plane', DileIconlibTicketsPlane);
}
