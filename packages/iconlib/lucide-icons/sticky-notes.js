...
export class DileIconlibStickyNotes extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-sticky-notes')) {
  customElements.define('dile-lucide-icon-sticky-notes', DileIconlibStickyNotes);
}
