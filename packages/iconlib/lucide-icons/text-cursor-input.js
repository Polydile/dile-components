...
export class DileIconlibTextCursorInput extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-text-cursor-input')) {
  customElements.define('dile-lucide-icon-text-cursor-input', DileIconlibTextCursorInput);
}
