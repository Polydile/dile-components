...
export class DileIconlibShrub extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-shrub')) {
  customElements.define('dile-lucide-icon-shrub', DileIconlibShrub);
}
