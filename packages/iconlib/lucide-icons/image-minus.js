...
export class DileIconlibImageMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-image-minus')) {
  customElements.define('dile-lucide-icon-image-minus', DileIconlibImageMinus);
}
