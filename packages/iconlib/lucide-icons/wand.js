...
export class DileIconlibWand extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-wand')) {
  customElements.define('dile-lucide-icon-wand', DileIconlibWand);
}
