...
export class DileIconlibBookUp2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-book-up-2')) {
  customElements.define('dile-lucide-icon-book-up-2', DileIconlibBookUp2);
}
