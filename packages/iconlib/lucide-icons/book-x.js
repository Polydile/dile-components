...
export class DileIconlibBookX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-book-x')) {
  customElements.define('dile-lucide-icon-book-x', DileIconlibBookX);
}
