...
export class DileIconlibEarOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-ear-off')) {
  customElements.define('dile-lucide-icon-ear-off', DileIconlibEarOff);
}
