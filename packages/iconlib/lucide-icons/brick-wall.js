...
export class DileIconlibBrickWall extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-brick-wall')) {
  customElements.define('dile-lucide-icon-brick-wall', DileIconlibBrickWall);
}
