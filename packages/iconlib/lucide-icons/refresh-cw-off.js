...
export class DileIconlibRefreshCwOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-refresh-cw-off')) {
  customElements.define('dile-lucide-icon-refresh-cw-off', DileIconlibRefreshCwOff);
}
