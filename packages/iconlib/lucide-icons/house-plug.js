...
export class DileIconlibHousePlug extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-house-plug')) {
  customElements.define('dile-lucide-icon-house-plug', DileIconlibHousePlug);
}
