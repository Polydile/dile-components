...
export class DileIconlibDrill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-drill')) {
  customElements.define('dile-lucide-icon-drill', DileIconlibDrill);
}
