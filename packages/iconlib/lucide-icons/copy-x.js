...
export class DileIconlibCopyX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-copy-x')) {
  customElements.define('dile-lucide-icon-copy-x', DileIconlibCopyX);
}
