...
export class DileIconlibBean extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-bean')) {
  customElements.define('dile-lucide-icon-bean', DileIconlibBean);
}
