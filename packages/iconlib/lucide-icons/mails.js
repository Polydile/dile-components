...
export class DileIconlibMails extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-mails')) {
  customElements.define('dile-lucide-icon-mails', DileIconlibMails);
}
