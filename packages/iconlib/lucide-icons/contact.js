...
export class DileIconlibContact extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-contact')) {
  customElements.define('dile-lucide-icon-contact', DileIconlibContact);
}
