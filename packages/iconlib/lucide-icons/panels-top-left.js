...
export class DileIconlibPanelsTopLeft extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-panels-top-left')) {
  customElements.define('dile-lucide-icon-panels-top-left', DileIconlibPanelsTopLeft);
}
