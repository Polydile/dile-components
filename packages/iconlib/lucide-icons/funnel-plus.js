...
export class DileIconlibFunnelPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-funnel-plus')) {
  customElements.define('dile-lucide-icon-funnel-plus', DileIconlibFunnelPlus);
}
