...
export class DileIconlibFileAudio2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-audio-2')) {
  customElements.define('dile-lucide-icon-file-audio-2', DileIconlibFileAudio2);
}
