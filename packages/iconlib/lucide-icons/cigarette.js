...
export class DileIconlibCigarette extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-cigarette')) {
  customElements.define('dile-lucide-icon-cigarette', DileIconlibCigarette);
}
