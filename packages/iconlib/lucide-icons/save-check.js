...
export class DileIconlibSaveCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-save-check')) {
  customElements.define('dile-lucide-icon-save-check', DileIconlibSaveCheck);
}
