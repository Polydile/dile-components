...
export class DileIconlibBookHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-book-heart')) {
  customElements.define('dile-lucide-icon-book-heart', DileIconlibBookHeart);
}
