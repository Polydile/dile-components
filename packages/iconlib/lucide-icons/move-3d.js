...
export class DileIconlibMove3d extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-move-3d')) {
  customElements.define('dile-lucide-icon-move-3d', DileIconlibMove3d);
}
