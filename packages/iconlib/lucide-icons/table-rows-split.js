...
export class DileIconlibTableRowsSplit extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-table-rows-split')) {
  customElements.define('dile-lucide-icon-table-rows-split', DileIconlibTableRowsSplit);
}
