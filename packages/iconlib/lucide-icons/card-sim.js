...
export class DileIconlibCardSim extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-card-sim')) {
  customElements.define('dile-lucide-icon-card-sim', DileIconlibCardSim);
}
