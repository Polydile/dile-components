...
export class DileIconlibHandHelping extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-hand-helping')) {
  customElements.define('dile-lucide-icon-hand-helping', DileIconlibHandHelping);
}
