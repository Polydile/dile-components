...
export class DileIconlibDiamondPercent extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-diamond-percent')) {
  customElements.define('dile-lucide-icon-diamond-percent', DileIconlibDiamondPercent);
}
