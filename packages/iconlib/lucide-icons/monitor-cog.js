...
export class DileIconlibMonitorCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-monitor-cog')) {
  customElements.define('dile-lucide-icon-monitor-cog', DileIconlibMonitorCog);
}
