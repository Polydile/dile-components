...
export class DileIconlibFileBadge extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-badge')) {
  customElements.define('dile-lucide-icon-file-badge', DileIconlibFileBadge);
}
