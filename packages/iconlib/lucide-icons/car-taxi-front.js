...
export class DileIconlibCarTaxiFront extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-car-taxi-front')) {
  customElements.define('dile-lucide-icon-car-taxi-front', DileIconlibCarTaxiFront);
}
