...
export class DileIconlibCigaretteOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-cigarette-off')) {
  customElements.define('dile-lucide-icon-cigarette-off', DileIconlibCigaretteOff);
}
