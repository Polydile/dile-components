...
export class DileIconlibSquareLibrary extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-square-library')) {
  customElements.define('dile-lucide-icon-square-library', DileIconlibSquareLibrary);
}
