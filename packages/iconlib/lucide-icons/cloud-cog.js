...
export class DileIconlibCloudCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-cloud-cog')) {
  customElements.define('dile-lucide-icon-cloud-cog', DileIconlibCloudCog);
}
