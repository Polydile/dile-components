...
export class DileIconlibHandMetal extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-hand-metal')) {
  customElements.define('dile-lucide-icon-hand-metal', DileIconlibHandMetal);
}
