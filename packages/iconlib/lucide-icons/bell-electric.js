...
export class DileIconlibBellElectric extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-bell-electric')) {
  customElements.define('dile-lucide-icon-bell-electric', DileIconlibBellElectric);
}
