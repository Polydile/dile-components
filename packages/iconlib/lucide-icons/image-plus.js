...
export class DileIconlibImagePlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-image-plus')) {
  customElements.define('dile-lucide-icon-image-plus', DileIconlibImagePlus);
}
