...
export class DileIconlibGlobeLock extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-globe-lock')) {
  customElements.define('dile-lucide-icon-globe-lock', DileIconlibGlobeLock);
}
