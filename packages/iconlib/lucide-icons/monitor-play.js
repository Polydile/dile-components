...
export class DileIconlibMonitorPlay extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-monitor-play')) {
  customElements.define('dile-lucide-icon-monitor-play', DileIconlibMonitorPlay);
}
