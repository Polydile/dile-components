...
export class DileIconlibSnowflake extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-snowflake')) {
  customElements.define('dile-lucide-icon-snowflake', DileIconlibSnowflake);
}
