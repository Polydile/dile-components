...
export class DileIconlibFileCodeCorner extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-code-corner')) {
  customElements.define('dile-lucide-icon-file-code-corner', DileIconlibFileCodeCorner);
}
