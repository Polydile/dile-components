...
export class DileIconlibPinOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-pin-off')) {
  customElements.define('dile-lucide-icon-pin-off', DileIconlibPinOff);
}
