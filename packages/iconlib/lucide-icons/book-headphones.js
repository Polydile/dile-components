...
export class DileIconlibBookHeadphones extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-book-headphones')) {
  customElements.define('dile-lucide-icon-book-headphones', DileIconlibBookHeadphones);
}
