...
export class DileIconlibSheet extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-sheet')) {
  customElements.define('dile-lucide-icon-sheet', DileIconlibSheet);
}
