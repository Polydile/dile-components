...
export class DileIconlibPhoneIncoming extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-phone-incoming')) {
  customElements.define('dile-lucide-icon-phone-incoming', DileIconlibPhoneIncoming);
}
