...
export class DileIconlibPackageOpen extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-package-open')) {
  customElements.define('dile-lucide-icon-package-open', DileIconlibPackageOpen);
}
