...
export class DileIconlibListMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-list-minus')) {
  customElements.define('dile-lucide-icon-list-minus', DileIconlibListMinus);
}
