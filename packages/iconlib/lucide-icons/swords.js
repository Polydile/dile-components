...
export class DileIconlibSwords extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-swords')) {
  customElements.define('dile-lucide-icon-swords', DileIconlibSwords);
}
