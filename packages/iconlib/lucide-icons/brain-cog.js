...
export class DileIconlibBrainCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-brain-cog')) {
  customElements.define('dile-lucide-icon-brain-cog', DileIconlibBrainCog);
}
