...
export class DileIconlibReceiptText extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-receipt-text')) {
  customElements.define('dile-lucide-icon-receipt-text', DileIconlibReceiptText);
}
