...
export class DileIconlibBanana extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-banana')) {
  customElements.define('dile-lucide-icon-banana', DileIconlibBanana);
}
