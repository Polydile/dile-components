...
export class DileIconlibBadgeMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-badge-minus')) {
  customElements.define('dile-lucide-icon-badge-minus', DileIconlibBadgeMinus);
}
