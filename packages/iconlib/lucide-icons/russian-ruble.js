...
export class DileIconlibRussianRuble extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-russian-ruble')) {
  customElements.define('dile-lucide-icon-russian-ruble', DileIconlibRussianRuble);
}
