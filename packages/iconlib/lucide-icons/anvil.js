...
export class DileIconlibAnvil extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-anvil')) {
  customElements.define('dile-lucide-icon-anvil', DileIconlibAnvil);
}
