...
export class DileIconlibSquareStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-square-star')) {
  customElements.define('dile-lucide-icon-square-star', DileIconlibSquareStar);
}
