...
export class DileIconlibLeafyGreen extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-leafy-green')) {
  customElements.define('dile-lucide-icon-leafy-green', DileIconlibLeafyGreen);
}
