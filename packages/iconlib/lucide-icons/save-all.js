...
export class DileIconlibSaveAll extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-save-all')) {
  customElements.define('dile-lucide-icon-save-all', DileIconlibSaveAll);
}
