...
export class DileIconlibTagX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-tag-x')) {
  customElements.define('dile-lucide-icon-tag-x', DileIconlibTagX);
}
