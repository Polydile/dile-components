...
export class DileIconlibCakeSlice extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-cake-slice')) {
  customElements.define('dile-lucide-icon-cake-slice', DileIconlibCakeSlice);
}
