...
export class DileIconlibBusFront extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-bus-front')) {
  customElements.define('dile-lucide-icon-bus-front', DileIconlibBusFront);
}
