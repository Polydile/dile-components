...
export class DileIconlibGrid2x2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-grid-2x2')) {
  customElements.define('dile-lucide-icon-grid-2x2', DileIconlibGrid2x2);
}
