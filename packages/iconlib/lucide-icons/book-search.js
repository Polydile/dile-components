...
export class DileIconlibBookSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-book-search')) {
  customElements.define('dile-lucide-icon-book-search', DileIconlibBookSearch);
}
