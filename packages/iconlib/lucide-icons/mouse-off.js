...
export class DileIconlibMouseOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-mouse-off')) {
  customElements.define('dile-lucide-icon-mouse-off', DileIconlibMouseOff);
}
