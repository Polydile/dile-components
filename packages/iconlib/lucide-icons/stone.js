...
export class DileIconlibStone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-stone')) {
  customElements.define('dile-lucide-icon-stone', DileIconlibStone);
}
