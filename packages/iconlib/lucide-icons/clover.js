...
export class DileIconlibClover extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-clover')) {
  customElements.define('dile-lucide-icon-clover', DileIconlibClover);
}
