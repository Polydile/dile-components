...
export class DileIconlibFileType extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-type')) {
  customElements.define('dile-lucide-icon-file-type', DileIconlibFileType);
}
