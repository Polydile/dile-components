...
export class DileIconlibBellPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-bell-plus')) {
  customElements.define('dile-lucide-icon-bell-plus', DileIconlibBellPlus);
}
