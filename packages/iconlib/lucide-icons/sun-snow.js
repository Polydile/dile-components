...
export class DileIconlibSunSnow extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-sun-snow')) {
  customElements.define('dile-lucide-icon-sun-snow', DileIconlibSunSnow);
}
