...
export class DileIconlibCodesandbox extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-codesandbox')) {
  customElements.define('dile-lucide-icon-codesandbox', DileIconlibCodesandbox);
}
