...
export class DileIconlibBookImage extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-book-image')) {
  customElements.define('dile-lucide-icon-book-image', DileIconlibBookImage);
}
