...
export class DileIconlibArrowBigUpDash extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-arrow-big-up-dash')) {
  customElements.define('dile-lucide-icon-arrow-big-up-dash', DileIconlibArrowBigUpDash);
}
