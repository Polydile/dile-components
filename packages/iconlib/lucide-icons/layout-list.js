...
export class DileIconlibLayoutList extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-layout-list')) {
  customElements.define('dile-lucide-icon-layout-list', DileIconlibLayoutList);
}
