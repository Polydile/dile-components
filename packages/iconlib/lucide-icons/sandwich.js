...
export class DileIconlibSandwich extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-sandwich')) {
  customElements.define('dile-lucide-icon-sandwich', DileIconlibSandwich);
}
