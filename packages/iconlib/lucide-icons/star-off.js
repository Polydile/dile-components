...
export class DileIconlibStarOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-star-off')) {
  customElements.define('dile-lucide-icon-star-off', DileIconlibStarOff);
}
