...
export class DileIconlibBanknoteArrowUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-banknote-arrow-up')) {
  customElements.define('dile-lucide-icon-banknote-arrow-up', DileIconlibBanknoteArrowUp);
}
