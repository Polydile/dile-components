...
export class DileIconlibSpool extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-spool')) {
  customElements.define('dile-lucide-icon-spool', DileIconlibSpool);
}
