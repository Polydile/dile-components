...
export class DileIconlibSunMedium extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-sun-medium')) {
  customElements.define('dile-lucide-icon-sun-medium', DileIconlibSunMedium);
}
