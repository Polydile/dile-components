...
export class DileIconlibCalendarCheck2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-calendar-check-2')) {
  customElements.define('dile-lucide-icon-calendar-check-2', DileIconlibCalendarCheck2);
}
