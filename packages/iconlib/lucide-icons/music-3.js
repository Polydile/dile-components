...
export class DileIconlibMusic3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-music-3')) {
  customElements.define('dile-lucide-icon-music-3', DileIconlibMusic3);
}
