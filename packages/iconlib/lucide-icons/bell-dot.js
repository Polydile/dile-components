...
export class DileIconlibBellDot extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-bell-dot')) {
  customElements.define('dile-lucide-icon-bell-dot', DileIconlibBellDot);
}
