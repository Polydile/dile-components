...
export class DileIconlibFileKey extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-lucide-icon-file-key')) {
  customElements.define('dile-lucide-icon-file-key', DileIconlibFileKey);
}
