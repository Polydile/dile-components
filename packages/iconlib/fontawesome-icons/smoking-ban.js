...
export class DileIconlibSmokingBan extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-smoking-ban')) {
  customElements.define('dile-fontawesome-icon-smoking-ban', DileIconlibSmokingBan);
}
