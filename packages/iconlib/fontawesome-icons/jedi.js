...
export class DileIconlibJedi extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-jedi')) {
  customElements.define('dile-fontawesome-icon-jedi', DileIconlibJedi);
}
