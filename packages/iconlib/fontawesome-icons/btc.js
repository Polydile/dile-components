...
export class DileIconlibBtc extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-btc')) {
  customElements.define('dile-fontawesome-icon-btc', DileIconlibBtc);
}
