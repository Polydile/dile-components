...
export class DileIconlibLariSign extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-lari-sign')) {
  customElements.define('dile-fontawesome-icon-lari-sign', DileIconlibLariSign);
}
