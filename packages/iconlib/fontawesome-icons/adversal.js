...
export class DileIconlibAdversal extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-adversal')) {
  customElements.define('dile-fontawesome-icon-adversal', DileIconlibAdversal);
}
