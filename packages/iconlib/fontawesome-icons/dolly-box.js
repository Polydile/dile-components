...
export class DileIconlibDollyBox extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-dolly-box')) {
  customElements.define('dile-fontawesome-icon-dolly-box', DileIconlibDollyBox);
}
