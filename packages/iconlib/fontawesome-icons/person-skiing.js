...
export class DileIconlibPersonSkiing extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-person-skiing')) {
  customElements.define('dile-fontawesome-icon-person-skiing', DileIconlibPersonSkiing);
}
