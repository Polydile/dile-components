...
export class DileIconlibGooglePlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-google-plus')) {
  customElements.define('dile-fontawesome-icon-google-plus', DileIconlibGooglePlus);
}
