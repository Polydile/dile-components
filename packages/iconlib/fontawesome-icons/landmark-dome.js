...
export class DileIconlibLandmarkDome extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-landmark-dome')) {
  customElements.define('dile-fontawesome-icon-landmark-dome', DileIconlibLandmarkDome);
}
