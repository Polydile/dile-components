...
export class DileIconlibHomeUser extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-home-user')) {
  customElements.define('dile-fontawesome-icon-home-user', DileIconlibHomeUser);
}
