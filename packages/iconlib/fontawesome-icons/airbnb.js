...
export class DileIconlibAirbnb extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-airbnb')) {
  customElements.define('dile-fontawesome-icon-airbnb', DileIconlibAirbnb);
}
