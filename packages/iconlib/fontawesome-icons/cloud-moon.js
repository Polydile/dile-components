...
export class DileIconlibCloudMoon extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-cloud-moon')) {
  customElements.define('dile-fontawesome-icon-cloud-moon', DileIconlibCloudMoon);
}
