...
export class DileIconlibDiceD20 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-dice-d20')) {
  customElements.define('dile-fontawesome-icon-dice-d20', DileIconlibDiceD20);
}
