...
if (!customElements.get('dile-fontawesome-icon-grin-tongue-squint')) {
  customElements.define('dile-fontawesome-icon-grin-tongue-squint', DileIconlibGrinTongueSquint);
}
