...
export class DileIconlibRssSquare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-rss-square')) {
  customElements.define('dile-fontawesome-icon-rss-square', DileIconlibRssSquare);
}
