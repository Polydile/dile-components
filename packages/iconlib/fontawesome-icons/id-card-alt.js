...
export class DileIconlibIdCardAlt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-id-card-alt')) {
  customElements.define('dile-fontawesome-icon-id-card-alt', DileIconlibIdCardAlt);
}
