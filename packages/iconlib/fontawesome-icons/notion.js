...
export class DileIconlibNotion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-notion')) {
  customElements.define('dile-fontawesome-icon-notion', DileIconlibNotion);
}
