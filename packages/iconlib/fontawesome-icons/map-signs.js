...
export class DileIconlibMapSigns extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-map-signs')) {
  customElements.define('dile-fontawesome-icon-map-signs', DileIconlibMapSigns);
}
