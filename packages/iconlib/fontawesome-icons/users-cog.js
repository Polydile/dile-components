...
export class DileIconlibUsersCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-users-cog')) {
  customElements.define('dile-fontawesome-icon-users-cog', DileIconlibUsersCog);
}
