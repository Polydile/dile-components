...
export class DileIconlibVenusDouble extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-venus-double')) {
  customElements.define('dile-fontawesome-icon-venus-double', DileIconlibVenusDouble);
}
