...
export class DileIconlibTruckField extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-truck-field')) {
  customElements.define('dile-fontawesome-icon-truck-field', DileIconlibTruckField);
}
