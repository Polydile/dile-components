...
export class DileIconlibGithubSquare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-github-square')) {
  customElements.define('dile-fontawesome-icon-github-square', DileIconlibGithubSquare);
}
