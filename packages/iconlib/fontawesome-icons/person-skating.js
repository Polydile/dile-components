...
export class DileIconlibPersonSkating extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-person-skating')) {
  customElements.define('dile-fontawesome-icon-person-skating', DileIconlibPersonSkating);
}
