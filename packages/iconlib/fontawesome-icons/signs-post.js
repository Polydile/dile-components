...
export class DileIconlibSignsPost extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-signs-post')) {
  customElements.define('dile-fontawesome-icon-signs-post', DileIconlibSignsPost);
}
