...
export class DileIconlibObjectUngroup extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-object-ungroup')) {
  customElements.define('dile-fontawesome-icon-object-ungroup', DileIconlibObjectUngroup);
}
