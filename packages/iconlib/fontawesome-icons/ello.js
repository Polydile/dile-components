...
export class DileIconlibEllo extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-ello')) {
  customElements.define('dile-fontawesome-icon-ello', DileIconlibEllo);
}
