...
export class DileIconlibGifts extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-gifts')) {
  customElements.define('dile-fontawesome-icon-gifts', DileIconlibGifts);
}
