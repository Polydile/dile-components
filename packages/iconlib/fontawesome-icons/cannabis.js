...
export class DileIconlibCannabis extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-cannabis')) {
  customElements.define('dile-fontawesome-icon-cannabis', DileIconlibCannabis);
}
