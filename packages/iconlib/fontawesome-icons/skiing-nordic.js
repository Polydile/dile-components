...
export class DileIconlibSkiingNordic extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-skiing-nordic')) {
  customElements.define('dile-fontawesome-icon-skiing-nordic', DileIconlibSkiingNordic);
}
