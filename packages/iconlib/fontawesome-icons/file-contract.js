...
export class DileIconlibFileContract extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-file-contract')) {
  customElements.define('dile-fontawesome-icon-file-contract', DileIconlibFileContract);
}
