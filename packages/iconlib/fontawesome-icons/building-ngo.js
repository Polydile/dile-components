...
export class DileIconlibBuildingNgo extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-building-ngo')) {
  customElements.define('dile-fontawesome-icon-building-ngo', DileIconlibBuildingNgo);
}
