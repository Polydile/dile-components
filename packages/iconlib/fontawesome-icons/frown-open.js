...
export class DileIconlibFrownOpen extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-frown-open')) {
  customElements.define('dile-fontawesome-icon-frown-open', DileIconlibFrownOpen);
}
