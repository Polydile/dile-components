...
export class DileIconlibPix extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-pix')) {
  customElements.define('dile-fontawesome-icon-pix', DileIconlibPix);
}
