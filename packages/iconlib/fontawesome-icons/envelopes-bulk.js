...
export class DileIconlibEnvelopesBulk extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-envelopes-bulk')) {
  customElements.define('dile-fontawesome-icon-envelopes-bulk', DileIconlibEnvelopesBulk);
}
