...
export class DileIconlibHandPaper extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-regular-hand-paper')) {
  customElements.define('dile-fontawesome-icon-regular-hand-paper', DileIconlibHandPaper);
}
