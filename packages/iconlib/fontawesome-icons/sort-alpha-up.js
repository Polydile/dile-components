...
export class DileIconlibSortAlphaUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-sort-alpha-up')) {
  customElements.define('dile-fontawesome-icon-sort-alpha-up', DileIconlibSortAlphaUp);
}
