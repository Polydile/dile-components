...
export class DileIconlibSquareBehance extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-square-behance')) {
  customElements.define('dile-fontawesome-icon-square-behance', DileIconlibSquareBehance);
}
