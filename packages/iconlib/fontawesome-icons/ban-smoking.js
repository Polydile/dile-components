...
export class DileIconlibBanSmoking extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-ban-smoking')) {
  customElements.define('dile-fontawesome-icon-ban-smoking', DileIconlibBanSmoking);
}
