...
export class DileIconlibCogs extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-cogs')) {
  customElements.define('dile-fontawesome-icon-cogs', DileIconlibCogs);
}
