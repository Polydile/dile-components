...
export class DileIconlibRadiationAlt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-radiation-alt')) {
  customElements.define('dile-fontawesome-icon-radiation-alt', DileIconlibRadiationAlt);
}
