...
export class DileIconlibHips extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-hips')) {
  customElements.define('dile-fontawesome-icon-hips', DileIconlibHips);
}
