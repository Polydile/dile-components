...
export class DileIconlib500px extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-500px')) {
  customElements.define('dile-fontawesome-icon-500px', DileIconlib500px);
}
