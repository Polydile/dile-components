...
export class DileIconlibHandBackFist extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-regular-hand-back-fist')) {
  customElements.define('dile-fontawesome-icon-regular-hand-back-fist', DileIconlibHandBackFist);
}
