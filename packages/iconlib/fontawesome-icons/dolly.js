...
export class DileIconlibDolly extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-dolly')) {
  customElements.define('dile-fontawesome-icon-dolly', DileIconlibDolly);
}
