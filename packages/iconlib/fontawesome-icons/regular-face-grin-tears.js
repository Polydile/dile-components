...
if (!customElements.get('dile-fontawesome-icon-regular-face-grin-tears')) {
  customElements.define('dile-fontawesome-icon-regular-face-grin-tears', DileIconlibFaceGrinTears);
}
