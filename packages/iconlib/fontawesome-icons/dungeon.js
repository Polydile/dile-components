...
export class DileIconlibDungeon extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-dungeon')) {
  customElements.define('dile-fontawesome-icon-dungeon', DileIconlibDungeon);
}
