...
if (!customElements.get('dile-fontawesome-icon-face-grin-squint-tears')) {
  customElements.define('dile-fontawesome-icon-face-grin-squint-tears', DileIconlibFaceGrinSquintTears);
}
