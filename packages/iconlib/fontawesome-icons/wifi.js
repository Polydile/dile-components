...
export class DileIconlibWifi extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-wifi')) {
  customElements.define('dile-fontawesome-icon-wifi', DileIconlibWifi);
}
