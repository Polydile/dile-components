...
export class DileIconlibTrainTram extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-train-tram')) {
  customElements.define('dile-fontawesome-icon-train-tram', DileIconlibTrainTram);
}
