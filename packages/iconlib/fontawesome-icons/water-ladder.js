...
export class DileIconlibWaterLadder extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-water-ladder')) {
  customElements.define('dile-fontawesome-icon-water-ladder', DileIconlibWaterLadder);
}
