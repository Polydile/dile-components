...
export class DileIconlibFaceGrimace extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-regular-face-grimace')) {
  customElements.define('dile-fontawesome-icon-regular-face-grimace', DileIconlibFaceGrimace);
}
