...
export class DileIconlibChildren extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-children')) {
  customElements.define('dile-fontawesome-icon-children', DileIconlibChildren);
}
