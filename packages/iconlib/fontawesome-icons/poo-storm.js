...
export class DileIconlibPooStorm extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-poo-storm')) {
  customElements.define('dile-fontawesome-icon-poo-storm', DileIconlibPooStorm);
}
