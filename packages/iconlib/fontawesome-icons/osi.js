...
export class DileIconlibOsi extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-osi')) {
  customElements.define('dile-fontawesome-icon-osi', DileIconlibOsi);
}
