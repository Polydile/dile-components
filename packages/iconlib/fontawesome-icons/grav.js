...
export class DileIconlibGrav extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-grav')) {
  customElements.define('dile-fontawesome-icon-grav', DileIconlibGrav);
}
