...
export class DileIconlibArrowsToDot extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-arrows-to-dot')) {
  customElements.define('dile-fontawesome-icon-arrows-to-dot', DileIconlibArrowsToDot);
}
