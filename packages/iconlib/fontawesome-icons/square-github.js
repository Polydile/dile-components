...
export class DileIconlibSquareGithub extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-square-github')) {
  customElements.define('dile-fontawesome-icon-square-github', DileIconlibSquareGithub);
}
