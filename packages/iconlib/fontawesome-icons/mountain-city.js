...
export class DileIconlibMountainCity extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-mountain-city')) {
  customElements.define('dile-fontawesome-icon-mountain-city', DileIconlibMountainCity);
}
