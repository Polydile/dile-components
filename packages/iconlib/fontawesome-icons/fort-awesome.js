...
export class DileIconlibFortAwesome extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-fort-awesome')) {
  customElements.define('dile-fontawesome-icon-fort-awesome', DileIconlibFortAwesome);
}
