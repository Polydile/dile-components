...
export class DileIconlibUsersRays extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-users-rays')) {
  customElements.define('dile-fontawesome-icon-users-rays', DileIconlibUsersRays);
}
