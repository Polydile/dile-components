...
export class DileIconlibWifi3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-wifi-3')) {
  customElements.define('dile-fontawesome-icon-wifi-3', DileIconlibWifi3);
}
