...
export class DileIconlibVirusSlash extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-virus-slash')) {
  customElements.define('dile-fontawesome-icon-virus-slash', DileIconlibVirusSlash);
}
