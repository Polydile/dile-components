...
export class DileIconlibRoadLock extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-road-lock')) {
  customElements.define('dile-fontawesome-icon-road-lock', DileIconlibRoadLock);
}
