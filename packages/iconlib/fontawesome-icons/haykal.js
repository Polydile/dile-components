...
export class DileIconlibHaykal extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-haykal')) {
  customElements.define('dile-fontawesome-icon-haykal', DileIconlibHaykal);
}
