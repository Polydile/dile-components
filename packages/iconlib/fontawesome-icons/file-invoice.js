...
export class DileIconlibFileInvoice extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-file-invoice')) {
  customElements.define('dile-fontawesome-icon-file-invoice', DileIconlibFileInvoice);
}
