...
export class DileIconlibCircleUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-regular-circle-up')) {
  customElements.define('dile-fontawesome-icon-regular-circle-up', DileIconlibCircleUp);
}
