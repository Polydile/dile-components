...
export class DileIconlibGit extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-git')) {
  customElements.define('dile-fontawesome-icon-git', DileIconlibGit);
}
