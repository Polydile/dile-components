...
export class DileIconlibDribbble extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-dribbble')) {
  customElements.define('dile-fontawesome-icon-dribbble', DileIconlibDribbble);
}
