...
export class DileIconlibSquareRss extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-square-rss')) {
  customElements.define('dile-fontawesome-icon-square-rss', DileIconlibSquareRss);
}
