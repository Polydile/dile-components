...
export class DileIconlibOm extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-om')) {
  customElements.define('dile-fontawesome-icon-om', DileIconlibOm);
}
