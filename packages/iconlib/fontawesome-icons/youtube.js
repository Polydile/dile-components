...
export class DileIconlibYoutube extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-youtube')) {
  customElements.define('dile-fontawesome-icon-youtube', DileIconlibYoutube);
}
