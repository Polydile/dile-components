...
export class DileIconlibFigma extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-figma')) {
  customElements.define('dile-fontawesome-icon-figma', DileIconlibFigma);
}
