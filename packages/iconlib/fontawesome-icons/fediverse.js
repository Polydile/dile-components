...
export class DileIconlibFediverse extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-fediverse')) {
  customElements.define('dile-fontawesome-icon-fediverse', DileIconlibFediverse);
}
