...
export class DileIconlibSpa extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-spa')) {
  customElements.define('dile-fontawesome-icon-spa', DileIconlibSpa);
}
