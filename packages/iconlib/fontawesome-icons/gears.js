...
export class DileIconlibGears extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-gears')) {
  customElements.define('dile-fontawesome-icon-gears', DileIconlibGears);
}
