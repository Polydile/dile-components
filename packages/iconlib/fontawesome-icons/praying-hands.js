...
export class DileIconlibPrayingHands extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-praying-hands')) {
  customElements.define('dile-fontawesome-icon-praying-hands', DileIconlibPrayingHands);
}
