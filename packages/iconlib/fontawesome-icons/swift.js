...
export class DileIconlibSwift extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-swift')) {
  customElements.define('dile-fontawesome-icon-swift', DileIconlibSwift);
}
