...
export class DileIconlibBacterium extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-bacterium')) {
  customElements.define('dile-fontawesome-icon-bacterium', DileIconlibBacterium);
}
