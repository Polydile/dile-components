...
export class DileIconlibDrupal extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-drupal')) {
  customElements.define('dile-fontawesome-icon-drupal', DileIconlibDrupal);
}
