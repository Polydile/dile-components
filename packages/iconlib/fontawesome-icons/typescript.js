...
export class DileIconlibTypescript extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-typescript')) {
  customElements.define('dile-fontawesome-icon-typescript', DileIconlibTypescript);
}
