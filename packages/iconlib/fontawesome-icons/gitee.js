...
export class DileIconlibGitee extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-gitee')) {
  customElements.define('dile-fontawesome-icon-gitee', DileIconlibGitee);
}
