...
export class DileIconlibArrowUpAZ extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-arrow-up-a-z')) {
  customElements.define('dile-fontawesome-icon-arrow-up-a-z', DileIconlibArrowUpAZ);
}
