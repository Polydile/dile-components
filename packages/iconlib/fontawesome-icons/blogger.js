...
export class DileIconlibBlogger extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-blogger')) {
  customElements.define('dile-fontawesome-icon-blogger', DileIconlibBlogger);
}
