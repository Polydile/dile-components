...
export class DileIconlibGrimace extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-grimace')) {
  customElements.define('dile-fontawesome-icon-grimace', DileIconlibGrimace);
}
