...
export class DileIconlibHouseSignal extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-house-signal')) {
  customElements.define('dile-fontawesome-icon-house-signal', DileIconlibHouseSignal);
}
