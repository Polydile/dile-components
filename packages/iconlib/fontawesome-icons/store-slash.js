...
export class DileIconlibStoreSlash extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-store-slash')) {
  customElements.define('dile-fontawesome-icon-store-slash', DileIconlibStoreSlash);
}
