...
export class DileIconlibSquareFigma extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-square-figma')) {
  customElements.define('dile-fontawesome-icon-square-figma', DileIconlibSquareFigma);
}
