...
export class DileIconlibTowerCell extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-tower-cell')) {
  customElements.define('dile-fontawesome-icon-tower-cell', DileIconlibTowerCell);
}
