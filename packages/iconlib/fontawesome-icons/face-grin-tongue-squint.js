...
if (!customElements.get('dile-fontawesome-icon-face-grin-tongue-squint')) {
  customElements.define('dile-fontawesome-icon-face-grin-tongue-squint', DileIconlibFaceGrinTongueSquint);
}
