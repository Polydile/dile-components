...
export class DileIconlibTablets extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-tablets')) {
  customElements.define('dile-fontawesome-icon-tablets', DileIconlibTablets);
}
