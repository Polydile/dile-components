...
export class DileIconlibEarthOceania extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-earth-oceania')) {
  customElements.define('dile-fontawesome-icon-earth-oceania', DileIconlibEarthOceania);
}
