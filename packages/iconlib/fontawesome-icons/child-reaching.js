...
export class DileIconlibChildReaching extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-child-reaching')) {
  customElements.define('dile-fontawesome-icon-child-reaching', DileIconlibChildReaching);
}
