...
export class DileIconlibBehanceSquare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-behance-square')) {
  customElements.define('dile-fontawesome-icon-behance-square', DileIconlibBehanceSquare);
}
