...
export class DileIconlibXmarksLines extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-xmarks-lines')) {
  customElements.define('dile-fontawesome-icon-xmarks-lines', DileIconlibXmarksLines);
}
