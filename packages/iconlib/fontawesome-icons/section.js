...
export class DileIconlibSection extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-section')) {
  customElements.define('dile-fontawesome-icon-section', DileIconlibSection);
}
