...
export class DileIconlibTimes extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-times')) {
  customElements.define('dile-fontawesome-icon-times', DileIconlibTimes);
}
