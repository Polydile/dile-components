...
export class DileIconlibCcApplePay extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-cc-apple-pay')) {
  customElements.define('dile-fontawesome-icon-cc-apple-pay', DileIconlibCcApplePay);
}
