...
export class DileIconlibCopyright extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-regular-copyright')) {
  customElements.define('dile-fontawesome-icon-regular-copyright', DileIconlibCopyright);
}
