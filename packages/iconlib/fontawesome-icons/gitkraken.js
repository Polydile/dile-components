...
export class DileIconlibGitkraken extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-gitkraken')) {
  customElements.define('dile-fontawesome-icon-gitkraken', DileIconlibGitkraken);
}
