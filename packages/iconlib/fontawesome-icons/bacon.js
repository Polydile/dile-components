...
export class DileIconlibBacon extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-bacon')) {
  customElements.define('dile-fontawesome-icon-bacon', DileIconlibBacon);
}
