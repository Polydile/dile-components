...
export class DileIconlibSnowman extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-snowman')) {
  customElements.define('dile-fontawesome-icon-snowman', DileIconlibSnowman);
}
