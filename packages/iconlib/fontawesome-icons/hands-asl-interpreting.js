...
export class DileIconlibHandsAslInterpreting extends DileBaseIcon {
  getSvgIcon() {
...
customElements.define('dile-fontawesome-icon-hands-asl-interpreting', DileIconlibHandsAslInterpreting);
