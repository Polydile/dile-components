...
export class DileIconlibBookQuran extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-book-quran')) {
  customElements.define('dile-fontawesome-icon-book-quran', DileIconlibBookQuran);
}
