...
export class DileIconlibArchive extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-archive')) {
  customElements.define('dile-fontawesome-icon-archive', DileIconlibArchive);
}
