...
export class DileIconlibEtsy extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-etsy')) {
  customElements.define('dile-fontawesome-icon-etsy', DileIconlibEtsy);
}
