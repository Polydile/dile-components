...
export class DileIconlibHouseUser extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-house-user')) {
  customElements.define('dile-fontawesome-icon-house-user', DileIconlibHouseUser);
}
