...
export class DileIconlibBugSlash extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-bug-slash')) {
  customElements.define('dile-fontawesome-icon-bug-slash', DileIconlibBugSlash);
}
