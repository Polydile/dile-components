...
export class DileIconlibExplosion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-explosion')) {
  customElements.define('dile-fontawesome-icon-explosion', DileIconlibExplosion);
}
