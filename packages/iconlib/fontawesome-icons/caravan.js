...
export class DileIconlibCaravan extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-caravan')) {
  customElements.define('dile-fontawesome-icon-caravan', DileIconlibCaravan);
}
