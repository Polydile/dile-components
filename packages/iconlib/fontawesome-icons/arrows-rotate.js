...
export class DileIconlibArrowsRotate extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-arrows-rotate')) {
  customElements.define('dile-fontawesome-icon-arrows-rotate', DileIconlibArrowsRotate);
}
