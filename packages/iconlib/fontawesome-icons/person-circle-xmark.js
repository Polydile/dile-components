...
export class DileIconlibPersonCircleXmark extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-person-circle-xmark')) {
  customElements.define('dile-fontawesome-icon-person-circle-xmark', DileIconlibPersonCircleXmark);
}
