...
export class DileIconlibVirusCovid extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-virus-covid')) {
  customElements.define('dile-fontawesome-icon-virus-covid', DileIconlibVirusCovid);
}
