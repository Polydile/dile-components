...
export class DileIconlibIcons extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-icons')) {
  customElements.define('dile-fontawesome-icon-icons', DileIconlibIcons);
}
