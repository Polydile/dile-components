...
export class DileIconlibSocks extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-socks')) {
  customElements.define('dile-fontawesome-icon-socks', DileIconlibSocks);
}
