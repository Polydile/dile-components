...
export class DileIconlibSwimmingPool extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-swimming-pool')) {
  customElements.define('dile-fontawesome-icon-swimming-pool', DileIconlibSwimmingPool);
}
