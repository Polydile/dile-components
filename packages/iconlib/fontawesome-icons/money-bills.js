...
export class DileIconlibMoneyBills extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-money-bills')) {
  customElements.define('dile-fontawesome-icon-money-bills', DileIconlibMoneyBills);
}
