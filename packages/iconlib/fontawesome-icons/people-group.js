...
export class DileIconlibPeopleGroup extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-people-group')) {
  customElements.define('dile-fontawesome-icon-people-group', DileIconlibPeopleGroup);
}
