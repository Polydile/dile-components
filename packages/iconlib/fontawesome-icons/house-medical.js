...
export class DileIconlibHouseMedical extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-house-medical')) {
  customElements.define('dile-fontawesome-icon-house-medical', DileIconlibHouseMedical);
}
