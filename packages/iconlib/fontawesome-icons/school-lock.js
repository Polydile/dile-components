...
export class DileIconlibSchoolLock extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-school-lock')) {
  customElements.define('dile-fontawesome-icon-school-lock', DileIconlibSchoolLock);
}
