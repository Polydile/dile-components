...
export class DileIconlibPage4 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-page4')) {
  customElements.define('dile-fontawesome-icon-page4', DileIconlibPage4);
}
