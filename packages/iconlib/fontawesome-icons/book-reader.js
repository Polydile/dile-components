...
export class DileIconlibBookReader extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-book-reader')) {
  customElements.define('dile-fontawesome-icon-book-reader', DileIconlibBookReader);
}
