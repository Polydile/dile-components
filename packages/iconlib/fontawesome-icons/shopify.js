...
export class DileIconlibShopify extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-shopify')) {
  customElements.define('dile-fontawesome-icon-shopify', DileIconlibShopify);
}
