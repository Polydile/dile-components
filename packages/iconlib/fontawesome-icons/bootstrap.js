...
export class DileIconlibBootstrap extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-bootstrap')) {
  customElements.define('dile-fontawesome-icon-bootstrap', DileIconlibBootstrap);
}
