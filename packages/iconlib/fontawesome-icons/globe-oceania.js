...
export class DileIconlibGlobeOceania extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-globe-oceania')) {
  customElements.define('dile-fontawesome-icon-globe-oceania', DileIconlibGlobeOceania);
}
