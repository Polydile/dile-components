...
export class DileIconlibHeartPulse extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-heart-pulse')) {
  customElements.define('dile-fontawesome-icon-heart-pulse', DileIconlibHeartPulse);
}
