...
export class DileIconlibEarthAfrica extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-earth-africa')) {
  customElements.define('dile-fontawesome-icon-earth-africa', DileIconlibEarthAfrica);
}
