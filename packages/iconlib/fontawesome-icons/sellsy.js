...
export class DileIconlibSellsy extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-sellsy')) {
  customElements.define('dile-fontawesome-icon-sellsy', DileIconlibSellsy);
}
