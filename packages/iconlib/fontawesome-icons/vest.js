...
export class DileIconlibVest extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-vest')) {
  customElements.define('dile-fontawesome-icon-vest', DileIconlibVest);
}
