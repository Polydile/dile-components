...
export class DileIconlibJsfiddle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-jsfiddle')) {
  customElements.define('dile-fontawesome-icon-jsfiddle', DileIconlibJsfiddle);
}
