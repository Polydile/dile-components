...
export class DileIconlibW3c extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-w3c')) {
  customElements.define('dile-fontawesome-icon-w3c', DileIconlibW3c);
}
