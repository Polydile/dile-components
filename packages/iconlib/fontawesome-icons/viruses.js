...
export class DileIconlibViruses extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-viruses')) {
  customElements.define('dile-fontawesome-icon-viruses', DileIconlibViruses);
}
