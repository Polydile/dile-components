...
export class DileIconlibHand extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-regular-hand')) {
  customElements.define('dile-fontawesome-icon-regular-hand', DileIconlibHand);
}
