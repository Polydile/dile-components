...
export class DileIconlibTrailer extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-trailer')) {
  customElements.define('dile-fontawesome-icon-trailer', DileIconlibTrailer);
}
