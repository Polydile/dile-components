...
export class DileIconlibStreetView extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-street-view')) {
  customElements.define('dile-fontawesome-icon-street-view', DileIconlibStreetView);
}
