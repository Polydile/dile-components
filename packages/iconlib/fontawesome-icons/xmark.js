...
export class DileIconlibXmark extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-xmark')) {
  customElements.define('dile-fontawesome-icon-xmark', DileIconlibXmark);
}
