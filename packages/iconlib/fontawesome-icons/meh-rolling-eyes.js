...
export class DileIconlibMehRollingEyes extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-meh-rolling-eyes')) {
  customElements.define('dile-fontawesome-icon-meh-rolling-eyes', DileIconlibMehRollingEyes);
}
