...
export class DileIconlibLandmarkAlt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-fontawesome-icon-landmark-alt')) {
  customElements.define('dile-fontawesome-icon-landmark-alt', DileIconlibLandmarkAlt);
}
