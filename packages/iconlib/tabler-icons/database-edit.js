...
export class DileIconlibDatabaseEdit extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-database-edit')) {
  customElements.define('dile-tabler-icon-database-edit', DileIconlibDatabaseEdit);
}
