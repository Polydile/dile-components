...
export class DileIconlibFlood extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flood')) {
  customElements.define('dile-tabler-icon-flood', DileIconlibFlood);
}
