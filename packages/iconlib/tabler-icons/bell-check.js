...
export class DileIconlibBellCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-check')) {
  customElements.define('dile-tabler-icon-bell-check', DileIconlibBellCheck);
}
