...
export class DileIconlibLockUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-up')) {
  customElements.define('dile-tabler-icon-lock-up', DileIconlibLockUp);
}
