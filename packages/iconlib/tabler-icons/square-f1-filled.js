...
export class DileIconlibSquareF1Filled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-f1-filled')) {
  customElements.define('dile-tabler-icon-square-f1-filled', DileIconlibSquareF1Filled);
}
