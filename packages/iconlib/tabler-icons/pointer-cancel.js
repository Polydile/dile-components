...
export class DileIconlibPointerCancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pointer-cancel')) {
  customElements.define('dile-tabler-icon-pointer-cancel', DileIconlibPointerCancel);
}
