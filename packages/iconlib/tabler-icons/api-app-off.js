...
export class DileIconlibApiAppOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-api-app-off')) {
  customElements.define('dile-tabler-icon-api-app-off', DileIconlibApiAppOff);
}
