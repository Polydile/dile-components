...
export class DileIconlibIdOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-id-off')) {
  customElements.define('dile-tabler-icon-id-off', DileIconlibIdOff);
}
