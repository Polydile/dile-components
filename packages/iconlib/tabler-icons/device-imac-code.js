...
export class DileIconlibDeviceImacCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-imac-code')) {
  customElements.define('dile-tabler-icon-device-imac-code', DileIconlibDeviceImacCode);
}
