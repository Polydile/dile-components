...
export class DileIconlibAbacus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-abacus')) {
  customElements.define('dile-tabler-icon-abacus', DileIconlibAbacus);
}
