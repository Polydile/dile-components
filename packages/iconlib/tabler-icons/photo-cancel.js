...
export class DileIconlibPhotoCancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-cancel')) {
  customElements.define('dile-tabler-icon-photo-cancel', DileIconlibPhotoCancel);
}
