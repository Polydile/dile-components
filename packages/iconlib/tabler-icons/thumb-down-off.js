...
export class DileIconlibThumbDownOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-thumb-down-off')) {
  customElements.define('dile-tabler-icon-thumb-down-off', DileIconlibThumbDownOff);
}
