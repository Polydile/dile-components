...
export class DileIconlibCameraDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-camera-down')) {
  customElements.define('dile-tabler-icon-camera-down', DileIconlibCameraDown);
}
