...
export class DileIconlibListDetails extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-list-details')) {
  customElements.define('dile-tabler-icon-list-details', DileIconlibListDetails);
}
