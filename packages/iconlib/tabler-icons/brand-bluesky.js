...
export class DileIconlibBrandBluesky extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-brand-bluesky')) {
  customElements.define('dile-tabler-icon-brand-bluesky', DileIconlibBrandBluesky);
}
