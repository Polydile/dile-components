...
export class DileIconlibSunLow extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sun-low')) {
  customElements.define('dile-tabler-icon-sun-low', DileIconlibSunLow);
}
