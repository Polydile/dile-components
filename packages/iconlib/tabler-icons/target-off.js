...
export class DileIconlibTargetOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-target-off')) {
  customElements.define('dile-tabler-icon-target-off', DileIconlibTargetOff);
}
