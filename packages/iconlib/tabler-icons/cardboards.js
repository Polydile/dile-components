...
export class DileIconlibCardboards extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cardboards')) {
  customElements.define('dile-tabler-icon-cardboards', DileIconlibCardboards);
}
