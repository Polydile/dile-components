...
export class DileIconlibMoodHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-heart')) {
  customElements.define('dile-tabler-icon-mood-heart', DileIconlibMoodHeart);
}
