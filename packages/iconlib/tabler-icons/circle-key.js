...
export class DileIconlibCircleKey extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-circle-key')) {
  customElements.define('dile-tabler-icon-circle-key', DileIconlibCircleKey);
}
