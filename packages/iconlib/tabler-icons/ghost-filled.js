...
export class DileIconlibGhostFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ghost-filled')) {
  customElements.define('dile-tabler-icon-ghost-filled', DileIconlibGhostFilled);
}
