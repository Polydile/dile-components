...
export class DileIconlibCarFan1 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-car-fan-1')) {
  customElements.define('dile-tabler-icon-car-fan-1', DileIconlibCarFan1);
}
