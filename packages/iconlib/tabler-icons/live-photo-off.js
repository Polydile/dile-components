...
export class DileIconlibLivePhotoOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-live-photo-off')) {
  customElements.define('dile-tabler-icon-live-photo-off', DileIconlibLivePhotoOff);
}
