...
export class DileIconlibSquareF9 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-f9')) {
  customElements.define('dile-tabler-icon-square-f9', DileIconlibSquareF9);
}
