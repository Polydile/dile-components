...
export class DileIconlibReplaceOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-replace-off')) {
  customElements.define('dile-tabler-icon-replace-off', DileIconlibReplaceOff);
}
