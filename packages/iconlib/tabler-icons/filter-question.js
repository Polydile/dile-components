...
export class DileIconlibFilterQuestion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-question')) {
  customElements.define('dile-tabler-icon-filter-question', DileIconlibFilterQuestion);
}
