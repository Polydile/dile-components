...
export class DileIconlibOlympics extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-olympics')) {
  customElements.define('dile-tabler-icon-olympics', DileIconlibOlympics);
}
