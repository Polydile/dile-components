...
export class DileIconlibLockX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-x')) {
  customElements.define('dile-tabler-icon-lock-x', DileIconlibLockX);
}
