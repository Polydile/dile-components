...
export class DileIconlibJson extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-json')) {
  customElements.define('dile-tabler-icon-json', DileIconlibJson);
}
