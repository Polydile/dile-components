...
export class DileIconlibAdOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ad-off')) {
  customElements.define('dile-tabler-icon-ad-off', DileIconlibAdOff);
}
