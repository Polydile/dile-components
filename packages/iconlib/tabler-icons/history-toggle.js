...
export class DileIconlibHistoryToggle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-history-toggle')) {
  customElements.define('dile-tabler-icon-history-toggle', DileIconlibHistoryToggle);
}
