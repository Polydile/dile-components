...
export class DileIconlibSchoolOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-school-off')) {
  customElements.define('dile-tabler-icon-school-off', DileIconlibSchoolOff);
}
