...
export class DileIconlibGrowth extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-growth')) {
  customElements.define('dile-tabler-icon-growth', DileIconlibGrowth);
}
