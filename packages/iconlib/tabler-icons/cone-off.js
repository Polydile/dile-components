...
export class DileIconlibConeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cone-off')) {
  customElements.define('dile-tabler-icon-cone-off', DileIconlibConeOff);
}
