...
export class DileIconlibAdjustmentsUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-adjustments-up')) {
  customElements.define('dile-tabler-icon-adjustments-up', DileIconlibAdjustmentsUp);
}
