...
export class DileIconlibCashHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cash-heart')) {
  customElements.define('dile-tabler-icon-cash-heart', DileIconlibCashHeart);
}
