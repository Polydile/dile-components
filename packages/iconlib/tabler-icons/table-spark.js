...
export class DileIconlibTableSpark extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-table-spark')) {
  customElements.define('dile-tabler-icon-table-spark', DileIconlibTableSpark);
}
