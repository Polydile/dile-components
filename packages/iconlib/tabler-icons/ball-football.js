...
export class DileIconlibBallFootball extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ball-football')) {
  customElements.define('dile-tabler-icon-ball-football', DileIconlibBallFootball);
}
