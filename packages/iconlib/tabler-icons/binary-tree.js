...
export class DileIconlibBinaryTree extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-binary-tree')) {
  customElements.define('dile-tabler-icon-binary-tree', DileIconlibBinaryTree);
}
