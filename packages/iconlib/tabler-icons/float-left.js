...
export class DileIconlibFloatLeft extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-float-left')) {
  customElements.define('dile-tabler-icon-float-left', DileIconlibFloatLeft);
}
