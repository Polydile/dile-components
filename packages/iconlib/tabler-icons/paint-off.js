...
export class DileIconlibPaintOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-paint-off')) {
  customElements.define('dile-tabler-icon-paint-off', DileIconlibPaintOff);
}
