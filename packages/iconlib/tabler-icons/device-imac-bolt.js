...
export class DileIconlibDeviceImacBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-imac-bolt')) {
  customElements.define('dile-tabler-icon-device-imac-bolt', DileIconlibDeviceImacBolt);
}
