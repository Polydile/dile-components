...
export class DileIconlibFilterDiscount extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-discount')) {
  customElements.define('dile-tabler-icon-filter-discount', DileIconlibFilterDiscount);
}
