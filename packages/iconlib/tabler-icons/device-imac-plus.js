...
export class DileIconlibDeviceImacPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-imac-plus')) {
  customElements.define('dile-tabler-icon-device-imac-plus', DileIconlibDeviceImacPlus);
}
