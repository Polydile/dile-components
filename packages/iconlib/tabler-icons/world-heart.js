...
export class DileIconlibWorldHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-heart')) {
  customElements.define('dile-tabler-icon-world-heart', DileIconlibWorldHeart);
}
