...
export class DileIconlibFolderSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-folder-search')) {
  customElements.define('dile-tabler-icon-folder-search', DileIconlibFolderSearch);
}
