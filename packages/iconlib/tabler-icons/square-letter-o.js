...
export class DileIconlibSquareLetterO extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-letter-o')) {
  customElements.define('dile-tabler-icon-square-letter-o', DileIconlibSquareLetterO);
}
