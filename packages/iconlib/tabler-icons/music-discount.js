...
export class DileIconlibMusicDiscount extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-music-discount')) {
  customElements.define('dile-tabler-icon-music-discount', DileIconlibMusicDiscount);
}
