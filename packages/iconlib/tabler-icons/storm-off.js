...
export class DileIconlibStormOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-storm-off')) {
  customElements.define('dile-tabler-icon-storm-off', DileIconlibStormOff);
}
