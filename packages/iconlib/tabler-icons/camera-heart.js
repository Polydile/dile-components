...
export class DileIconlibCameraHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-camera-heart')) {
  customElements.define('dile-tabler-icon-camera-heart', DileIconlibCameraHeart);
}
