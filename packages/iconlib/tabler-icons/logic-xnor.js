...
export class DileIconlibLogicXnor extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-logic-xnor')) {
  customElements.define('dile-tabler-icon-logic-xnor', DileIconlibLogicXnor);
}
