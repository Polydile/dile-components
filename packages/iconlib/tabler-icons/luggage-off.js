...
export class DileIconlibLuggageOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-luggage-off')) {
  customElements.define('dile-tabler-icon-luggage-off', DileIconlibLuggageOff);
}
