...
export class DileIconlibMusicPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-music-pin')) {
  customElements.define('dile-tabler-icon-music-pin', DileIconlibMusicPin);
}
