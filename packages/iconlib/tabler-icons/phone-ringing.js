...
export class DileIconlibPhoneRinging extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-phone-ringing')) {
  customElements.define('dile-tabler-icon-phone-ringing', DileIconlibPhoneRinging);
}
