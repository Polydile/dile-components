...
export class DileIconlibFeatherOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-feather-off')) {
  customElements.define('dile-tabler-icon-feather-off', DileIconlibFeatherOff);
}
