...
export class DileIconlibWorldCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-code')) {
  customElements.define('dile-tabler-icon-world-code', DileIconlibWorldCode);
}
