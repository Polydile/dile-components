...
export class DileIconlibBookmarksOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bookmarks-off')) {
  customElements.define('dile-tabler-icon-bookmarks-off', DileIconlibBookmarksOff);
}
