...
export class DileIconlibDatabaseOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-database-off')) {
  customElements.define('dile-tabler-icon-database-off', DileIconlibDatabaseOff);
}
