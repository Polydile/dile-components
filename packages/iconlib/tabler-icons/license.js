...
export class DileIconlibLicense extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-license')) {
  customElements.define('dile-tabler-icon-license', DileIconlibLicense);
}
