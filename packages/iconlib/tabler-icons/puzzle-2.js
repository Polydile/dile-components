...
export class DileIconlibPuzzle2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-puzzle-2')) {
  customElements.define('dile-tabler-icon-puzzle-2', DileIconlibPuzzle2);
}
