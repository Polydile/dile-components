...
export class DileIconlibBasketDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-basket-dollar')) {
  customElements.define('dile-tabler-icon-basket-dollar', DileIconlibBasketDollar);
}
