...
export class DileIconlibMapPinUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-pin-up')) {
  customElements.define('dile-tabler-icon-map-pin-up', DileIconlibMapPinUp);
}
