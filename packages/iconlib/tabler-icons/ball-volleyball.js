...
export class DileIconlibBallVolleyball extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ball-volleyball')) {
  customElements.define('dile-tabler-icon-ball-volleyball', DileIconlibBallVolleyball);
}
