...
export class DileIconlibSocial extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-social')) {
  customElements.define('dile-tabler-icon-social', DileIconlibSocial);
}
