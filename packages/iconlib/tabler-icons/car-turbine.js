...
export class DileIconlibCarTurbine extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-car-turbine')) {
  customElements.define('dile-tabler-icon-car-turbine', DileIconlibCarTurbine);
}
