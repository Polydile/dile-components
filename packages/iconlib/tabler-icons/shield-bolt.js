...
export class DileIconlibShieldBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shield-bolt')) {
  customElements.define('dile-tabler-icon-shield-bolt', DileIconlibShieldBolt);
}
