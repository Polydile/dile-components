...
export class DileIconlibScaleOutlineOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-scale-outline-off')) {
  customElements.define('dile-tabler-icon-scale-outline-off', DileIconlibScaleOutlineOff);
}
