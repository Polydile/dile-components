...
export class DileIconlibAlertHexagonOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-alert-hexagon-off')) {
  customElements.define('dile-tabler-icon-alert-hexagon-off', DileIconlibAlertHexagonOff);
}
