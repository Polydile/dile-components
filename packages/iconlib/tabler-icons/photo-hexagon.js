...
export class DileIconlibPhotoHexagon extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-hexagon')) {
  customElements.define('dile-tabler-icon-photo-hexagon', DileIconlibPhotoHexagon);
}
