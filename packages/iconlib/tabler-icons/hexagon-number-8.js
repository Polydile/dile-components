...
export class DileIconlibHexagonNumber8 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-number-8')) {
  customElements.define('dile-tabler-icon-hexagon-number-8', DileIconlibHexagonNumber8);
}
