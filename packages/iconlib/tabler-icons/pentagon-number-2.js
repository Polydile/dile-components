...
export class DileIconlibPentagonNumber2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pentagon-number-2')) {
  customElements.define('dile-tabler-icon-pentagon-number-2', DileIconlibPentagonNumber2);
}
