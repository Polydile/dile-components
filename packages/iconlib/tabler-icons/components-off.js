...
export class DileIconlibComponentsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-components-off')) {
  customElements.define('dile-tabler-icon-components-off', DileIconlibComponentsOff);
}
