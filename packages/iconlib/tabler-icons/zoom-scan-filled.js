...
export class DileIconlibZoomScanFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-zoom-scan-filled')) {
  customElements.define('dile-tabler-icon-zoom-scan-filled', DileIconlibZoomScanFilled);
}
