...
export class DileIconlibFocusAuto extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-focus-auto')) {
  customElements.define('dile-tabler-icon-focus-auto', DileIconlibFocusAuto);
}
