...
export class DileIconlibFlowerOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flower-off')) {
  customElements.define('dile-tabler-icon-flower-off', DileIconlibFlowerOff);
}
