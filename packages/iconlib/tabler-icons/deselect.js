...
export class DileIconlibDeselect extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-deselect')) {
  customElements.define('dile-tabler-icon-deselect', DileIconlibDeselect);
}
