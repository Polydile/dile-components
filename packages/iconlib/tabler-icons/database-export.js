...
export class DileIconlibDatabaseExport extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-database-export')) {
  customElements.define('dile-tabler-icon-database-export', DileIconlibDatabaseExport);
}
