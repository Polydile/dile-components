...
export class DileIconlibCircleNumber3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-circle-number-3')) {
  customElements.define('dile-tabler-icon-circle-number-3', DileIconlibCircleNumber3);
}
