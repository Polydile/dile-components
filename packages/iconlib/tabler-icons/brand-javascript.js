...
export class DileIconlibBrandJavascript extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-brand-javascript')) {
  customElements.define('dile-tabler-icon-brand-javascript', DileIconlibBrandJavascript);
}
