...
export class DileIconlibHexagonLetterR extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-r')) {
  customElements.define('dile-tabler-icon-hexagon-letter-r', DileIconlibHexagonLetterR);
}
