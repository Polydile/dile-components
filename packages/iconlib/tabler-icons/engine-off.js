...
export class DileIconlibEngineOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-engine-off')) {
  customElements.define('dile-tabler-icon-engine-off', DileIconlibEngineOff);
}
