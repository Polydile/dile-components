...
export class DileIconlibPlayCardJ extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-j')) {
  customElements.define('dile-tabler-icon-play-card-j', DileIconlibPlayCardJ);
}
