...
export class DileIconlibNumber64Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-64-small')) {
  customElements.define('dile-tabler-icon-number-64-small', DileIconlibNumber64Small);
}
