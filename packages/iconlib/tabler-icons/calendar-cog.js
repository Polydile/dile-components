...
export class DileIconlibCalendarCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-calendar-cog')) {
  customElements.define('dile-tabler-icon-calendar-cog', DileIconlibCalendarCog);
}
