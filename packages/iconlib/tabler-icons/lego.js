...
export class DileIconlibLego extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lego')) {
  customElements.define('dile-tabler-icon-lego', DileIconlibLego);
}
