...
export class DileIconlibGardenCart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-garden-cart')) {
  customElements.define('dile-tabler-icon-garden-cart', DileIconlibGardenCart);
}
