...
export class DileIconlibBoxMultiple7 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-box-multiple-7')) {
  customElements.define('dile-tabler-icon-box-multiple-7', DileIconlibBoxMultiple7);
}
