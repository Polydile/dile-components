...
export class DileIconlibLockCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-check')) {
  customElements.define('dile-tabler-icon-lock-check', DileIconlibLockCheck);
}
