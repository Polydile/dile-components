...
export class DileIconlibBadgesOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-badges-off')) {
  customElements.define('dile-tabler-icon-badges-off', DileIconlibBadgesOff);
}
