...
export class DileIconlibClock24 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-clock-24')) {
  customElements.define('dile-tabler-icon-clock-24', DileIconlibClock24);
}
