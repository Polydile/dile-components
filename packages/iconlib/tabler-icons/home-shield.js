...
export class DileIconlibHomeShield extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-shield')) {
  customElements.define('dile-tabler-icon-home-shield', DileIconlibHomeShield);
}
