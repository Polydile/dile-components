...
export class DileIconlibView360Off extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-view-360-off')) {
  customElements.define('dile-tabler-icon-view-360-off', DileIconlibView360Off);
}
