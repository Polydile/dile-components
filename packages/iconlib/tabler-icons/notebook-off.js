...
export class DileIconlibNotebookOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-notebook-off')) {
  customElements.define('dile-tabler-icon-notebook-off', DileIconlibNotebookOff);
}
