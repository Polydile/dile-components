...
export class DileIconlibMeterSquare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-meter-square')) {
  customElements.define('dile-tabler-icon-meter-square', DileIconlibMeterSquare);
}
