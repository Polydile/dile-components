...
export class DileIconlibAdjustmentsAlt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-adjustments-alt')) {
  customElements.define('dile-tabler-icon-adjustments-alt', DileIconlibAdjustmentsAlt);
}
