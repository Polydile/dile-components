...
export class DileIconlibBadge2k extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-badge-2k')) {
  customElements.define('dile-tabler-icon-badge-2k', DileIconlibBadge2k);
}
