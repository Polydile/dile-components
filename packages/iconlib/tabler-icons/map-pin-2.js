...
export class DileIconlibMapPin2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-pin-2')) {
  customElements.define('dile-tabler-icon-map-pin-2', DileIconlibMapPin2);
}
