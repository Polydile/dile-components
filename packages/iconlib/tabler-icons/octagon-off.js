...
export class DileIconlibOctagonOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-octagon-off')) {
  customElements.define('dile-tabler-icon-octagon-off', DileIconlibOctagonOff);
}
