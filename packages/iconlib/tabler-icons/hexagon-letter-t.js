...
export class DileIconlibHexagonLetterT extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-t')) {
  customElements.define('dile-tabler-icon-hexagon-letter-t', DileIconlibHexagonLetterT);
}
