...
export class DileIconlibRosetteAsterisk extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rosette-asterisk')) {
  customElements.define('dile-tabler-icon-rosette-asterisk', DileIconlibRosetteAsterisk);
}
