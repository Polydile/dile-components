...
export class DileIconlibPick extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pick')) {
  customElements.define('dile-tabler-icon-pick', DileIconlibPick);
}
