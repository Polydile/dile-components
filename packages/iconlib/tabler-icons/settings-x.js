...
export class DileIconlibSettingsX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-settings-x')) {
  customElements.define('dile-tabler-icon-settings-x', DileIconlibSettingsX);
}
