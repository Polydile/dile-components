...
export class DileIconlibPhotoCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-cog')) {
  customElements.define('dile-tabler-icon-photo-cog', DileIconlibPhotoCog);
}
