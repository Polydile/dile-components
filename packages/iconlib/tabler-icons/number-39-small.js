...
export class DileIconlibNumber39Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-39-small')) {
  customElements.define('dile-tabler-icon-number-39-small', DileIconlibNumber39Small);
}
