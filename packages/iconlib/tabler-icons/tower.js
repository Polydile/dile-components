...
export class DileIconlibTower extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-tower')) {
  customElements.define('dile-tabler-icon-tower', DileIconlibTower);
}
