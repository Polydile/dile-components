...
export class DileIconlibWritingOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-writing-off')) {
  customElements.define('dile-tabler-icon-writing-off', DileIconlibWritingOff);
}
