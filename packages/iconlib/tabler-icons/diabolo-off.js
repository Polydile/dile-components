...
export class DileIconlibDiaboloOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-diabolo-off')) {
  customElements.define('dile-tabler-icon-diabolo-off', DileIconlibDiaboloOff);
}
