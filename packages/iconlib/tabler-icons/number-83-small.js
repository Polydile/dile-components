...
export class DileIconlibNumber83Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-83-small')) {
  customElements.define('dile-tabler-icon-number-83-small', DileIconlibNumber83Small);
}
