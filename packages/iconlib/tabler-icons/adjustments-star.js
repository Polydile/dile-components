...
export class DileIconlibAdjustmentsStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-adjustments-star')) {
  customElements.define('dile-tabler-icon-adjustments-star', DileIconlibAdjustmentsStar);
}
