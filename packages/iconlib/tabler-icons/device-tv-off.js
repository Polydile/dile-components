...
export class DileIconlibDeviceTvOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-tv-off')) {
  customElements.define('dile-tabler-icon-device-tv-off', DileIconlibDeviceTvOff);
}
