...
export class DileIconlibLibraryMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-library-minus')) {
  customElements.define('dile-tabler-icon-library-minus', DileIconlibLibraryMinus);
}
