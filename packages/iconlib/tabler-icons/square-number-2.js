...
export class DileIconlibSquareNumber2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-number-2')) {
  customElements.define('dile-tabler-icon-square-number-2', DileIconlibSquareNumber2);
}
