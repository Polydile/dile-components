...
export class DileIconlibDice6Filled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-dice-6-filled')) {
  customElements.define('dile-tabler-icon-dice-6-filled', DileIconlibDice6Filled);
}
