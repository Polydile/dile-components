...
export class DileIconlibABOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-a-b-off')) {
  customElements.define('dile-tabler-icon-a-b-off', DileIconlibABOff);
}
