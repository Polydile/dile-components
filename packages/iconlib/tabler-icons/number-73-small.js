...
export class DileIconlibNumber73Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-73-small')) {
  customElements.define('dile-tabler-icon-number-73-small', DileIconlibNumber73Small);
}
