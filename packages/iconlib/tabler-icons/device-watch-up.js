...
export class DileIconlibDeviceWatchUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-watch-up')) {
  customElements.define('dile-tabler-icon-device-watch-up', DileIconlibDeviceWatchUp);
}
