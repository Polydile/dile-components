...
export class DileIconlibRewindBackward30 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rewind-backward-30')) {
  customElements.define('dile-tabler-icon-rewind-backward-30', DileIconlibRewindBackward30);
}
