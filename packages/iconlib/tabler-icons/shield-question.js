...
export class DileIconlibShieldQuestion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shield-question')) {
  customElements.define('dile-tabler-icon-shield-question', DileIconlibShieldQuestion);
}
