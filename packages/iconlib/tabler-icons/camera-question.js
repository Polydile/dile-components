...
export class DileIconlibCameraQuestion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-camera-question')) {
  customElements.define('dile-tabler-icon-camera-question', DileIconlibCameraQuestion);
}
