...
export class DileIconlibMapSouth extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-south')) {
  customElements.define('dile-tabler-icon-map-south', DileIconlibMapSouth);
}
