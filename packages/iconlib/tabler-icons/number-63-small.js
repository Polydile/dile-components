...
export class DileIconlibNumber63Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-63-small')) {
  customElements.define('dile-tabler-icon-number-63-small', DileIconlibNumber63Small);
}
