...
export class DileIconlibDeviceWatchPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-watch-pin')) {
  customElements.define('dile-tabler-icon-device-watch-pin', DileIconlibDeviceWatchPin);
}
