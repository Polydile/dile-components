...
export class DileIconlibSitemapFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sitemap-filled')) {
  customElements.define('dile-tabler-icon-sitemap-filled', DileIconlibSitemapFilled);
}
