...
export class DileIconlibHanger extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hanger')) {
  customElements.define('dile-tabler-icon-hanger', DileIconlibHanger);
}
