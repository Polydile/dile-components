...
export class DileIconlibNfcOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-nfc-off')) {
  customElements.define('dile-tabler-icon-nfc-off', DileIconlibNfcOff);
}
