...
export class DileIconlibManualGearbox extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-manual-gearbox')) {
  customElements.define('dile-tabler-icon-manual-gearbox', DileIconlibManualGearbox);
}
