...
export class DileIconlibBandageOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bandage-off')) {
  customElements.define('dile-tabler-icon-bandage-off', DileIconlibBandageOff);
}
