...
export class DileIconlibTemplate extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-template')) {
  customElements.define('dile-tabler-icon-template', DileIconlibTemplate);
}
