...
export class DileIconlibFlagPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flag-pin')) {
  customElements.define('dile-tabler-icon-flag-pin', DileIconlibFlagPin);
}
