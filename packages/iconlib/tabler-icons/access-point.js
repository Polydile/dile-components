...
export class DileIconlibAccessPoint extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-access-point')) {
  customElements.define('dile-tabler-icon-access-point', DileIconlibAccessPoint);
}
