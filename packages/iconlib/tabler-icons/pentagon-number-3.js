...
export class DileIconlibPentagonNumber3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pentagon-number-3')) {
  customElements.define('dile-tabler-icon-pentagon-number-3', DileIconlibPentagonNumber3);
}
