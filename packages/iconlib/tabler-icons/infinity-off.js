...
export class DileIconlibInfinityOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-infinity-off')) {
  customElements.define('dile-tabler-icon-infinity-off', DileIconlibInfinityOff);
}
