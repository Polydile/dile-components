...
export class DileIconlibEyeTable extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-table')) {
  customElements.define('dile-tabler-icon-eye-table', DileIconlibEyeTable);
}
