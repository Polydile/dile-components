...
export class DileIconlibHours12 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hours-12')) {
  customElements.define('dile-tabler-icon-hours-12', DileIconlibHours12);
}
