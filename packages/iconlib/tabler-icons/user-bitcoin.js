...
export class DileIconlibUserBitcoin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-user-bitcoin')) {
  customElements.define('dile-tabler-icon-user-bitcoin', DileIconlibUserBitcoin);
}
