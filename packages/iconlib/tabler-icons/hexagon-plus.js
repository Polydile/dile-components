...
export class DileIconlibHexagonPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-plus')) {
  customElements.define('dile-tabler-icon-hexagon-plus', DileIconlibHexagonPlus);
}
