...
export class DileIconlibNumber88Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-88-small')) {
  customElements.define('dile-tabler-icon-number-88-small', DileIconlibNumber88Small);
}
