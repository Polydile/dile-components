...
export class DileIconlibDropletShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-share')) {
  customElements.define('dile-tabler-icon-droplet-share', DileIconlibDropletShare);
}
