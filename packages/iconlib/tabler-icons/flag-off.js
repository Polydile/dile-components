...
export class DileIconlibFlagOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flag-off')) {
  customElements.define('dile-tabler-icon-flag-off', DileIconlibFlagOff);
}
