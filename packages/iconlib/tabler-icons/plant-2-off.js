...
export class DileIconlibPlant2Off extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-plant-2-off')) {
  customElements.define('dile-tabler-icon-plant-2-off', DileIconlibPlant2Off);
}
