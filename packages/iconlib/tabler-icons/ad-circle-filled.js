...
export class DileIconlibAdCircleFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ad-circle-filled')) {
  customElements.define('dile-tabler-icon-ad-circle-filled', DileIconlibAdCircleFilled);
}
