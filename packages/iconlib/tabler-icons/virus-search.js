...
export class DileIconlibVirusSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-virus-search')) {
  customElements.define('dile-tabler-icon-virus-search', DileIconlibVirusSearch);
}
