...
export class DileIconlibTimeDuration5 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-time-duration-5')) {
  customElements.define('dile-tabler-icon-time-duration-5', DileIconlibTimeDuration5);
}
