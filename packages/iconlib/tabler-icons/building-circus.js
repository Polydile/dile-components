...
export class DileIconlibBuildingCircus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-building-circus')) {
  customElements.define('dile-tabler-icon-building-circus', DileIconlibBuildingCircus);
}
