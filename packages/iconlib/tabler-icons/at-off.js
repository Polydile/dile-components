...
export class DileIconlibAtOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-at-off')) {
  customElements.define('dile-tabler-icon-at-off', DileIconlibAtOff);
}
