...
export class DileIconlibCalendarDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-calendar-down')) {
  customElements.define('dile-tabler-icon-calendar-down', DileIconlibCalendarDown);
}
