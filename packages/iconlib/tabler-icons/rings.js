...
export class DileIconlibRings extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rings')) {
  customElements.define('dile-tabler-icon-rings', DileIconlibRings);
}
