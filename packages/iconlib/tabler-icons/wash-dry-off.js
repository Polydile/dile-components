...
export class DileIconlibWashDryOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-wash-dry-off')) {
  customElements.define('dile-tabler-icon-wash-dry-off', DileIconlibWashDryOff);
}
