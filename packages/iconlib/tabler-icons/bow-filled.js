...
export class DileIconlibBowFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bow-filled')) {
  customElements.define('dile-tabler-icon-bow-filled', DileIconlibBowFilled);
}
