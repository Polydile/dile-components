...
export class DileIconlibRouteX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-route-x')) {
  customElements.define('dile-tabler-icon-route-x', DileIconlibRouteX);
}
