...
export class DileIconlibPentagonNumber7 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pentagon-number-7')) {
  customElements.define('dile-tabler-icon-pentagon-number-7', DileIconlibPentagonNumber7);
}
