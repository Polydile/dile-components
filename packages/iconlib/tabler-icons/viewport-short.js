...
export class DileIconlibViewportShort extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-viewport-short')) {
  customElements.define('dile-tabler-icon-viewport-short', DileIconlibViewportShort);
}
