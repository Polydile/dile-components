...
export class DileIconlibVariableOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-variable-off')) {
  customElements.define('dile-tabler-icon-variable-off', DileIconlibVariableOff);
}
