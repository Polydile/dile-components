...
export class DileIconlibMoodPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-plus')) {
  customElements.define('dile-tabler-icon-mood-plus', DileIconlibMoodPlus);
}
