...
export class DileIconlibChartDots extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-chart-dots')) {
  customElements.define('dile-tabler-icon-chart-dots', DileIconlibChartDots);
}
