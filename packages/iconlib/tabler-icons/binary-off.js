...
export class DileIconlibBinaryOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-binary-off')) {
  customElements.define('dile-tabler-icon-binary-off', DileIconlibBinaryOff);
}
