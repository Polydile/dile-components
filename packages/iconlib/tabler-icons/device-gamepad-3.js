...
export class DileIconlibDeviceGamepad3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-gamepad-3')) {
  customElements.define('dile-tabler-icon-device-gamepad-3', DileIconlibDeviceGamepad3);
}
