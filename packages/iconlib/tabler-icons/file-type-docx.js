...
export class DileIconlibFileTypeDocx extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-type-docx')) {
  customElements.define('dile-tabler-icon-file-type-docx', DileIconlibFileTypeDocx);
}
