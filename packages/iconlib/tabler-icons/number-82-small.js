...
export class DileIconlibNumber82Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-82-small')) {
  customElements.define('dile-tabler-icon-number-82-small', DileIconlibNumber82Small);
}
