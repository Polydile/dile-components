...
export class DileIconlibAssetFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-asset-filled')) {
  customElements.define('dile-tabler-icon-asset-filled', DileIconlibAssetFilled);
}
