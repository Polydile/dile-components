...
export class DileIconlibEyeglass extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eyeglass')) {
  customElements.define('dile-tabler-icon-eyeglass', DileIconlibEyeglass);
}
