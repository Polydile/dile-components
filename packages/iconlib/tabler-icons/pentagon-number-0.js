...
export class DileIconlibPentagonNumber0 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pentagon-number-0')) {
  customElements.define('dile-tabler-icon-pentagon-number-0', DileIconlibPentagonNumber0);
}
