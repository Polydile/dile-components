...
export class DileIconlibSoupFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-soup-filled')) {
  customElements.define('dile-tabler-icon-soup-filled', DileIconlibSoupFilled);
}
