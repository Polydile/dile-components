...
export class DileIconlibSquareNumber6 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-number-6')) {
  customElements.define('dile-tabler-icon-square-number-6', DileIconlibSquareNumber6);
}
