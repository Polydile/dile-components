...
export class DileIconlibSquareKey extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-key')) {
  customElements.define('dile-tabler-icon-square-key', DileIconlibSquareKey);
}
