...
export class DileIconlibPhotoPentagon extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-pentagon')) {
  customElements.define('dile-tabler-icon-photo-pentagon', DileIconlibPhotoPentagon);
}
