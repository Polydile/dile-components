...
export class DileIconlibBuildingStadium extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-building-stadium')) {
  customElements.define('dile-tabler-icon-building-stadium', DileIconlibBuildingStadium);
}
