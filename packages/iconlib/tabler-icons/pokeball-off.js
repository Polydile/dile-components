...
export class DileIconlibPokeballOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pokeball-off')) {
  customElements.define('dile-tabler-icon-pokeball-off', DileIconlibPokeballOff);
}
