...
export class DileIconlibDna2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-dna-2')) {
  customElements.define('dile-tabler-icon-dna-2', DileIconlibDna2);
}
