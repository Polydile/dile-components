...
export class DileIconlibPhotoOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-off')) {
  customElements.define('dile-tabler-icon-photo-off', DileIconlibPhotoOff);
}
