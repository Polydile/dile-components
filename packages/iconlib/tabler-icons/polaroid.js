...
export class DileIconlibPolaroid extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-polaroid')) {
  customElements.define('dile-tabler-icon-polaroid', DileIconlibPolaroid);
}
