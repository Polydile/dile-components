...
export class DileIconlibBongFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bong-filled')) {
  customElements.define('dile-tabler-icon-bong-filled', DileIconlibBongFilled);
}
