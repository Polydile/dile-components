...
export class DileIconlibNumber31Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-31-small')) {
  customElements.define('dile-tabler-icon-number-31-small', DileIconlibNumber31Small);
}
