...
export class DileIconlibLadle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ladle')) {
  customElements.define('dile-tabler-icon-ladle', DileIconlibLadle);
}
