...
export class DileIconlibChartDonut3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-chart-donut-3')) {
  customElements.define('dile-tabler-icon-chart-donut-3', DileIconlibChartDonut3);
}
