...
export class DileIconlibEyeEdit extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-edit')) {
  customElements.define('dile-tabler-icon-eye-edit', DileIconlibEyeEdit);
}
