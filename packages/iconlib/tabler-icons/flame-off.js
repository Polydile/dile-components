...
export class DileIconlibFlameOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flame-off')) {
  customElements.define('dile-tabler-icon-flame-off', DileIconlibFlameOff);
}
