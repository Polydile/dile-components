...
export class DileIconlibFilter2Cancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-2-cancel')) {
  customElements.define('dile-tabler-icon-filter-2-cancel', DileIconlibFilter2Cancel);
}
