...
export class DileIconlibSettingsPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-settings-pin')) {
  customElements.define('dile-tabler-icon-settings-pin', DileIconlibSettingsPin);
}
