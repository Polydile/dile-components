...
export class DileIconlibButterflyFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-butterfly-filled')) {
  customElements.define('dile-tabler-icon-butterfly-filled', DileIconlibButterflyFilled);
}
