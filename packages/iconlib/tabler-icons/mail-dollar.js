...
export class DileIconlibMailDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mail-dollar')) {
  customElements.define('dile-tabler-icon-mail-dollar', DileIconlibMailDollar);
}
