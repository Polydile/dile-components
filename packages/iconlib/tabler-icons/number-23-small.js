...
export class DileIconlibNumber23Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-23-small')) {
  customElements.define('dile-tabler-icon-number-23-small', DileIconlibNumber23Small);
}
