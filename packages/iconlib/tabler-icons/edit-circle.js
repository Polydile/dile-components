...
export class DileIconlibEditCircle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-edit-circle')) {
  customElements.define('dile-tabler-icon-edit-circle', DileIconlibEditCircle);
}
