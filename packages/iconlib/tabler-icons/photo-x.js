...
export class DileIconlibPhotoX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-x')) {
  customElements.define('dile-tabler-icon-photo-x', DileIconlibPhotoX);
}
