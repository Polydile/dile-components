...
export class DileIconlibTableShortcut extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-table-shortcut')) {
  customElements.define('dile-tabler-icon-table-shortcut', DileIconlibTableShortcut);
}
