...
export class DileIconlibHomeEco extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-eco')) {
  customElements.define('dile-tabler-icon-home-eco', DileIconlibHomeEco);
}
