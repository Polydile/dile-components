...
export class DileIconlibFireHydrantOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-fire-hydrant-off')) {
  customElements.define('dile-tabler-icon-fire-hydrant-off', DileIconlibFireHydrantOff);
}
