...
export class DileIconlibWindOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-wind-off')) {
  customElements.define('dile-tabler-icon-wind-off', DileIconlibWindOff);
}
