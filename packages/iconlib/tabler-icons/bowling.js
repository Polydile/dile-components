...
export class DileIconlibBowling extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bowling')) {
  customElements.define('dile-tabler-icon-bowling', DileIconlibBowling);
}
