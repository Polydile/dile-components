...
export class DileIconlibReportAnalytics extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-report-analytics')) {
  customElements.define('dile-tabler-icon-report-analytics', DileIconlibReportAnalytics);
}
