...
export class DileIconlibCircleNumber9 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-circle-number-9')) {
  customElements.define('dile-tabler-icon-circle-number-9', DileIconlibCircleNumber9);
}
