...
export class DileIconlibFishOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-fish-off')) {
  customElements.define('dile-tabler-icon-fish-off', DileIconlibFishOff);
}
