...
export class DileIconlibBrandNetbeans extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-brand-netbeans')) {
  customElements.define('dile-tabler-icon-brand-netbeans', DileIconlibBrandNetbeans);
}
