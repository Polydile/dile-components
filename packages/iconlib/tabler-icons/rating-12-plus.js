...
export class DileIconlibRating12Plus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rating-12-plus')) {
  customElements.define('dile-tabler-icon-rating-12-plus', DileIconlibRating12Plus);
}
