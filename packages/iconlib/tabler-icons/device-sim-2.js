...
export class DileIconlibDeviceSim2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-sim-2')) {
  customElements.define('dile-tabler-icon-device-sim-2', DileIconlibDeviceSim2);
}
