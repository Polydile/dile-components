...
export class DileIconlibSettingsMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-settings-minus')) {
  customElements.define('dile-tabler-icon-settings-minus', DileIconlibSettingsMinus);
}
