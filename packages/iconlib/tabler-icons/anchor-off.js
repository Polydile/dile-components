...
export class DileIconlibAnchorOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-anchor-off')) {
  customElements.define('dile-tabler-icon-anchor-off', DileIconlibAnchorOff);
}
