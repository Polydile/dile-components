...
export class DileIconlibMoodAnnoyed2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-annoyed-2')) {
  customElements.define('dile-tabler-icon-mood-annoyed-2', DileIconlibMoodAnnoyed2);
}
