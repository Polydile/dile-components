...
export class DileIconlibBoxModelOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-box-model-off')) {
  customElements.define('dile-tabler-icon-box-model-off', DileIconlibBoxModelOff);
}
