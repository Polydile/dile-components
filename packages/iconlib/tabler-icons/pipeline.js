...
export class DileIconlibPipeline extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pipeline')) {
  customElements.define('dile-tabler-icon-pipeline', DileIconlibPipeline);
}
