...
export class DileIconlibDropletHalf2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-half-2')) {
  customElements.define('dile-tabler-icon-droplet-half-2', DileIconlibDropletHalf2);
}
