...
export class DileIconlibCloudCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cloud-code')) {
  customElements.define('dile-tabler-icon-cloud-code', DileIconlibCloudCode);
}
