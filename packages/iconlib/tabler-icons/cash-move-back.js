...
export class DileIconlibCashMoveBack extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cash-move-back')) {
  customElements.define('dile-tabler-icon-cash-move-back', DileIconlibCashMoveBack);
}
