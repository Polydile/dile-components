...
export class DileIconlibSignal2g extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-signal-2g')) {
  customElements.define('dile-tabler-icon-signal-2g', DileIconlibSignal2g);
}
