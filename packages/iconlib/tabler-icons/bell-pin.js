...
export class DileIconlibBellPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-pin')) {
  customElements.define('dile-tabler-icon-bell-pin', DileIconlibBellPin);
}
