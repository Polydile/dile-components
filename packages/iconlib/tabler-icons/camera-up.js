...
export class DileIconlibCameraUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-camera-up')) {
  customElements.define('dile-tabler-icon-camera-up', DileIconlibCameraUp);
}
