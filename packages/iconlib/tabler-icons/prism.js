...
export class DileIconlibPrism extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-prism')) {
  customElements.define('dile-tabler-icon-prism', DileIconlibPrism);
}
