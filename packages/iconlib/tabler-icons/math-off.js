...
export class DileIconlibMathOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-math-off')) {
  customElements.define('dile-tabler-icon-math-off', DileIconlibMathOff);
}
