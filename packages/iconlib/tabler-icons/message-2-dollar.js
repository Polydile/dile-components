...
export class DileIconlibMessage2Dollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-2-dollar')) {
  customElements.define('dile-tabler-icon-message-2-dollar', DileIconlibMessage2Dollar);
}
