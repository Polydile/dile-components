...
export class DileIconlibShoe extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shoe')) {
  customElements.define('dile-tabler-icon-shoe', DileIconlibShoe);
}
