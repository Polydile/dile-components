...
export class DileIconlibSitemapOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sitemap-off')) {
  customElements.define('dile-tabler-icon-sitemap-off', DileIconlibSitemapOff);
}
