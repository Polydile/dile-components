...
export class DileIconlibLibraryPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-library-plus')) {
  customElements.define('dile-tabler-icon-library-plus', DileIconlibLibraryPlus);
}
