...
export class DileIconlibScribbleOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-scribble-off')) {
  customElements.define('dile-tabler-icon-scribble-off', DileIconlibScribbleOff);
}
