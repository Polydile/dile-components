...
export class DileIconlibBrandThreads extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-brand-threads')) {
  customElements.define('dile-tabler-icon-brand-threads', DileIconlibBrandThreads);
}
