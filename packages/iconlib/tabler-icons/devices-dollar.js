...
export class DileIconlibDevicesDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-dollar')) {
  customElements.define('dile-tabler-icon-devices-dollar', DileIconlibDevicesDollar);
}
