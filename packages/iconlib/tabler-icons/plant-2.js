...
export class DileIconlibPlant2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-plant-2')) {
  customElements.define('dile-tabler-icon-plant-2', DileIconlibPlant2);
}
