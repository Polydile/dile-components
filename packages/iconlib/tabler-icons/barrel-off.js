...
export class DileIconlibBarrelOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-barrel-off')) {
  customElements.define('dile-tabler-icon-barrel-off', DileIconlibBarrelOff);
}
