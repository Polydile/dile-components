...
export class DileIconlibMoodSad2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-sad-2')) {
  customElements.define('dile-tabler-icon-mood-sad-2', DileIconlibMoodSad2);
}
