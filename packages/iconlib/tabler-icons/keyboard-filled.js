...
export class DileIconlibKeyboardFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-keyboard-filled')) {
  customElements.define('dile-tabler-icon-keyboard-filled', DileIconlibKeyboardFilled);
}
