...
export class DileIconlibDeviceAnalytics extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-analytics')) {
  customElements.define('dile-tabler-icon-device-analytics', DileIconlibDeviceAnalytics);
}
