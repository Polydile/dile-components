...
export class DileIconlibMessage2Up extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-2-up')) {
  customElements.define('dile-tabler-icon-message-2-up', DileIconlibMessage2Up);
}
