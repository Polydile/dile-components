...
export class DileIconlibTagOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-tag-off')) {
  customElements.define('dile-tabler-icon-tag-off', DileIconlibTagOff);
}
