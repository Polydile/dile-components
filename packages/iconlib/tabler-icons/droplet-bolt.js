...
export class DileIconlibDropletBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-bolt')) {
  customElements.define('dile-tabler-icon-droplet-bolt', DileIconlibDropletBolt);
}
