...
export class DileIconlibCoinYenFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-coin-yen-filled')) {
  customElements.define('dile-tabler-icon-coin-yen-filled', DileIconlibCoinYenFilled);
}
