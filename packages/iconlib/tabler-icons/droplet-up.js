...
export class DileIconlibDropletUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-up')) {
  customElements.define('dile-tabler-icon-droplet-up', DileIconlibDropletUp);
}
