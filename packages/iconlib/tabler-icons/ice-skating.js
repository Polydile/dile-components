...
export class DileIconlibIceSkating extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ice-skating')) {
  customElements.define('dile-tabler-icon-ice-skating', DileIconlibIceSkating);
}
