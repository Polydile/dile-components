...
export class DileIconlibProgressBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-progress-bolt')) {
  customElements.define('dile-tabler-icon-progress-bolt', DileIconlibProgressBolt);
}
