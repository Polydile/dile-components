...
export class DileIconlibHexagonNumber0 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-number-0')) {
  customElements.define('dile-tabler-icon-hexagon-number-0', DileIconlibHexagonNumber0);
}
