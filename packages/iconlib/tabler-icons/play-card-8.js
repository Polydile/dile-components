...
export class DileIconlibPlayCard8 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-8')) {
  customElements.define('dile-tabler-icon-play-card-8', DileIconlibPlayCard8);
}
