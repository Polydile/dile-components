...
export class DileIconlibContrast2Off extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-contrast-2-off')) {
  customElements.define('dile-tabler-icon-contrast-2-off', DileIconlibContrast2Off);
}
