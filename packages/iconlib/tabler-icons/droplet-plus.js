...
export class DileIconlibDropletPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-plus')) {
  customElements.define('dile-tabler-icon-droplet-plus', DileIconlibDropletPlus);
}
