...
export class DileIconlibLivePhotoFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-live-photo-filled')) {
  customElements.define('dile-tabler-icon-live-photo-filled', DileIconlibLivePhotoFilled);
}
