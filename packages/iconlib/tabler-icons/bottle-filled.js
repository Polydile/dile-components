...
export class DileIconlibBottleFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bottle-filled')) {
  customElements.define('dile-tabler-icon-bottle-filled', DileIconlibBottleFilled);
}
