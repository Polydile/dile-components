...
export class DileIconlibCube3dSphere extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cube-3d-sphere')) {
  customElements.define('dile-tabler-icon-cube-3d-sphere', DileIconlibCube3dSphere);
}
