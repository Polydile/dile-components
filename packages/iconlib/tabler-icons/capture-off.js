...
export class DileIconlibCaptureOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-capture-off')) {
  customElements.define('dile-tabler-icon-capture-off', DileIconlibCaptureOff);
}
