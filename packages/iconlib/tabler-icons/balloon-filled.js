...
export class DileIconlibBalloonFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-balloon-filled')) {
  customElements.define('dile-tabler-icon-balloon-filled', DileIconlibBalloonFilled);
}
