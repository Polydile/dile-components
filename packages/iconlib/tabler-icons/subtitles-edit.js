...
export class DileIconlibSubtitlesEdit extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-subtitles-edit')) {
  customElements.define('dile-tabler-icon-subtitles-edit', DileIconlibSubtitlesEdit);
}
