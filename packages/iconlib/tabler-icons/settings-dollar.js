...
export class DileIconlibSettingsDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-settings-dollar')) {
  customElements.define('dile-tabler-icon-settings-dollar', DileIconlibSettingsDollar);
}
