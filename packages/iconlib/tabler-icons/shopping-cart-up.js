...
export class DileIconlibShoppingCartUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shopping-cart-up')) {
  customElements.define('dile-tabler-icon-shopping-cart-up', DileIconlibShoppingCartUp);
}
