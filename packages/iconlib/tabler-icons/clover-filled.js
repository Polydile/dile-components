...
export class DileIconlibCloverFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-clover-filled')) {
  customElements.define('dile-tabler-icon-clover-filled', DileIconlibCloverFilled);
}
