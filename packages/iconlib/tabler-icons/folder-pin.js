...
export class DileIconlibFolderPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-folder-pin')) {
  customElements.define('dile-tabler-icon-folder-pin', DileIconlibFolderPin);
}
