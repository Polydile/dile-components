...
export class DileIconlibTimeDuration0 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-time-duration-0')) {
  customElements.define('dile-tabler-icon-time-duration-0', DileIconlibTimeDuration0);
}
