...
export class DileIconlibNumber43Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-43-small')) {
  customElements.define('dile-tabler-icon-number-43-small', DileIconlibNumber43Small);
}
