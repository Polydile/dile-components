...
export class DileIconlibNavigationCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-navigation-code')) {
  customElements.define('dile-tabler-icon-navigation-code', DileIconlibNavigationCode);
}
