...
export class DileIconlibHttpPostOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-http-post-off')) {
  customElements.define('dile-tabler-icon-http-post-off', DileIconlibHttpPostOff);
}
