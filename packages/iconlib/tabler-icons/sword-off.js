...
export class DileIconlibSwordOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sword-off')) {
  customElements.define('dile-tabler-icon-sword-off', DileIconlibSwordOff);
}
