...
export class DileIconlibBellMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-minus')) {
  customElements.define('dile-tabler-icon-bell-minus', DileIconlibBellMinus);
}
