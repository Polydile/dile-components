...
export class DileIconlibLinkMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-link-minus')) {
  customElements.define('dile-tabler-icon-link-minus', DileIconlibLinkMinus);
}
