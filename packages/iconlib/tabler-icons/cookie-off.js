...
export class DileIconlibCookieOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cookie-off')) {
  customElements.define('dile-tabler-icon-cookie-off', DileIconlibCookieOff);
}
