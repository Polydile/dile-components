...
export class DileIconlibCakeRoll extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cake-roll')) {
  customElements.define('dile-tabler-icon-cake-roll', DileIconlibCakeRoll);
}
