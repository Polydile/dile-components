...
export class DileIconlibReceiptEuro extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-receipt-euro')) {
  customElements.define('dile-tabler-icon-receipt-euro', DileIconlibReceiptEuro);
}
