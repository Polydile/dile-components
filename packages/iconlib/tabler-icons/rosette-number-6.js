...
export class DileIconlibRosetteNumber6 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rosette-number-6')) {
  customElements.define('dile-tabler-icon-rosette-number-6', DileIconlibRosetteNumber6);
}
