...
export class DileIconlibDiscGolf extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-disc-golf')) {
  customElements.define('dile-tabler-icon-disc-golf', DileIconlibDiscGolf);
}
