...
export class DileIconlibRadioactiveOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-radioactive-off')) {
  customElements.define('dile-tabler-icon-radioactive-off', DileIconlibRadioactiveOff);
}
