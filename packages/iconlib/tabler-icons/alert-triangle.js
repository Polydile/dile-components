...
export class DileIconlibAlertTriangle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-alert-triangle')) {
  customElements.define('dile-tabler-icon-alert-triangle', DileIconlibAlertTriangle);
}
