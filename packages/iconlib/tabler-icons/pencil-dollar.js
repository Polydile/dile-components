...
export class DileIconlibPencilDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pencil-dollar')) {
  customElements.define('dile-tabler-icon-pencil-dollar', DileIconlibPencilDollar);
}
