...
export class DileIconlibLockAccessOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-access-off')) {
  customElements.define('dile-tabler-icon-lock-access-off', DileIconlibLockAccessOff);
}
