...
export class DileIconlibPhotoShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-share')) {
  customElements.define('dile-tabler-icon-photo-share', DileIconlibPhotoShare);
}
