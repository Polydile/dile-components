...
export class DileIconlibBusStop extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bus-stop')) {
  customElements.define('dile-tabler-icon-bus-stop', DileIconlibBusStop);
}
