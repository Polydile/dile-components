...
export class DileIconlibCoinOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-coin-off')) {
  customElements.define('dile-tabler-icon-coin-off', DileIconlibCoinOff);
}
