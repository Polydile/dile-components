...
export class DileIconlibParachuteOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-parachute-off')) {
  customElements.define('dile-tabler-icon-parachute-off', DileIconlibParachuteOff);
}
