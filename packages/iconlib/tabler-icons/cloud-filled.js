...
export class DileIconlibCloudFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cloud-filled')) {
  customElements.define('dile-tabler-icon-cloud-filled', DileIconlibCloudFilled);
}
