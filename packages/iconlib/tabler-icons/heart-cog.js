...
export class DileIconlibHeartCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-heart-cog')) {
  customElements.define('dile-tabler-icon-heart-cog', DileIconlibHeartCog);
}
