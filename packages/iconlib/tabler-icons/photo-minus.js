...
export class DileIconlibPhotoMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-minus')) {
  customElements.define('dile-tabler-icon-photo-minus', DileIconlibPhotoMinus);
}
