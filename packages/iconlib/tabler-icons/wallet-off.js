...
export class DileIconlibWalletOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-wallet-off')) {
  customElements.define('dile-tabler-icon-wallet-off', DileIconlibWalletOff);
}
