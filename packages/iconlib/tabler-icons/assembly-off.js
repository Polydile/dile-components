...
export class DileIconlibAssemblyOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-assembly-off')) {
  customElements.define('dile-tabler-icon-assembly-off', DileIconlibAssemblyOff);
}
