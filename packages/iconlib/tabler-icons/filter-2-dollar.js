...
export class DileIconlibFilter2Dollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-2-dollar')) {
  customElements.define('dile-tabler-icon-filter-2-dollar', DileIconlibFilter2Dollar);
}
