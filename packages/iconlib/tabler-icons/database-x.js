...
export class DileIconlibDatabaseX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-database-x')) {
  customElements.define('dile-tabler-icon-database-x', DileIconlibDatabaseX);
}
