...
export class DileIconlibNumber13Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-13-small')) {
  customElements.define('dile-tabler-icon-number-13-small', DileIconlibNumber13Small);
}
