...
export class DileIconlibTimeDuration15 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-time-duration-15')) {
  customElements.define('dile-tabler-icon-time-duration-15', DileIconlibTimeDuration15);
}
