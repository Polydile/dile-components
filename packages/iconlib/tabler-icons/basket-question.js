...
export class DileIconlibBasketQuestion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-basket-question')) {
  customElements.define('dile-tabler-icon-basket-question', DileIconlibBasketQuestion);
}
