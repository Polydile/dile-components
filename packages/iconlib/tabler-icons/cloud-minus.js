...
export class DileIconlibCloudMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cloud-minus')) {
  customElements.define('dile-tabler-icon-cloud-minus', DileIconlibCloudMinus);
}
