...
export class DileIconlibPentagonMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pentagon-minus')) {
  customElements.define('dile-tabler-icon-pentagon-minus', DileIconlibPentagonMinus);
}
