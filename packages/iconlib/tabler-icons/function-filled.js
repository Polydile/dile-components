...
export class DileIconlibFunctionFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-function-filled')) {
  customElements.define('dile-tabler-icon-function-filled', DileIconlibFunctionFilled);
}
