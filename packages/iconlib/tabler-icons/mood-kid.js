...
export class DileIconlibMoodKid extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-kid')) {
  customElements.define('dile-tabler-icon-mood-kid', DileIconlibMoodKid);
}
