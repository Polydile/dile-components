...
export class DileIconlibArrowFork extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-arrow-fork')) {
  customElements.define('dile-tabler-icon-arrow-fork', DileIconlibArrowFork);
}
