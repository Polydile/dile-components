...
export class DileIconlibHomeLock extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-lock')) {
  customElements.define('dile-tabler-icon-home-lock', DileIconlibHomeLock);
}
