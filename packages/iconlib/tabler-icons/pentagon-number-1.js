...
export class DileIconlibPentagonNumber1 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pentagon-number-1')) {
  customElements.define('dile-tabler-icon-pentagon-number-1', DileIconlibPentagonNumber1);
}
