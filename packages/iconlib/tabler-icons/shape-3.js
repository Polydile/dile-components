...
export class DileIconlibShape3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shape-3')) {
  customElements.define('dile-tabler-icon-shape-3', DileIconlibShape3);
}
