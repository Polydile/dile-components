...
export class DileIconlibFilesFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-files-filled')) {
  customElements.define('dile-tabler-icon-files-filled', DileIconlibFilesFilled);
}
