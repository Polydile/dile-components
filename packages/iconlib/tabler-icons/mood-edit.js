...
export class DileIconlibMoodEdit extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-edit')) {
  customElements.define('dile-tabler-icon-mood-edit', DileIconlibMoodEdit);
}
