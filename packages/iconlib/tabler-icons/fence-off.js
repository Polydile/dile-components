...
export class DileIconlibFenceOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-fence-off')) {
  customElements.define('dile-tabler-icon-fence-off', DileIconlibFenceOff);
}
