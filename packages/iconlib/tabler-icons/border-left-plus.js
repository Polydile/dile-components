...
export class DileIconlibBorderLeftPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-border-left-plus')) {
  customElements.define('dile-tabler-icon-border-left-plus', DileIconlibBorderLeftPlus);
}
