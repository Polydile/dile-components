...
export class DileIconlibAdjustmentsPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-adjustments-pin')) {
  customElements.define('dile-tabler-icon-adjustments-pin', DileIconlibAdjustmentsPin);
}
