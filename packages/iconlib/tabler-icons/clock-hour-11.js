...
export class DileIconlibClockHour11 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-clock-hour-11')) {
  customElements.define('dile-tabler-icon-clock-hour-11', DileIconlibClockHour11);
}
