...
export class DileIconlibDiscOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-disc-off')) {
  customElements.define('dile-tabler-icon-disc-off', DileIconlibDiscOff);
}
