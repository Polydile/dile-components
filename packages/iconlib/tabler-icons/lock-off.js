...
export class DileIconlibLockOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-off')) {
  customElements.define('dile-tabler-icon-lock-off', DileIconlibLockOff);
}
