...
export class DileIconlibHomeDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-down')) {
  customElements.define('dile-tabler-icon-home-down', DileIconlibHomeDown);
}
