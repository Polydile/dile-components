...
export class DileIconlibLayoutCards extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-layout-cards')) {
  customElements.define('dile-tabler-icon-layout-cards', DileIconlibLayoutCards);
}
