...
export class DileIconlibNumber59Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-59-small')) {
  customElements.define('dile-tabler-icon-number-59-small', DileIconlibNumber59Small);
}
