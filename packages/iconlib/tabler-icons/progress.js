...
export class DileIconlibProgress extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-progress')) {
  customElements.define('dile-tabler-icon-progress', DileIconlibProgress);
}
