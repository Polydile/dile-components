...
export class DileIconlibShape extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shape')) {
  customElements.define('dile-tabler-icon-shape', DileIconlibShape);
}
