...
export class DileIconlibTrafficLights extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-traffic-lights')) {
  customElements.define('dile-tabler-icon-traffic-lights', DileIconlibTrafficLights);
}
