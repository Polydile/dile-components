...
export class DileIconlibHexagonNumber9 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-number-9')) {
  customElements.define('dile-tabler-icon-hexagon-number-9', DileIconlibHexagonNumber9);
}
