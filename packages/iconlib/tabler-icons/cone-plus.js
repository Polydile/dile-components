...
export class DileIconlibConePlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cone-plus')) {
  customElements.define('dile-tabler-icon-cone-plus', DileIconlibConePlus);
}
