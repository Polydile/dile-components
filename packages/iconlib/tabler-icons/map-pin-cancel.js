...
export class DileIconlibMapPinCancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-pin-cancel')) {
  customElements.define('dile-tabler-icon-map-pin-cancel', DileIconlibMapPinCancel);
}
