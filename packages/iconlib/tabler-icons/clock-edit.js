...
export class DileIconlibClockEdit extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-clock-edit')) {
  customElements.define('dile-tabler-icon-clock-edit', DileIconlibClockEdit);
}
