...
export class DileIconlibUsersGroup extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-users-group')) {
  customElements.define('dile-tabler-icon-users-group', DileIconlibUsersGroup);
}
