...
export class DileIconlibCertificate2Off extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-certificate-2-off')) {
  customElements.define('dile-tabler-icon-certificate-2-off', DileIconlibCertificate2Off);
}
