...
export class DileIconlibNumber55Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-55-small')) {
  customElements.define('dile-tabler-icon-number-55-small', DileIconlibNumber55Small);
}
