...
export class DileIconlibFilesOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-files-off')) {
  customElements.define('dile-tabler-icon-files-off', DileIconlibFilesOff);
}
