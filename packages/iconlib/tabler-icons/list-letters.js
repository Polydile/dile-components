...
export class DileIconlibListLetters extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-list-letters')) {
  customElements.define('dile-tabler-icon-list-letters', DileIconlibListLetters);
}
