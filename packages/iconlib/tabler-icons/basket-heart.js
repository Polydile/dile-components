...
export class DileIconlibBasketHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-basket-heart')) {
  customElements.define('dile-tabler-icon-basket-heart', DileIconlibBasketHeart);
}
