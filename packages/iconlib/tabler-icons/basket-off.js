...
export class DileIconlibBasketOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-basket-off')) {
  customElements.define('dile-tabler-icon-basket-off', DileIconlibBasketOff);
}
