...
export class DileIconlibRocketOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rocket-off')) {
  customElements.define('dile-tabler-icon-rocket-off', DileIconlibRocketOff);
}
