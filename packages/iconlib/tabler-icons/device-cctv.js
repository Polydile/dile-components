...
export class DileIconlibDeviceCctv extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-cctv')) {
  customElements.define('dile-tabler-icon-device-cctv', DileIconlibDeviceCctv);
}
