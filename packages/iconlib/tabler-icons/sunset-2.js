...
export class DileIconlibSunset2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sunset-2')) {
  customElements.define('dile-tabler-icon-sunset-2', DileIconlibSunset2);
}
