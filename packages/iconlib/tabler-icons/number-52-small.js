...
export class DileIconlibNumber52Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-52-small')) {
  customElements.define('dile-tabler-icon-number-52-small', DileIconlibNumber52Small);
}
