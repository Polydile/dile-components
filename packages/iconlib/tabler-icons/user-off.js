...
export class DileIconlibUserOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-user-off')) {
  customElements.define('dile-tabler-icon-user-off', DileIconlibUserOff);
}
