...
export class DileIconlibPointerQuestion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pointer-question')) {
  customElements.define('dile-tabler-icon-pointer-question', DileIconlibPointerQuestion);
}
