...
export class DileIconlibPhotoQuestion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-question')) {
  customElements.define('dile-tabler-icon-photo-question', DileIconlibPhotoQuestion);
}
