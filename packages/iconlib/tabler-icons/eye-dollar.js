...
export class DileIconlibEyeDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-dollar')) {
  customElements.define('dile-tabler-icon-eye-dollar', DileIconlibEyeDollar);
}
