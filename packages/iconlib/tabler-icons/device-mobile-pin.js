...
export class DileIconlibDeviceMobilePin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-mobile-pin')) {
  customElements.define('dile-tabler-icon-device-mobile-pin', DileIconlibDeviceMobilePin);
}
