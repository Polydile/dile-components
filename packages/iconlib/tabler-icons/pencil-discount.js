...
export class DileIconlibPencilDiscount extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pencil-discount')) {
  customElements.define('dile-tabler-icon-pencil-discount', DileIconlibPencilDiscount);
}
