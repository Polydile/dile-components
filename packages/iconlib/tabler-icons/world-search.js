...
export class DileIconlibWorldSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-search')) {
  customElements.define('dile-tabler-icon-world-search', DileIconlibWorldSearch);
}
