...
export class DileIconlibBulbOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bulb-off')) {
  customElements.define('dile-tabler-icon-bulb-off', DileIconlibBulbOff);
}
