...
export class DileIconlibClipboardSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-clipboard-search')) {
  customElements.define('dile-tabler-icon-clipboard-search', DileIconlibClipboardSearch);
}
