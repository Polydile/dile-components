...
export class DileIconlibDevices2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-2')) {
  customElements.define('dile-tabler-icon-devices-2', DileIconlibDevices2);
}
