...
export class DileIconlibNumber46Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-46-small')) {
  customElements.define('dile-tabler-icon-number-46-small', DileIconlibNumber46Small);
}
