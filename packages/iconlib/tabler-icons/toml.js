...
export class DileIconlibToml extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-toml')) {
  customElements.define('dile-tabler-icon-toml', DileIconlibToml);
}
