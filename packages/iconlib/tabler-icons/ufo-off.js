...
export class DileIconlibUfoOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ufo-off')) {
  customElements.define('dile-tabler-icon-ufo-off', DileIconlibUfoOff);
}
