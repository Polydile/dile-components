...
export class DileIconlibBasketCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-basket-check')) {
  customElements.define('dile-tabler-icon-basket-check', DileIconlibBasketCheck);
}
