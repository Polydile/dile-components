...
export class DileIconlibLollipopOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lollipop-off')) {
  customElements.define('dile-tabler-icon-lollipop-off', DileIconlibLollipopOff);
}
