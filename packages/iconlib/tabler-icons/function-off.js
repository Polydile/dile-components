...
export class DileIconlibFunctionOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-function-off')) {
  customElements.define('dile-tabler-icon-function-off', DileIconlibFunctionOff);
}
