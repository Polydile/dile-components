...
export class DileIconlibBadge3d extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-badge-3d')) {
  customElements.define('dile-tabler-icon-badge-3d', DileIconlibBadge3d);
}
