...
export class DileIconlibCalendarCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-calendar-code')) {
  customElements.define('dile-tabler-icon-calendar-code', DileIconlibCalendarCode);
}
