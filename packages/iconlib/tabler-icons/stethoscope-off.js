...
export class DileIconlibStethoscopeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-stethoscope-off')) {
  customElements.define('dile-tabler-icon-stethoscope-off', DileIconlibStethoscopeOff);
}
