...
export class DileIconlibCertificate2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-certificate-2')) {
  customElements.define('dile-tabler-icon-certificate-2', DileIconlibCertificate2);
}
