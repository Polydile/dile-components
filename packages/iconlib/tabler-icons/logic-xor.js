...
export class DileIconlibLogicXor extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-logic-xor')) {
  customElements.define('dile-tabler-icon-logic-xor', DileIconlibLogicXor);
}
