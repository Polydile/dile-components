...
export class DileIconlibDropletHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-heart')) {
  customElements.define('dile-tabler-icon-droplet-heart', DileIconlibDropletHeart);
}
