...
export class DileIconlibMeteorOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-meteor-off')) {
  customElements.define('dile-tabler-icon-meteor-off', DileIconlibMeteorOff);
}
