...
export class DileIconlibArrowsMinimize extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-arrows-minimize')) {
  customElements.define('dile-tabler-icon-arrows-minimize', DileIconlibArrowsMinimize);
}
