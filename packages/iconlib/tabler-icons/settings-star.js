...
export class DileIconlibSettingsStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-settings-star')) {
  customElements.define('dile-tabler-icon-settings-star', DileIconlibSettingsStar);
}
