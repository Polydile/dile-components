...
export class DileIconlibDetailsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-details-off')) {
  customElements.define('dile-tabler-icon-details-off', DileIconlibDetailsOff);
}
