...
export class DileIconlibRoulette extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-roulette')) {
  customElements.define('dile-tabler-icon-roulette', DileIconlibRoulette);
}
