...
export class DileIconlibHomeHand extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-hand')) {
  customElements.define('dile-tabler-icon-home-hand', DileIconlibHomeHand);
}
