...
export class DileIconlibFilterPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-plus')) {
  customElements.define('dile-tabler-icon-filter-plus', DileIconlibFilterPlus);
}
