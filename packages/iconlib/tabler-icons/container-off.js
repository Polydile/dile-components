...
export class DileIconlibContainerOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-container-off')) {
  customElements.define('dile-tabler-icon-container-off', DileIconlibContainerOff);
}
