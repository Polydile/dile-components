...
export class DileIconlibMessageUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-up')) {
  customElements.define('dile-tabler-icon-message-up', DileIconlibMessageUp);
}
