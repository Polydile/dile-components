...
export class DileIconlibBadgeVr extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-badge-vr')) {
  customElements.define('dile-tabler-icon-badge-vr', DileIconlibBadgeVr);
}
