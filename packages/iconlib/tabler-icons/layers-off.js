...
export class DileIconlibLayersOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-layers-off')) {
  customElements.define('dile-tabler-icon-layers-off', DileIconlibLayersOff);
}
