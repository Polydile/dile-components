...
export class DileIconlibMusicCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-music-cog')) {
  customElements.define('dile-tabler-icon-music-cog', DileIconlibMusicCog);
}
