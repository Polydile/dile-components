...
export class DileIconlibFileInfoFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-info-filled')) {
  customElements.define('dile-tabler-icon-file-info-filled', DileIconlibFileInfoFilled);
}
