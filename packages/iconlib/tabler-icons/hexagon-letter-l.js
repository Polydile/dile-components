...
export class DileIconlibHexagonLetterL extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-l')) {
  customElements.define('dile-tabler-icon-hexagon-letter-l', DileIconlibHexagonLetterL);
}
