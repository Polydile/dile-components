...
export class DileIconlibBadgeHd extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-badge-hd')) {
  customElements.define('dile-tabler-icon-badge-hd', DileIconlibBadgeHd);
}
