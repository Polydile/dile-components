...
export class DileIconlibSquareLetterD extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-letter-d')) {
  customElements.define('dile-tabler-icon-square-letter-d', DileIconlibSquareLetterD);
}
