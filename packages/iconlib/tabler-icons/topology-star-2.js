...
export class DileIconlibTopologyStar2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-topology-star-2')) {
  customElements.define('dile-tabler-icon-topology-star-2', DileIconlibTopologyStar2);
}
