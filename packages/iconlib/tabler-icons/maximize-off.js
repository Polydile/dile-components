...
export class DileIconlibMaximizeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-maximize-off')) {
  customElements.define('dile-tabler-icon-maximize-off', DileIconlibMaximizeOff);
}
