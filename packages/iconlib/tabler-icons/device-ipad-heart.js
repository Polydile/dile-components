...
export class DileIconlibDeviceIpadHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-ipad-heart')) {
  customElements.define('dile-tabler-icon-device-ipad-heart', DileIconlibDeviceIpadHeart);
}
