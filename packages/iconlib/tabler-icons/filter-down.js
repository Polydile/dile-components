...
export class DileIconlibFilterDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-down')) {
  customElements.define('dile-tabler-icon-filter-down', DileIconlibFilterDown);
}
