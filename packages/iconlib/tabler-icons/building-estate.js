...
export class DileIconlibBuildingEstate extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-building-estate')) {
  customElements.define('dile-tabler-icon-building-estate', DileIconlibBuildingEstate);
}
