...
export class DileIconlibMoodSilence extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-silence')) {
  customElements.define('dile-tabler-icon-mood-silence', DileIconlibMoodSilence);
}
