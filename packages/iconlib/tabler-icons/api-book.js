...
export class DileIconlibApiBook extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-api-book')) {
  customElements.define('dile-tabler-icon-api-book', DileIconlibApiBook);
}
