...
export class DileIconlibBasketStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-basket-star')) {
  customElements.define('dile-tabler-icon-basket-star', DileIconlibBasketStar);
}
