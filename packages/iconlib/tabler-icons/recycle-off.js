...
export class DileIconlibRecycleOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-recycle-off')) {
  customElements.define('dile-tabler-icon-recycle-off', DileIconlibRecycleOff);
}
