...
export class DileIconlibLifebuoyFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lifebuoy-filled')) {
  customElements.define('dile-tabler-icon-lifebuoy-filled', DileIconlibLifebuoyFilled);
}
