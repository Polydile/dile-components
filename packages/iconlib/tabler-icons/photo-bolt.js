...
export class DileIconlibPhotoBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-bolt')) {
  customElements.define('dile-tabler-icon-photo-bolt', DileIconlibPhotoBolt);
}
