...
export class DileIconlibMessage2X extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-2-x')) {
  customElements.define('dile-tabler-icon-message-2-x', DileIconlibMessage2X);
}
