...
export class DileIconlibLockCancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-cancel')) {
  customElements.define('dile-tabler-icon-lock-cancel', DileIconlibLockCancel);
}
