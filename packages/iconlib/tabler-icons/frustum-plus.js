...
export class DileIconlibFrustumPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-frustum-plus')) {
  customElements.define('dile-tabler-icon-frustum-plus', DileIconlibFrustumPlus);
}
