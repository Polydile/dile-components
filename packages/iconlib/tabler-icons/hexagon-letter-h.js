...
export class DileIconlibHexagonLetterH extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-h')) {
  customElements.define('dile-tabler-icon-hexagon-letter-h', DileIconlibHexagonLetterH);
}
