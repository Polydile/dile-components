...
export class DileIconlibTablePlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-table-plus')) {
  customElements.define('dile-tabler-icon-table-plus', DileIconlibTablePlus);
}
