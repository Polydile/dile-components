...
export class DileIconlibReceipt2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-receipt-2')) {
  customElements.define('dile-tabler-icon-receipt-2', DileIconlibReceipt2);
}
