...
export class DileIconlibFrustumOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-frustum-off')) {
  customElements.define('dile-tabler-icon-frustum-off', DileIconlibFrustumOff);
}
