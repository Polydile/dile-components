...
export class DileIconlibNavigationDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-navigation-down')) {
  customElements.define('dile-tabler-icon-navigation-down', DileIconlibNavigationDown);
}
