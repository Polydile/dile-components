...
export class DileIconlibBottle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bottle')) {
  customElements.define('dile-tabler-icon-bottle', DileIconlibBottle);
}
