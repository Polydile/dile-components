...
export class DileIconlibNumber49Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-49-small')) {
  customElements.define('dile-tabler-icon-number-49-small', DileIconlibNumber49Small);
}
