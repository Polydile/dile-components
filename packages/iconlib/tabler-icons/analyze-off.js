...
export class DileIconlibAnalyzeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-analyze-off')) {
  customElements.define('dile-tabler-icon-analyze-off', DileIconlibAnalyzeOff);
}
