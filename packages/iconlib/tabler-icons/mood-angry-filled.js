...
export class DileIconlibMoodAngryFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-angry-filled')) {
  customElements.define('dile-tabler-icon-mood-angry-filled', DileIconlibMoodAngryFilled);
}
