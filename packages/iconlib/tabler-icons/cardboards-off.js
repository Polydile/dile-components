...
export class DileIconlibCardboardsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cardboards-off')) {
  customElements.define('dile-tabler-icon-cardboards-off', DileIconlibCardboardsOff);
}
