...
export class DileIconlibEyeShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-share')) {
  customElements.define('dile-tabler-icon-eye-share', DileIconlibEyeShare);
}
