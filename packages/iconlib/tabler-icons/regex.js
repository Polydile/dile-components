...
export class DileIconlibRegex extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-regex')) {
  customElements.define('dile-tabler-icon-regex', DileIconlibRegex);
}
