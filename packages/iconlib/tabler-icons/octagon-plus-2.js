...
export class DileIconlibOctagonPlus2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-octagon-plus-2')) {
  customElements.define('dile-tabler-icon-octagon-plus-2', DileIconlibOctagonPlus2);
}
