...
export class DileIconlibImageInPicture extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-image-in-picture')) {
  customElements.define('dile-tabler-icon-image-in-picture', DileIconlibImageInPicture);
}
