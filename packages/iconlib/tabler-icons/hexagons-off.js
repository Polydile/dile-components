...
export class DileIconlibHexagonsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagons-off')) {
  customElements.define('dile-tabler-icon-hexagons-off', DileIconlibHexagonsOff);
}
