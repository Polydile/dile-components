...
export class DileIconlibGrillSpatula extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-grill-spatula')) {
  customElements.define('dile-tabler-icon-grill-spatula', DileIconlibGrillSpatula);
}
