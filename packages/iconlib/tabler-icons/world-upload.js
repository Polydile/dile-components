...
export class DileIconlibWorldUpload extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-upload')) {
  customElements.define('dile-tabler-icon-world-upload', DileIconlibWorldUpload);
}
