...
export class DileIconlibNewsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-news-off')) {
  customElements.define('dile-tabler-icon-news-off', DileIconlibNewsOff);
}
