...
export class DileIconlibTournament extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-tournament')) {
  customElements.define('dile-tabler-icon-tournament', DileIconlibTournament);
}
