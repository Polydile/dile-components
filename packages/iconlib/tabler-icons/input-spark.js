...
export class DileIconlibInputSpark extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-input-spark')) {
  customElements.define('dile-tabler-icon-input-spark', DileIconlibInputSpark);
}
