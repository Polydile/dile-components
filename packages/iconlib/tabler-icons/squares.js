...
export class DileIconlibSquares extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-squares')) {
  customElements.define('dile-tabler-icon-squares', DileIconlibSquares);
}
