...
export class DileIconlibBellShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-share')) {
  customElements.define('dile-tabler-icon-bell-share', DileIconlibBellShare);
}
