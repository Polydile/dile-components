...
export class DileIconlibPentagonNumber4 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pentagon-number-4')) {
  customElements.define('dile-tabler-icon-pentagon-number-4', DileIconlibPentagonNumber4);
}
