...
export class DileIconlibLibraryPhoto extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-library-photo')) {
  customElements.define('dile-tabler-icon-library-photo', DileIconlibLibraryPhoto);
}
