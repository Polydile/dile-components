...
export class DileIconlibCandy extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-candy')) {
  customElements.define('dile-tabler-icon-candy', DileIconlibCandy);
}
