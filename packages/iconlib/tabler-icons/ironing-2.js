...
export class DileIconlibIroning2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ironing-2')) {
  customElements.define('dile-tabler-icon-ironing-2', DileIconlibIroning2);
}
