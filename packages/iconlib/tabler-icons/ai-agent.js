...
export class DileIconlibAiAgent extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ai-agent')) {
  customElements.define('dile-tabler-icon-ai-agent', DileIconlibAiAgent);
}
