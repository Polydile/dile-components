...
export class DileIconlibSwipe extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-swipe')) {
  customElements.define('dile-tabler-icon-swipe', DileIconlibSwipe);
}
