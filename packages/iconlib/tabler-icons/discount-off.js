...
export class DileIconlibDiscountOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-discount-off')) {
  customElements.define('dile-tabler-icon-discount-off', DileIconlibDiscountOff);
}
