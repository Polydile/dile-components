...
export class DileIconlibRewindForward20 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rewind-forward-20')) {
  customElements.define('dile-tabler-icon-rewind-forward-20', DileIconlibRewindForward20);
}
