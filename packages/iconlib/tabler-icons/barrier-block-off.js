...
export class DileIconlibBarrierBlockOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-barrier-block-off')) {
  customElements.define('dile-tabler-icon-barrier-block-off', DileIconlibBarrierBlockOff);
}
