...
export class DileIconlibCapture extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-capture')) {
  customElements.define('dile-tabler-icon-capture', DileIconlibCapture);
}
