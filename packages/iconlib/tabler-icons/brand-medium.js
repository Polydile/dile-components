...
export class DileIconlibBrandMedium extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-brand-medium')) {
  customElements.define('dile-tabler-icon-brand-medium', DileIconlibBrandMedium);
}
