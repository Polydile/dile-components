...
export class DileIconlibSeedlingOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-seedling-off')) {
  customElements.define('dile-tabler-icon-seedling-off', DileIconlibSeedlingOff);
}
