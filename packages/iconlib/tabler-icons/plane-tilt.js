...
export class DileIconlibPlaneTilt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-plane-tilt')) {
  customElements.define('dile-tabler-icon-plane-tilt', DileIconlibPlaneTilt);
}
