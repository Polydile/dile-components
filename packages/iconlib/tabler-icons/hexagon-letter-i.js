...
export class DileIconlibHexagonLetterI extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-i')) {
  customElements.define('dile-tabler-icon-hexagon-letter-i', DileIconlibHexagonLetterI);
}
