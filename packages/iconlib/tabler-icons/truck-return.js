...
export class DileIconlibTruckReturn extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-truck-return')) {
  customElements.define('dile-tabler-icon-truck-return', DileIconlibTruckReturn);
}
