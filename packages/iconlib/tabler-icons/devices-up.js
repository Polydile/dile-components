...
export class DileIconlibDevicesUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-up')) {
  customElements.define('dile-tabler-icon-devices-up', DileIconlibDevicesUp);
}
