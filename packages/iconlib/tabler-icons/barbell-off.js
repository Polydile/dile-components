...
export class DileIconlibBarbellOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-barbell-off')) {
  customElements.define('dile-tabler-icon-barbell-off', DileIconlibBarbellOff);
}
