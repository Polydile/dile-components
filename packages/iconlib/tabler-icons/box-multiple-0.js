...
export class DileIconlibBoxMultiple0 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-box-multiple-0')) {
  customElements.define('dile-tabler-icon-box-multiple-0', DileIconlibBoxMultiple0);
}
