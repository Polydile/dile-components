...
export class DileIconlibBathOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bath-off')) {
  customElements.define('dile-tabler-icon-bath-off', DileIconlibBathOff);
}
