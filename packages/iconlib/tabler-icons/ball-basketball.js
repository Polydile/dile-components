...
export class DileIconlibBallBasketball extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ball-basketball')) {
  customElements.define('dile-tabler-icon-ball-basketball', DileIconlibBallBasketball);
}
