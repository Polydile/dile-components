...
export class DileIconlibLineScan extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-line-scan')) {
  customElements.define('dile-tabler-icon-line-scan', DileIconlibLineScan);
}
