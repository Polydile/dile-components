...
export class DileIconlibMapPinShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-pin-share')) {
  customElements.define('dile-tabler-icon-map-pin-share', DileIconlibMapPinShare);
}
