...
export class DileIconlibFocusCentered extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-focus-centered')) {
  customElements.define('dile-tabler-icon-focus-centered', DileIconlibFocusCentered);
}
