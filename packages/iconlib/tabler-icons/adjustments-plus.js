...
export class DileIconlibAdjustmentsPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-adjustments-plus')) {
  customElements.define('dile-tabler-icon-adjustments-plus', DileIconlibAdjustmentsPlus);
}
