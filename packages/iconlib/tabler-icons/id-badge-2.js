...
export class DileIconlibIdBadge2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-id-badge-2')) {
  customElements.define('dile-tabler-icon-id-badge-2', DileIconlibIdBadge2);
}
