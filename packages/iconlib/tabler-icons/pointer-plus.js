...
export class DileIconlibPointerPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pointer-plus')) {
  customElements.define('dile-tabler-icon-pointer-plus', DileIconlibPointerPlus);
}
