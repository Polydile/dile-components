...
export class DileIconlibDevicesPcOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-pc-off')) {
  customElements.define('dile-tabler-icon-devices-pc-off', DileIconlibDevicesPcOff);
}
