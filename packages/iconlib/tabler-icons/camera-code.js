...
export class DileIconlibCameraCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-camera-code')) {
  customElements.define('dile-tabler-icon-camera-code', DileIconlibCameraCode);
}
