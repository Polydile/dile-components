...
export class DileIconlibGradienter extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-gradienter')) {
  customElements.define('dile-tabler-icon-gradienter', DileIconlibGradienter);
}
