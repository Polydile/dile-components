...
export class DileIconlibNumber99Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-99-small')) {
  customElements.define('dile-tabler-icon-number-99-small', DileIconlibNumber99Small);
}
