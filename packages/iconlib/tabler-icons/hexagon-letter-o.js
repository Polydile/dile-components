...
export class DileIconlibHexagonLetterO extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-o')) {
  customElements.define('dile-tabler-icon-hexagon-letter-o', DileIconlibHexagonLetterO);
}
