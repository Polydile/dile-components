...
export class DileIconlibClick extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-click')) {
  customElements.define('dile-tabler-icon-click', DileIconlibClick);
}
