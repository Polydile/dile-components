...
export class DileIconlibServerless extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-serverless')) {
  customElements.define('dile-tabler-icon-serverless', DileIconlibServerless);
}
