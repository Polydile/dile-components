...
export class DileIconlibDeviceImacShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-imac-share')) {
  customElements.define('dile-tabler-icon-device-imac-share', DileIconlibDeviceImacShare);
}
