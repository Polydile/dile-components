...
export class DileIconlibAdjustmentsX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-adjustments-x')) {
  customElements.define('dile-tabler-icon-adjustments-x', DileIconlibAdjustmentsX);
}
