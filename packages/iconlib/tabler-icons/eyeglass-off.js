...
export class DileIconlibEyeglassOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eyeglass-off')) {
  customElements.define('dile-tabler-icon-eyeglass-off', DileIconlibEyeglassOff);
}
