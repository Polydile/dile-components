...
export class DileIconlibLaurelWreath2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-laurel-wreath-2')) {
  customElements.define('dile-tabler-icon-laurel-wreath-2', DileIconlibLaurelWreath2);
}
