...
export class DileIconlibNews extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-news')) {
  customElements.define('dile-tabler-icon-news', DileIconlibNews);
}
