...
export class DileIconlibMessage2Down extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-2-down')) {
  customElements.define('dile-tabler-icon-message-2-down', DileIconlibMessage2Down);
}
