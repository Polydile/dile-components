...
export class DileIconlibMessage2Share extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-2-share')) {
  customElements.define('dile-tabler-icon-message-2-share', DileIconlibMessage2Share);
}
