...
export class DileIconlibBadgeTm extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-badge-tm')) {
  customElements.define('dile-tabler-icon-badge-tm', DileIconlibBadgeTm);
}
