...
export class DileIconlibDatabaseSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-database-search')) {
  customElements.define('dile-tabler-icon-database-search', DileIconlibDatabaseSearch);
}
