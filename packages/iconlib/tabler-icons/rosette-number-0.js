...
export class DileIconlibRosetteNumber0 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rosette-number-0')) {
  customElements.define('dile-tabler-icon-rosette-number-0', DileIconlibRosetteNumber0);
}
