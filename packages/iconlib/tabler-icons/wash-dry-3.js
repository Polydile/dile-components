...
export class DileIconlibWashDry3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-wash-dry-3')) {
  customElements.define('dile-tabler-icon-wash-dry-3', DileIconlibWashDry3);
}
