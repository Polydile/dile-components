...
export class DileIconlibFileCodeFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-code-filled')) {
  customElements.define('dile-tabler-icon-file-code-filled', DileIconlibFileCodeFilled);
}
