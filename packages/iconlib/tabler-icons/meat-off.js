...
export class DileIconlibMeatOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-meat-off')) {
  customElements.define('dile-tabler-icon-meat-off', DileIconlibMeatOff);
}
