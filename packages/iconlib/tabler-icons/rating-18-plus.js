...
export class DileIconlibRating18Plus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rating-18-plus')) {
  customElements.define('dile-tabler-icon-rating-18-plus', DileIconlibRating18Plus);
}
