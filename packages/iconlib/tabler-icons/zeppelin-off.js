...
export class DileIconlibZeppelinOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-zeppelin-off')) {
  customElements.define('dile-tabler-icon-zeppelin-off', DileIconlibZeppelinOff);
}
