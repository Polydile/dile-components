...
export class DileIconlibDeviceIpadPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-ipad-pin')) {
  customElements.define('dile-tabler-icon-device-ipad-pin', DileIconlibDeviceIpadPin);
}
