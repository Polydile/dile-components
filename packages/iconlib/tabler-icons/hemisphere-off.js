...
export class DileIconlibHemisphereOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hemisphere-off')) {
  customElements.define('dile-tabler-icon-hemisphere-off', DileIconlibHemisphereOff);
}
