...
export class DileIconlibEyeExclamation extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-exclamation')) {
  customElements.define('dile-tabler-icon-eye-exclamation', DileIconlibEyeExclamation);
}
