...
export class DileIconlibBowl extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bowl')) {
  customElements.define('dile-tabler-icon-bowl', DileIconlibBowl);
}
