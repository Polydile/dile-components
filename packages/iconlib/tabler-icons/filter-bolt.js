...
export class DileIconlibFilterBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-bolt')) {
  customElements.define('dile-tabler-icon-filter-bolt', DileIconlibFilterBolt);
}
