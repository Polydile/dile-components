...
export class DileIconlibFilterCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-check')) {
  customElements.define('dile-tabler-icon-filter-check', DileIconlibFilterCheck);
}
