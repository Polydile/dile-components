...
export class DileIconlibSquareNumber3Filled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-number-3-filled')) {
  customElements.define('dile-tabler-icon-square-number-3-filled', DileIconlibSquareNumber3Filled);
}
