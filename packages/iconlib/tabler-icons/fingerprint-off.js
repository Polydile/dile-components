...
export class DileIconlibFingerprintOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-fingerprint-off')) {
  customElements.define('dile-tabler-icon-fingerprint-off', DileIconlibFingerprintOff);
}
