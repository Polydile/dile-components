...
export class DileIconlibPhotoBitcoin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-bitcoin')) {
  customElements.define('dile-tabler-icon-photo-bitcoin', DileIconlibPhotoBitcoin);
}
