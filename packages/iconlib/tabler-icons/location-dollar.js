...
export class DileIconlibLocationDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-location-dollar')) {
  customElements.define('dile-tabler-icon-location-dollar', DileIconlibLocationDollar);
}
