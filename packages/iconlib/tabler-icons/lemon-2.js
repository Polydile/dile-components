...
export class DileIconlibLemon2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lemon-2')) {
  customElements.define('dile-tabler-icon-lemon-2', DileIconlibLemon2);
}
