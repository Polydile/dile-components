...
export class DileIconlibCreditCardHand extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-credit-card-hand')) {
  customElements.define('dile-tabler-icon-credit-card-hand', DileIconlibCreditCardHand);
}
