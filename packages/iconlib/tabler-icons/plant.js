...
export class DileIconlibPlant extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-plant')) {
  customElements.define('dile-tabler-icon-plant', DileIconlibPlant);
}
