...
export class DileIconlibBuildingMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-building-minus')) {
  customElements.define('dile-tabler-icon-building-minus', DileIconlibBuildingMinus);
}
