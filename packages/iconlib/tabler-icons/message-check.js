...
export class DileIconlibMessageCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-check')) {
  customElements.define('dile-tabler-icon-message-check', DileIconlibMessageCheck);
}
