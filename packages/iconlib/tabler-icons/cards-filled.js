...
export class DileIconlibCardsFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cards-filled')) {
  customElements.define('dile-tabler-icon-cards-filled', DileIconlibCardsFilled);
}
