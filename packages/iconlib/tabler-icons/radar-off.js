...
export class DileIconlibRadarOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-radar-off')) {
  customElements.define('dile-tabler-icon-radar-off', DileIconlibRadarOff);
}
