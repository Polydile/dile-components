...
export class DileIconlibNumber36Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-36-small')) {
  customElements.define('dile-tabler-icon-number-36-small', DileIconlibNumber36Small);
}
