...
export class DileIconlibSmartHome extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-smart-home')) {
  customElements.define('dile-tabler-icon-smart-home', DileIconlibSmartHome);
}
