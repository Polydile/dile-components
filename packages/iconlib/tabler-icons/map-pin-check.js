...
export class DileIconlibMapPinCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-pin-check')) {
  customElements.define('dile-tabler-icon-map-pin-check', DileIconlibMapPinCheck);
}
