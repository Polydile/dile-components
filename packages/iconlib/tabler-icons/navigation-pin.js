...
export class DileIconlibNavigationPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-navigation-pin')) {
  customElements.define('dile-tabler-icon-navigation-pin', DileIconlibNavigationPin);
}
