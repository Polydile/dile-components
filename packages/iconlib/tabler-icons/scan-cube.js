...
export class DileIconlibScanCube extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-scan-cube')) {
  customElements.define('dile-tabler-icon-scan-cube', DileIconlibScanCube);
}
