...
export class DileIconlibArrowMerge extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-arrow-merge')) {
  customElements.define('dile-tabler-icon-arrow-merge', DileIconlibArrowMerge);
}
