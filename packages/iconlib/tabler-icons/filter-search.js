...
export class DileIconlibFilterSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-search')) {
  customElements.define('dile-tabler-icon-filter-search', DileIconlibFilterSearch);
}
