...
export class DileIconlibHelpHexagon extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-help-hexagon')) {
  customElements.define('dile-tabler-icon-help-hexagon', DileIconlibHelpHexagon);
}
