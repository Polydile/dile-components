...
export class DileIconlibNumber30Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-30-small')) {
  customElements.define('dile-tabler-icon-number-30-small', DileIconlibNumber30Small);
}
