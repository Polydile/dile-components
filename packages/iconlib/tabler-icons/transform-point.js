...
export class DileIconlibTransformPoint extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-transform-point')) {
  customElements.define('dile-tabler-icon-transform-point', DileIconlibTransformPoint);
}
