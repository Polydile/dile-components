...
export class DileIconlibPlayCard2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-2')) {
  customElements.define('dile-tabler-icon-play-card-2', DileIconlibPlayCard2);
}
