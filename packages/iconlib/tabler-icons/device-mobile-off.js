...
export class DileIconlibDeviceMobileOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-mobile-off')) {
  customElements.define('dile-tabler-icon-device-mobile-off', DileIconlibDeviceMobileOff);
}
