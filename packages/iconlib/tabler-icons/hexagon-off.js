...
export class DileIconlibHexagonOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-off')) {
  customElements.define('dile-tabler-icon-hexagon-off', DileIconlibHexagonOff);
}
