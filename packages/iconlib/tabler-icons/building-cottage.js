...
export class DileIconlibBuildingCottage extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-building-cottage')) {
  customElements.define('dile-tabler-icon-building-cottage', DileIconlibBuildingCottage);
}
