...
export class DileIconlibWorldShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-share')) {
  customElements.define('dile-tabler-icon-world-share', DileIconlibWorldShare);
}
