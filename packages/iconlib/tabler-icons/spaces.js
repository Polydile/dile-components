...
export class DileIconlibSpaces extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-spaces')) {
  customElements.define('dile-tabler-icon-spaces', DileIconlibSpaces);
}
