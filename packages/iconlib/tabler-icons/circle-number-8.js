...
export class DileIconlibCircleNumber8 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-circle-number-8')) {
  customElements.define('dile-tabler-icon-circle-number-8', DileIconlibCircleNumber8);
}
