...
export class DileIconlibUserScan extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-user-scan')) {
  customElements.define('dile-tabler-icon-user-scan', DileIconlibUserScan);
}
