...
export class DileIconlibPaintFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-paint-filled')) {
  customElements.define('dile-tabler-icon-paint-filled', DileIconlibPaintFilled);
}
