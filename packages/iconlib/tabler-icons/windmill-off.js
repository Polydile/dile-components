...
export class DileIconlibWindmillOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-windmill-off')) {
  customElements.define('dile-tabler-icon-windmill-off', DileIconlibWindmillOff);
}
