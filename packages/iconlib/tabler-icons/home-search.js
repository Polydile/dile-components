...
export class DileIconlibHomeSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-search')) {
  customElements.define('dile-tabler-icon-home-search', DileIconlibHomeSearch);
}
