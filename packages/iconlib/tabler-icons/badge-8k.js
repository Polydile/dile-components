...
export class DileIconlibBadge8k extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-badge-8k')) {
  customElements.define('dile-tabler-icon-badge-8k', DileIconlibBadge8k);
}
