...
export class DileIconlibBorderTopPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-border-top-plus')) {
  customElements.define('dile-tabler-icon-border-top-plus', DileIconlibBorderTopPlus);
}
