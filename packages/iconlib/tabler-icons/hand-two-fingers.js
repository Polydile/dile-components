...
export class DileIconlibHandTwoFingers extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hand-two-fingers')) {
  customElements.define('dile-tabler-icon-hand-two-fingers', DileIconlibHandTwoFingers);
}
