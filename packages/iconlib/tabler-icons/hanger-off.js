...
export class DileIconlibHangerOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hanger-off')) {
  customElements.define('dile-tabler-icon-hanger-off', DileIconlibHangerOff);
}
