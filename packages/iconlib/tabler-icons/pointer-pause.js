...
export class DileIconlibPointerPause extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pointer-pause')) {
  customElements.define('dile-tabler-icon-pointer-pause', DileIconlibPointerPause);
}
