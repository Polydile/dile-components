...
export class DileIconlibMapPinStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-pin-star')) {
  customElements.define('dile-tabler-icon-map-pin-star', DileIconlibMapPinStar);
}
