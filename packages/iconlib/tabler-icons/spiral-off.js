...
export class DileIconlibSpiralOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-spiral-off')) {
  customElements.define('dile-tabler-icon-spiral-off', DileIconlibSpiralOff);
}
