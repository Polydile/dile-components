...
export class DileIconlibDropletQuestion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-question')) {
  customElements.define('dile-tabler-icon-droplet-question', DileIconlibDropletQuestion);
}
