...
export class DileIconlibSquareF3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-f3')) {
  customElements.define('dile-tabler-icon-square-f3', DileIconlibSquareF3);
}
