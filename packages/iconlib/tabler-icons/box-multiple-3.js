...
export class DileIconlibBoxMultiple3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-box-multiple-3')) {
  customElements.define('dile-tabler-icon-box-multiple-3', DileIconlibBoxMultiple3);
}
