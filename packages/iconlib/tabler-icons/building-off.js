...
export class DileIconlibBuildingOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-building-off')) {
  customElements.define('dile-tabler-icon-building-off', DileIconlibBuildingOff);
}
