...
export class DileIconlibMoodDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-dollar')) {
  customElements.define('dile-tabler-icon-mood-dollar', DileIconlibMoodDollar);
}
