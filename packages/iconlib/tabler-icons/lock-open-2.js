...
export class DileIconlibLockOpen2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-open-2')) {
  customElements.define('dile-tabler-icon-lock-open-2', DileIconlibLockOpen2);
}
