...
export class DileIconlibArmchair2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-armchair-2')) {
  customElements.define('dile-tabler-icon-armchair-2', DileIconlibArmchair2);
}
