...
export class DileIconlibHeartsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hearts-off')) {
  customElements.define('dile-tabler-icon-hearts-off', DileIconlibHeartsOff);
}
