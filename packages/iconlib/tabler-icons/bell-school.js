...
export class DileIconlibBellSchool extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-school')) {
  customElements.define('dile-tabler-icon-bell-school', DileIconlibBellSchool);
}
