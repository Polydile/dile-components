...
export class DileIconlibQuoteOpen extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-quote-open')) {
  customElements.define('dile-tabler-icon-quote-open', DileIconlibQuoteOpen);
}
