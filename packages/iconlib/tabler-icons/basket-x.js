...
export class DileIconlibBasketX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-basket-x')) {
  customElements.define('dile-tabler-icon-basket-x', DileIconlibBasketX);
}
