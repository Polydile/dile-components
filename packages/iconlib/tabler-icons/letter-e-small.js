...
export class DileIconlibLetterESmall extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-letter-e-small')) {
  customElements.define('dile-tabler-icon-letter-e-small', DileIconlibLetterESmall);
}
