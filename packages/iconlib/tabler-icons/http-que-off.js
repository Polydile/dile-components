...
export class DileIconlibHttpQueOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-http-que-off')) {
  customElements.define('dile-tabler-icon-http-que-off', DileIconlibHttpQueOff);
}
