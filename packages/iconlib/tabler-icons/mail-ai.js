...
export class DileIconlibMailAi extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mail-ai')) {
  customElements.define('dile-tabler-icon-mail-ai', DileIconlibMailAi);
}
