...
export class DileIconlibBoxModel2Off extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-box-model-2-off')) {
  customElements.define('dile-tabler-icon-box-model-2-off', DileIconlibBoxModel2Off);
}
