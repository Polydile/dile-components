...
export class DileIconlibWallOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-wall-off')) {
  customElements.define('dile-tabler-icon-wall-off', DileIconlibWallOff);
}
