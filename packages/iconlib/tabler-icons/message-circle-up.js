...
export class DileIconlibMessageCircleUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-circle-up')) {
  customElements.define('dile-tabler-icon-message-circle-up', DileIconlibMessageCircleUp);
}
