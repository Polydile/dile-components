...
export class DileIconlibRubberStamp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rubber-stamp')) {
  customElements.define('dile-tabler-icon-rubber-stamp', DileIconlibRubberStamp);
}
