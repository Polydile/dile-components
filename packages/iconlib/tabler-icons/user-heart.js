...
export class DileIconlibUserHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-user-heart')) {
  customElements.define('dile-tabler-icon-user-heart', DileIconlibUserHeart);
}
