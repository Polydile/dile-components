...
export class DileIconlibPokerChip extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-poker-chip')) {
  customElements.define('dile-tabler-icon-poker-chip', DileIconlibPokerChip);
}
