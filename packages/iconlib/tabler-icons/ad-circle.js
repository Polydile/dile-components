...
export class DileIconlibAdCircle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ad-circle')) {
  customElements.define('dile-tabler-icon-ad-circle', DileIconlibAdCircle);
}
