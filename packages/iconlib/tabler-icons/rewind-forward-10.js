...
export class DileIconlibRewindForward10 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rewind-forward-10')) {
  customElements.define('dile-tabler-icon-rewind-forward-10', DileIconlibRewindForward10);
}
