...
export class DileIconlibSoupOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-soup-off')) {
  customElements.define('dile-tabler-icon-soup-off', DileIconlibSoupOff);
}
