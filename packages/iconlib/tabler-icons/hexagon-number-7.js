...
export class DileIconlibHexagonNumber7 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-number-7')) {
  customElements.define('dile-tabler-icon-hexagon-number-7', DileIconlibHexagonNumber7);
}
