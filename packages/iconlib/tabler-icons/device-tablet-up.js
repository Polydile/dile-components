...
export class DileIconlibDeviceTabletUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-tablet-up')) {
  customElements.define('dile-tabler-icon-device-tablet-up', DileIconlibDeviceTabletUp);
}
