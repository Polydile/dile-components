...
export class DileIconlibTrophyFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-trophy-filled')) {
  customElements.define('dile-tabler-icon-trophy-filled', DileIconlibTrophyFilled);
}
