...
export class DileIconlibEyeCancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-cancel')) {
  customElements.define('dile-tabler-icon-eye-cancel', DileIconlibEyeCancel);
}
