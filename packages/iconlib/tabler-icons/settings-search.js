...
export class DileIconlibSettingsSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-settings-search')) {
  customElements.define('dile-tabler-icon-settings-search', DileIconlibSettingsSearch);
}
