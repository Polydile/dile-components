...
export class DileIconlibEyeCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-code')) {
  customElements.define('dile-tabler-icon-eye-code', DileIconlibEyeCode);
}
