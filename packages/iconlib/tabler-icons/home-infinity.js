...
export class DileIconlibHomeInfinity extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-infinity')) {
  customElements.define('dile-tabler-icon-home-infinity', DileIconlibHomeInfinity);
}
