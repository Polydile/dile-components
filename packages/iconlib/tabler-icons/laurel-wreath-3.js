...
export class DileIconlibLaurelWreath3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-laurel-wreath-3')) {
  customElements.define('dile-tabler-icon-laurel-wreath-3', DileIconlibLaurelWreath3);
}
