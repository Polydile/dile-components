...
export class DileIconlibCrownOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-crown-off')) {
  customElements.define('dile-tabler-icon-crown-off', DileIconlibCrownOff);
}
