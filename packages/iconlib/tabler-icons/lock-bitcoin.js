...
export class DileIconlibLockBitcoin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-bitcoin')) {
  customElements.define('dile-tabler-icon-lock-bitcoin', DileIconlibLockBitcoin);
}
