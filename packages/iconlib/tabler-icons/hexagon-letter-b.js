...
export class DileIconlibHexagonLetterB extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-b')) {
  customElements.define('dile-tabler-icon-hexagon-letter-b', DileIconlibHexagonLetterB);
}
