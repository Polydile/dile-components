...
export class DileIconlibImageGeneration extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-image-generation')) {
  customElements.define('dile-tabler-icon-image-generation', DileIconlibImageGeneration);
}
