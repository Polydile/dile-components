...
export class DileIconlibSquareNumber3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-number-3')) {
  customElements.define('dile-tabler-icon-square-number-3', DileIconlibSquareNumber3);
}
