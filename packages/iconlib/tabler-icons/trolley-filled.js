...
export class DileIconlibTrolleyFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-trolley-filled')) {
  customElements.define('dile-tabler-icon-trolley-filled', DileIconlibTrolleyFilled);
}
