...
export class DileIconlibCloudHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cloud-heart')) {
  customElements.define('dile-tabler-icon-cloud-heart', DileIconlibCloudHeart);
}
