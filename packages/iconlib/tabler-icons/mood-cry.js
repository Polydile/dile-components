...
export class DileIconlibMoodCry extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-cry')) {
  customElements.define('dile-tabler-icon-mood-cry', DileIconlibMoodCry);
}
