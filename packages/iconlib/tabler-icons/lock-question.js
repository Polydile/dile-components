...
export class DileIconlibLockQuestion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-question')) {
  customElements.define('dile-tabler-icon-lock-question', DileIconlibLockQuestion);
}
