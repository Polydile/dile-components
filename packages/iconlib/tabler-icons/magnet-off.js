...
export class DileIconlibMagnetOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-magnet-off')) {
  customElements.define('dile-tabler-icon-magnet-off', DileIconlibMagnetOff);
}
