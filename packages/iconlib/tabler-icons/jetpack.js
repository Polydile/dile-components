...
export class DileIconlibJetpack extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-jetpack')) {
  customElements.define('dile-tabler-icon-jetpack', DileIconlibJetpack);
}
