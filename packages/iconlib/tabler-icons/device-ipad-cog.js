...
export class DileIconlibDeviceIpadCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-ipad-cog')) {
  customElements.define('dile-tabler-icon-device-ipad-cog', DileIconlibDeviceIpadCog);
}
