...
export class DileIconlibVaccine extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-vaccine')) {
  customElements.define('dile-tabler-icon-vaccine', DileIconlibVaccine);
}
