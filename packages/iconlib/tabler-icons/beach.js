...
export class DileIconlibBeach extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-beach')) {
  customElements.define('dile-tabler-icon-beach', DileIconlibBeach);
}
