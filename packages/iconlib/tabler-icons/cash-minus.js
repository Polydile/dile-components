...
export class DileIconlibCashMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cash-minus')) {
  customElements.define('dile-tabler-icon-cash-minus', DileIconlibCashMinus);
}
