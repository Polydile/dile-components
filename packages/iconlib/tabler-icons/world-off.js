...
export class DileIconlibWorldOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-off')) {
  customElements.define('dile-tabler-icon-world-off', DileIconlibWorldOff);
}
