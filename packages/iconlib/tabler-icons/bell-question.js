...
export class DileIconlibBellQuestion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-question')) {
  customElements.define('dile-tabler-icon-bell-question', DileIconlibBellQuestion);
}
