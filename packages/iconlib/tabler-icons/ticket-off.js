...
export class DileIconlibTicketOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ticket-off')) {
  customElements.define('dile-tabler-icon-ticket-off', DileIconlibTicketOff);
}
