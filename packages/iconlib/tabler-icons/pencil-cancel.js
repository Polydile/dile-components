...
export class DileIconlibPencilCancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pencil-cancel')) {
  customElements.define('dile-tabler-icon-pencil-cancel', DileIconlibPencilCancel);
}
