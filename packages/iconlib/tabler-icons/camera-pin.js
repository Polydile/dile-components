...
export class DileIconlibCameraPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-camera-pin')) {
  customElements.define('dile-tabler-icon-camera-pin', DileIconlibCameraPin);
}
