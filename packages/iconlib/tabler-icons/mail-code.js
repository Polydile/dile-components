...
export class DileIconlibMailCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mail-code')) {
  customElements.define('dile-tabler-icon-mail-code', DileIconlibMailCode);
}
