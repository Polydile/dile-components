...
export class DileIconlibAtomOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-atom-off')) {
  customElements.define('dile-tabler-icon-atom-off', DileIconlibAtomOff);
}
