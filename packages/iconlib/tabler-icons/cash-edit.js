...
export class DileIconlibCashEdit extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cash-edit')) {
  customElements.define('dile-tabler-icon-cash-edit', DileIconlibCashEdit);
}
