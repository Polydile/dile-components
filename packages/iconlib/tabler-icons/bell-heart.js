...
export class DileIconlibBellHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-heart')) {
  customElements.define('dile-tabler-icon-bell-heart', DileIconlibBellHeart);
}
