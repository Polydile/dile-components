...
export class DileIconlibArrowsSplit2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-arrows-split-2')) {
  customElements.define('dile-tabler-icon-arrows-split-2', DileIconlibArrowsSplit2);
}
