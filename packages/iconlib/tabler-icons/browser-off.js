...
export class DileIconlibBrowserOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-browser-off')) {
  customElements.define('dile-tabler-icon-browser-off', DileIconlibBrowserOff);
}
