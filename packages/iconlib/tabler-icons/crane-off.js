...
export class DileIconlibCraneOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-crane-off')) {
  customElements.define('dile-tabler-icon-crane-off', DileIconlibCraneOff);
}
