...
export class DileIconlibMathSymbols extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-math-symbols')) {
  customElements.define('dile-tabler-icon-math-symbols', DileIconlibMathSymbols);
}
