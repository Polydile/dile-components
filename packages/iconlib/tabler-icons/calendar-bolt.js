...
export class DileIconlibCalendarBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-calendar-bolt')) {
  customElements.define('dile-tabler-icon-calendar-bolt', DileIconlibCalendarBolt);
}
