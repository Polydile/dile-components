...
export class DileIconlibBubble extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bubble')) {
  customElements.define('dile-tabler-icon-bubble', DileIconlibBubble);
}
