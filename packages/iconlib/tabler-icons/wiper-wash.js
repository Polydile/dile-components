...
export class DileIconlibWiperWash extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-wiper-wash')) {
  customElements.define('dile-tabler-icon-wiper-wash', DileIconlibWiperWash);
}
