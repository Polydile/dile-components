...
export class DileIconlibSquareLetterB extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-letter-b')) {
  customElements.define('dile-tabler-icon-square-letter-b', DileIconlibSquareLetterB);
}
