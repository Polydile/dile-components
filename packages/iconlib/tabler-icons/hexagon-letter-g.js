...
export class DileIconlibHexagonLetterG extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-g')) {
  customElements.define('dile-tabler-icon-hexagon-letter-g', DileIconlibHexagonLetterG);
}
