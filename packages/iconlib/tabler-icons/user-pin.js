...
export class DileIconlibUserPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-user-pin')) {
  customElements.define('dile-tabler-icon-user-pin', DileIconlibUserPin);
}
