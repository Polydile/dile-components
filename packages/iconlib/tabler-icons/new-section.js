...
export class DileIconlibNewSection extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-new-section')) {
  customElements.define('dile-tabler-icon-new-section', DileIconlibNewSection);
}
