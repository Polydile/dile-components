...
export class DileIconlibScooterElectric extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-scooter-electric')) {
  customElements.define('dile-tabler-icon-scooter-electric', DileIconlibScooterElectric);
}
