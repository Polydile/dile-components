...
export class DileIconlibMeeple extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-meeple')) {
  customElements.define('dile-tabler-icon-meeple', DileIconlibMeeple);
}
