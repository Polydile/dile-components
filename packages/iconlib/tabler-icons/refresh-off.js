...
export class DileIconlibRefreshOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-refresh-off')) {
  customElements.define('dile-tabler-icon-refresh-off', DileIconlibRefreshOff);
}
