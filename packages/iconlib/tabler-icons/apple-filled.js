...
export class DileIconlibAppleFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-apple-filled')) {
  customElements.define('dile-tabler-icon-apple-filled', DileIconlibAppleFilled);
}
