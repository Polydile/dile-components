...
export class DileIconlibHexagonNumber6 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-number-6')) {
  customElements.define('dile-tabler-icon-hexagon-number-6', DileIconlibHexagonNumber6);
}
