...
export class DileIconlibSquareF4 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-f4')) {
  customElements.define('dile-tabler-icon-square-f4', DileIconlibSquareF4);
}
