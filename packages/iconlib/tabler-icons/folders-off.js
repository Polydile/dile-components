...
export class DileIconlibFoldersOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-folders-off')) {
  customElements.define('dile-tabler-icon-folders-off', DileIconlibFoldersOff);
}
