...
export class DileIconlibCastOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cast-off')) {
  customElements.define('dile-tabler-icon-cast-off', DileIconlibCastOff);
}
