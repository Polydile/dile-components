...
export class DileIconlibMovieOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-movie-off')) {
  customElements.define('dile-tabler-icon-movie-off', DileIconlibMovieOff);
}
