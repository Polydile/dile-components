...
export class DileIconlibEyeBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-bolt')) {
  customElements.define('dile-tabler-icon-eye-bolt', DileIconlibEyeBolt);
}
