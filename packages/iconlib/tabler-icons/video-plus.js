...
export class DileIconlibVideoPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-video-plus')) {
  customElements.define('dile-tabler-icon-video-plus', DileIconlibVideoPlus);
}
