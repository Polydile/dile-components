...
export class DileIconlibWorldUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-up')) {
  customElements.define('dile-tabler-icon-world-up', DileIconlibWorldUp);
}
