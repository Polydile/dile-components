...
export class DileIconlibDevicesX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-x')) {
  customElements.define('dile-tabler-icon-devices-x', DileIconlibDevicesX);
}
