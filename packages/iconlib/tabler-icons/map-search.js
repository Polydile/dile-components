...
export class DileIconlibMapSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-search')) {
  customElements.define('dile-tabler-icon-map-search', DileIconlibMapSearch);
}
