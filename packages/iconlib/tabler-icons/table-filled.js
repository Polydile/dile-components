...
export class DileIconlibTableFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-table-filled')) {
  customElements.define('dile-tabler-icon-table-filled', DileIconlibTableFilled);
}
