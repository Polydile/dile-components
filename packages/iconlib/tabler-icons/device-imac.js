...
export class DileIconlibDeviceImac extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-imac')) {
  customElements.define('dile-tabler-icon-device-imac', DileIconlibDeviceImac);
}
