...
export class DileIconlibTableDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-table-down')) {
  customElements.define('dile-tabler-icon-table-down', DileIconlibTableDown);
}
