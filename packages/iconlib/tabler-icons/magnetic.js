...
export class DileIconlibMagnetic extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-magnetic')) {
  customElements.define('dile-tabler-icon-magnetic', DileIconlibMagnetic);
}
