...
export class DileIconlibBeachOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-beach-off')) {
  customElements.define('dile-tabler-icon-beach-off', DileIconlibBeachOff);
}
