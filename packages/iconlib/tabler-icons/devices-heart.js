...
export class DileIconlibDevicesHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-heart')) {
  customElements.define('dile-tabler-icon-devices-heart', DileIconlibDevicesHeart);
}
