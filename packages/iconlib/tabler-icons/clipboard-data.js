...
export class DileIconlibClipboardData extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-clipboard-data')) {
  customElements.define('dile-tabler-icon-clipboard-data', DileIconlibClipboardData);
}
