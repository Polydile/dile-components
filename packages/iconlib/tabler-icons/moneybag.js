...
export class DileIconlibMoneybag extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-moneybag')) {
  customElements.define('dile-tabler-icon-moneybag', DileIconlibMoneybag);
}
