...
export class DileIconlibNumber38Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-38-small')) {
  customElements.define('dile-tabler-icon-number-38-small', DileIconlibNumber38Small);
}
