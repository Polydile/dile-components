...
export class DileIconlibPaletteOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-palette-off')) {
  customElements.define('dile-tabler-icon-palette-off', DileIconlibPaletteOff);
}
