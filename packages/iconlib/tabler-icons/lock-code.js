...
export class DileIconlibLockCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-code')) {
  customElements.define('dile-tabler-icon-lock-code', DileIconlibLockCode);
}
