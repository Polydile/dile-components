...
export class DileIconlibBeerOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-beer-off')) {
  customElements.define('dile-tabler-icon-beer-off', DileIconlibBeerOff);
}
