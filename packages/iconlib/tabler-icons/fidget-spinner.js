...
export class DileIconlibFidgetSpinner extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-fidget-spinner')) {
  customElements.define('dile-tabler-icon-fidget-spinner', DileIconlibFidgetSpinner);
}
