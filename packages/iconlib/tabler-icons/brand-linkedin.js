...
export class DileIconlibBrandLinkedin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-brand-linkedin')) {
  customElements.define('dile-tabler-icon-brand-linkedin', DileIconlibBrandLinkedin);
}
