...
export class DileIconlibCurrencyEuroOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-currency-euro-off')) {
  customElements.define('dile-tabler-icon-currency-euro-off', DileIconlibCurrencyEuroOff);
}
