...
export class DileIconlibBatterySpark extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-battery-spark')) {
  customElements.define('dile-tabler-icon-battery-spark', DileIconlibBatterySpark);
}
