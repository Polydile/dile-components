...
export class DileIconlibFlagBitcoin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flag-bitcoin')) {
  customElements.define('dile-tabler-icon-flag-bitcoin', DileIconlibFlagBitcoin);
}
