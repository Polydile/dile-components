...
export class DileIconlibLetterHSmall extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-letter-h-small')) {
  customElements.define('dile-tabler-icon-letter-h-small', DileIconlibLetterHSmall);
}
