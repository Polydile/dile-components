...
export class DileIconlibDeviceLandlinePhone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-landline-phone')) {
  customElements.define('dile-tabler-icon-device-landline-phone', DileIconlibDeviceLandlinePhone);
}
