...
export class DileIconlibSettingsPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-settings-plus')) {
  customElements.define('dile-tabler-icon-settings-plus', DileIconlibSettingsPlus);
}
