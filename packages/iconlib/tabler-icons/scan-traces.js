...
export class DileIconlibScanTraces extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-scan-traces')) {
  customElements.define('dile-tabler-icon-scan-traces', DileIconlibScanTraces);
}
