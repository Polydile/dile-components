...
export class DileIconlibOctahedron extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-octahedron')) {
  customElements.define('dile-tabler-icon-octahedron', DileIconlibOctahedron);
}
