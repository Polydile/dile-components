...
export class DileIconlibExplicitOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-explicit-off')) {
  customElements.define('dile-tabler-icon-explicit-off', DileIconlibExplicitOff);
}
