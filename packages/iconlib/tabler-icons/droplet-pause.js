...
export class DileIconlibDropletPause extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-pause')) {
  customElements.define('dile-tabler-icon-droplet-pause', DileIconlibDropletPause);
}
