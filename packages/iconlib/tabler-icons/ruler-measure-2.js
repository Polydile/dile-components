...
export class DileIconlibRulerMeasure2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ruler-measure-2')) {
  customElements.define('dile-tabler-icon-ruler-measure-2', DileIconlibRulerMeasure2);
}
