...
export class DileIconlibBadgeAr extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-badge-ar')) {
  customElements.define('dile-tabler-icon-badge-ar', DileIconlibBadgeAr);
}
