...
export class DileIconlibPhotoFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-filled')) {
  customElements.define('dile-tabler-icon-photo-filled', DileIconlibPhotoFilled);
}
