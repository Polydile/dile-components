...
export class DileIconlibQuoteFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-quote-filled')) {
  customElements.define('dile-tabler-icon-quote-filled', DileIconlibQuoteFilled);
}
