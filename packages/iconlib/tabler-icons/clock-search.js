...
export class DileIconlibClockSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-clock-search')) {
  customElements.define('dile-tabler-icon-clock-search', DileIconlibClockSearch);
}
