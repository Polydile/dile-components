...
export class DileIconlibCoinEuroFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-coin-euro-filled')) {
  customElements.define('dile-tabler-icon-coin-euro-filled', DileIconlibCoinEuroFilled);
}
