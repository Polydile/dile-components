...
export class DileIconlibShapeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shape-off')) {
  customElements.define('dile-tabler-icon-shape-off', DileIconlibShapeOff);
}
