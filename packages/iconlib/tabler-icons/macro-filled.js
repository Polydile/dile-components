...
export class DileIconlibMacroFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-macro-filled')) {
  customElements.define('dile-tabler-icon-macro-filled', DileIconlibMacroFilled);
}
