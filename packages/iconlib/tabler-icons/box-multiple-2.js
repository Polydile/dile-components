...
export class DileIconlibBoxMultiple2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-box-multiple-2')) {
  customElements.define('dile-tabler-icon-box-multiple-2', DileIconlibBoxMultiple2);
}
