...
export class DileIconlibHexagonLetterY extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-y')) {
  customElements.define('dile-tabler-icon-hexagon-letter-y', DileIconlibHexagonLetterY);
}
