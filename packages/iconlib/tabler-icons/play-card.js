...
export class DileIconlibPlayCard extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card')) {
  customElements.define('dile-tabler-icon-play-card', DileIconlibPlayCard);
}
