...
export class DileIconlibLayersSelected extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-layers-selected')) {
  customElements.define('dile-tabler-icon-layers-selected', DileIconlibLayersSelected);
}
