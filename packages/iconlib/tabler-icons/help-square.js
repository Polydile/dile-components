...
export class DileIconlibHelpSquare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-help-square')) {
  customElements.define('dile-tabler-icon-help-square', DileIconlibHelpSquare);
}
