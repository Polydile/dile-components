...
export class DileIconlibHexagonLetterJ extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-j')) {
  customElements.define('dile-tabler-icon-hexagon-letter-j', DileIconlibHexagonLetterJ);
}
