...
export class DileIconlibAtom2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-atom-2')) {
  customElements.define('dile-tabler-icon-atom-2', DileIconlibAtom2);
}
