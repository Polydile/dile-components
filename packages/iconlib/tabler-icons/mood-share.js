...
export class DileIconlibMoodShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-share')) {
  customElements.define('dile-tabler-icon-mood-share', DileIconlibMoodShare);
}
