...
export class DileIconlibCellSignal5 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cell-signal-5')) {
  customElements.define('dile-tabler-icon-cell-signal-5', DileIconlibCellSignal5);
}
