...
export class DileIconlibMessageShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-share')) {
  customElements.define('dile-tabler-icon-message-share', DileIconlibMessageShare);
}
