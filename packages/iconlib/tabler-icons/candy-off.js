...
export class DileIconlibCandyOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-candy-off')) {
  customElements.define('dile-tabler-icon-candy-off', DileIconlibCandyOff);
}
