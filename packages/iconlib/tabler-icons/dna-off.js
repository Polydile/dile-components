...
export class DileIconlibDnaOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-dna-off')) {
  customElements.define('dile-tabler-icon-dna-off', DileIconlibDnaOff);
}
