...
export class DileIconlibMessageBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-bolt')) {
  customElements.define('dile-tabler-icon-message-bolt', DileIconlibMessageBolt);
}
