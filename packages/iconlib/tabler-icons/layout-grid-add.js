...
export class DileIconlibLayoutGridAdd extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-layout-grid-add')) {
  customElements.define('dile-tabler-icon-layout-grid-add', DileIconlibLayoutGridAdd);
}
