...
export class DileIconlibDevicesPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-pin')) {
  customElements.define('dile-tabler-icon-devices-pin', DileIconlibDevicesPin);
}
