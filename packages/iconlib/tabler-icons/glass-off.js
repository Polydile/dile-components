...
export class DileIconlibGlassOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-glass-off')) {
  customElements.define('dile-tabler-icon-glass-off', DileIconlibGlassOff);
}
