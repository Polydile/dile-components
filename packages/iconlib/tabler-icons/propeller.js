...
export class DileIconlibPropeller extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-propeller')) {
  customElements.define('dile-tabler-icon-propeller', DileIconlibPropeller);
}
