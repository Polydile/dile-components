...
export class DileIconlibBulbFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bulb-filled')) {
  customElements.define('dile-tabler-icon-bulb-filled', DileIconlibBulbFilled);
}
