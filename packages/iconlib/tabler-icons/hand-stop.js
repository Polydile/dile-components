...
export class DileIconlibHandStop extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hand-stop')) {
  customElements.define('dile-tabler-icon-hand-stop', DileIconlibHandStop);
}
