...
export class DileIconlibToolsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-tools-off')) {
  customElements.define('dile-tabler-icon-tools-off', DileIconlibToolsOff);
}
