...
export class DileIconlibIroningSteamOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ironing-steam-off')) {
  customElements.define('dile-tabler-icon-ironing-steam-off', DileIconlibIroningSteamOff);
}
