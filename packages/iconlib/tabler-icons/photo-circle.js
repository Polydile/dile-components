...
export class DileIconlibPhotoCircle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-circle')) {
  customElements.define('dile-tabler-icon-photo-circle', DileIconlibPhotoCircle);
}
