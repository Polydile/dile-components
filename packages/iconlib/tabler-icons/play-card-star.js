...
export class DileIconlibPlayCardStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-star')) {
  customElements.define('dile-tabler-icon-play-card-star', DileIconlibPlayCardStar);
}
