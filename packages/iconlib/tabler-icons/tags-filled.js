...
export class DileIconlibTagsFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-tags-filled')) {
  customElements.define('dile-tabler-icon-tags-filled', DileIconlibTagsFilled);
}
