...
export class DileIconlibAlarmOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-alarm-off')) {
  customElements.define('dile-tabler-icon-alarm-off', DileIconlibAlarmOff);
}
