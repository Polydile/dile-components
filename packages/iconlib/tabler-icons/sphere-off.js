...
export class DileIconlibSphereOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sphere-off')) {
  customElements.define('dile-tabler-icon-sphere-off', DileIconlibSphereOff);
}
