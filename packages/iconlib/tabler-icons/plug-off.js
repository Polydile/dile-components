...
export class DileIconlibPlugOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-plug-off')) {
  customElements.define('dile-tabler-icon-plug-off', DileIconlibPlugOff);
}
