...
export class DileIconlibPhotoSpark extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-spark')) {
  customElements.define('dile-tabler-icon-photo-spark', DileIconlibPhotoSpark);
}
