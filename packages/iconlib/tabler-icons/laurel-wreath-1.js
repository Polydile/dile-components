...
export class DileIconlibLaurelWreath1 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-laurel-wreath-1')) {
  customElements.define('dile-tabler-icon-laurel-wreath-1', DileIconlibLaurelWreath1);
}
