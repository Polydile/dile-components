...
export class DileIconlibFilterEdit extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-edit')) {
  customElements.define('dile-tabler-icon-filter-edit', DileIconlibFilterEdit);
}
