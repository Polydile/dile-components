...
export class DileIconlibNumber65Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-65-small')) {
  customElements.define('dile-tabler-icon-number-65-small', DileIconlibNumber65Small);
}
