...
export class DileIconlibHomeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-off')) {
  customElements.define('dile-tabler-icon-home-off', DileIconlibHomeOff);
}
