...
export class DileIconlibArrowsShuffle2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-arrows-shuffle-2')) {
  customElements.define('dile-tabler-icon-arrows-shuffle-2', DileIconlibArrowsShuffle2);
}
