...
export class DileIconlibDeviceImacSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-imac-search')) {
  customElements.define('dile-tabler-icon-device-imac-search', DileIconlibDeviceImacSearch);
}
