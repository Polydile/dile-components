...
export class DileIconlibArrowBigLeft extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-arrow-big-left')) {
  customElements.define('dile-tabler-icon-arrow-big-left', DileIconlibArrowBigLeft);
}
