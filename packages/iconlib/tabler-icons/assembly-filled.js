...
export class DileIconlibAssemblyFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-assembly-filled')) {
  customElements.define('dile-tabler-icon-assembly-filled', DileIconlibAssemblyFilled);
}
