...
export class DileIconlibVariablePlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-variable-plus')) {
  customElements.define('dile-tabler-icon-variable-plus', DileIconlibVariablePlus);
}
