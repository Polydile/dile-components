...
export class DileIconlibCloudDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cloud-down')) {
  customElements.define('dile-tabler-icon-cloud-down', DileIconlibCloudDown);
}
