...
export class DileIconlibGrill extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-grill')) {
  customElements.define('dile-tabler-icon-grill', DileIconlibGrill);
}
