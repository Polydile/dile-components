...
export class DileIconlibDevicesDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-down')) {
  customElements.define('dile-tabler-icon-devices-down', DileIconlibDevicesDown);
}
