...
export class DileIconlibAlbumOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-album-off')) {
  customElements.define('dile-tabler-icon-album-off', DileIconlibAlbumOff);
}
