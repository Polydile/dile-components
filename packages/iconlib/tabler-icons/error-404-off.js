...
export class DileIconlibError404Off extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-error-404-off')) {
  customElements.define('dile-tabler-icon-error-404-off', DileIconlibError404Off);
}
