...
export class DileIconlibComet extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-comet')) {
  customElements.define('dile-tabler-icon-comet', DileIconlibComet);
}
