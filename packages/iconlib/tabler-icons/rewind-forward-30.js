...
export class DileIconlibRewindForward30 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rewind-forward-30')) {
  customElements.define('dile-tabler-icon-rewind-forward-30', DileIconlibRewindForward30);
}
