...
export class DileIconlibPhotoStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-star')) {
  customElements.define('dile-tabler-icon-photo-star', DileIconlibPhotoStar);
}
