...
export class DileIconlibHomeSignal extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-signal')) {
  customElements.define('dile-tabler-icon-home-signal', DileIconlibHomeSignal);
}
