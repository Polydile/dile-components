...
export class DileIconlibFishBone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-fish-bone')) {
  customElements.define('dile-tabler-icon-fish-bone', DileIconlibFishBone);
}
