...
export class DileIconlibBallpenFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ballpen-filled')) {
  customElements.define('dile-tabler-icon-ballpen-filled', DileIconlibBallpenFilled);
}
