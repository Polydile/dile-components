...
export class DileIconlibBellCancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-cancel')) {
  customElements.define('dile-tabler-icon-bell-cancel', DileIconlibBellCancel);
}
