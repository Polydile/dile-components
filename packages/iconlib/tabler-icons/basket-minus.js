...
export class DileIconlibBasketMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-basket-minus')) {
  customElements.define('dile-tabler-icon-basket-minus', DileIconlibBasketMinus);
}
