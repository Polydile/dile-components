...
export class DileIconlibScubaMaskOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-scuba-mask-off')) {
  customElements.define('dile-tabler-icon-scuba-mask-off', DileIconlibScubaMaskOff);
}
