...
export class DileIconlibMessage2Code extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-2-code')) {
  customElements.define('dile-tabler-icon-message-2-code', DileIconlibMessage2Code);
}
