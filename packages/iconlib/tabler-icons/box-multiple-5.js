...
export class DileIconlibBoxMultiple5 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-box-multiple-5')) {
  customElements.define('dile-tabler-icon-box-multiple-5', DileIconlibBoxMultiple5);
}
