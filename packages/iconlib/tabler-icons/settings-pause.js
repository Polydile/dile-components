...
export class DileIconlibSettingsPause extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-settings-pause')) {
  customElements.define('dile-tabler-icon-settings-pause', DileIconlibSettingsPause);
}
