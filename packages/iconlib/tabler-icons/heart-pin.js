...
export class DileIconlibHeartPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-heart-pin')) {
  customElements.define('dile-tabler-icon-heart-pin', DileIconlibHeartPin);
}
