...
export class DileIconlibSquareF6 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-f6')) {
  customElements.define('dile-tabler-icon-square-f6', DileIconlibSquareF6);
}
