...
export class DileIconlibLockOpenOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-open-off')) {
  customElements.define('dile-tabler-icon-lock-open-off', DileIconlibLockOpenOff);
}
