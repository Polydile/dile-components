...
export class DileIconlibPlayFootball extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-football')) {
  customElements.define('dile-tabler-icon-play-football', DileIconlibPlayFootball);
}
