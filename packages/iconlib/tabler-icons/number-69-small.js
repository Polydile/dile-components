...
export class DileIconlibNumber69Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-69-small')) {
  customElements.define('dile-tabler-icon-number-69-small', DileIconlibNumber69Small);
}
