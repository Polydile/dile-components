...
export class DileIconlibFlagShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flag-share')) {
  customElements.define('dile-tabler-icon-flag-share', DileIconlibFlagShare);
}
