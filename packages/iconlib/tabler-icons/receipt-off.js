...
export class DileIconlibReceiptOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-receipt-off')) {
  customElements.define('dile-tabler-icon-receipt-off', DileIconlibReceiptOff);
}
