...
export class DileIconlibClipboardCopy extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-clipboard-copy')) {
  customElements.define('dile-tabler-icon-clipboard-copy', DileIconlibClipboardCopy);
}
