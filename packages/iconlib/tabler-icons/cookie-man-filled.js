...
export class DileIconlibCookieManFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cookie-man-filled')) {
  customElements.define('dile-tabler-icon-cookie-man-filled', DileIconlibCookieManFilled);
}
