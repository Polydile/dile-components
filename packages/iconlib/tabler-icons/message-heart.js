...
export class DileIconlibMessageHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-heart')) {
  customElements.define('dile-tabler-icon-message-heart', DileIconlibMessageHeart);
}
