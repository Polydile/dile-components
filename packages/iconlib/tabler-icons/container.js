...
export class DileIconlibContainer extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-container')) {
  customElements.define('dile-tabler-icon-container', DileIconlibContainer);
}
