...
export class DileIconlibEggCracked extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-egg-cracked')) {
  customElements.define('dile-tabler-icon-egg-cracked', DileIconlibEggCracked);
}
