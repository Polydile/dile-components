...
export class DileIconlibTableExport extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-table-export')) {
  customElements.define('dile-tabler-icon-table-export', DileIconlibTableExport);
}
