...
export class DileIconlibNumber66Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-66-small')) {
  customElements.define('dile-tabler-icon-number-66-small', DileIconlibNumber66Small);
}
