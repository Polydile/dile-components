...
export class DileIconlibSettingsUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-settings-up')) {
  customElements.define('dile-tabler-icon-settings-up', DileIconlibSettingsUp);
}
