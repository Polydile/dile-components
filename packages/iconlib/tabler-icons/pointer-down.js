...
export class DileIconlibPointerDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pointer-down')) {
  customElements.define('dile-tabler-icon-pointer-down', DileIconlibPointerDown);
}
