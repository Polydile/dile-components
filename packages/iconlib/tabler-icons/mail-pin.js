...
export class DileIconlibMailPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mail-pin')) {
  customElements.define('dile-tabler-icon-mail-pin', DileIconlibMailPin);
}
