...
export class DileIconlibRosetteNumber1 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rosette-number-1')) {
  customElements.define('dile-tabler-icon-rosette-number-1', DileIconlibRosetteNumber1);
}
