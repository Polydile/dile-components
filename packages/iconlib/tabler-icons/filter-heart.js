...
export class DileIconlibFilterHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-heart')) {
  customElements.define('dile-tabler-icon-filter-heart', DileIconlibFilterHeart);
}
