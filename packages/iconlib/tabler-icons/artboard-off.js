...
export class DileIconlibArtboardOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-artboard-off')) {
  customElements.define('dile-tabler-icon-artboard-off', DileIconlibArtboardOff);
}
