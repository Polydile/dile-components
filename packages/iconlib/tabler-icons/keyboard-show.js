...
export class DileIconlibKeyboardShow extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-keyboard-show')) {
  customElements.define('dile-tabler-icon-keyboard-show', DileIconlibKeyboardShow);
}
