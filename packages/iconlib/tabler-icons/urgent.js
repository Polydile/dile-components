...
export class DileIconlibUrgent extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-urgent')) {
  customElements.define('dile-tabler-icon-urgent', DileIconlibUrgent);
}
