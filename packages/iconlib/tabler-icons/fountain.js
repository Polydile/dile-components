...
export class DileIconlibFountain extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-fountain')) {
  customElements.define('dile-tabler-icon-fountain', DileIconlibFountain);
}
