...
export class DileIconlibFlagDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flag-dollar')) {
  customElements.define('dile-tabler-icon-flag-dollar', DileIconlibFlagDollar);
}
