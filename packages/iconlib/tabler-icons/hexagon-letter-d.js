...
export class DileIconlibHexagonLetterD extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-d')) {
  customElements.define('dile-tabler-icon-hexagon-letter-d', DileIconlibHexagonLetterD);
}
