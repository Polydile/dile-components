...
export class DileIconlibSquareF7Filled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-f7-filled')) {
  customElements.define('dile-tabler-icon-square-f7-filled', DileIconlibSquareF7Filled);
}
