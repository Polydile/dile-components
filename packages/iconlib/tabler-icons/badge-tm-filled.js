...
export class DileIconlibBadgeTmFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-badge-tm-filled')) {
  customElements.define('dile-tabler-icon-badge-tm-filled', DileIconlibBadgeTmFilled);
}
