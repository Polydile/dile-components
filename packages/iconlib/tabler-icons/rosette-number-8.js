...
export class DileIconlibRosetteNumber8 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rosette-number-8')) {
  customElements.define('dile-tabler-icon-rosette-number-8', DileIconlibRosetteNumber8);
}
