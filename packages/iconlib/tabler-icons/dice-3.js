...
export class DileIconlibDice3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-dice-3')) {
  customElements.define('dile-tabler-icon-dice-3', DileIconlibDice3);
}
