...
export class DileIconlibNumber48Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-48-small')) {
  customElements.define('dile-tabler-icon-number-48-small', DileIconlibNumber48Small);
}
