...
export class DileIconlibHomeUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-up')) {
  customElements.define('dile-tabler-icon-home-up', DileIconlibHomeUp);
}
