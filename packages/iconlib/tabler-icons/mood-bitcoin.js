...
export class DileIconlibMoodBitcoin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-bitcoin')) {
  customElements.define('dile-tabler-icon-mood-bitcoin', DileIconlibMoodBitcoin);
}
