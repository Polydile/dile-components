...
export class DileIconlibMailCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mail-cog')) {
  customElements.define('dile-tabler-icon-mail-cog', DileIconlibMailCog);
}
