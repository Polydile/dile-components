...
export class DileIconlibGhost3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ghost-3')) {
  customElements.define('dile-tabler-icon-ghost-3', DileIconlibGhost3);
}
