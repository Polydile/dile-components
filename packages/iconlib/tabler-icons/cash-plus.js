...
export class DileIconlibCashPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cash-plus')) {
  customElements.define('dile-tabler-icon-cash-plus', DileIconlibCashPlus);
}
