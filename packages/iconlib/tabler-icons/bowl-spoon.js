...
export class DileIconlibBowlSpoon extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bowl-spoon')) {
  customElements.define('dile-tabler-icon-bowl-spoon', DileIconlibBowlSpoon);
}
