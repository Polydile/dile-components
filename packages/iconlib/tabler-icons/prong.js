...
export class DileIconlibProng extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-prong')) {
  customElements.define('dile-tabler-icon-prong', DileIconlibProng);
}
