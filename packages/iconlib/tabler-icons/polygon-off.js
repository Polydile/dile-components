...
export class DileIconlibPolygonOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-polygon-off')) {
  customElements.define('dile-tabler-icon-polygon-off', DileIconlibPolygonOff);
}
