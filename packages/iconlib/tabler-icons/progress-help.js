...
export class DileIconlibProgressHelp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-progress-help')) {
  customElements.define('dile-tabler-icon-progress-help', DileIconlibProgressHelp);
}
