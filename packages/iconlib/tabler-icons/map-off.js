...
export class DileIconlibMapOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-off')) {
  customElements.define('dile-tabler-icon-map-off', DileIconlibMapOff);
}
