...
export class DileIconlibMiddleware extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-middleware')) {
  customElements.define('dile-tabler-icon-middleware', DileIconlibMiddleware);
}
