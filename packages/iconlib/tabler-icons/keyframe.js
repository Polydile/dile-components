...
export class DileIconlibKeyframe extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-keyframe')) {
  customElements.define('dile-tabler-icon-keyframe', DileIconlibKeyframe);
}
