...
export class DileIconlibEyeStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-star')) {
  customElements.define('dile-tabler-icon-eye-star', DileIconlibEyeStar);
}
