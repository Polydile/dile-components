...
export class DileIconlibCreditCardPay extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-credit-card-pay')) {
  customElements.define('dile-tabler-icon-credit-card-pay', DileIconlibCreditCardPay);
}
