...
export class DileIconlibInfoTriangle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-info-triangle')) {
  customElements.define('dile-tabler-icon-info-triangle', DileIconlibInfoTriangle);
}
