...
export class DileIconlibDatabaseShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-database-share')) {
  customElements.define('dile-tabler-icon-database-share', DileIconlibDatabaseShare);
}
