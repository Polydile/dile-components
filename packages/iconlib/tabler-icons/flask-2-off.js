...
export class DileIconlibFlask2Off extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flask-2-off')) {
  customElements.define('dile-tabler-icon-flask-2-off', DileIconlibFlask2Off);
}
