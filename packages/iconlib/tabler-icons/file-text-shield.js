...
export class DileIconlibFileTextShield extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-text-shield')) {
  customElements.define('dile-tabler-icon-file-text-shield', DileIconlibFileTextShield);
}
