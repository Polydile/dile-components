...
export class DileIconlibIroning3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ironing-3')) {
  customElements.define('dile-tabler-icon-ironing-3', DileIconlibIroning3);
}
