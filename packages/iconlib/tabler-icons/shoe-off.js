...
export class DileIconlibShoeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shoe-off')) {
  customElements.define('dile-tabler-icon-shoe-off', DileIconlibShoeOff);
}
