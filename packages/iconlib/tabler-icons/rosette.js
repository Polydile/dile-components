...
export class DileIconlibRosette extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rosette')) {
  customElements.define('dile-tabler-icon-rosette', DileIconlibRosette);
}
