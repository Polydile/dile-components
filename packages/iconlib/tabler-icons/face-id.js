...
export class DileIconlibFaceId extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-face-id')) {
  customElements.define('dile-tabler-icon-face-id', DileIconlibFaceId);
}
