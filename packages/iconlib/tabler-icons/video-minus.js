...
export class DileIconlibVideoMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-video-minus')) {
  customElements.define('dile-tabler-icon-video-minus', DileIconlibVideoMinus);
}
