...
export class DileIconlibWheel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-wheel')) {
  customElements.define('dile-tabler-icon-wheel', DileIconlibWheel);
}
