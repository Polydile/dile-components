...
export class DileIconlibMoodPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-pin')) {
  customElements.define('dile-tabler-icon-mood-pin', DileIconlibMoodPin);
}
