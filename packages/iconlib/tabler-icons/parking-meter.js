...
export class DileIconlibParkingMeter extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-parking-meter')) {
  customElements.define('dile-tabler-icon-parking-meter', DileIconlibParkingMeter);
}
