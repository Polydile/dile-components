...
export class DileIconlibCheckupList extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-checkup-list')) {
  customElements.define('dile-tabler-icon-checkup-list', DileIconlibCheckupList);
}
