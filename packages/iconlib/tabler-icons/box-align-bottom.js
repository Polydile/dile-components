...
export class DileIconlibBoxAlignBottom extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-box-align-bottom')) {
  customElements.define('dile-tabler-icon-box-align-bottom', DileIconlibBoxAlignBottom);
}
