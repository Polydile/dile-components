...
export class DileIconlibCubeSend extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cube-send')) {
  customElements.define('dile-tabler-icon-cube-send', DileIconlibCubeSend);
}
