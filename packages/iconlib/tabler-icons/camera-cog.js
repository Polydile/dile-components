...
export class DileIconlibCameraCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-camera-cog')) {
  customElements.define('dile-tabler-icon-camera-cog', DileIconlibCameraCog);
}
