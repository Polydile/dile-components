...
export class DileIconlibDeviceScreen extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-screen')) {
  customElements.define('dile-tabler-icon-device-screen', DileIconlibDeviceScreen);
}
