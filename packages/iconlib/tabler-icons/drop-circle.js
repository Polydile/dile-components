...
export class DileIconlibDropCircle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-drop-circle')) {
  customElements.define('dile-tabler-icon-drop-circle', DileIconlibDropCircle);
}
