...
export class DileIconlibDeviceRemote extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-remote')) {
  customElements.define('dile-tabler-icon-device-remote', DileIconlibDeviceRemote);
}
