...
export class DileIconlibBellDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-dollar')) {
  customElements.define('dile-tabler-icon-bell-dollar', DileIconlibBellDollar);
}
