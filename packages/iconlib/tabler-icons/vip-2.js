...
export class DileIconlibVip2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-vip-2')) {
  customElements.define('dile-tabler-icon-vip-2', DileIconlibVip2);
}
