...
export class DileIconlibCameraX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-camera-x')) {
  customElements.define('dile-tabler-icon-camera-x', DileIconlibCameraX);
}
