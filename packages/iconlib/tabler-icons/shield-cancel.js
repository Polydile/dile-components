...
export class DileIconlibShieldCancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shield-cancel')) {
  customElements.define('dile-tabler-icon-shield-cancel', DileIconlibShieldCancel);
}
