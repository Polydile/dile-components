...
export class DileIconlibLeaf2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-leaf-2')) {
  customElements.define('dile-tabler-icon-leaf-2', DileIconlibLeaf2);
}
