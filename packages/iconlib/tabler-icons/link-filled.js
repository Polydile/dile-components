...
export class DileIconlibLinkFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-link-filled')) {
  customElements.define('dile-tabler-icon-link-filled', DileIconlibLinkFilled);
}
