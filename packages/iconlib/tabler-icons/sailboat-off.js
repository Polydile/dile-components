...
export class DileIconlibSailboatOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sailboat-off')) {
  customElements.define('dile-tabler-icon-sailboat-off', DileIconlibSailboatOff);
}
