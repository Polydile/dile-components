...
export class DileIconlibDeviceImacCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-imac-cog')) {
  customElements.define('dile-tabler-icon-device-imac-cog', DileIconlibDeviceImacCog);
}
