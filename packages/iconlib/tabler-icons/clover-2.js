...
export class DileIconlibClover2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-clover-2')) {
  customElements.define('dile-tabler-icon-clover-2', DileIconlibClover2);
}
