...
export class DileIconlibPlayCard5 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-5')) {
  customElements.define('dile-tabler-icon-play-card-5', DileIconlibPlayCard5);
}
