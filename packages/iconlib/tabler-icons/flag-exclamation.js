...
export class DileIconlibFlagExclamation extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flag-exclamation')) {
  customElements.define('dile-tabler-icon-flag-exclamation', DileIconlibFlagExclamation);
}
