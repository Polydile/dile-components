...
export class DileIconlibDeviceDesktopUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-desktop-up')) {
  customElements.define('dile-tabler-icon-device-desktop-up', DileIconlibDeviceDesktopUp);
}
