...
export class DileIconlibMicrophoneOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-microphone-off')) {
  customElements.define('dile-tabler-icon-microphone-off', DileIconlibMicrophoneOff);
}
