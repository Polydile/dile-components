...
export class DileIconlibContract extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-contract')) {
  customElements.define('dile-tabler-icon-contract', DileIconlibContract);
}
