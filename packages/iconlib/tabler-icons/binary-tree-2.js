...
export class DileIconlibBinaryTree2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-binary-tree-2')) {
  customElements.define('dile-tabler-icon-binary-tree-2', DileIconlibBinaryTree2);
}
