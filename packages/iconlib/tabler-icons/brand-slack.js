...
export class DileIconlibBrandSlack extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-brand-slack')) {
  customElements.define('dile-tabler-icon-brand-slack', DileIconlibBrandSlack);
}
