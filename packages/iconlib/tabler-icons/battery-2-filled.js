...
export class DileIconlibBattery2Filled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-battery-2-filled')) {
  customElements.define('dile-tabler-icon-battery-2-filled', DileIconlibBattery2Filled);
}
