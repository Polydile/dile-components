...
export class DileIconlibSolarPanel2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-solar-panel-2')) {
  customElements.define('dile-tabler-icon-solar-panel-2', DileIconlibSolarPanel2);
}
