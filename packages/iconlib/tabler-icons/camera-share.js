...
export class DileIconlibCameraShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-camera-share')) {
  customElements.define('dile-tabler-icon-camera-share', DileIconlibCameraShare);
}
