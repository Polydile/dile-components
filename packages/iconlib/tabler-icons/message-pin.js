...
export class DileIconlibMessagePin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-pin')) {
  customElements.define('dile-tabler-icon-message-pin', DileIconlibMessagePin);
}
