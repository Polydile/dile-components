...
export class DileIconlibPlantOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-plant-off')) {
  customElements.define('dile-tabler-icon-plant-off', DileIconlibPlantOff);
}
