...
export class DileIconlibDropletDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-down')) {
  customElements.define('dile-tabler-icon-droplet-down', DileIconlibDropletDown);
}
