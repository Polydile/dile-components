...
export class DileIconlibBadgeSd extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-badge-sd')) {
  customElements.define('dile-tabler-icon-badge-sd', DileIconlibBadgeSd);
}
