...
export class DileIconlibSettings2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-settings-2')) {
  customElements.define('dile-tabler-icon-settings-2', DileIconlibSettings2);
}
