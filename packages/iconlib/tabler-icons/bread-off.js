...
export class DileIconlibBreadOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bread-off')) {
  customElements.define('dile-tabler-icon-bread-off', DileIconlibBreadOff);
}
