...
export class DileIconlibHomeQuestion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-question')) {
  customElements.define('dile-tabler-icon-home-question', DileIconlibHomeQuestion);
}
