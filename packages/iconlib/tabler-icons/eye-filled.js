...
export class DileIconlibEyeFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-filled')) {
  customElements.define('dile-tabler-icon-eye-filled', DileIconlibEyeFilled);
}
