...
export class DileIconlibSunOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sun-off')) {
  customElements.define('dile-tabler-icon-sun-off', DileIconlibSunOff);
}
