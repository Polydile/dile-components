...
export class DileIconlibPlayCard7 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-7')) {
  customElements.define('dile-tabler-icon-play-card-7', DileIconlibPlayCard7);
}
