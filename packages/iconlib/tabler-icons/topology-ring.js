...
export class DileIconlibTopologyRing extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-topology-ring')) {
  customElements.define('dile-tabler-icon-topology-ring', DileIconlibTopologyRing);
}
