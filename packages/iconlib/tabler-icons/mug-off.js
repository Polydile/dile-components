...
export class DileIconlibMugOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mug-off')) {
  customElements.define('dile-tabler-icon-mug-off', DileIconlibMugOff);
}
