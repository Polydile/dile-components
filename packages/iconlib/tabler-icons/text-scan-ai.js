...
export class DileIconlibTextScanAi extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-text-scan-ai')) {
  customElements.define('dile-tabler-icon-text-scan-ai', DileIconlibTextScanAi);
}
