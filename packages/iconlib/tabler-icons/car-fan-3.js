...
export class DileIconlibCarFan3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-car-fan-3')) {
  customElements.define('dile-tabler-icon-car-fan-3', DileIconlibCarFan3);
}
