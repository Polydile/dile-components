...
export class DileIconlibSubtitlesAi extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-subtitles-ai')) {
  customElements.define('dile-tabler-icon-subtitles-ai', DileIconlibSubtitlesAi);
}
