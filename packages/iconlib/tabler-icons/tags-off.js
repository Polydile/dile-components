...
export class DileIconlibTagsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-tags-off')) {
  customElements.define('dile-tabler-icon-tags-off', DileIconlibTagsOff);
}
