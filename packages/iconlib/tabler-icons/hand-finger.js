...
export class DileIconlibHandFinger extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hand-finger')) {
  customElements.define('dile-tabler-icon-hand-finger', DileIconlibHandFinger);
}
