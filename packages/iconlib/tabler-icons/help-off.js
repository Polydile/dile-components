...
export class DileIconlibHelpOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-help-off')) {
  customElements.define('dile-tabler-icon-help-off', DileIconlibHelpOff);
}
