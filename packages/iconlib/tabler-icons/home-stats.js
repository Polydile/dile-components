...
export class DileIconlibHomeStats extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-stats')) {
  customElements.define('dile-tabler-icon-home-stats', DileIconlibHomeStats);
}
