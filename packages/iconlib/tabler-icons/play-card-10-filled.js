...
export class DileIconlibPlayCard10Filled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-10-filled')) {
  customElements.define('dile-tabler-icon-play-card-10-filled', DileIconlibPlayCard10Filled);
}
