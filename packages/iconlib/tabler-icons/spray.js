...
export class DileIconlibSpray extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-spray')) {
  customElements.define('dile-tabler-icon-spray', DileIconlibSpray);
}
