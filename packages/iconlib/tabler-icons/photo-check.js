...
export class DileIconlibPhotoCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-check')) {
  customElements.define('dile-tabler-icon-photo-check', DileIconlibPhotoCheck);
}
