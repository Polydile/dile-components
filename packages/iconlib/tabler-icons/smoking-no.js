...
export class DileIconlibSmokingNo extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-smoking-no')) {
  customElements.define('dile-tabler-icon-smoking-no', DileIconlibSmokingNo);
}
