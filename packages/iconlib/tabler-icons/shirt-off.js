...
export class DileIconlibShirtOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shirt-off')) {
  customElements.define('dile-tabler-icon-shirt-off', DileIconlibShirtOff);
}
