...
export class DileIconlibNumber93Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-93-small')) {
  customElements.define('dile-tabler-icon-number-93-small', DileIconlibNumber93Small);
}
