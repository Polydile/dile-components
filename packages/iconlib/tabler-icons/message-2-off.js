...
export class DileIconlibMessage2Off extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-2-off')) {
  customElements.define('dile-tabler-icon-message-2-off', DileIconlibMessage2Off);
}
