...
export class DileIconlibDeviceProjector extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-projector')) {
  customElements.define('dile-tabler-icon-device-projector', DileIconlibDeviceProjector);
}
