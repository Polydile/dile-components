...
export class DileIconlibMusicHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-music-heart')) {
  customElements.define('dile-tabler-icon-music-heart', DileIconlibMusicHeart);
}
