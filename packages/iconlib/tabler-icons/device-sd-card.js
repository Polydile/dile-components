...
export class DileIconlibDeviceSdCard extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-sd-card')) {
  customElements.define('dile-tabler-icon-device-sd-card', DileIconlibDeviceSdCard);
}
