...
export class DileIconlibBellSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-search')) {
  customElements.define('dile-tabler-icon-bell-search', DileIconlibBellSearch);
}
