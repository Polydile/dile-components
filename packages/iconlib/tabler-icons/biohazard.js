...
export class DileIconlibBiohazard extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-biohazard')) {
  customElements.define('dile-tabler-icon-biohazard', DileIconlibBiohazard);
}
