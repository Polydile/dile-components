...
export class DileIconlibCircleDotted extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-circle-dotted')) {
  customElements.define('dile-tabler-icon-circle-dotted', DileIconlibCircleDotted);
}
