...
export class DileIconlibClockHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-clock-heart')) {
  customElements.define('dile-tabler-icon-clock-heart', DileIconlibClockHeart);
}
