...
export class DileIconlibTableOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-table-off')) {
  customElements.define('dile-tabler-icon-table-off', DileIconlibTableOff);
}
