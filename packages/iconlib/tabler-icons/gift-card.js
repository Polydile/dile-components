...
export class DileIconlibGiftCard extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-gift-card')) {
  customElements.define('dile-tabler-icon-gift-card', DileIconlibGiftCard);
}
