...
export class DileIconlibExerciseBall extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-exercise-ball')) {
  customElements.define('dile-tabler-icon-exercise-ball', DileIconlibExerciseBall);
}
