...
export class DileIconlibIconsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-icons-off')) {
  customElements.define('dile-tabler-icon-icons-off', DileIconlibIconsOff);
}
