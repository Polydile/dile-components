...
export class DileIconlibFreezeRowColumn extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-freeze-row-column')) {
  customElements.define('dile-tabler-icon-freeze-row-column', DileIconlibFreezeRowColumn);
}
