...
export class DileIconlibPhotoUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-up')) {
  customElements.define('dile-tabler-icon-photo-up', DileIconlibPhotoUp);
}
