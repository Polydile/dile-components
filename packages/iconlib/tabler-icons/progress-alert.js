...
export class DileIconlibProgressAlert extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-progress-alert')) {
  customElements.define('dile-tabler-icon-progress-alert', DileIconlibProgressAlert);
}
