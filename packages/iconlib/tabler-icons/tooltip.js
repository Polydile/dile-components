...
export class DileIconlibTooltip extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-tooltip')) {
  customElements.define('dile-tabler-icon-tooltip', DileIconlibTooltip);
}
