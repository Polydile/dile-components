...
export class DileIconlibHeartSpark extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-heart-spark')) {
  customElements.define('dile-tabler-icon-heart-spark', DileIconlibHeartSpark);
}
