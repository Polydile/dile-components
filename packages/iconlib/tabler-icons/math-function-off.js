...
export class DileIconlibMathFunctionOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-math-function-off')) {
  customElements.define('dile-tabler-icon-math-function-off', DileIconlibMathFunctionOff);
}
