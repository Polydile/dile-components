...
export class DileIconlibFileTextFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-text-filled')) {
  customElements.define('dile-tabler-icon-file-text-filled', DileIconlibFileTextFilled);
}
