...
export class DileIconlibHttpOptionsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-http-options-off')) {
  customElements.define('dile-tabler-icon-http-options-off', DileIconlibHttpOptionsOff);
}
