...
export class DileIconlibIdBadgeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-id-badge-off')) {
  customElements.define('dile-tabler-icon-id-badge-off', DileIconlibIdBadgeOff);
}
