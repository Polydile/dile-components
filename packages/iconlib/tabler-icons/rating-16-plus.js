...
export class DileIconlibRating16Plus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rating-16-plus')) {
  customElements.define('dile-tabler-icon-rating-16-plus', DileIconlibRating16Plus);
}
