...
export class DileIconlibMelon extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-melon')) {
  customElements.define('dile-tabler-icon-melon', DileIconlibMelon);
}
