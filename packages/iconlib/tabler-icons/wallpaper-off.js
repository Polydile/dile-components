...
export class DileIconlibWallpaperOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-wallpaper-off')) {
  customElements.define('dile-tabler-icon-wallpaper-off', DileIconlibWallpaperOff);
}
