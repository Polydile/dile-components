...
export class DileIconlibLanguageOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-language-off')) {
  customElements.define('dile-tabler-icon-language-off', DileIconlibLanguageOff);
}
