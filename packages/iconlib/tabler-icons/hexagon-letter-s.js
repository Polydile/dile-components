...
export class DileIconlibHexagonLetterS extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-s')) {
  customElements.define('dile-tabler-icon-hexagon-letter-s', DileIconlibHexagonLetterS);
}
