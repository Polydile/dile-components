...
export class DileIconlibPlayCardOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-off')) {
  customElements.define('dile-tabler-icon-play-card-off', DileIconlibPlayCardOff);
}
