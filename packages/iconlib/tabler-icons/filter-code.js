...
export class DileIconlibFilterCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-code')) {
  customElements.define('dile-tabler-icon-filter-code', DileIconlibFilterCode);
}
