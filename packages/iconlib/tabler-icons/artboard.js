...
export class DileIconlibArtboard extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-artboard')) {
  customElements.define('dile-tabler-icon-artboard', DileIconlibArtboard);
}
