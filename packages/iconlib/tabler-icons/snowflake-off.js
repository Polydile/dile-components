...
export class DileIconlibSnowflakeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-snowflake-off')) {
  customElements.define('dile-tabler-icon-snowflake-off', DileIconlibSnowflakeOff);
}
