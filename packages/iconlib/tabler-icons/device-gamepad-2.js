...
export class DileIconlibDeviceGamepad2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-gamepad-2')) {
  customElements.define('dile-tabler-icon-device-gamepad-2', DileIconlibDeviceGamepad2);
}
