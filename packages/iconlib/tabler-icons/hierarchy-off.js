...
export class DileIconlibHierarchyOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hierarchy-off')) {
  customElements.define('dile-tabler-icon-hierarchy-off', DileIconlibHierarchyOff);
}
