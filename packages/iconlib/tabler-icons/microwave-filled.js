...
export class DileIconlibMicrowaveFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-microwave-filled')) {
  customElements.define('dile-tabler-icon-microwave-filled', DileIconlibMicrowaveFilled);
}
