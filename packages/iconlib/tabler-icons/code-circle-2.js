...
export class DileIconlibCodeCircle2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-code-circle-2')) {
  customElements.define('dile-tabler-icon-code-circle-2', DileIconlibCodeCircle2);
}
