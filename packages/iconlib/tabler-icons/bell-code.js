...
export class DileIconlibBellCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-code')) {
  customElements.define('dile-tabler-icon-bell-code', DileIconlibBellCode);
}
