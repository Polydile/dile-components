...
export class DileIconlibClockPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-clock-pin')) {
  customElements.define('dile-tabler-icon-clock-pin', DileIconlibClockPin);
}
