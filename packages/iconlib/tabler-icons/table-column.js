...
export class DileIconlibTableColumn extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-table-column')) {
  customElements.define('dile-tabler-icon-table-column', DileIconlibTableColumn);
}
