...
export class DileIconlibEyePause extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-pause')) {
  customElements.define('dile-tabler-icon-eye-pause', DileIconlibEyePause);
}
