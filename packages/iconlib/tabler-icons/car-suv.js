...
export class DileIconlibCarSuv extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-car-suv')) {
  customElements.define('dile-tabler-icon-car-suv', DileIconlibCarSuv);
}
