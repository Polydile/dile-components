...
export class DileIconlibLivePhoto extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-live-photo')) {
  customElements.define('dile-tabler-icon-live-photo', DileIconlibLivePhoto);
}
