...
export class DileIconlibCircleLetterS extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-circle-letter-s')) {
  customElements.define('dile-tabler-icon-circle-letter-s', DileIconlibCircleLetterS);
}
