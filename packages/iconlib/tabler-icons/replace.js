...
export class DileIconlibReplace extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-replace')) {
  customElements.define('dile-tabler-icon-replace', DileIconlibReplace);
}
