...
export class DileIconlibInboxOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-inbox-off')) {
  customElements.define('dile-tabler-icon-inbox-off', DileIconlibInboxOff);
}
