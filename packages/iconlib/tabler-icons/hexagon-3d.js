...
export class DileIconlibHexagon3d extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-3d')) {
  customElements.define('dile-tabler-icon-hexagon-3d', DileIconlibHexagon3d);
}
