...
export class DileIconlibHexagonLetterU extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-u')) {
  customElements.define('dile-tabler-icon-hexagon-letter-u', DileIconlibHexagonLetterU);
}
