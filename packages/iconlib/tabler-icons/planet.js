...
export class DileIconlibPlanet extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-planet')) {
  customElements.define('dile-tabler-icon-planet', DileIconlibPlanet);
}
