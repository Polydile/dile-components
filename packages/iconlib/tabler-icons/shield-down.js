...
export class DileIconlibShieldDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shield-down')) {
  customElements.define('dile-tabler-icon-shield-down', DileIconlibShieldDown);
}
