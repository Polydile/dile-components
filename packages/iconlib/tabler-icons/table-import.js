...
export class DileIconlibTableImport extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-table-import')) {
  customElements.define('dile-tabler-icon-table-import', DileIconlibTableImport);
}
