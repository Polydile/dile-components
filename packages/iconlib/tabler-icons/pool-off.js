...
export class DileIconlibPoolOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pool-off')) {
  customElements.define('dile-tabler-icon-pool-off', DileIconlibPoolOff);
}
