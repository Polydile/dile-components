...
export class DileIconlibBadge4k extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-badge-4k')) {
  customElements.define('dile-tabler-icon-badge-4k', DileIconlibBadge4k);
}
