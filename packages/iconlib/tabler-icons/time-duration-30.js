...
export class DileIconlibTimeDuration30 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-time-duration-30')) {
  customElements.define('dile-tabler-icon-time-duration-30', DileIconlibTimeDuration30);
}
