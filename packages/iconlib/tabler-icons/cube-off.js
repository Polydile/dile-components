...
export class DileIconlibCubeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cube-off')) {
  customElements.define('dile-tabler-icon-cube-off', DileIconlibCubeOff);
}
