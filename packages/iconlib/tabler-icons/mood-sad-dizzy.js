...
export class DileIconlibMoodSadDizzy extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-sad-dizzy')) {
  customElements.define('dile-tabler-icon-mood-sad-dizzy', DileIconlibMoodSadDizzy);
}
