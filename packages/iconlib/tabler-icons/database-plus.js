...
export class DileIconlibDatabasePlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-database-plus')) {
  customElements.define('dile-tabler-icon-database-plus', DileIconlibDatabasePlus);
}
