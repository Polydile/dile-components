...
export class DileIconlibPencilHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pencil-heart')) {
  customElements.define('dile-tabler-icon-pencil-heart', DileIconlibPencilHeart);
}
