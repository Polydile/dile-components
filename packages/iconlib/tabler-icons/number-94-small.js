...
export class DileIconlibNumber94Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-94-small')) {
  customElements.define('dile-tabler-icon-number-94-small', DileIconlibNumber94Small);
}
