...
export class DileIconlibSalt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-salt')) {
  customElements.define('dile-tabler-icon-salt', DileIconlibSalt);
}
