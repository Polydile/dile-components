...
export class DileIconlibSquareNumber8 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-number-8')) {
  customElements.define('dile-tabler-icon-square-number-8', DileIconlibSquareNumber8);
}
