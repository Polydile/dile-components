...
export class DileIconlibWood extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-wood')) {
  customElements.define('dile-tabler-icon-wood', DileIconlibWood);
}
