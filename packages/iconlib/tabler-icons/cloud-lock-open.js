...
export class DileIconlibCloudLockOpen extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cloud-lock-open')) {
  customElements.define('dile-tabler-icon-cloud-lock-open', DileIconlibCloudLockOpen);
}
