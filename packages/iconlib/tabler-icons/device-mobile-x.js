...
export class DileIconlibDeviceMobileX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-mobile-x')) {
  customElements.define('dile-tabler-icon-device-mobile-x', DileIconlibDeviceMobileX);
}
