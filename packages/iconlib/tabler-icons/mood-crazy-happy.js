...
export class DileIconlibMoodCrazyHappy extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-crazy-happy')) {
  customElements.define('dile-tabler-icon-mood-crazy-happy', DileIconlibMoodCrazyHappy);
}
