...
export class DileIconlibDashboardOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-dashboard-off')) {
  customElements.define('dile-tabler-icon-dashboard-off', DileIconlibDashboardOff);
}
