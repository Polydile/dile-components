...
export class DileIconlibHearts extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hearts')) {
  customElements.define('dile-tabler-icon-hearts', DileIconlibHearts);
}
