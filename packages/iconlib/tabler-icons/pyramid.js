...
export class DileIconlibPyramid extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pyramid')) {
  customElements.define('dile-tabler-icon-pyramid', DileIconlibPyramid);
}
