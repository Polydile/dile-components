...
export class DileIconlibShieldCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shield-cog')) {
  customElements.define('dile-tabler-icon-shield-cog', DileIconlibShieldCog);
}
