...
export class DileIconlibScubaMask extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-scuba-mask')) {
  customElements.define('dile-tabler-icon-scuba-mask', DileIconlibScubaMask);
}
