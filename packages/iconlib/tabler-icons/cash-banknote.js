...
export class DileIconlibCashBanknote extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cash-banknote')) {
  customElements.define('dile-tabler-icon-cash-banknote', DileIconlibCashBanknote);
}
