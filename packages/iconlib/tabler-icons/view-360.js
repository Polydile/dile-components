...
export class DileIconlibView360 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-view-360')) {
  customElements.define('dile-tabler-icon-view-360', DileIconlibView360);
}
