...
export class DileIconlibPlugX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-plug-x')) {
  customElements.define('dile-tabler-icon-plug-x', DileIconlibPlugX);
}
