...
export class DileIconlibMapPinCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-pin-code')) {
  customElements.define('dile-tabler-icon-map-pin-code', DileIconlibMapPinCode);
}
