...
export class DileIconlibSpadeFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-spade-filled')) {
  customElements.define('dile-tabler-icon-spade-filled', DileIconlibSpadeFilled);
}
