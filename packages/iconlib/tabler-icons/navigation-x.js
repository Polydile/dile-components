...
export class DileIconlibNavigationX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-navigation-x')) {
  customElements.define('dile-tabler-icon-navigation-x', DileIconlibNavigationX);
}
