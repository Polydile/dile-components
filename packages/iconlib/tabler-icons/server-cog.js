...
export class DileIconlibServerCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-server-cog')) {
  customElements.define('dile-tabler-icon-server-cog', DileIconlibServerCog);
}
