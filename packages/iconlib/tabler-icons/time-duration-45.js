...
export class DileIconlibTimeDuration45 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-time-duration-45')) {
  customElements.define('dile-tabler-icon-time-duration-45', DileIconlibTimeDuration45);
}
