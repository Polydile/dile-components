...
export class DileIconlibBellStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-star')) {
  customElements.define('dile-tabler-icon-bell-star', DileIconlibBellStar);
}
