...
export class DileIconlibPhotoSensor3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-sensor-3')) {
  customElements.define('dile-tabler-icon-photo-sensor-3', DileIconlibPhotoSensor3);
}
