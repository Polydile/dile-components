...
export class DileIconlibHeartQuestion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-heart-question')) {
  customElements.define('dile-tabler-icon-heart-question', DileIconlibHeartQuestion);
}
