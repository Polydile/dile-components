...
export class DileIconlibFileDatabase extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-database')) {
  customElements.define('dile-tabler-icon-file-database', DileIconlibFileDatabase);
}
