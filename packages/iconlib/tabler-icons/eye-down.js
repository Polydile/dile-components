...
export class DileIconlibEyeDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-down')) {
  customElements.define('dile-tabler-icon-eye-down', DileIconlibEyeDown);
}
