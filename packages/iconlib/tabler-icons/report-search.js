...
export class DileIconlibReportSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-report-search')) {
  customElements.define('dile-tabler-icon-report-search', DileIconlibReportSearch);
}
