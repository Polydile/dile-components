...
export class DileIconlibIcosahedron extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-icosahedron')) {
  customElements.define('dile-tabler-icon-icosahedron', DileIconlibIcosahedron);
}
