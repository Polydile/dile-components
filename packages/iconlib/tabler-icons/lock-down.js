...
export class DileIconlibLockDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-down')) {
  customElements.define('dile-tabler-icon-lock-down', DileIconlibLockDown);
}
