...
export class DileIconlibServer2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-server-2')) {
  customElements.define('dile-tabler-icon-server-2', DileIconlibServer2);
}
