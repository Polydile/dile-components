...
export class DileIconlibVocabulary extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-vocabulary')) {
  customElements.define('dile-tabler-icon-vocabulary', DileIconlibVocabulary);
}
