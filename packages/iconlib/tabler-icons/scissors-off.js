...
export class DileIconlibScissorsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-scissors-off')) {
  customElements.define('dile-tabler-icon-scissors-off', DileIconlibScissorsOff);
}
