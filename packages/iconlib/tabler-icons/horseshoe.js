...
export class DileIconlibHorseshoe extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-horseshoe')) {
  customElements.define('dile-tabler-icon-horseshoe', DileIconlibHorseshoe);
}
