...
export class DileIconlibPointerUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pointer-up')) {
  customElements.define('dile-tabler-icon-pointer-up', DileIconlibPointerUp);
}
