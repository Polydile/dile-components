...
export class DileIconlibPasswordUser extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-password-user')) {
  customElements.define('dile-tabler-icon-password-user', DileIconlibPasswordUser);
}
