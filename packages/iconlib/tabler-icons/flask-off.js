...
export class DileIconlibFlaskOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flask-off')) {
  customElements.define('dile-tabler-icon-flask-off', DileIconlibFlaskOff);
}
