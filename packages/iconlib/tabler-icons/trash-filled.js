...
export class DileIconlibTrashFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-trash-filled')) {
  customElements.define('dile-tabler-icon-trash-filled', DileIconlibTrashFilled);
}
