...
export class DileIconlibMapPinHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-pin-heart')) {
  customElements.define('dile-tabler-icon-map-pin-heart', DileIconlibMapPinHeart);
}
