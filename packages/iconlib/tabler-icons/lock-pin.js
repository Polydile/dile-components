...
export class DileIconlibLockPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-pin')) {
  customElements.define('dile-tabler-icon-lock-pin', DileIconlibLockPin);
}
