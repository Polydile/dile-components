...
export class DileIconlibFileXFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-x-filled')) {
  customElements.define('dile-tabler-icon-file-x-filled', DileIconlibFileXFilled);
}
