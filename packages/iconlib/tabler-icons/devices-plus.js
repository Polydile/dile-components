...
export class DileIconlibDevicesPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-plus')) {
  customElements.define('dile-tabler-icon-devices-plus', DileIconlibDevicesPlus);
}
