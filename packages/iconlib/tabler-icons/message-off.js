...
export class DileIconlibMessageOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-off')) {
  customElements.define('dile-tabler-icon-message-off', DileIconlibMessageOff);
}
