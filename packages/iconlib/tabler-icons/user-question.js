...
export class DileIconlibUserQuestion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-user-question')) {
  customElements.define('dile-tabler-icon-user-question', DileIconlibUserQuestion);
}
