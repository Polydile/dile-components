...
export class DileIconlibBoxMultiple8 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-box-multiple-8')) {
  customElements.define('dile-tabler-icon-box-multiple-8', DileIconlibBoxMultiple8);
}
