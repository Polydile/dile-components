...
export class DileIconlibDeviceTvOld extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-tv-old')) {
  customElements.define('dile-tabler-icon-device-tv-old', DileIconlibDeviceTvOld);
}
