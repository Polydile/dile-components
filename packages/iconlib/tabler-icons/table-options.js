...
export class DileIconlibTableOptions extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-table-options')) {
  customElements.define('dile-tabler-icon-table-options', DileIconlibTableOptions);
}
