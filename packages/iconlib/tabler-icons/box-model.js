...
export class DileIconlibBoxModel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-box-model')) {
  customElements.define('dile-tabler-icon-box-model', DileIconlibBoxModel);
}
