...
export class DileIconlibCpu2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cpu-2')) {
  customElements.define('dile-tabler-icon-cpu-2', DileIconlibCpu2);
}
