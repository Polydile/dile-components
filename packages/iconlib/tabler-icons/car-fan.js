...
export class DileIconlibCarFan extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-car-fan')) {
  customElements.define('dile-tabler-icon-car-fan', DileIconlibCarFan);
}
