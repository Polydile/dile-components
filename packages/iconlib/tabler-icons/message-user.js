...
export class DileIconlibMessageUser extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-user')) {
  customElements.define('dile-tabler-icon-message-user', DileIconlibMessageUser);
}
