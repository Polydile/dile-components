...
export class DileIconlibConfettiOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-confetti-off')) {
  customElements.define('dile-tabler-icon-confetti-off', DileIconlibConfettiOff);
}
