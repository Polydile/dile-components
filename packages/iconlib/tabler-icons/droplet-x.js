...
export class DileIconlibDropletX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-x')) {
  customElements.define('dile-tabler-icon-droplet-x', DileIconlibDropletX);
}
