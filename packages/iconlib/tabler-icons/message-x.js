...
export class DileIconlibMessageX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-x')) {
  customElements.define('dile-tabler-icon-message-x', DileIconlibMessageX);
}
