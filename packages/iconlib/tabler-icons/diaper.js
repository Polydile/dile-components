...
export class DileIconlibDiaper extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-diaper')) {
  customElements.define('dile-tabler-icon-diaper', DileIconlibDiaper);
}
