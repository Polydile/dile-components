...
export class DileIconlibFlagUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flag-up')) {
  customElements.define('dile-tabler-icon-flag-up', DileIconlibFlagUp);
}
