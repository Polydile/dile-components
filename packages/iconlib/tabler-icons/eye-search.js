...
export class DileIconlibEyeSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-search')) {
  customElements.define('dile-tabler-icon-eye-search', DileIconlibEyeSearch);
}
