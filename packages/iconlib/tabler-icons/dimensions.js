...
export class DileIconlibDimensions extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-dimensions')) {
  customElements.define('dile-tabler-icon-dimensions', DileIconlibDimensions);
}
