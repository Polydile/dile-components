...
export class DileIconlibTriangleOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-triangle-off')) {
  customElements.define('dile-tabler-icon-triangle-off', DileIconlibTriangleOff);
}
