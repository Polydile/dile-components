...
export class DileIconlibApiOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-api-off')) {
  customElements.define('dile-tabler-icon-api-off', DileIconlibApiOff);
}
