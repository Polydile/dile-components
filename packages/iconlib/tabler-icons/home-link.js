...
export class DileIconlibHomeLink extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-link')) {
  customElements.define('dile-tabler-icon-home-link', DileIconlibHomeLink);
}
