...
export class DileIconlibServerSpark extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-server-spark')) {
  customElements.define('dile-tabler-icon-server-spark', DileIconlibServerSpark);
}
