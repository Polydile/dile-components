...
export class DileIconlibArticleOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-article-off')) {
  customElements.define('dile-tabler-icon-article-off', DileIconlibArticleOff);
}
