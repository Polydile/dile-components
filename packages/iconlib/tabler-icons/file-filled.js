...
export class DileIconlibFileFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-filled')) {
  customElements.define('dile-tabler-icon-file-filled', DileIconlibFileFilled);
}
