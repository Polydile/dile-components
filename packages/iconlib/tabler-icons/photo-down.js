...
export class DileIconlibPhotoDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-down')) {
  customElements.define('dile-tabler-icon-photo-down', DileIconlibPhotoDown);
}
