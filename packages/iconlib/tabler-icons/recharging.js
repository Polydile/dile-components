...
export class DileIconlibRecharging extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-recharging')) {
  customElements.define('dile-tabler-icon-recharging', DileIconlibRecharging);
}
