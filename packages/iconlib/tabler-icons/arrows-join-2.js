...
export class DileIconlibArrowsJoin2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-arrows-join-2')) {
  customElements.define('dile-tabler-icon-arrows-join-2', DileIconlibArrowsJoin2);
}
