...
export class DileIconlibCloudNetwork extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cloud-network')) {
  customElements.define('dile-tabler-icon-cloud-network', DileIconlibCloudNetwork);
}
