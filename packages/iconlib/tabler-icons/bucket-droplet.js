...
export class DileIconlibBucketDroplet extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bucket-droplet')) {
  customElements.define('dile-tabler-icon-bucket-droplet', DileIconlibBucketDroplet);
}
