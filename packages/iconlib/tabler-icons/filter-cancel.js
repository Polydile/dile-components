...
export class DileIconlibFilterCancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-cancel')) {
  customElements.define('dile-tabler-icon-filter-cancel', DileIconlibFilterCancel);
}
