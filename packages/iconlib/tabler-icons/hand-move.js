...
export class DileIconlibHandMove extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hand-move')) {
  customElements.define('dile-tabler-icon-hand-move', DileIconlibHandMove);
}
