...
export class DileIconlibQuote extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-quote')) {
  customElements.define('dile-tabler-icon-quote', DileIconlibQuote);
}
