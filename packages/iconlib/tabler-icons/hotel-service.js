...
export class DileIconlibHotelService extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hotel-service')) {
  customElements.define('dile-tabler-icon-hotel-service', DileIconlibHotelService);
}
