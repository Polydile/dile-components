...
export class DileIconlibTowerOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-tower-off')) {
  customElements.define('dile-tabler-icon-tower-off', DileIconlibTowerOff);
}
