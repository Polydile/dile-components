...
export class DileIconlibPointerCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pointer-code')) {
  customElements.define('dile-tabler-icon-pointer-code', DileIconlibPointerCode);
}
