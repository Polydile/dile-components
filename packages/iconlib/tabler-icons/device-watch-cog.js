...
export class DileIconlibDeviceWatchCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-watch-cog')) {
  customElements.define('dile-tabler-icon-device-watch-cog', DileIconlibDeviceWatchCog);
}
