...
export class DileIconlibCarCraneFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-car-crane-filled')) {
  customElements.define('dile-tabler-icon-car-crane-filled', DileIconlibCarCraneFilled);
}
