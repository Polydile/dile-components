...
export class DileIconlibEyeBitcoin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-bitcoin')) {
  customElements.define('dile-tabler-icon-eye-bitcoin', DileIconlibEyeBitcoin);
}
