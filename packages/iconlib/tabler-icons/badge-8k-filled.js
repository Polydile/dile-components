...
export class DileIconlibBadge8kFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-badge-8k-filled')) {
  customElements.define('dile-tabler-icon-badge-8k-filled', DileIconlibBadge8kFilled);
}
