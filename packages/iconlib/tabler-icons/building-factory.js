...
export class DileIconlibBuildingFactory extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-building-factory')) {
  customElements.define('dile-tabler-icon-building-factory', DileIconlibBuildingFactory);
}
