...
export class DileIconlibShredder extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shredder')) {
  customElements.define('dile-tabler-icon-shredder', DileIconlibShredder);
}
