...
export class DileIconlibMoodOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-off')) {
  customElements.define('dile-tabler-icon-mood-off', DileIconlibMoodOff);
}
