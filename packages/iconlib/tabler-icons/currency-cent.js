...
export class DileIconlibCurrencyCent extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-currency-cent')) {
  customElements.define('dile-tabler-icon-currency-cent', DileIconlibCurrencyCent);
}
