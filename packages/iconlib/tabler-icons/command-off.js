...
export class DileIconlibCommandOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-command-off')) {
  customElements.define('dile-tabler-icon-command-off', DileIconlibCommandOff);
}
