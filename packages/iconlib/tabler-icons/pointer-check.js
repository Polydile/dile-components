...
export class DileIconlibPointerCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pointer-check')) {
  customElements.define('dile-tabler-icon-pointer-check', DileIconlibPointerCheck);
}
