...
export class DileIconlibArmchair2Off extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-armchair-2-off')) {
  customElements.define('dile-tabler-icon-armchair-2-off', DileIconlibArmchair2Off);
}
