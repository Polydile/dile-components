...
export class DileIconlibNumber98Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-98-small')) {
  customElements.define('dile-tabler-icon-number-98-small', DileIconlibNumber98Small);
}
