...
export class DileIconlibChefHatOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-chef-hat-off')) {
  customElements.define('dile-tabler-icon-chef-hat-off', DileIconlibChefHatOff);
}
