...
export class DileIconlibUserPentagon extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-user-pentagon')) {
  customElements.define('dile-tabler-icon-user-pentagon', DileIconlibUserPentagon);
}
