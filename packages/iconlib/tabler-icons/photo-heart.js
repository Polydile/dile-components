...
export class DileIconlibPhotoHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-heart')) {
  customElements.define('dile-tabler-icon-photo-heart', DileIconlibPhotoHeart);
}
