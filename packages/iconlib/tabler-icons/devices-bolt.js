...
export class DileIconlibDevicesBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-bolt')) {
  customElements.define('dile-tabler-icon-devices-bolt', DileIconlibDevicesBolt);
}
