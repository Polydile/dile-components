...
export class DileIconlibDatabaseHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-database-heart')) {
  customElements.define('dile-tabler-icon-database-heart', DileIconlibDatabaseHeart);
}
