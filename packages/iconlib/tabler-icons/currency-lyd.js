...
export class DileIconlibCurrencyLyd extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-currency-lyd')) {
  customElements.define('dile-tabler-icon-currency-lyd', DileIconlibCurrencyLyd);
}
