...
export class DileIconlibGhostOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ghost-off')) {
  customElements.define('dile-tabler-icon-ghost-off', DileIconlibGhostOff);
}
