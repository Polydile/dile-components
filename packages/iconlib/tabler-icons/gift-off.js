...
export class DileIconlibGiftOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-gift-off')) {
  customElements.define('dile-tabler-icon-gift-off', DileIconlibGiftOff);
}
