...
export class DileIconlibHomeX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-x')) {
  customElements.define('dile-tabler-icon-home-x', DileIconlibHomeX);
}
