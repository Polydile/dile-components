...
export class DileIconlibPhoneXFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-phone-x-filled')) {
  customElements.define('dile-tabler-icon-phone-x-filled', DileIconlibPhoneXFilled);
}
