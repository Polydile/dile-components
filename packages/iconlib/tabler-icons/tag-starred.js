...
export class DileIconlibTagStarred extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-tag-starred')) {
  customElements.define('dile-tabler-icon-tag-starred', DileIconlibTagStarred);
}
