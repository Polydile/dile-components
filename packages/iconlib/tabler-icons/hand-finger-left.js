...
export class DileIconlibHandFingerLeft extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hand-finger-left')) {
  customElements.define('dile-tabler-icon-hand-finger-left', DileIconlibHandFingerLeft);
}
