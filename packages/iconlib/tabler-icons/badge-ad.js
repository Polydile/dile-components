...
export class DileIconlibBadgeAd extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-badge-ad')) {
  customElements.define('dile-tabler-icon-badge-ad', DileIconlibBadgeAd);
}
