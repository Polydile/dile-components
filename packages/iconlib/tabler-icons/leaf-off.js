...
export class DileIconlibLeafOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-leaf-off')) {
  customElements.define('dile-tabler-icon-leaf-off', DileIconlibLeafOff);
}
