...
export class DileIconlibPointerShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pointer-share')) {
  customElements.define('dile-tabler-icon-pointer-share', DileIconlibPointerShare);
}
