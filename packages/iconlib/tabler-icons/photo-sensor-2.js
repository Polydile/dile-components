...
export class DileIconlibPhotoSensor2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-sensor-2')) {
  customElements.define('dile-tabler-icon-photo-sensor-2', DileIconlibPhotoSensor2);
}
