...
export class DileIconlibPlayCard3Filled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-3-filled')) {
  customElements.define('dile-tabler-icon-play-card-3-filled', DileIconlibPlayCard3Filled);
}
