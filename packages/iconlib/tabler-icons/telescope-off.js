...
export class DileIconlibTelescopeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-telescope-off')) {
  customElements.define('dile-tabler-icon-telescope-off', DileIconlibTelescopeOff);
}
