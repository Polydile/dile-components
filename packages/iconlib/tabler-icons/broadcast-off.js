...
export class DileIconlibBroadcastOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-broadcast-off')) {
  customElements.define('dile-tabler-icon-broadcast-off', DileIconlibBroadcastOff);
}
