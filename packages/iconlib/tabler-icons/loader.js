...
export class DileIconlibLoader extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-loader')) {
  customElements.define('dile-tabler-icon-loader', DileIconlibLoader);
}
