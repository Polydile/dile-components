...
export class DileIconlibSquareF5 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-f5')) {
  customElements.define('dile-tabler-icon-square-f5', DileIconlibSquareF5);
}
