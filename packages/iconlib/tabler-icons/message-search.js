...
export class DileIconlibMessageSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-search')) {
  customElements.define('dile-tabler-icon-message-search', DileIconlibMessageSearch);
}
