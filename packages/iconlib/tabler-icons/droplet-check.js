...
export class DileIconlibDropletCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-check')) {
  customElements.define('dile-tabler-icon-droplet-check', DileIconlibDropletCheck);
}
