...
export class DileIconlibAppsFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-apps-filled')) {
  customElements.define('dile-tabler-icon-apps-filled', DileIconlibAppsFilled);
}
