...
export class DileIconlibPentagonNumber5 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pentagon-number-5')) {
  customElements.define('dile-tabler-icon-pentagon-number-5', DileIconlibPentagonNumber5);
}
