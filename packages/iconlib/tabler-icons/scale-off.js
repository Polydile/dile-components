...
export class DileIconlibScaleOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-scale-off')) {
  customElements.define('dile-tabler-icon-scale-off', DileIconlibScaleOff);
}
