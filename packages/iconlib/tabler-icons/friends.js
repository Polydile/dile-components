...
export class DileIconlibFriends extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-friends')) {
  customElements.define('dile-tabler-icon-friends', DileIconlibFriends);
}
