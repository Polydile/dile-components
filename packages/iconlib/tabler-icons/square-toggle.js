...
export class DileIconlibSquareToggle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-toggle')) {
  customElements.define('dile-tabler-icon-square-toggle', DileIconlibSquareToggle);
}
