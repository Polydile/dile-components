...
export class DileIconlibPizzaOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pizza-off')) {
  customElements.define('dile-tabler-icon-pizza-off', DileIconlibPizzaOff);
}
