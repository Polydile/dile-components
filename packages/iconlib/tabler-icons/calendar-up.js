...
export class DileIconlibCalendarUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-calendar-up')) {
  customElements.define('dile-tabler-icon-calendar-up', DileIconlibCalendarUp);
}
