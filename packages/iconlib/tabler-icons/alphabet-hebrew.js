...
export class DileIconlibAlphabetHebrew extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-alphabet-hebrew')) {
  customElements.define('dile-tabler-icon-alphabet-hebrew', DileIconlibAlphabetHebrew);
}
