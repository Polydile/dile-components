...
export class DileIconlibBoneOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bone-off')) {
  customElements.define('dile-tabler-icon-bone-off', DileIconlibBoneOff);
}
