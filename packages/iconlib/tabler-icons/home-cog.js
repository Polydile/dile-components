...
export class DileIconlibHomeCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-cog')) {
  customElements.define('dile-tabler-icon-home-cog', DileIconlibHomeCog);
}
