...
export class DileIconlibBuildingCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-building-cog')) {
  customElements.define('dile-tabler-icon-building-cog', DileIconlibBuildingCog);
}
