...
export class DileIconlibDropletCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-cog')) {
  customElements.define('dile-tabler-icon-droplet-cog', DileIconlibDropletCog);
}
