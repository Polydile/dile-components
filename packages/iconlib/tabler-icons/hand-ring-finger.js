...
export class DileIconlibHandRingFinger extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hand-ring-finger')) {
  customElements.define('dile-tabler-icon-hand-ring-finger', DileIconlibHandRingFinger);
}
