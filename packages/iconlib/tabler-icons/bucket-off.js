...
export class DileIconlibBucketOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bucket-off')) {
  customElements.define('dile-tabler-icon-bucket-off', DileIconlibBucketOff);
}
