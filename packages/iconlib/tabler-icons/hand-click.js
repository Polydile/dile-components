...
export class DileIconlibHandClick extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hand-click')) {
  customElements.define('dile-tabler-icon-hand-click', DileIconlibHandClick);
}
