...
export class DileIconlibBarcodeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-barcode-off')) {
  customElements.define('dile-tabler-icon-barcode-off', DileIconlibBarcodeOff);
}
