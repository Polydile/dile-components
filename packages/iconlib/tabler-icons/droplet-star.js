...
export class DileIconlibDropletStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-star')) {
  customElements.define('dile-tabler-icon-droplet-star', DileIconlibDropletStar);
}
