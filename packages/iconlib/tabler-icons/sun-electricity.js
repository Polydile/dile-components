...
export class DileIconlibSunElectricity extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sun-electricity')) {
  customElements.define('dile-tabler-icon-sun-electricity', DileIconlibSunElectricity);
}
