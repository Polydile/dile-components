...
export class DileIconlibTransactionYuan extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-transaction-yuan')) {
  customElements.define('dile-tabler-icon-transaction-yuan', DileIconlibTransactionYuan);
}
