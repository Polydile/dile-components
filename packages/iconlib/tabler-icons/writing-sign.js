...
export class DileIconlibWritingSign extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-writing-sign')) {
  customElements.define('dile-tabler-icon-writing-sign', DileIconlibWritingSign);
}
