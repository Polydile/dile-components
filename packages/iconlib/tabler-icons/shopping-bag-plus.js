...
export class DileIconlibShoppingBagPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shopping-bag-plus')) {
  customElements.define('dile-tabler-icon-shopping-bag-plus', DileIconlibShoppingBagPlus);
}
