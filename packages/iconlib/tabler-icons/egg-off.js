...
export class DileIconlibEggOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-egg-off')) {
  customElements.define('dile-tabler-icon-egg-off', DileIconlibEggOff);
}
