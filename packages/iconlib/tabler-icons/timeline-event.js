...
export class DileIconlibTimelineEvent extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-timeline-event')) {
  customElements.define('dile-tabler-icon-timeline-event', DileIconlibTimelineEvent);
}
