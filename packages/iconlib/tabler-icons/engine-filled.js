...
export class DileIconlibEngineFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-engine-filled')) {
  customElements.define('dile-tabler-icon-engine-filled', DileIconlibEngineFilled);
}
