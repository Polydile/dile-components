...
export class DileIconlibMailboxOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mailbox-off')) {
  customElements.define('dile-tabler-icon-mailbox-off', DileIconlibMailboxOff);
}
