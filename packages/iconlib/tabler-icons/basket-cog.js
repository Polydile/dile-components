...
export class DileIconlibBasketCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-basket-cog')) {
  customElements.define('dile-tabler-icon-basket-cog', DileIconlibBasketCog);
}
