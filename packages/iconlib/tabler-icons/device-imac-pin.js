...
export class DileIconlibDeviceImacPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-imac-pin')) {
  customElements.define('dile-tabler-icon-device-imac-pin', DileIconlibDeviceImacPin);
}
