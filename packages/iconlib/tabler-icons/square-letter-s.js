...
export class DileIconlibSquareLetterS extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-letter-s')) {
  customElements.define('dile-tabler-icon-square-letter-s', DileIconlibSquareLetterS);
}
