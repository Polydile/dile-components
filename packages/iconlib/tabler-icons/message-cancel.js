...
export class DileIconlibMessageCancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-cancel')) {
  customElements.define('dile-tabler-icon-message-cancel', DileIconlibMessageCancel);
}
