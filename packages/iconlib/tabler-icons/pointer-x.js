...
export class DileIconlibPointerX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pointer-x')) {
  customElements.define('dile-tabler-icon-pointer-x', DileIconlibPointerX);
}
