...
export class DileIconlibTableRow extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-table-row')) {
  customElements.define('dile-tabler-icon-table-row', DileIconlibTableRow);
}
