...
export class DileIconlibWorldPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-pin')) {
  customElements.define('dile-tabler-icon-world-pin', DileIconlibWorldPin);
}
