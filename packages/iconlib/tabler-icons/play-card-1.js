...
export class DileIconlibPlayCard1 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-1')) {
  customElements.define('dile-tabler-icon-play-card-1', DileIconlibPlayCard1);
}
