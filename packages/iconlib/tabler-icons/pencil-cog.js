...
export class DileIconlibPencilCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pencil-cog')) {
  customElements.define('dile-tabler-icon-pencil-cog', DileIconlibPencilCog);
}
