...
export class DileIconlibAffiliate extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-affiliate')) {
  customElements.define('dile-tabler-icon-affiliate', DileIconlibAffiliate);
}
