...
export class DileIconlibFlagHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flag-heart')) {
  customElements.define('dile-tabler-icon-flag-heart', DileIconlibFlagHeart);
}
