...
export class DileIconlibWashGentle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-wash-gentle')) {
  customElements.define('dile-tabler-icon-wash-gentle', DileIconlibWashGentle);
}
