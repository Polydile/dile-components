...
export class DileIconlibBedOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bed-off')) {
  customElements.define('dile-tabler-icon-bed-off', DileIconlibBedOff);
}
