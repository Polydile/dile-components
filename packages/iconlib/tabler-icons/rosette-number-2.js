...
export class DileIconlibRosetteNumber2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rosette-number-2')) {
  customElements.define('dile-tabler-icon-rosette-number-2', DileIconlibRosetteNumber2);
}
