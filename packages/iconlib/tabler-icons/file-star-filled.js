...
export class DileIconlibFileStarFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-star-filled')) {
  customElements.define('dile-tabler-icon-file-star-filled', DileIconlibFileStarFilled);
}
