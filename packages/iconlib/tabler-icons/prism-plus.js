...
export class DileIconlibPrismPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-prism-plus')) {
  customElements.define('dile-tabler-icon-prism-plus', DileIconlibPrismPlus);
}
