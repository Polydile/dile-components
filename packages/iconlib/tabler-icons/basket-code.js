...
export class DileIconlibBasketCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-basket-code')) {
  customElements.define('dile-tabler-icon-basket-code', DileIconlibBasketCode);
}
