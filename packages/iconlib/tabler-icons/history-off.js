...
export class DileIconlibHistoryOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-history-off')) {
  customElements.define('dile-tabler-icon-history-off', DileIconlibHistoryOff);
}
