...
export class DileIconlibLockExclamation extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-exclamation')) {
  customElements.define('dile-tabler-icon-lock-exclamation', DileIconlibLockExclamation);
}
