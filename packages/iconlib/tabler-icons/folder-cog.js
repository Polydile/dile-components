...
export class DileIconlibFolderCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-folder-cog')) {
  customElements.define('dile-tabler-icon-folder-cog', DileIconlibFolderCog);
}
