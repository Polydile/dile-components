...
export class DileIconlibBoxOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-box-off')) {
  customElements.define('dile-tabler-icon-box-off', DileIconlibBoxOff);
}
