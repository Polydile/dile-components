...
export class DileIconlibFlagDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flag-down')) {
  customElements.define('dile-tabler-icon-flag-down', DileIconlibFlagDown);
}
