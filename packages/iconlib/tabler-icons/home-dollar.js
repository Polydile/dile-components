...
export class DileIconlibHomeDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-dollar')) {
  customElements.define('dile-tabler-icon-home-dollar', DileIconlibHomeDollar);
}
