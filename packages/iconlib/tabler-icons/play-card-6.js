...
export class DileIconlibPlayCard6 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-6')) {
  customElements.define('dile-tabler-icon-play-card-6', DileIconlibPlayCard6);
}
