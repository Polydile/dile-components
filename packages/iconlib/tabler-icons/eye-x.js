...
export class DileIconlibEyeX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-x')) {
  customElements.define('dile-tabler-icon-eye-x', DileIconlibEyeX);
}
