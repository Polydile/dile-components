...
export class DileIconlibCameraDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-camera-dollar')) {
  customElements.define('dile-tabler-icon-camera-dollar', DileIconlibCameraDollar);
}
