...
export class DileIconlibBorderRightPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-border-right-plus')) {
  customElements.define('dile-tabler-icon-border-right-plus', DileIconlibBorderRightPlus);
}
