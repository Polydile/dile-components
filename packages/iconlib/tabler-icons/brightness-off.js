...
export class DileIconlibBrightnessOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-brightness-off')) {
  customElements.define('dile-tabler-icon-brightness-off', DileIconlibBrightnessOff);
}
