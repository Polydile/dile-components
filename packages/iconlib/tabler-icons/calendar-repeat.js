...
export class DileIconlibCalendarRepeat extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-calendar-repeat')) {
  customElements.define('dile-tabler-icon-calendar-repeat', DileIconlibCalendarRepeat);
}
