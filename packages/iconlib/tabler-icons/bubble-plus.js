...
export class DileIconlibBubblePlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bubble-plus')) {
  customElements.define('dile-tabler-icon-bubble-plus', DileIconlibBubblePlus);
}
