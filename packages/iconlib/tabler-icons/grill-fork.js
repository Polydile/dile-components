...
export class DileIconlibGrillFork extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-grill-fork')) {
  customElements.define('dile-tabler-icon-grill-fork', DileIconlibGrillFork);
}
