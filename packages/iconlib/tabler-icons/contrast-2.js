...
export class DileIconlibContrast2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-contrast-2')) {
  customElements.define('dile-tabler-icon-contrast-2', DileIconlibContrast2);
}
