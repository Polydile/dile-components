...
export class DileIconlibClef extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-clef')) {
  customElements.define('dile-tabler-icon-clef', DileIconlibClef);
}
