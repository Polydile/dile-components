...
export class DileIconlibBugFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bug-filled')) {
  customElements.define('dile-tabler-icon-bug-filled', DileIconlibBugFilled);
}
