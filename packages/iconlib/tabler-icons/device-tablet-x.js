...
export class DileIconlibDeviceTabletX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-tablet-x')) {
  customElements.define('dile-tabler-icon-device-tablet-x', DileIconlibDeviceTabletX);
}
