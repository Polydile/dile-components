...
export class DileIconlibCrutches extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-crutches')) {
  customElements.define('dile-tabler-icon-crutches', DileIconlibCrutches);
}
