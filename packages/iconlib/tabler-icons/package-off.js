...
export class DileIconlibPackageOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-package-off')) {
  customElements.define('dile-tabler-icon-package-off', DileIconlibPackageOff);
}
