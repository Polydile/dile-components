...
export class DileIconlibFaceMaskOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-face-mask-off')) {
  customElements.define('dile-tabler-icon-face-mask-off', DileIconlibFaceMaskOff);
}
