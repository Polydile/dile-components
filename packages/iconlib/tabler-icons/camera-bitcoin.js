...
export class DileIconlibCameraBitcoin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-camera-bitcoin')) {
  customElements.define('dile-tabler-icon-camera-bitcoin', DileIconlibCameraBitcoin);
}
