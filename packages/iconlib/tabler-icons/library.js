...
export class DileIconlibLibrary extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-library')) {
  customElements.define('dile-tabler-icon-library', DileIconlibLibrary);
}
