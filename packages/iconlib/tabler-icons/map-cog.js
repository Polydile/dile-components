...
export class DileIconlibMapCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-cog')) {
  customElements.define('dile-tabler-icon-map-cog', DileIconlibMapCog);
}
