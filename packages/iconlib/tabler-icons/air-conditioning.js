...
export class DileIconlibAirConditioning extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-air-conditioning')) {
  customElements.define('dile-tabler-icon-air-conditioning', DileIconlibAirConditioning);
}
