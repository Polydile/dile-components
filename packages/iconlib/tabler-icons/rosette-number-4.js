...
export class DileIconlibRosetteNumber4 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rosette-number-4')) {
  customElements.define('dile-tabler-icon-rosette-number-4', DileIconlibRosetteNumber4);
}
