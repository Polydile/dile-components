...
export class DileIconlibFilterPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-pin')) {
  customElements.define('dile-tabler-icon-filter-pin', DileIconlibFilterPin);
}
