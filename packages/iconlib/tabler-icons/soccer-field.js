...
export class DileIconlibSoccerField extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-soccer-field')) {
  customElements.define('dile-tabler-icon-soccer-field', DileIconlibSoccerField);
}
