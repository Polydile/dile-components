...
export class DileIconlibPhoneCallFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-phone-call-filled')) {
  customElements.define('dile-tabler-icon-phone-call-filled', DileIconlibPhoneCallFilled);
}
