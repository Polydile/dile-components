...
export class DileIconlibMailUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mail-up')) {
  customElements.define('dile-tabler-icon-mail-up', DileIconlibMailUp);
}
