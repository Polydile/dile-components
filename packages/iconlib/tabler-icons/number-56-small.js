...
export class DileIconlibNumber56Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-56-small')) {
  customElements.define('dile-tabler-icon-number-56-small', DileIconlibNumber56Small);
}
