...
export class DileIconlibPhotoAi extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-ai')) {
  customElements.define('dile-tabler-icon-photo-ai', DileIconlibPhotoAi);
}
