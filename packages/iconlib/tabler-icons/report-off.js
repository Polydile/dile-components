...
export class DileIconlibReportOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-report-off')) {
  customElements.define('dile-tabler-icon-report-off', DileIconlibReportOff);
}
