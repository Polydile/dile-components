...
export class DileIconlibCameraSelfie extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-camera-selfie')) {
  customElements.define('dile-tabler-icon-camera-selfie', DileIconlibCameraSelfie);
}
