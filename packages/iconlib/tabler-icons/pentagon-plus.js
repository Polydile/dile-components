...
export class DileIconlibPentagonPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pentagon-plus')) {
  customElements.define('dile-tabler-icon-pentagon-plus', DileIconlibPentagonPlus);
}
