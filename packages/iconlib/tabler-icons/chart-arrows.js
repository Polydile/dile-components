...
export class DileIconlibChartArrows extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-chart-arrows')) {
  customElements.define('dile-tabler-icon-chart-arrows', DileIconlibChartArrows);
}
