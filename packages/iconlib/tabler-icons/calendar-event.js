...
export class DileIconlibCalendarEvent extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-calendar-event')) {
  customElements.define('dile-tabler-icon-calendar-event', DileIconlibCalendarEvent);
}
