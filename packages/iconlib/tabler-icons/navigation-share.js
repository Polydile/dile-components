...
export class DileIconlibNavigationShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-navigation-share')) {
  customElements.define('dile-tabler-icon-navigation-share', DileIconlibNavigationShare);
}
