...
export class DileIconlibPlayCardQ extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-q')) {
  customElements.define('dile-tabler-icon-play-card-q', DileIconlibPlayCardQ);
}
