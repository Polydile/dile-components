...
export class DileIconlibPointerBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pointer-bolt')) {
  customElements.define('dile-tabler-icon-pointer-bolt', DileIconlibPointerBolt);
}
