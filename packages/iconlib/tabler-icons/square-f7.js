...
export class DileIconlibSquareF7 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-f7')) {
  customElements.define('dile-tabler-icon-square-f7', DileIconlibSquareF7);
}
