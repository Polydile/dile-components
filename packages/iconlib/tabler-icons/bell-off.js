...
export class DileIconlibBellOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-off')) {
  customElements.define('dile-tabler-icon-bell-off', DileIconlibBellOff);
}
