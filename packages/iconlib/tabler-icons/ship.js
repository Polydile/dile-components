...
export class DileIconlibShip extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ship')) {
  customElements.define('dile-tabler-icon-ship', DileIconlibShip);
}
