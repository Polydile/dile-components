...
export class DileIconlibRosetteNumber9 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rosette-number-9')) {
  customElements.define('dile-tabler-icon-rosette-number-9', DileIconlibRosetteNumber9);
}
