...
export class DileIconlibShieldCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shield-code')) {
  customElements.define('dile-tabler-icon-shield-code', DileIconlibShieldCode);
}
