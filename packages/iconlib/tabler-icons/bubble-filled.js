...
export class DileIconlibBubbleFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bubble-filled')) {
  customElements.define('dile-tabler-icon-bubble-filled', DileIconlibBubbleFilled);
}
