...
export class DileIconlibPooFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-poo-filled')) {
  customElements.define('dile-tabler-icon-poo-filled', DileIconlibPooFilled);
}
