...
export class DileIconlibTimeDuration10 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-time-duration-10')) {
  customElements.define('dile-tabler-icon-time-duration-10', DileIconlibTimeDuration10);
}
