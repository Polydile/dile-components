...
export class DileIconlibChessKingFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-chess-king-filled')) {
  customElements.define('dile-tabler-icon-chess-king-filled', DileIconlibChessKingFilled);
}
