...
export class DileIconlibAppsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-apps-off')) {
  customElements.define('dile-tabler-icon-apps-off', DileIconlibAppsOff);
}
