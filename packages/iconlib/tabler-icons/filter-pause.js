...
export class DileIconlibFilterPause extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-pause')) {
  customElements.define('dile-tabler-icon-filter-pause', DileIconlibFilterPause);
}
