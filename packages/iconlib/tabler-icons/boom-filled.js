...
export class DileIconlibBoomFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-boom-filled')) {
  customElements.define('dile-tabler-icon-boom-filled', DileIconlibBoomFilled);
}
