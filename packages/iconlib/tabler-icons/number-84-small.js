...
export class DileIconlibNumber84Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-84-small')) {
  customElements.define('dile-tabler-icon-number-84-small', DileIconlibNumber84Small);
}
