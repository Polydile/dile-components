...
export class DileIconlibMushroomOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mushroom-off')) {
  customElements.define('dile-tabler-icon-mushroom-off', DileIconlibMushroomOff);
}
