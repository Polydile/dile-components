...
export class DileIconlibRulerOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ruler-off')) {
  customElements.define('dile-tabler-icon-ruler-off', DileIconlibRulerOff);
}
