...
export class DileIconlibMathMax extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-math-max')) {
  customElements.define('dile-tabler-icon-math-max', DileIconlibMathMax);
}
