...
export class DileIconlibEyeDotted extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-dotted')) {
  customElements.define('dile-tabler-icon-eye-dotted', DileIconlibEyeDotted);
}
