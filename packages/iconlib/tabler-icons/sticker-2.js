...
export class DileIconlibSticker2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sticker-2')) {
  customElements.define('dile-tabler-icon-sticker-2', DileIconlibSticker2);
}
