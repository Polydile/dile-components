...
export class DileIconlibHexagonPlus2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-plus-2')) {
  customElements.define('dile-tabler-icon-hexagon-plus-2', DileIconlibHexagonPlus2);
}
