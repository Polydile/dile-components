...
export class DileIconlibSpiderFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-spider-filled')) {
  customElements.define('dile-tabler-icon-spider-filled', DileIconlibSpiderFilled);
}
