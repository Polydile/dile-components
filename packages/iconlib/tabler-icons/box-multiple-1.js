...
export class DileIconlibBoxMultiple1 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-box-multiple-1')) {
  customElements.define('dile-tabler-icon-box-multiple-1', DileIconlibBoxMultiple1);
}
