...
export class DileIconlibSoup extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-soup')) {
  customElements.define('dile-tabler-icon-soup', DileIconlibSoup);
}
