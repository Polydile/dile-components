...
export class DileIconlibNumber92Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-92-small')) {
  customElements.define('dile-tabler-icon-number-92-small', DileIconlibNumber92Small);
}
