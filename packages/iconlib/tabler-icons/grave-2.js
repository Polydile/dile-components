...
export class DileIconlibGrave2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-grave-2')) {
  customElements.define('dile-tabler-icon-grave-2', DileIconlibGrave2);
}
