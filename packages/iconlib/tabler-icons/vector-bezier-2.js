...
export class DileIconlibVectorBezier2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-vector-bezier-2')) {
  customElements.define('dile-tabler-icon-vector-bezier-2', DileIconlibVectorBezier2);
}
