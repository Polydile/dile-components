...
export class DileIconlibAddressBookOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-address-book-off')) {
  customElements.define('dile-tabler-icon-address-book-off', DileIconlibAddressBookOff);
}
