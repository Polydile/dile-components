...
export class DileIconlibWorldPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-plus')) {
  customElements.define('dile-tabler-icon-world-plus', DileIconlibWorldPlus);
}
