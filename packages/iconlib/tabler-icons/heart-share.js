...
export class DileIconlibHeartShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-heart-share')) {
  customElements.define('dile-tabler-icon-heart-share', DileIconlibHeartShare);
}
