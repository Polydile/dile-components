...
export class DileIconlibVectorBezierArc extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-vector-bezier-arc')) {
  customElements.define('dile-tabler-icon-vector-bezier-arc', DileIconlibVectorBezierArc);
}
