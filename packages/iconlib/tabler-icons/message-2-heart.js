...
export class DileIconlibMessage2Heart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-2-heart')) {
  customElements.define('dile-tabler-icon-message-2-heart', DileIconlibMessage2Heart);
}
