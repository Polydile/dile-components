...
export class DileIconlibZoomMoney extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-zoom-money')) {
  customElements.define('dile-tabler-icon-zoom-money', DileIconlibZoomMoney);
}
