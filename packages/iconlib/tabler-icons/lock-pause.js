...
export class DileIconlibLockPause extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-pause')) {
  customElements.define('dile-tabler-icon-lock-pause', DileIconlibLockPause);
}
