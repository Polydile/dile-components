...
export class DileIconlibTrees extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-trees')) {
  customElements.define('dile-tabler-icon-trees', DileIconlibTrees);
}
