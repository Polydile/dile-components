...
export class DileIconlibNavigationBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-navigation-bolt')) {
  customElements.define('dile-tabler-icon-navigation-bolt', DileIconlibNavigationBolt);
}
