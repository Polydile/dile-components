...
export class DileIconlibCylinderOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cylinder-off')) {
  customElements.define('dile-tabler-icon-cylinder-off', DileIconlibCylinderOff);
}
