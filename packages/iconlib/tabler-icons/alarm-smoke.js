...
export class DileIconlibAlarmSmoke extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-alarm-smoke')) {
  customElements.define('dile-tabler-icon-alarm-smoke', DileIconlibAlarmSmoke);
}
