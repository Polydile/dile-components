...
export class DileIconlibHeartCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-heart-check')) {
  customElements.define('dile-tabler-icon-heart-check', DileIconlibHeartCheck);
}
