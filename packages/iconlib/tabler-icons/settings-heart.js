...
export class DileIconlibSettingsHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-settings-heart')) {
  customElements.define('dile-tabler-icon-settings-heart', DileIconlibSettingsHeart);
}
