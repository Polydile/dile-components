...
export class DileIconlibMapPinDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-pin-down')) {
  customElements.define('dile-tabler-icon-map-pin-down', DileIconlibMapPinDown);
}
