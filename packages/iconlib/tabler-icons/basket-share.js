...
export class DileIconlibBasketShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-basket-share')) {
  customElements.define('dile-tabler-icon-basket-share', DileIconlibBasketShare);
}
