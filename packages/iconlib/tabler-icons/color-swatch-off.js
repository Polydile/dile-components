...
export class DileIconlibColorSwatchOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-color-swatch-off')) {
  customElements.define('dile-tabler-icon-color-swatch-off', DileIconlibColorSwatchOff);
}
