...
export class DileIconlibRewindForward60 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rewind-forward-60')) {
  customElements.define('dile-tabler-icon-rewind-forward-60', DileIconlibRewindForward60);
}
