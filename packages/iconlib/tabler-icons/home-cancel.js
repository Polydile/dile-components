...
export class DileIconlibHomeCancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-cancel')) {
  customElements.define('dile-tabler-icon-home-cancel', DileIconlibHomeCancel);
}
