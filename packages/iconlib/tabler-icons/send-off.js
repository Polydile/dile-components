...
export class DileIconlibSendOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-send-off')) {
  customElements.define('dile-tabler-icon-send-off', DileIconlibSendOff);
}
