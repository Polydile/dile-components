...
export class DileIconlibSettingsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-settings-off')) {
  customElements.define('dile-tabler-icon-settings-off', DileIconlibSettingsOff);
}
