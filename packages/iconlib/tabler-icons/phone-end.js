...
export class DileIconlibPhoneEnd extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-phone-end')) {
  customElements.define('dile-tabler-icon-phone-end', DileIconlibPhoneEnd);
}
