...
export class DileIconlibRouteAltRight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-route-alt-right')) {
  customElements.define('dile-tabler-icon-route-alt-right', DileIconlibRouteAltRight);
}
