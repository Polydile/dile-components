...
export class DileIconlibTemperatureSun extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-temperature-sun')) {
  customElements.define('dile-tabler-icon-temperature-sun', DileIconlibTemperatureSun);
}
