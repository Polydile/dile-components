...
export class DileIconlibHexagonNumber3Filled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-number-3-filled')) {
  customElements.define('dile-tabler-icon-hexagon-number-3-filled', DileIconlibHexagonNumber3Filled);
}
