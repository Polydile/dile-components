...
export class DileIconlibDatabaseCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-database-cog')) {
  customElements.define('dile-tabler-icon-database-cog', DileIconlibDatabaseCog);
}
