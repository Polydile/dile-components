...
export class DileIconlibNumber32Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-32-small')) {
  customElements.define('dile-tabler-icon-number-32-small', DileIconlibNumber32Small);
}
