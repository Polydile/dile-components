...
export class DileIconlibZoomOutArea extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-zoom-out-area')) {
  customElements.define('dile-tabler-icon-zoom-out-area', DileIconlibZoomOutArea);
}
