...
export class DileIconlibAdCircleOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ad-circle-off')) {
  customElements.define('dile-tabler-icon-ad-circle-off', DileIconlibAdCircleOff);
}
