...
export class DileIconlibBallFootballOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ball-football-off')) {
  customElements.define('dile-tabler-icon-ball-football-off', DileIconlibBallFootballOff);
}
