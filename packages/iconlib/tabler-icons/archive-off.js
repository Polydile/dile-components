...
export class DileIconlibArchiveOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-archive-off')) {
  customElements.define('dile-tabler-icon-archive-off', DileIconlibArchiveOff);
}
