...
export class DileIconlibPentagonNumber8 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pentagon-number-8')) {
  customElements.define('dile-tabler-icon-pentagon-number-8', DileIconlibPentagonNumber8);
}
