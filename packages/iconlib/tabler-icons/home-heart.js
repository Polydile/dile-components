...
export class DileIconlibHomeHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-heart')) {
  customElements.define('dile-tabler-icon-home-heart', DileIconlibHomeHeart);
}
