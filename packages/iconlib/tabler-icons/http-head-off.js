...
export class DileIconlibHttpHeadOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-http-head-off')) {
  customElements.define('dile-tabler-icon-http-head-off', DileIconlibHttpHeadOff);
}
