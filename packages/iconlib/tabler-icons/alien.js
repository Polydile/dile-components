...
export class DileIconlibAlien extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-alien')) {
  customElements.define('dile-tabler-icon-alien', DileIconlibAlien);
}
