...
export class DileIconlibFileSadFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-sad-filled')) {
  customElements.define('dile-tabler-icon-file-sad-filled', DileIconlibFileSadFilled);
}
