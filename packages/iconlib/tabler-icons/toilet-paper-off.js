...
export class DileIconlibToiletPaperOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-toilet-paper-off')) {
  customElements.define('dile-tabler-icon-toilet-paper-off', DileIconlibToiletPaperOff);
}
