...
export class DileIconlibKeyframesFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-keyframes-filled')) {
  customElements.define('dile-tabler-icon-keyframes-filled', DileIconlibKeyframesFilled);
}
