...
export class DileIconlibAwardFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-award-filled')) {
  customElements.define('dile-tabler-icon-award-filled', DileIconlibAwardFilled);
}
