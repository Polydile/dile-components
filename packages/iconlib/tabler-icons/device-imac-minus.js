...
export class DileIconlibDeviceImacMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-imac-minus')) {
  customElements.define('dile-tabler-icon-device-imac-minus', DileIconlibDeviceImacMinus);
}
