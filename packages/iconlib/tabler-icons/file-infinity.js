...
export class DileIconlibFileInfinity extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-infinity')) {
  customElements.define('dile-tabler-icon-file-infinity', DileIconlibFileInfinity);
}
