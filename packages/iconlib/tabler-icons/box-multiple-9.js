...
export class DileIconlibBoxMultiple9 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-box-multiple-9')) {
  customElements.define('dile-tabler-icon-box-multiple-9', DileIconlibBoxMultiple9);
}
