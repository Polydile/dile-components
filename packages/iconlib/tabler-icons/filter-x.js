...
export class DileIconlibFilterX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-x')) {
  customElements.define('dile-tabler-icon-filter-x', DileIconlibFilterX);
}
