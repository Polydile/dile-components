...
export class DileIconlibCloudPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cloud-plus')) {
  customElements.define('dile-tabler-icon-cloud-plus', DileIconlibCloudPlus);
}
