...
export class DileIconlibTargetArrow extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-target-arrow')) {
  customElements.define('dile-tabler-icon-target-arrow', DileIconlibTargetArrow);
}
