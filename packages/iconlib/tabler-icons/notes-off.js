...
export class DileIconlibNotesOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-notes-off')) {
  customElements.define('dile-tabler-icon-notes-off', DileIconlibNotesOff);
}
