...
export class DileIconlibNumber22Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-22-small')) {
  customElements.define('dile-tabler-icon-number-22-small', DileIconlibNumber22Small);
}
