...
export class DileIconlibWorldCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-cog')) {
  customElements.define('dile-tabler-icon-world-cog', DileIconlibWorldCog);
}
