...
export class DileIconlibTarget2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-target-2')) {
  customElements.define('dile-tabler-icon-target-2', DileIconlibTarget2);
}
