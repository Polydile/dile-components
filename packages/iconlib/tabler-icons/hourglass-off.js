...
export class DileIconlibHourglassOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hourglass-off')) {
  customElements.define('dile-tabler-icon-hourglass-off', DileIconlibHourglassOff);
}
