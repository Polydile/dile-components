...
export class DileIconlibCookieMan extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cookie-man')) {
  customElements.define('dile-tabler-icon-cookie-man', DileIconlibCookieMan);
}
