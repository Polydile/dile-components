...
export class DileIconlibHelmetOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-helmet-off')) {
  customElements.define('dile-tabler-icon-helmet-off', DileIconlibHelmetOff);
}
