...
export class DileIconlibFilterCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-cog')) {
  customElements.define('dile-tabler-icon-filter-cog', DileIconlibFilterCog);
}
