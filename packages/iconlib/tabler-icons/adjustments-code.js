...
export class DileIconlibAdjustmentsCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-adjustments-code')) {
  customElements.define('dile-tabler-icon-adjustments-code', DileIconlibAdjustmentsCode);
}
