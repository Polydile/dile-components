...
export class DileIconlibShieldUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shield-up')) {
  customElements.define('dile-tabler-icon-shield-up', DileIconlibShieldUp);
}
