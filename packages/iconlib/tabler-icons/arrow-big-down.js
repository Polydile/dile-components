...
export class DileIconlibArrowBigDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-arrow-big-down')) {
  customElements.define('dile-tabler-icon-arrow-big-down', DileIconlibArrowBigDown);
}
