...
export class DileIconlibRouterOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-router-off')) {
  customElements.define('dile-tabler-icon-router-off', DileIconlibRouterOff);
}
