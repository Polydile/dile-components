...
export class DileIconlibWorldBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-bolt')) {
  customElements.define('dile-tabler-icon-world-bolt', DileIconlibWorldBolt);
}
