...
export class DileIconlibDental extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-dental')) {
  customElements.define('dile-tabler-icon-dental', DileIconlibDental);
}
