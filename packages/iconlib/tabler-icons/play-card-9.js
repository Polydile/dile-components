...
export class DileIconlibPlayCard9 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-9')) {
  customElements.define('dile-tabler-icon-play-card-9', DileIconlibPlayCard9);
}
