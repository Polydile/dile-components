...
export class DileIconlibAB2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-a-b-2')) {
  customElements.define('dile-tabler-icon-a-b-2', DileIconlibAB2);
}
