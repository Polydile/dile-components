...
export class DileIconlibMoneybagEdit extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-moneybag-edit')) {
  customElements.define('dile-tabler-icon-moneybag-edit', DileIconlibMoneybagEdit);
}
