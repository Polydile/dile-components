...
export class DileIconlibHourglassFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hourglass-filled')) {
  customElements.define('dile-tabler-icon-hourglass-filled', DileIconlibHourglassFilled);
}
