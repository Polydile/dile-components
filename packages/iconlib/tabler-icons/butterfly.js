...
export class DileIconlibButterfly extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-butterfly')) {
  customElements.define('dile-tabler-icon-butterfly', DileIconlibButterfly);
}
