...
export class DileIconlibSettingsDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-settings-down')) {
  customElements.define('dile-tabler-icon-settings-down', DileIconlibSettingsDown);
}
