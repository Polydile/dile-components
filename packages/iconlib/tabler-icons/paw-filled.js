...
export class DileIconlibPawFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-paw-filled')) {
  customElements.define('dile-tabler-icon-paw-filled', DileIconlibPawFilled);
}
