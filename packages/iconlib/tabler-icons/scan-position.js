...
export class DileIconlibScanPosition extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-scan-position')) {
  customElements.define('dile-tabler-icon-scan-position', DileIconlibScanPosition);
}
