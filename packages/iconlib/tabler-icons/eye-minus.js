...
export class DileIconlibEyeMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-minus')) {
  customElements.define('dile-tabler-icon-eye-minus', DileIconlibEyeMinus);
}
