...
export class DileIconlibHexagonMinus2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-minus-2')) {
  customElements.define('dile-tabler-icon-hexagon-minus-2', DileIconlibHexagonMinus2);
}
