...
export class DileIconlibCarFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-car-filled')) {
  customElements.define('dile-tabler-icon-car-filled', DileIconlibCarFilled);
}
