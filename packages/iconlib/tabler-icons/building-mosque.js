...
export class DileIconlibBuildingMosque extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-building-mosque')) {
  customElements.define('dile-tabler-icon-building-mosque', DileIconlibBuildingMosque);
}
