...
export class DileIconlibFolderRoot extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-folder-root')) {
  customElements.define('dile-tabler-icon-folder-root', DileIconlibFolderRoot);
}
