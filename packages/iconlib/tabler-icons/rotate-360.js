...
export class DileIconlibRotate360 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rotate-360')) {
  customElements.define('dile-tabler-icon-rotate-360', DileIconlibRotate360);
}
