...
export class DileIconlibBalloonOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-balloon-off')) {
  customElements.define('dile-tabler-icon-balloon-off', DileIconlibBalloonOff);
}
