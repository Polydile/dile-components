...
export class DileIconlibFlagSpark extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flag-spark')) {
  customElements.define('dile-tabler-icon-flag-spark', DileIconlibFlagSpark);
}
