...
export class DileIconlibPointerCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pointer-cog')) {
  customElements.define('dile-tabler-icon-pointer-cog', DileIconlibPointerCog);
}
