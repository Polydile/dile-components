...
export class DileIconlibAdjustmentsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-adjustments-off')) {
  customElements.define('dile-tabler-icon-adjustments-off', DileIconlibAdjustmentsOff);
}
