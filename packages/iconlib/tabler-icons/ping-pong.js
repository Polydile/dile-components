...
export class DileIconlibPingPong extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ping-pong')) {
  customElements.define('dile-tabler-icon-ping-pong', DileIconlibPingPong);
}
