...
export class DileIconlibBrandPinterest extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-brand-pinterest')) {
  customElements.define('dile-tabler-icon-brand-pinterest', DileIconlibBrandPinterest);
}
