...
export class DileIconlibNumber96Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-96-small')) {
  customElements.define('dile-tabler-icon-number-96-small', DileIconlibNumber96Small);
}
