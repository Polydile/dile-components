...
export class DileIconlibDeviceTabletCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-tablet-cog')) {
  customElements.define('dile-tabler-icon-device-tablet-cog', DileIconlibDeviceTabletCog);
}
