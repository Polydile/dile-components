...
export class DileIconlibPhotoPause extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-pause')) {
  customElements.define('dile-tabler-icon-photo-pause', DileIconlibPhotoPause);
}
