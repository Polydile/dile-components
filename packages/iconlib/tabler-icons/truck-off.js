...
export class DileIconlibTruckOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-truck-off')) {
  customElements.define('dile-tabler-icon-truck-off', DileIconlibTruckOff);
}
