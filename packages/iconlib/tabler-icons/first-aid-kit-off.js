...
export class DileIconlibFirstAidKitOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-first-aid-kit-off')) {
  customElements.define('dile-tabler-icon-first-aid-kit-off', DileIconlibFirstAidKitOff);
}
