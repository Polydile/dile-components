...
export class DileIconlibDoorHanger extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-door-hanger')) {
  customElements.define('dile-tabler-icon-door-hanger', DileIconlibDoorHanger);
}
