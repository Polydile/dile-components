...
export class DileIconlibBatteryEco extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-battery-eco')) {
  customElements.define('dile-tabler-icon-battery-eco', DileIconlibBatteryEco);
}
