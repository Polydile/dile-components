...
export class DileIconlibMessageDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-down')) {
  customElements.define('dile-tabler-icon-message-down', DileIconlibMessageDown);
}
