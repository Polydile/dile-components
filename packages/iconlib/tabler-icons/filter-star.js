...
export class DileIconlibFilterStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-star')) {
  customElements.define('dile-tabler-icon-filter-star', DileIconlibFilterStar);
}
