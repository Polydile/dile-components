...
export class DileIconlibSquareNumber9 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-number-9')) {
  customElements.define('dile-tabler-icon-square-number-9', DileIconlibSquareNumber9);
}
