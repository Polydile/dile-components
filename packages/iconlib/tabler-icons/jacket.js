...
export class DileIconlibJacket extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-jacket')) {
  customElements.define('dile-tabler-icon-jacket', DileIconlibJacket);
}
