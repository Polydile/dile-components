...
export class DileIconlibShieldLock extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shield-lock')) {
  customElements.define('dile-tabler-icon-shield-lock', DileIconlibShieldLock);
}
