...
export class DileIconlibDeviceSim3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-sim-3')) {
  customElements.define('dile-tabler-icon-device-sim-3', DileIconlibDeviceSim3);
}
