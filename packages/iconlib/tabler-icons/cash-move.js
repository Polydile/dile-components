...
export class DileIconlibCashMove extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cash-move')) {
  customElements.define('dile-tabler-icon-cash-move', DileIconlibCashMove);
}
