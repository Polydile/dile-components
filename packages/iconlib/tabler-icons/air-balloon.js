...
export class DileIconlibAirBalloon extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-air-balloon')) {
  customElements.define('dile-tabler-icon-air-balloon', DileIconlibAirBalloon);
}
