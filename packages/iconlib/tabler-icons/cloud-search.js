...
export class DileIconlibCloudSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cloud-search')) {
  customElements.define('dile-tabler-icon-cloud-search', DileIconlibCloudSearch);
}
