...
export class DileIconlibEmpathize extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-empathize')) {
  customElements.define('dile-tabler-icon-empathize', DileIconlibEmpathize);
}
