...
export class DileIconlibDeviceGamepad extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-gamepad')) {
  customElements.define('dile-tabler-icon-device-gamepad', DileIconlibDeviceGamepad);
}
