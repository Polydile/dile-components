...
export class DileIconlibDevicesStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-star')) {
  customElements.define('dile-tabler-icon-devices-star', DileIconlibDevicesStar);
}
