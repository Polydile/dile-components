...
export class DileIconlibBellCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-cog')) {
  customElements.define('dile-tabler-icon-bell-cog', DileIconlibBellCog);
}
