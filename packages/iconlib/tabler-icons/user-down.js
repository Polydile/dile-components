...
export class DileIconlibUserDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-user-down')) {
  customElements.define('dile-tabler-icon-user-down', DileIconlibUserDown);
}
