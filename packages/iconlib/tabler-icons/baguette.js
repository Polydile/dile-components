...
export class DileIconlibBaguette extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-baguette')) {
  customElements.define('dile-tabler-icon-baguette', DileIconlibBaguette);
}
