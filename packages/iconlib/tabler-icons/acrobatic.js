...
export class DileIconlibAcrobatic extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-acrobatic')) {
  customElements.define('dile-tabler-icon-acrobatic', DileIconlibAcrobatic);
}
