...
export class DileIconlibDeviceWatchX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-watch-x')) {
  customElements.define('dile-tabler-icon-device-watch-x', DileIconlibDeviceWatchX);
}
