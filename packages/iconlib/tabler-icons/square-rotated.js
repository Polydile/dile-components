...
export class DileIconlibSquareRotated extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-rotated')) {
  customElements.define('dile-tabler-icon-square-rotated', DileIconlibSquareRotated);
}
