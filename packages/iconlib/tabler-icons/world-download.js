...
export class DileIconlibWorldDownload extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-download')) {
  customElements.define('dile-tabler-icon-world-download', DileIconlibWorldDownload);
}
