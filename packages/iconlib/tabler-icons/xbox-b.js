...
export class DileIconlibXboxB extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-xbox-b')) {
  customElements.define('dile-tabler-icon-xbox-b', DileIconlibXboxB);
}
