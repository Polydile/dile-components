...
export class DileIconlibArrowsShuffle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-arrows-shuffle')) {
  customElements.define('dile-tabler-icon-arrows-shuffle', DileIconlibArrowsShuffle);
}
