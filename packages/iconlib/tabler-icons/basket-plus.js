...
export class DileIconlibBasketPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-basket-plus')) {
  customElements.define('dile-tabler-icon-basket-plus', DileIconlibBasketPlus);
}
