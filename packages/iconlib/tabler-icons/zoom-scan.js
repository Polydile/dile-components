...
export class DileIconlibZoomScan extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-zoom-scan')) {
  customElements.define('dile-tabler-icon-zoom-scan', DileIconlibZoomScan);
}
