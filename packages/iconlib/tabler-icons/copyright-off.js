...
export class DileIconlibCopyrightOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-copyright-off')) {
  customElements.define('dile-tabler-icon-copyright-off', DileIconlibCopyrightOff);
}
