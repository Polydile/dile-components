...
export class DileIconlibDevicesShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-share')) {
  customElements.define('dile-tabler-icon-devices-share', DileIconlibDevicesShare);
}
