...
export class DileIconlibWheatOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-wheat-off')) {
  customElements.define('dile-tabler-icon-wheat-off', DileIconlibWheatOff);
}
