...
export class DileIconlibNumber34Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-34-small')) {
  customElements.define('dile-tabler-icon-number-34-small', DileIconlibNumber34Small);
}
