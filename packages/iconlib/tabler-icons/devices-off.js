...
export class DileIconlibDevicesOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-off')) {
  customElements.define('dile-tabler-icon-devices-off', DileIconlibDevicesOff);
}
