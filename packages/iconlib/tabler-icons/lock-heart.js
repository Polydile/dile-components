...
export class DileIconlibLockHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-heart')) {
  customElements.define('dile-tabler-icon-lock-heart', DileIconlibLockHeart);
}
