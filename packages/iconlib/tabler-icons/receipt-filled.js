...
export class DileIconlibReceiptFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-receipt-filled')) {
  customElements.define('dile-tabler-icon-receipt-filled', DileIconlibReceiptFilled);
}
