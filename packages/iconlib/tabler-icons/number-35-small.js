...
export class DileIconlibNumber35Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-35-small')) {
  customElements.define('dile-tabler-icon-number-35-small', DileIconlibNumber35Small);
}
