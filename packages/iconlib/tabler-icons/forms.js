...
export class DileIconlibForms extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-forms')) {
  customElements.define('dile-tabler-icon-forms', DileIconlibForms);
}
