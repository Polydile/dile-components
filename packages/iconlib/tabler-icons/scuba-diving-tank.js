...
export class DileIconlibScubaDivingTank extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-scuba-diving-tank')) {
  customElements.define('dile-tabler-icon-scuba-diving-tank', DileIconlibScubaDivingTank);
}
