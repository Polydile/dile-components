...
export class DileIconlibBorderStyle2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-border-style-2')) {
  customElements.define('dile-tabler-icon-border-style-2', DileIconlibBorderStyle2);
}
