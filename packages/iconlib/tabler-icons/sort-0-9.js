...
export class DileIconlibSort09 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sort-0-9')) {
  customElements.define('dile-tabler-icon-sort-0-9', DileIconlibSort09);
}
