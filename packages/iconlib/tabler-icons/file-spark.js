...
export class DileIconlibFileSpark extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-spark')) {
  customElements.define('dile-tabler-icon-file-spark', DileIconlibFileSpark);
}
