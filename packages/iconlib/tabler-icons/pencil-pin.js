...
export class DileIconlibPencilPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pencil-pin')) {
  customElements.define('dile-tabler-icon-pencil-pin', DileIconlibPencilPin);
}
