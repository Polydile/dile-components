...
export class DileIconlibMickey extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mickey')) {
  customElements.define('dile-tabler-icon-mickey', DileIconlibMickey);
}
