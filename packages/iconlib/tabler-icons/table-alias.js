...
export class DileIconlibTableAlias extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-table-alias')) {
  customElements.define('dile-tabler-icon-table-alias', DileIconlibTableAlias);
}
