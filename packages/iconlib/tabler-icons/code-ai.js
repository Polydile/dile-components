...
export class DileIconlibCodeAi extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-code-ai')) {
  customElements.define('dile-tabler-icon-code-ai', DileIconlibCodeAi);
}
