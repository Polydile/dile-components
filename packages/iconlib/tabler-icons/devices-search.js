...
export class DileIconlibDevicesSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-search')) {
  customElements.define('dile-tabler-icon-devices-search', DileIconlibDevicesSearch);
}
