...
export class DileIconlibOctahedronOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-octahedron-off')) {
  customElements.define('dile-tabler-icon-octahedron-off', DileIconlibOctahedronOff);
}
