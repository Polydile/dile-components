...
export class DileIconlibHexagonLetterF extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-f')) {
  customElements.define('dile-tabler-icon-hexagon-letter-f', DileIconlibHexagonLetterF);
}
