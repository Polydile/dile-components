...
export class DileIconlibMoodUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-up')) {
  customElements.define('dile-tabler-icon-mood-up', DileIconlibMoodUp);
}
