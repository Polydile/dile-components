...
export class DileIconlibHttpTraceOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-http-trace-off')) {
  customElements.define('dile-tabler-icon-http-trace-off', DileIconlibHttpTraceOff);
}
