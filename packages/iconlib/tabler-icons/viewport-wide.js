...
export class DileIconlibViewportWide extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-viewport-wide')) {
  customElements.define('dile-tabler-icon-viewport-wide', DileIconlibViewportWide);
}
