...
export class DileIconlibCertificateOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-certificate-off')) {
  customElements.define('dile-tabler-icon-certificate-off', DileIconlibCertificateOff);
}
