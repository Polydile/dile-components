...
export class DileIconlibGolfFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-golf-filled')) {
  customElements.define('dile-tabler-icon-golf-filled', DileIconlibGolfFilled);
}
