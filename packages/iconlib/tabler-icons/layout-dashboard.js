...
export class DileIconlibLayoutDashboard extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-layout-dashboard')) {
  customElements.define('dile-tabler-icon-layout-dashboard', DileIconlibLayoutDashboard);
}
