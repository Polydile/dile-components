...
export class DileIconlibCalendarUser extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-calendar-user')) {
  customElements.define('dile-tabler-icon-calendar-user', DileIconlibCalendarUser);
}
