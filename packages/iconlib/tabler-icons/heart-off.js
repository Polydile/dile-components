...
export class DileIconlibHeartOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-heart-off')) {
  customElements.define('dile-tabler-icon-heart-off', DileIconlibHeartOff);
}
