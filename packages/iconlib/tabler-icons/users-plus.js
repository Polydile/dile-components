...
export class DileIconlibUsersPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-users-plus')) {
  customElements.define('dile-tabler-icon-users-plus', DileIconlibUsersPlus);
}
