...
export class DileIconlibPyramidOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pyramid-off')) {
  customElements.define('dile-tabler-icon-pyramid-off', DileIconlibPyramidOff);
}
