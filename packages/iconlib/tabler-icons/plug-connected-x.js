...
export class DileIconlibPlugConnectedX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-plug-connected-x')) {
  customElements.define('dile-tabler-icon-plug-connected-x', DileIconlibPlugConnectedX);
}
