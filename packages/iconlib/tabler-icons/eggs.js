...
export class DileIconlibEggs extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eggs')) {
  customElements.define('dile-tabler-icon-eggs', DileIconlibEggs);
}
