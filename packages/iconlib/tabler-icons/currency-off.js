...
export class DileIconlibCurrencyOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-currency-off')) {
  customElements.define('dile-tabler-icon-currency-off', DileIconlibCurrencyOff);
}
