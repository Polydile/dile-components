...
export class DileIconlibExposureOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-exposure-off')) {
  customElements.define('dile-tabler-icon-exposure-off', DileIconlibExposureOff);
}
