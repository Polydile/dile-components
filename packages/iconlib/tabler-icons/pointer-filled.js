...
export class DileIconlibPointerFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pointer-filled')) {
  customElements.define('dile-tabler-icon-pointer-filled', DileIconlibPointerFilled);
}
