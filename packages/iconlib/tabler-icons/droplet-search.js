...
export class DileIconlibDropletSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-search')) {
  customElements.define('dile-tabler-icon-droplet-search', DileIconlibDropletSearch);
}
