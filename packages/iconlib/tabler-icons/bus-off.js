...
export class DileIconlibBusOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bus-off')) {
  customElements.define('dile-tabler-icon-bus-off', DileIconlibBusOff);
}
