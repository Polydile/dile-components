...
export class DileIconlibNumber95Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-95-small')) {
  customElements.define('dile-tabler-icon-number-95-small', DileIconlibNumber95Small);
}
