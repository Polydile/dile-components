...
export class DileIconlibFlagCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flag-code')) {
  customElements.define('dile-tabler-icon-flag-code', DileIconlibFlagCode);
}
