...
export class DileIconlibFileLike extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-like')) {
  customElements.define('dile-tabler-icon-file-like', DileIconlibFileLike);
}
