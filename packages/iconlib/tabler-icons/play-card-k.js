...
export class DileIconlibPlayCardK extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-k')) {
  customElements.define('dile-tabler-icon-play-card-k', DileIconlibPlayCardK);
}
