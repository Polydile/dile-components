...
export class DileIconlibBrandTwitter extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-brand-twitter')) {
  customElements.define('dile-tabler-icon-brand-twitter', DileIconlibBrandTwitter);
}
