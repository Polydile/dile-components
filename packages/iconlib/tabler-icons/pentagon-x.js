...
export class DileIconlibPentagonX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pentagon-x')) {
  customElements.define('dile-tabler-icon-pentagon-x', DileIconlibPentagonX);
}
