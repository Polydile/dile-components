...
export class DileIconlibHexagonLetterX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-x')) {
  customElements.define('dile-tabler-icon-hexagon-letter-x', DileIconlibHexagonLetterX);
}
