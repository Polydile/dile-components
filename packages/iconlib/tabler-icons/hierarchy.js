...
export class DileIconlibHierarchy extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hierarchy')) {
  customElements.define('dile-tabler-icon-hierarchy', DileIconlibHierarchy);
}
