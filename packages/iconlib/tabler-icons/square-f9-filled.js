...
export class DileIconlibSquareF9Filled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-f9-filled')) {
  customElements.define('dile-tabler-icon-square-f9-filled', DileIconlibSquareF9Filled);
}
