...
export class DileIconlibPhotoSensor extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-sensor')) {
  customElements.define('dile-tabler-icon-photo-sensor', DileIconlibPhotoSensor);
}
