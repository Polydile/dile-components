...
export class DileIconlibTableHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-table-heart')) {
  customElements.define('dile-tabler-icon-table-heart', DileIconlibTableHeart);
}
