...
export class DileIconlibReceiptYen extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-receipt-yen')) {
  customElements.define('dile-tabler-icon-receipt-yen', DileIconlibReceiptYen);
}
