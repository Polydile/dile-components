...
export class DileIconlibDevicesCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-cog')) {
  customElements.define('dile-tabler-icon-devices-cog', DileIconlibDevicesCog);
}
