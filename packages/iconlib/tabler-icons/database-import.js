...
export class DileIconlibDatabaseImport extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-database-import')) {
  customElements.define('dile-tabler-icon-database-import', DileIconlibDatabaseImport);
}
