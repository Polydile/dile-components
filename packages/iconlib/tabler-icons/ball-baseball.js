...
export class DileIconlibBallBaseball extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ball-baseball')) {
  customElements.define('dile-tabler-icon-ball-baseball', DileIconlibBallBaseball);
}
