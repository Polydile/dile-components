...
export class DileIconlibBlade extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-blade')) {
  customElements.define('dile-tabler-icon-blade', DileIconlibBlade);
}
