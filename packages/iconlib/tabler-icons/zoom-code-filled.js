...
export class DileIconlibZoomCodeFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-zoom-code-filled')) {
  customElements.define('dile-tabler-icon-zoom-code-filled', DileIconlibZoomCodeFilled);
}
