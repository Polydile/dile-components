...
export class DileIconlibUsersMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-users-minus')) {
  customElements.define('dile-tabler-icon-users-minus', DileIconlibUsersMinus);
}
