...
export class DileIconlibColumnsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-columns-off')) {
  customElements.define('dile-tabler-icon-columns-off', DileIconlibColumnsOff);
}
