...
export class DileIconlibBoxMultiple extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-box-multiple')) {
  customElements.define('dile-tabler-icon-box-multiple', DileIconlibBoxMultiple);
}
