...
export class DileIconlibRippleDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ripple-down')) {
  customElements.define('dile-tabler-icon-ripple-down', DileIconlibRippleDown);
}
