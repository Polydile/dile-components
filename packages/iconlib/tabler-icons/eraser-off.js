...
export class DileIconlibEraserOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eraser-off')) {
  customElements.define('dile-tabler-icon-eraser-off', DileIconlibEraserOff);
}
