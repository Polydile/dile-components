...
export class DileIconlibFlagPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flag-plus')) {
  customElements.define('dile-tabler-icon-flag-plus', DileIconlibFlagPlus);
}
