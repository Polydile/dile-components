...
export class DileIconlibDentalOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-dental-off')) {
  customElements.define('dile-tabler-icon-dental-off', DileIconlibDentalOff);
}
