...
export class DileIconlibChessFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-chess-filled')) {
  customElements.define('dile-tabler-icon-chess-filled', DileIconlibChessFilled);
}
