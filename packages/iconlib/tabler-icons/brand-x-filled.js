...
export class DileIconlibBrandXFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-brand-x-filled')) {
  customElements.define('dile-tabler-icon-brand-x-filled', DileIconlibBrandXFilled);
}
