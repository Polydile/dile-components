...
export class DileIconlibMarquee extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-marquee')) {
  customElements.define('dile-tabler-icon-marquee', DileIconlibMarquee);
}
