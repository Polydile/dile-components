...
export class DileIconlibFilter2Pin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-2-pin')) {
  customElements.define('dile-tabler-icon-filter-2-pin', DileIconlibFilter2Pin);
}
