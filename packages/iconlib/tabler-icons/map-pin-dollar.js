...
export class DileIconlibMapPinDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-pin-dollar')) {
  customElements.define('dile-tabler-icon-map-pin-dollar', DileIconlibMapPinDollar);
}
