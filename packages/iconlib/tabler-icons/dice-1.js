...
export class DileIconlibDice1 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-dice-1')) {
  customElements.define('dile-tabler-icon-dice-1', DileIconlibDice1);
}
