...
export class DileIconlibClockShield extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-clock-shield')) {
  customElements.define('dile-tabler-icon-clock-shield', DileIconlibClockShield);
}
