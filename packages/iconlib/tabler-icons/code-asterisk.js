...
export class DileIconlibCodeAsterisk extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-code-asterisk')) {
  customElements.define('dile-tabler-icon-code-asterisk', DileIconlibCodeAsterisk);
}
