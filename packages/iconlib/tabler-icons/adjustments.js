...
export class DileIconlibAdjustments extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-adjustments')) {
  customElements.define('dile-tabler-icon-adjustments', DileIconlibAdjustments);
}
