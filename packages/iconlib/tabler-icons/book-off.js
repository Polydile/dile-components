...
export class DileIconlibBookOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-book-off')) {
  customElements.define('dile-tabler-icon-book-off', DileIconlibBookOff);
}
