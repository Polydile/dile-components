...
export class DileIconlibTagFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-tag-filled')) {
  customElements.define('dile-tabler-icon-tag-filled', DileIconlibTagFilled);
}
