...
export class DileIconlibCookieFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cookie-filled')) {
  customElements.define('dile-tabler-icon-cookie-filled', DileIconlibCookieFilled);
}
