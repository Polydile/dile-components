...
export class DileIconlibPaint extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-paint')) {
  customElements.define('dile-tabler-icon-paint', DileIconlibPaint);
}
