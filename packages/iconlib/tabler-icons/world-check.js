...
export class DileIconlibWorldCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-check')) {
  customElements.define('dile-tabler-icon-world-check', DileIconlibWorldCheck);
}
