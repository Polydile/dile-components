...
export class DileIconlibLamp2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lamp-2')) {
  customElements.define('dile-tabler-icon-lamp-2', DileIconlibLamp2);
}
