...
export class DileIconlibChartPieOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-chart-pie-off')) {
  customElements.define('dile-tabler-icon-chart-pie-off', DileIconlibChartPieOff);
}
