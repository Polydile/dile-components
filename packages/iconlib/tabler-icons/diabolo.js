...
export class DileIconlibDiabolo extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-diabolo')) {
  customElements.define('dile-tabler-icon-diabolo', DileIconlibDiabolo);
}
