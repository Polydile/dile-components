...
export class DileIconlibPentagonNumber9 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pentagon-number-9')) {
  customElements.define('dile-tabler-icon-pentagon-number-9', DileIconlibPentagonNumber9);
}
