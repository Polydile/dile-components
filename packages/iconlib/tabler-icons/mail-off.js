...
export class DileIconlibMailOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mail-off')) {
  customElements.define('dile-tabler-icon-mail-off', DileIconlibMailOff);
}
