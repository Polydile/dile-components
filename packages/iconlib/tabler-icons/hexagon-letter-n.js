...
export class DileIconlibHexagonLetterN extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-n')) {
  customElements.define('dile-tabler-icon-hexagon-letter-n', DileIconlibHexagonLetterN);
}
