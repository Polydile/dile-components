...
export class DileIconlibSquareF2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-f2')) {
  customElements.define('dile-tabler-icon-square-f2', DileIconlibSquareF2);
}
