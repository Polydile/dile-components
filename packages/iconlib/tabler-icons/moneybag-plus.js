...
export class DileIconlibMoneybagPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-moneybag-plus')) {
  customElements.define('dile-tabler-icon-moneybag-plus', DileIconlibMoneybagPlus);
}
