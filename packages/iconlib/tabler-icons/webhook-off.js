...
export class DileIconlibWebhookOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-webhook-off')) {
  customElements.define('dile-tabler-icon-webhook-off', DileIconlibWebhookOff);
}
