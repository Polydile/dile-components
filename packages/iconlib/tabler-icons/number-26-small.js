...
export class DileIconlibNumber26Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-26-small')) {
  customElements.define('dile-tabler-icon-number-26-small', DileIconlibNumber26Small);
}
