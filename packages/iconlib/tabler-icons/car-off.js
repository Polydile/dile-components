...
export class DileIconlibCarOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-car-off')) {
  customElements.define('dile-tabler-icon-car-off', DileIconlibCarOff);
}
