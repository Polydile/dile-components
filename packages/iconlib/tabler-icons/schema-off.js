...
export class DileIconlibSchemaOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-schema-off')) {
  customElements.define('dile-tabler-icon-schema-off', DileIconlibSchemaOff);
}
