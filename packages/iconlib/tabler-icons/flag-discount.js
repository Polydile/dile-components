...
export class DileIconlibFlagDiscount extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flag-discount')) {
  customElements.define('dile-tabler-icon-flag-discount', DileIconlibFlagDiscount);
}
