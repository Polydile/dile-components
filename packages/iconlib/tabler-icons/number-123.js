...
export class DileIconlibNumber123 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-123')) {
  customElements.define('dile-tabler-icon-number-123', DileIconlibNumber123);
}
