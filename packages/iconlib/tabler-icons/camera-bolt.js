...
export class DileIconlibCameraBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-camera-bolt')) {
  customElements.define('dile-tabler-icon-camera-bolt', DileIconlibCameraBolt);
}
