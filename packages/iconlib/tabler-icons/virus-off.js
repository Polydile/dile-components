...
export class DileIconlibVirusOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-virus-off')) {
  customElements.define('dile-tabler-icon-virus-off', DileIconlibVirusOff);
}
