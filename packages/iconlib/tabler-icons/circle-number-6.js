...
export class DileIconlibCircleNumber6 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-circle-number-6')) {
  customElements.define('dile-tabler-icon-circle-number-6', DileIconlibCircleNumber6);
}
