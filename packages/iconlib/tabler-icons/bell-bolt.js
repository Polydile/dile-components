...
export class DileIconlibBellBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-bolt')) {
  customElements.define('dile-tabler-icon-bell-bolt', DileIconlibBellBolt);
}
