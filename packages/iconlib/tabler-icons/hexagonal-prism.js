...
export class DileIconlibHexagonalPrism extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagonal-prism')) {
  customElements.define('dile-tabler-icon-hexagonal-prism', DileIconlibHexagonalPrism);
}
