...
export class DileIconlibPlayCard3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-3')) {
  customElements.define('dile-tabler-icon-play-card-3', DileIconlibPlayCard3);
}
