...
export class DileIconlibGrillOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-grill-off')) {
  customElements.define('dile-tabler-icon-grill-off', DileIconlibGrillOff);
}
