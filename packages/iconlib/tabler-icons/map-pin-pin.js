...
export class DileIconlibMapPinPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-pin-pin')) {
  customElements.define('dile-tabler-icon-map-pin-pin', DileIconlibMapPinPin);
}
