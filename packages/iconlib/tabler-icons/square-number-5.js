...
export class DileIconlibSquareNumber5 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-number-5')) {
  customElements.define('dile-tabler-icon-square-number-5', DileIconlibSquareNumber5);
}
