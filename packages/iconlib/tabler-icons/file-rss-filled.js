...
export class DileIconlibFileRssFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-rss-filled')) {
  customElements.define('dile-tabler-icon-file-rss-filled', DileIconlibFileRssFilled);
}
