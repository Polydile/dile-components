...
export class DileIconlibLockBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-bolt')) {
  customElements.define('dile-tabler-icon-lock-bolt', DileIconlibLockBolt);
}
