...
export class DileIconlibCalendarDue extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-calendar-due')) {
  customElements.define('dile-tabler-icon-calendar-due', DileIconlibCalendarDue);
}
