...
export class DileIconlibCalendarCancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-calendar-cancel')) {
  customElements.define('dile-tabler-icon-calendar-cancel', DileIconlibCalendarCancel);
}
