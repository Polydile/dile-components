...
export class DileIconlibSort90 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sort-9-0')) {
  customElements.define('dile-tabler-icon-sort-9-0', DileIconlibSort90);
}
