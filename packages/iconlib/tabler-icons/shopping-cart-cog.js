...
export class DileIconlibShoppingCartCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shopping-cart-cog')) {
  customElements.define('dile-tabler-icon-shopping-cart-cog', DileIconlibShoppingCartCog);
}
