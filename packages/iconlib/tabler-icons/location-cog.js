...
export class DileIconlibLocationCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-location-cog')) {
  customElements.define('dile-tabler-icon-location-cog', DileIconlibLocationCog);
}
