...
export class DileIconlibDiamondOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-diamond-off')) {
  customElements.define('dile-tabler-icon-diamond-off', DileIconlibDiamondOff);
}
