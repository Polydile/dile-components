...
export class DileIconlibScreenshot extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-screenshot')) {
  customElements.define('dile-tabler-icon-screenshot', DileIconlibScreenshot);
}
