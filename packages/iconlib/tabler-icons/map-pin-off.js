...
export class DileIconlibMapPinOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-pin-off')) {
  customElements.define('dile-tabler-icon-map-pin-off', DileIconlibMapPinOff);
}
