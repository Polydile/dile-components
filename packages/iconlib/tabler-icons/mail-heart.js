...
export class DileIconlibMailHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mail-heart')) {
  customElements.define('dile-tabler-icon-mail-heart', DileIconlibMailHeart);
}
