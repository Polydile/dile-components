...
export class DileIconlibChargingPile extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-charging-pile')) {
  customElements.define('dile-tabler-icon-charging-pile', DileIconlibChargingPile);
}
