...
export class DileIconlibChartBarOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-chart-bar-off')) {
  customElements.define('dile-tabler-icon-chart-bar-off', DileIconlibChartBarOff);
}
