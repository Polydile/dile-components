...
export class DileIconlibDeviceVisionPro extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-vision-pro')) {
  customElements.define('dile-tabler-icon-device-vision-pro', DileIconlibDeviceVisionPro);
}
