...
export class DileIconlibLegoOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lego-off')) {
  customElements.define('dile-tabler-icon-lego-off', DileIconlibLegoOff);
}
