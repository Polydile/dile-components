...
export class DileIconlibBellExclamation extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-exclamation')) {
  customElements.define('dile-tabler-icon-bell-exclamation', DileIconlibBellExclamation);
}
