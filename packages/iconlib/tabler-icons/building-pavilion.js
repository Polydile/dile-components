...
export class DileIconlibBuildingPavilion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-building-pavilion')) {
  customElements.define('dile-tabler-icon-building-pavilion', DileIconlibBuildingPavilion);
}
