...
export class DileIconlibIceCreamOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ice-cream-off')) {
  customElements.define('dile-tabler-icon-ice-cream-off', DileIconlibIceCreamOff);
}
