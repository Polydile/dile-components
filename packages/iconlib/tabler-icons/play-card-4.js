...
export class DileIconlibPlayCard4 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-4')) {
  customElements.define('dile-tabler-icon-play-card-4', DileIconlibPlayCard4);
}
