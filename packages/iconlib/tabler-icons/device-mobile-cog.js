...
export class DileIconlibDeviceMobileCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-mobile-cog')) {
  customElements.define('dile-tabler-icon-device-mobile-cog', DileIconlibDeviceMobileCog);
}
