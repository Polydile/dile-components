...
export class DileIconlibVinyl extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-vinyl')) {
  customElements.define('dile-tabler-icon-vinyl', DileIconlibVinyl);
}
