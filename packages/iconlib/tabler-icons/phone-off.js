...
export class DileIconlibPhoneOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-phone-off')) {
  customElements.define('dile-tabler-icon-phone-off', DileIconlibPhoneOff);
}
