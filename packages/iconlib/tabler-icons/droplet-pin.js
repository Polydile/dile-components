...
export class DileIconlibDropletPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-pin')) {
  customElements.define('dile-tabler-icon-droplet-pin', DileIconlibDropletPin);
}
