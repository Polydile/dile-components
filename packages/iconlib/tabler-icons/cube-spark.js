...
export class DileIconlibCubeSpark extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cube-spark')) {
  customElements.define('dile-tabler-icon-cube-spark', DileIconlibCubeSpark);
}
