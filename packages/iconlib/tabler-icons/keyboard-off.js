...
export class DileIconlibKeyboardOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-keyboard-off')) {
  customElements.define('dile-tabler-icon-keyboard-off', DileIconlibKeyboardOff);
}
