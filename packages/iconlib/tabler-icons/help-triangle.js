...
export class DileIconlibHelpTriangle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-help-triangle')) {
  customElements.define('dile-tabler-icon-help-triangle', DileIconlibHelpTriangle);
}
