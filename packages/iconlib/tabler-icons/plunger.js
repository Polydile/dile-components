...
export class DileIconlibPlunger extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-plunger')) {
  customElements.define('dile-tabler-icon-plunger', DileIconlibPlunger);
}
