...
export class DileIconlibCarFanAuto extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-car-fan-auto')) {
  customElements.define('dile-tabler-icon-car-fan-auto', DileIconlibCarFanAuto);
}
