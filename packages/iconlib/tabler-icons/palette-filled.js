...
export class DileIconlibPaletteFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-palette-filled')) {
  customElements.define('dile-tabler-icon-palette-filled', DileIconlibPaletteFilled);
}
