...
export class DileIconlibShoppingBagX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shopping-bag-x')) {
  customElements.define('dile-tabler-icon-shopping-bag-x', DileIconlibShoppingBagX);
}
