...
export class DileIconlibLockPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-plus')) {
  customElements.define('dile-tabler-icon-lock-plus', DileIconlibLockPlus);
}
