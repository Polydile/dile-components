...
export class DileIconlibHexagonLetterW extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-w')) {
  customElements.define('dile-tabler-icon-hexagon-letter-w', DileIconlibHexagonLetterW);
}
