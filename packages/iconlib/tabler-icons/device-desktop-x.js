...
export class DileIconlibDeviceDesktopX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-desktop-x')) {
  customElements.define('dile-tabler-icon-device-desktop-x', DileIconlibDeviceDesktopX);
}
