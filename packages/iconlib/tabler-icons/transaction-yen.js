...
export class DileIconlibTransactionYen extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-transaction-yen')) {
  customElements.define('dile-tabler-icon-transaction-yen', DileIconlibTransactionYen);
}
