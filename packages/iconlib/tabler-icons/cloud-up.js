...
export class DileIconlibCloudUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cloud-up')) {
  customElements.define('dile-tabler-icon-cloud-up', DileIconlibCloudUp);
}
