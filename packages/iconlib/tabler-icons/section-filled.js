...
export class DileIconlibSectionFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-section-filled')) {
  customElements.define('dile-tabler-icon-section-filled', DileIconlibSectionFilled);
}
