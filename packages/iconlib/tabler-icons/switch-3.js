...
export class DileIconlibSwitch3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-switch-3')) {
  customElements.define('dile-tabler-icon-switch-3', DileIconlibSwitch3);
}
