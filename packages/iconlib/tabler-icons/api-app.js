...
export class DileIconlibApiApp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-api-app')) {
  customElements.define('dile-tabler-icon-api-app', DileIconlibApiApp);
}
