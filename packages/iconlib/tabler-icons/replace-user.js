...
export class DileIconlibReplaceUser extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-replace-user')) {
  customElements.define('dile-tabler-icon-replace-user', DileIconlibReplaceUser);
}
