...
export class DileIconlibTemplateOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-template-off')) {
  customElements.define('dile-tabler-icon-template-off', DileIconlibTemplateOff);
}
