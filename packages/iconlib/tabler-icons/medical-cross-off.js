...
export class DileIconlibMedicalCrossOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-medical-cross-off')) {
  customElements.define('dile-tabler-icon-medical-cross-off', DileIconlibMedicalCrossOff);
}
