...
export class DileIconlibPlayerPause extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-player-pause')) {
  customElements.define('dile-tabler-icon-player-pause', DileIconlibPlayerPause);
}
