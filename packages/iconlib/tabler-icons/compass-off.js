...
export class DileIconlibCompassOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-compass-off')) {
  customElements.define('dile-tabler-icon-compass-off', DileIconlibCompassOff);
}
