...
export class DileIconlibDropletCancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-cancel')) {
  customElements.define('dile-tabler-icon-droplet-cancel', DileIconlibDropletCancel);
}
