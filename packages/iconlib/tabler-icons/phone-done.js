...
export class DileIconlibPhoneDone extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-phone-done')) {
  customElements.define('dile-tabler-icon-phone-done', DileIconlibPhoneDone);
}
