...
export class DileIconlibWorldX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-x')) {
  customElements.define('dile-tabler-icon-world-x', DileIconlibWorldX);
}
