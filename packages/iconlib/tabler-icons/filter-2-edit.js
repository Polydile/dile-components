...
export class DileIconlibFilter2Edit extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-2-edit')) {
  customElements.define('dile-tabler-icon-filter-2-edit', DileIconlibFilter2Edit);
}
