...
export class DileIconlibSunLowFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sun-low-filled')) {
  customElements.define('dile-tabler-icon-sun-low-filled', DileIconlibSunLowFilled);
}
