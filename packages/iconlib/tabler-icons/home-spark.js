...
export class DileIconlibHomeSpark extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-spark')) {
  customElements.define('dile-tabler-icon-home-spark', DileIconlibHomeSpark);
}
