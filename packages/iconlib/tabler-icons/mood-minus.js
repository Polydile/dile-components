...
export class DileIconlibMoodMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-minus')) {
  customElements.define('dile-tabler-icon-mood-minus', DileIconlibMoodMinus);
}
