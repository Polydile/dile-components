...
export class DileIconlibDeviceImacOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-imac-off')) {
  customElements.define('dile-tabler-icon-device-imac-off', DileIconlibDeviceImacOff);
}
