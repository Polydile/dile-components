...
export class DileIconlibRosetteNumber3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rosette-number-3')) {
  customElements.define('dile-tabler-icon-rosette-number-3', DileIconlibRosetteNumber3);
}
