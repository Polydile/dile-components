...
export class DileIconlibBellPause extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-pause')) {
  customElements.define('dile-tabler-icon-bell-pause', DileIconlibBellPause);
}
