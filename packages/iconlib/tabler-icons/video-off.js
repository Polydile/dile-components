...
export class DileIconlibVideoOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-video-off')) {
  customElements.define('dile-tabler-icon-video-off', DileIconlibVideoOff);
}
