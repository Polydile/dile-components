...
export class DileIconlibRewindForward40 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rewind-forward-40')) {
  customElements.define('dile-tabler-icon-rewind-forward-40', DileIconlibRewindForward40);
}
