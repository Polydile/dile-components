...
export class DileIconlibPointer2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pointer-2')) {
  customElements.define('dile-tabler-icon-pointer-2', DileIconlibPointer2);
}
