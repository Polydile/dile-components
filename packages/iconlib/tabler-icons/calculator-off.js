...
export class DileIconlibCalculatorOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-calculator-off')) {
  customElements.define('dile-tabler-icon-calculator-off', DileIconlibCalculatorOff);
}
