...
export class DileIconlibSignal3g extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-signal-3g')) {
  customElements.define('dile-tabler-icon-signal-3g', DileIconlibSignal3g);
}
