...
export class DileIconlibBatteryFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-battery-filled')) {
  customElements.define('dile-tabler-icon-battery-filled', DileIconlibBatteryFilled);
}
