...
export class DileIconlibBubbleTea extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bubble-tea')) {
  customElements.define('dile-tabler-icon-bubble-tea', DileIconlibBubbleTea);
}
