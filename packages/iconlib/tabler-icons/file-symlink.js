...
export class DileIconlibFileSymlink extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-symlink')) {
  customElements.define('dile-tabler-icon-file-symlink', DileIconlibFileSymlink);
}
