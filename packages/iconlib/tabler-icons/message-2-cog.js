...
export class DileIconlibMessage2Cog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-2-cog')) {
  customElements.define('dile-tabler-icon-message-2-cog', DileIconlibMessage2Cog);
}
