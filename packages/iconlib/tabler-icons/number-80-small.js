...
export class DileIconlibNumber80Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-80-small')) {
  customElements.define('dile-tabler-icon-number-80-small', DileIconlibNumber80Small);
}
