...
export class DileIconlibCalendarPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-calendar-pin')) {
  customElements.define('dile-tabler-icon-calendar-pin', DileIconlibCalendarPin);
}
