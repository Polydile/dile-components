...
export class DileIconlibHomeDot extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-home-dot')) {
  customElements.define('dile-tabler-icon-home-dot', DileIconlibHomeDot);
}
