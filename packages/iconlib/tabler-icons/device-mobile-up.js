...
export class DileIconlibDeviceMobileUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-mobile-up')) {
  customElements.define('dile-tabler-icon-device-mobile-up', DileIconlibDeviceMobileUp);
}
