...
export class DileIconlibPool extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pool')) {
  customElements.define('dile-tabler-icon-pool', DileIconlibPool);
}
