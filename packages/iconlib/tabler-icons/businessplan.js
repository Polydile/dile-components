...
export class DileIconlibBusinessplan extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-businessplan')) {
  customElements.define('dile-tabler-icon-businessplan', DileIconlibBusinessplan);
}
