...
export class DileIconlibEyeSpark extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-spark')) {
  customElements.define('dile-tabler-icon-eye-spark', DileIconlibEyeSpark);
}
