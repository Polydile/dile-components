...
export class DileIconlibReplaceFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-replace-filled')) {
  customElements.define('dile-tabler-icon-replace-filled', DileIconlibReplaceFilled);
}
