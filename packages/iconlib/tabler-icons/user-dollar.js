...
export class DileIconlibUserDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-user-dollar')) {
  customElements.define('dile-tabler-icon-user-dollar', DileIconlibUserDollar);
}
