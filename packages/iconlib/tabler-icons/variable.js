...
export class DileIconlibVariable extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-variable')) {
  customElements.define('dile-tabler-icon-variable', DileIconlibVariable);
}
