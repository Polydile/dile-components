...
export class DileIconlibQueuePopIn extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-queue-pop-in')) {
  customElements.define('dile-tabler-icon-queue-pop-in', DileIconlibQueuePopIn);
}
