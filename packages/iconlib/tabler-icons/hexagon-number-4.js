...
export class DileIconlibHexagonNumber4 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-number-4')) {
  customElements.define('dile-tabler-icon-hexagon-number-4', DileIconlibHexagonNumber4);
}
