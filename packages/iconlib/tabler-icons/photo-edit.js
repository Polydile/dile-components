...
export class DileIconlibPhotoEdit extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-edit')) {
  customElements.define('dile-tabler-icon-photo-edit', DileIconlibPhotoEdit);
}
