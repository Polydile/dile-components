...
export class DileIconlibSquareF0Filled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-f0-filled')) {
  customElements.define('dile-tabler-icon-square-f0-filled', DileIconlibSquareF0Filled);
}
