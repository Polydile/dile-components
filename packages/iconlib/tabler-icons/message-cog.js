...
export class DileIconlibMessageCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-cog')) {
  customElements.define('dile-tabler-icon-message-cog', DileIconlibMessageCog);
}
