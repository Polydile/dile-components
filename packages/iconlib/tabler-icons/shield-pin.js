...
export class DileIconlibShieldPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shield-pin')) {
  customElements.define('dile-tabler-icon-shield-pin', DileIconlibShieldPin);
}
