...
export class DileIconlibMoodWrrr extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-wrrr')) {
  customElements.define('dile-tabler-icon-mood-wrrr', DileIconlibMoodWrrr);
}
