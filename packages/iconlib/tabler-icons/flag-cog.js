...
export class DileIconlibFlagCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flag-cog')) {
  customElements.define('dile-tabler-icon-flag-cog', DileIconlibFlagCog);
}
