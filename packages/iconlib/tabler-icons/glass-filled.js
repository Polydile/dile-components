...
export class DileIconlibGlassFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-glass-filled')) {
  customElements.define('dile-tabler-icon-glass-filled', DileIconlibGlassFilled);
}
