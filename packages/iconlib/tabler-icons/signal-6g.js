...
export class DileIconlibSignal6g extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-signal-6g')) {
  customElements.define('dile-tabler-icon-signal-6g', DileIconlibSignal6g);
}
