...
export class DileIconlibHexagonLetterA extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-a')) {
  customElements.define('dile-tabler-icon-hexagon-letter-a', DileIconlibHexagonLetterA);
}
