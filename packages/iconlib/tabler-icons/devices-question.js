...
export class DileIconlibDevicesQuestion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-question')) {
  customElements.define('dile-tabler-icon-devices-question', DileIconlibDevicesQuestion);
}
