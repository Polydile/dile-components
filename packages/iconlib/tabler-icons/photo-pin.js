...
export class DileIconlibPhotoPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-pin')) {
  customElements.define('dile-tabler-icon-photo-pin', DileIconlibPhotoPin);
}
