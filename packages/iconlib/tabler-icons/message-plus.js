...
export class DileIconlibMessagePlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-plus')) {
  customElements.define('dile-tabler-icon-message-plus', DileIconlibMessagePlus);
}
