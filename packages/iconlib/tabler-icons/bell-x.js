...
export class DileIconlibBellX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-x')) {
  customElements.define('dile-tabler-icon-bell-x', DileIconlibBellX);
}
