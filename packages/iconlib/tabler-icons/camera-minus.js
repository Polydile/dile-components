...
export class DileIconlibCameraMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-camera-minus')) {
  customElements.define('dile-tabler-icon-camera-minus', DileIconlibCameraMinus);
}
