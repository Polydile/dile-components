...
export class DileIconlibBlob extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-blob')) {
  customElements.define('dile-tabler-icon-blob', DileIconlibBlob);
}
