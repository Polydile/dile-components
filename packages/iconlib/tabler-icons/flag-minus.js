...
export class DileIconlibFlagMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flag-minus')) {
  customElements.define('dile-tabler-icon-flag-minus', DileIconlibFlagMinus);
}
