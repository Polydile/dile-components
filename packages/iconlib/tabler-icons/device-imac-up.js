...
export class DileIconlibDeviceImacUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-imac-up')) {
  customElements.define('dile-tabler-icon-device-imac-up', DileIconlibDeviceImacUp);
}
