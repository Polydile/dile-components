...
export class DileIconlibPackages extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-packages')) {
  customElements.define('dile-tabler-icon-packages', DileIconlibPackages);
}
