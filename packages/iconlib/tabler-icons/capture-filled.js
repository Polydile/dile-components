...
export class DileIconlibCaptureFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-capture-filled')) {
  customElements.define('dile-tabler-icon-capture-filled', DileIconlibCaptureFilled);
}
