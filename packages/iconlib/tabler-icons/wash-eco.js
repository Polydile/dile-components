...
export class DileIconlibWashEco extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-wash-eco')) {
  customElements.define('dile-tabler-icon-wash-eco', DileIconlibWashEco);
}
