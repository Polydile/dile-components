...
export class DileIconlibBattery1 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-battery-1')) {
  customElements.define('dile-tabler-icon-battery-1', DileIconlibBattery1);
}
