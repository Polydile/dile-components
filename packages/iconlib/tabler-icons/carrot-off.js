...
export class DileIconlibCarrotOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-carrot-off')) {
  customElements.define('dile-tabler-icon-carrot-off', DileIconlibCarrotOff);
}
