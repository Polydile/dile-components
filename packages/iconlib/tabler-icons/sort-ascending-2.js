...
export class DileIconlibSortAscending2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sort-ascending-2')) {
  customElements.define('dile-tabler-icon-sort-ascending-2', DileIconlibSortAscending2);
}
