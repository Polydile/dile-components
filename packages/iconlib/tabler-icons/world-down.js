...
export class DileIconlibWorldDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-down')) {
  customElements.define('dile-tabler-icon-world-down', DileIconlibWorldDown);
}
