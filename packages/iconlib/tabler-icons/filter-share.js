...
export class DileIconlibFilterShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-share')) {
  customElements.define('dile-tabler-icon-filter-share', DileIconlibFilterShare);
}
