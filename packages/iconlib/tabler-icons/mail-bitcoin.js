...
export class DileIconlibMailBitcoin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mail-bitcoin')) {
  customElements.define('dile-tabler-icon-mail-bitcoin', DileIconlibMailBitcoin);
}
