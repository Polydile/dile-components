...
export class DileIconlibBellDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-down')) {
  customElements.define('dile-tabler-icon-bell-down', DileIconlibBellDown);
}
