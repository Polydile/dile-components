...
export class DileIconlibSparkles2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sparkles-2')) {
  customElements.define('dile-tabler-icon-sparkles-2', DileIconlibSparkles2);
}
