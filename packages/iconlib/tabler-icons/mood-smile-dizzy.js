...
export class DileIconlibMoodSmileDizzy extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-smile-dizzy')) {
  customElements.define('dile-tabler-icon-mood-smile-dizzy', DileIconlibMoodSmileDizzy);
}
