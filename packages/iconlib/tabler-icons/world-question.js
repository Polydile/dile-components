...
export class DileIconlibWorldQuestion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-question')) {
  customElements.define('dile-tabler-icon-world-question', DileIconlibWorldQuestion);
}
