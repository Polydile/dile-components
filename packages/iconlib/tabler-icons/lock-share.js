...
export class DileIconlibLockShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lock-share')) {
  customElements.define('dile-tabler-icon-lock-share', DileIconlibLockShare);
}
