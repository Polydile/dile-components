...
export class DileIconlibBellRinging2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bell-ringing-2')) {
  customElements.define('dile-tabler-icon-bell-ringing-2', DileIconlibBellRinging2);
}
