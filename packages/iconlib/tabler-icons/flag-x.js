...
export class DileIconlibFlagX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-flag-x')) {
  customElements.define('dile-tabler-icon-flag-x', DileIconlibFlagX);
}
