...
export class DileIconlibHttpPost extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-http-post')) {
  customElements.define('dile-tabler-icon-http-post', DileIconlibHttpPost);
}
