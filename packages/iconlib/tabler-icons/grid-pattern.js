...
export class DileIconlibGridPattern extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-grid-pattern')) {
  customElements.define('dile-tabler-icon-grid-pattern', DileIconlibGridPattern);
}
