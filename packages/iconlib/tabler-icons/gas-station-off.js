...
export class DileIconlibGasStationOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-gas-station-off')) {
  customElements.define('dile-tabler-icon-gas-station-off', DileIconlibGasStationOff);
}
