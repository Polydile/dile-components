...
export class DileIconlibShieldX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-shield-x')) {
  customElements.define('dile-tabler-icon-shield-x', DileIconlibShieldX);
}
