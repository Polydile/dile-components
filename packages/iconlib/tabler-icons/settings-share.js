...
export class DileIconlibSettingsShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-settings-share')) {
  customElements.define('dile-tabler-icon-settings-share', DileIconlibSettingsShare);
}
