...
export class DileIconlibMessage2Search extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-2-search')) {
  customElements.define('dile-tabler-icon-message-2-search', DileIconlibMessage2Search);
}
