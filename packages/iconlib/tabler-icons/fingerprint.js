...
export class DileIconlibFingerprint extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-fingerprint')) {
  customElements.define('dile-tabler-icon-fingerprint', DileIconlibFingerprint);
}
