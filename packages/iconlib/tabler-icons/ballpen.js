...
export class DileIconlibBallpen extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ballpen')) {
  customElements.define('dile-tabler-icon-ballpen', DileIconlibBallpen);
}
