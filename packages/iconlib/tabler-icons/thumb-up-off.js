...
export class DileIconlibThumbUpOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-thumb-up-off')) {
  customElements.define('dile-tabler-icon-thumb-up-off', DileIconlibThumbUpOff);
}
