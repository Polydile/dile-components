...
export class DileIconlibDice4 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-dice-4')) {
  customElements.define('dile-tabler-icon-dice-4', DileIconlibDice4);
}
