...
export class DileIconlibFile3d extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-3d')) {
  customElements.define('dile-tabler-icon-file-3d', DileIconlibFile3d);
}
