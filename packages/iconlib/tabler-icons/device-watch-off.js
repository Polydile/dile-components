...
export class DileIconlibDeviceWatchOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-watch-off')) {
  customElements.define('dile-tabler-icon-device-watch-off', DileIconlibDeviceWatchOff);
}
