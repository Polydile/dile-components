...
export class DileIconlibDeviceCctvOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-cctv-off')) {
  customElements.define('dile-tabler-icon-device-cctv-off', DileIconlibDeviceCctvOff);
}
