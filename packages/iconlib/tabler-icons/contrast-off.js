...
export class DileIconlibContrastOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-contrast-off')) {
  customElements.define('dile-tabler-icon-contrast-off', DileIconlibContrastOff);
}
