...
export class DileIconlibMessagesOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-messages-off')) {
  customElements.define('dile-tabler-icon-messages-off', DileIconlibMessagesOff);
}
