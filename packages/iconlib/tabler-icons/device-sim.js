...
export class DileIconlibDeviceSim extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-sim')) {
  customElements.define('dile-tabler-icon-device-sim', DileIconlibDeviceSim);
}
