...
export class DileIconlibHexagonAsterisk extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-asterisk')) {
  customElements.define('dile-tabler-icon-hexagon-asterisk', DileIconlibHexagonAsterisk);
}
