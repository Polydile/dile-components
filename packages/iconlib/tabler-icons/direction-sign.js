...
export class DileIconlibDirectionSign extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-direction-sign')) {
  customElements.define('dile-tabler-icon-direction-sign', DileIconlibDirectionSign);
}
