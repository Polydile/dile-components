...
export class DileIconlibDatabaseDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-database-dollar')) {
  customElements.define('dile-tabler-icon-database-dollar', DileIconlibDatabaseDollar);
}
