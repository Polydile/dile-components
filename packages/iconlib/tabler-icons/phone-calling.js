...
export class DileIconlibPhoneCalling extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-phone-calling')) {
  customElements.define('dile-tabler-icon-phone-calling', DileIconlibPhoneCalling);
}
