...
export class DileIconlibBackpackOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-backpack-off')) {
  customElements.define('dile-tabler-icon-backpack-off', DileIconlibBackpackOff);
}
