...
export class DileIconlibMessage2Plus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-2-plus')) {
  customElements.define('dile-tabler-icon-message-2-plus', DileIconlibMessage2Plus);
}
