...
export class DileIconlibStarsOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-stars-off')) {
  customElements.define('dile-tabler-icon-stars-off', DileIconlibStarsOff);
}
