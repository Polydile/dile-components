...
export class DileIconlibMessage2Cancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-2-cancel')) {
  customElements.define('dile-tabler-icon-message-2-cancel', DileIconlibMessage2Cancel);
}
