...
export class DileIconlibTagMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-tag-minus')) {
  customElements.define('dile-tabler-icon-tag-minus', DileIconlibTagMinus);
}
