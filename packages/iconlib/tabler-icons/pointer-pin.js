...
export class DileIconlibPointerPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pointer-pin')) {
  customElements.define('dile-tabler-icon-pointer-pin', DileIconlibPointerPin);
}
