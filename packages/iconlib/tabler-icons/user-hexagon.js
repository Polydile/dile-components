...
export class DileIconlibUserHexagon extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-user-hexagon')) {
  customElements.define('dile-tabler-icon-user-hexagon', DileIconlibUserHexagon);
}
