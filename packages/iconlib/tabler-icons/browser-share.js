...
export class DileIconlibBrowserShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-browser-share')) {
  customElements.define('dile-tabler-icon-browser-share', DileIconlibBrowserShare);
}
