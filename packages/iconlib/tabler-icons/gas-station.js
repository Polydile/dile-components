...
export class DileIconlibGasStation extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-gas-station')) {
  customElements.define('dile-tabler-icon-gas-station', DileIconlibGasStation);
}
