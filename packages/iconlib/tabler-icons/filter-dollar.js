...
export class DileIconlibFilterDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-dollar')) {
  customElements.define('dile-tabler-icon-filter-dollar', DileIconlibFilterDollar);
}
