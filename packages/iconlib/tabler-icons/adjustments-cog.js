...
export class DileIconlibAdjustmentsCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-adjustments-cog')) {
  customElements.define('dile-tabler-icon-adjustments-cog', DileIconlibAdjustmentsCog);
}
