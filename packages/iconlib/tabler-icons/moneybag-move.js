...
export class DileIconlibMoneybagMove extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-moneybag-move')) {
  customElements.define('dile-tabler-icon-moneybag-move', DileIconlibMoneybagMove);
}
