...
export class DileIconlibFileVector extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-vector')) {
  customElements.define('dile-tabler-icon-file-vector', DileIconlibFileVector);
}
