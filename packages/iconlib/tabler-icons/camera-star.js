...
export class DileIconlibCameraStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-camera-star')) {
  customElements.define('dile-tabler-icon-camera-star', DileIconlibCameraStar);
}
