...
export class DileIconlibPhotoCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-code')) {
  customElements.define('dile-tabler-icon-photo-code', DileIconlibPhotoCode);
}
