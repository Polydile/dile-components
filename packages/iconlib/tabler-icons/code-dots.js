...
export class DileIconlibCodeDots extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-code-dots')) {
  customElements.define('dile-tabler-icon-code-dots', DileIconlibCodeDots);
}
