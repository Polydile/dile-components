...
export class DileIconlibBasketBolt extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-basket-bolt')) {
  customElements.define('dile-tabler-icon-basket-bolt', DileIconlibBasketBolt);
}
