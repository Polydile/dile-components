...
export class DileIconlibZoomPanFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-zoom-pan-filled')) {
  customElements.define('dile-tabler-icon-zoom-pan-filled', DileIconlibZoomPanFilled);
}
