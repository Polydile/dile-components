...
export class DileIconlibNavigationTop extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-navigation-top')) {
  customElements.define('dile-tabler-icon-navigation-top', DileIconlibNavigationTop);
}
