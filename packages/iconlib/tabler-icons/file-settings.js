...
export class DileIconlibFileSettings extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-settings')) {
  customElements.define('dile-tabler-icon-file-settings', DileIconlibFileSettings);
}
