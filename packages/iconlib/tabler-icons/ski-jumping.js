...
export class DileIconlibSkiJumping extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ski-jumping')) {
  customElements.define('dile-tabler-icon-ski-jumping', DileIconlibSkiJumping);
}
