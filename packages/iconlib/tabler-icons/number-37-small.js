...
export class DileIconlibNumber37Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-37-small')) {
  customElements.define('dile-tabler-icon-number-37-small', DileIconlibNumber37Small);
}
