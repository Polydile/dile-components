...
export class DileIconlibBubbleTea2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bubble-tea-2')) {
  customElements.define('dile-tabler-icon-bubble-tea-2', DileIconlibBubbleTea2);
}
