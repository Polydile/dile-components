...
export class DileIconlibPentagonOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pentagon-off')) {
  customElements.define('dile-tabler-icon-pentagon-off', DileIconlibPentagonOff);
}
