...
export class DileIconlibTopologyFull extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-topology-full')) {
  customElements.define('dile-tabler-icon-topology-full', DileIconlibTopologyFull);
}
