...
export class DileIconlibFilterSpark extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-spark')) {
  customElements.define('dile-tabler-icon-filter-spark', DileIconlibFilterSpark);
}
