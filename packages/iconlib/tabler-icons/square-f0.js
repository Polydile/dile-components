...
export class DileIconlibSquareF0 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-square-f0')) {
  customElements.define('dile-tabler-icon-square-f0', DileIconlibSquareF0);
}
