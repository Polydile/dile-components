...
export class DileIconlibDentalBroken extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-dental-broken')) {
  customElements.define('dile-tabler-icon-dental-broken', DileIconlibDentalBroken);
}
