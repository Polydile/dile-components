...
export class DileIconlibMeat extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-meat')) {
  customElements.define('dile-tabler-icon-meat', DileIconlibMeat);
}
