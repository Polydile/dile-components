...
export class DileIconlibPodiumOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-podium-off')) {
  customElements.define('dile-tabler-icon-podium-off', DileIconlibPodiumOff);
}
