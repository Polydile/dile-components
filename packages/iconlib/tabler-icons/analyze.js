...
export class DileIconlibAnalyze extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-analyze')) {
  customElements.define('dile-tabler-icon-analyze', DileIconlibAnalyze);
}
