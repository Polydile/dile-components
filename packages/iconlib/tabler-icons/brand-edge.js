...
export class DileIconlibBrandEdge extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-brand-edge')) {
  customElements.define('dile-tabler-icon-brand-edge', DileIconlibBrandEdge);
}
