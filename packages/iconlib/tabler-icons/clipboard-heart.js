...
export class DileIconlibClipboardHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-clipboard-heart')) {
  customElements.define('dile-tabler-icon-clipboard-heart', DileIconlibClipboardHeart);
}
