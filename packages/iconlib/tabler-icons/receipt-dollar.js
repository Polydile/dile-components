...
export class DileIconlibReceiptDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-receipt-dollar')) {
  customElements.define('dile-tabler-icon-receipt-dollar', DileIconlibReceiptDollar);
}
