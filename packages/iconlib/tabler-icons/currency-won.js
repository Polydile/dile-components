...
export class DileIconlibCurrencyWon extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-currency-won')) {
  customElements.define('dile-tabler-icon-currency-won', DileIconlibCurrencyWon);
}
