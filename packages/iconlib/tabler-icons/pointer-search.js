...
export class DileIconlibPointerSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pointer-search')) {
  customElements.define('dile-tabler-icon-pointer-search', DileIconlibPointerSearch);
}
