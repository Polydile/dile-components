...
export class DileIconlibBadgeWc extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-badge-wc')) {
  customElements.define('dile-tabler-icon-badge-wc', DileIconlibBadgeWc);
}
