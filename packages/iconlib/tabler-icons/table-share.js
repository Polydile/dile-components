...
export class DileIconlibTableShare extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-table-share')) {
  customElements.define('dile-tabler-icon-table-share', DileIconlibTableShare);
}
