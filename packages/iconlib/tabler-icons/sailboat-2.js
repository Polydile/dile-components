...
export class DileIconlibSailboat2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sailboat-2')) {
  customElements.define('dile-tabler-icon-sailboat-2', DileIconlibSailboat2);
}
