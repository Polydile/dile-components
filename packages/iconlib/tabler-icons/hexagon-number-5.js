...
export class DileIconlibHexagonNumber5 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-number-5')) {
  customElements.define('dile-tabler-icon-hexagon-number-5', DileIconlibHexagonNumber5);
}
