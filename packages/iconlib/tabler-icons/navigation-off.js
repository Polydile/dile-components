...
export class DileIconlibNavigationOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-navigation-off')) {
  customElements.define('dile-tabler-icon-navigation-off', DileIconlibNavigationOff);
}
