...
export class DileIconlibPresentationOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-presentation-off')) {
  customElements.define('dile-tabler-icon-presentation-off', DileIconlibPresentationOff);
}
