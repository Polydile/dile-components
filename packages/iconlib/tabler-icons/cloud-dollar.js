...
export class DileIconlibCloudDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cloud-dollar')) {
  customElements.define('dile-tabler-icon-cloud-dollar', DileIconlibCloudDollar);
}
