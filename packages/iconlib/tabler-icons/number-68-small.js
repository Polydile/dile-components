...
export class DileIconlibNumber68Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-68-small')) {
  customElements.define('dile-tabler-icon-number-68-small', DileIconlibNumber68Small);
}
