...
export class DileIconlibNumber62Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-62-small')) {
  customElements.define('dile-tabler-icon-number-62-small', DileIconlibNumber62Small);
}
