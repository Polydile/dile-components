...
export class DileIconlibFountainOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-fountain-off')) {
  customElements.define('dile-tabler-icon-fountain-off', DileIconlibFountainOff);
}
