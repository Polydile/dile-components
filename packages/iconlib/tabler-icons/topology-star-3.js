...
export class DileIconlibTopologyStar3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-topology-star-3')) {
  customElements.define('dile-tabler-icon-topology-star-3', DileIconlibTopologyStar3);
}
