...
export class DileIconlibLighter extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-lighter')) {
  customElements.define('dile-tabler-icon-lighter', DileIconlibLighter);
}
