...
export class DileIconlibChartRadar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-chart-radar')) {
  customElements.define('dile-tabler-icon-chart-radar', DileIconlibChartRadar);
}
