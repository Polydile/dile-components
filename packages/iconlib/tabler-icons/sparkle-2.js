...
export class DileIconlibSparkle2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sparkle-2')) {
  customElements.define('dile-tabler-icon-sparkle-2', DileIconlibSparkle2);
}
