...
export class DileIconlibWorldMap extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-map')) {
  customElements.define('dile-tabler-icon-world-map', DileIconlibWorldMap);
}
