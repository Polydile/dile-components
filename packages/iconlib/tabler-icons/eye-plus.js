...
export class DileIconlibEyePlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-eye-plus')) {
  customElements.define('dile-tabler-icon-eye-plus', DileIconlibEyePlus);
}
