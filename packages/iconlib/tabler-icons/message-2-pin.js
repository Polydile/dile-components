...
export class DileIconlibMessage2Pin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-message-2-pin')) {
  customElements.define('dile-tabler-icon-message-2-pin', DileIconlibMessage2Pin);
}
