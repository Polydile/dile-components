...
export class DileIconlibDumpling extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-dumpling')) {
  customElements.define('dile-tabler-icon-dumpling', DileIconlibDumpling);
}
