...
export class DileIconlibPhotoScan extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-scan')) {
  customElements.define('dile-tabler-icon-photo-scan', DileIconlibPhotoScan);
}
