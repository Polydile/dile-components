...
export class DileIconlibBatteryVertical extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-battery-vertical')) {
  customElements.define('dile-tabler-icon-battery-vertical', DileIconlibBatteryVertical);
}
