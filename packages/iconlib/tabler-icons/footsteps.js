...
export class DileIconlibFootsteps extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-footsteps')) {
  customElements.define('dile-tabler-icon-footsteps', DileIconlibFootsteps);
}
