...
export class DileIconlibMoodCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-check')) {
  customElements.define('dile-tabler-icon-mood-check', DileIconlibMoodCheck);
}
