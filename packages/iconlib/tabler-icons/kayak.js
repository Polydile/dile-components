...
export class DileIconlibKayak extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-kayak')) {
  customElements.define('dile-tabler-icon-kayak', DileIconlibKayak);
}
