...
export class DileIconlibBodyScan extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-body-scan')) {
  customElements.define('dile-tabler-icon-body-scan', DileIconlibBodyScan);
}
