...
export class DileIconlibNumber29Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-29-small')) {
  customElements.define('dile-tabler-icon-number-29-small', DileIconlibNumber29Small);
}
