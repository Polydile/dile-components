...
export class DileIconlibMapHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-heart')) {
  customElements.define('dile-tabler-icon-map-heart', DileIconlibMapHeart);
}
