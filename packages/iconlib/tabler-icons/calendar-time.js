...
export class DileIconlibCalendarTime extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-calendar-time')) {
  customElements.define('dile-tabler-icon-calendar-time', DileIconlibCalendarTime);
}
