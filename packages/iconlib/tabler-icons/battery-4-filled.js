...
export class DileIconlibBattery4Filled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-battery-4-filled')) {
  customElements.define('dile-tabler-icon-battery-4-filled', DileIconlibBattery4Filled);
}
