...
export class DileIconlibPhotoShield extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-shield')) {
  customElements.define('dile-tabler-icon-photo-shield', DileIconlibPhotoShield);
}
