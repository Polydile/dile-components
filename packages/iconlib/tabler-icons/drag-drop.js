...
export class DileIconlibDragDrop extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-drag-drop')) {
  customElements.define('dile-tabler-icon-drag-drop', DileIconlibDragDrop);
}
