...
export class DileIconlibFolderHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-folder-heart')) {
  customElements.define('dile-tabler-icon-folder-heart', DileIconlibFolderHeart);
}
