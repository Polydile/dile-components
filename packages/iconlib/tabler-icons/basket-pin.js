...
export class DileIconlibBasketPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-basket-pin')) {
  customElements.define('dile-tabler-icon-basket-pin', DileIconlibBasketPin);
}
