...
export class DileIconlibNumber58Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-58-small')) {
  customElements.define('dile-tabler-icon-number-58-small', DileIconlibNumber58Small);
}
