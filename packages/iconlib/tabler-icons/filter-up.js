...
export class DileIconlibFilterUp extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-filter-up')) {
  customElements.define('dile-tabler-icon-filter-up', DileIconlibFilterUp);
}
