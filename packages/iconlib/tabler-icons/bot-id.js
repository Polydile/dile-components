...
export class DileIconlibBotId extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bot-id')) {
  customElements.define('dile-tabler-icon-bot-id', DileIconlibBotId);
}
