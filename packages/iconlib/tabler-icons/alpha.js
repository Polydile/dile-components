...
export class DileIconlibAlpha extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-alpha')) {
  customElements.define('dile-tabler-icon-alpha', DileIconlibAlpha);
}
