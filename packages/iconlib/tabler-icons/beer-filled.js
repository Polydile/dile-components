...
export class DileIconlibBeerFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-beer-filled')) {
  customElements.define('dile-tabler-icon-beer-filled', DileIconlibBeerFilled);
}
