...
export class DileIconlibTrashX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-trash-x')) {
  customElements.define('dile-tabler-icon-trash-x', DileIconlibTrashX);
}
