...
export class DileIconlibDiamonds extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-diamonds')) {
  customElements.define('dile-tabler-icon-diamonds', DileIconlibDiamonds);
}
