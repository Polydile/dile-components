...
export class DileIconlibDeviceImacDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-imac-down')) {
  customElements.define('dile-tabler-icon-device-imac-down', DileIconlibDeviceImacDown);
}
