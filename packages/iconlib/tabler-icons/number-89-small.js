...
export class DileIconlibNumber89Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-89-small')) {
  customElements.define('dile-tabler-icon-number-89-small', DileIconlibNumber89Small);
}
