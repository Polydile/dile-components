...
export class DileIconlibBasketCancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-basket-cancel')) {
  customElements.define('dile-tabler-icon-basket-cancel', DileIconlibBasketCancel);
}
