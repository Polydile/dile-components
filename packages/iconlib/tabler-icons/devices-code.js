...
export class DileIconlibDevicesCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-code')) {
  customElements.define('dile-tabler-icon-devices-code', DileIconlibDevicesCode);
}
