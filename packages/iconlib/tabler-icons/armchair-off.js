...
export class DileIconlibArmchairOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-armchair-off')) {
  customElements.define('dile-tabler-icon-armchair-off', DileIconlibArmchairOff);
}
