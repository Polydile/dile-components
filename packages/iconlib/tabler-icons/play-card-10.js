...
export class DileIconlibPlayCard10 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-10')) {
  customElements.define('dile-tabler-icon-play-card-10', DileIconlibPlayCard10);
}
