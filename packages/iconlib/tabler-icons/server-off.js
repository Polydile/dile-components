...
export class DileIconlibServerOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-server-off')) {
  customElements.define('dile-tabler-icon-server-off', DileIconlibServerOff);
}
