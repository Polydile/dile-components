...
export class DileIconlibChartCandle extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-chart-candle')) {
  customElements.define('dile-tabler-icon-chart-candle', DileIconlibChartCandle);
}
