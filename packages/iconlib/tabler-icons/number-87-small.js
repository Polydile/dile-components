...
export class DileIconlibNumber87Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-87-small')) {
  customElements.define('dile-tabler-icon-number-87-small', DileIconlibNumber87Small);
}
