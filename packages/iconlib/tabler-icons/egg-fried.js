...
export class DileIconlibEggFried extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-egg-fried')) {
  customElements.define('dile-tabler-icon-egg-fried', DileIconlibEggFried);
}
