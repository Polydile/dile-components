...
export class DileIconlibAutomation extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-automation')) {
  customElements.define('dile-tabler-icon-automation', DileIconlibAutomation);
}
