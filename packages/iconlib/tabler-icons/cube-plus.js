...
export class DileIconlibCubePlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cube-plus')) {
  customElements.define('dile-tabler-icon-cube-plus', DileIconlibCubePlus);
}
