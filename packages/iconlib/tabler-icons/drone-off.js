...
export class DileIconlibDroneOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-drone-off')) {
  customElements.define('dile-tabler-icon-drone-off', DileIconlibDroneOff);
}
