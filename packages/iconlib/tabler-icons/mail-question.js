...
export class DileIconlibMailQuestion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mail-question')) {
  customElements.define('dile-tabler-icon-mail-question', DileIconlibMailQuestion);
}
