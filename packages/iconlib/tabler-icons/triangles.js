...
export class DileIconlibTriangles extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-triangles')) {
  customElements.define('dile-tabler-icon-triangles', DileIconlibTriangles);
}
