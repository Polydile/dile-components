...
export class DileIconlibToolsKitchenOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-tools-kitchen-off')) {
  customElements.define('dile-tabler-icon-tools-kitchen-off', DileIconlibToolsKitchenOff);
}
