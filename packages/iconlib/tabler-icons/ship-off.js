...
export class DileIconlibShipOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ship-off')) {
  customElements.define('dile-tabler-icon-ship-off', DileIconlibShipOff);
}
