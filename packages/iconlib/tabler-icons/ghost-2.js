...
export class DileIconlibGhost2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-ghost-2')) {
  customElements.define('dile-tabler-icon-ghost-2', DileIconlibGhost2);
}
