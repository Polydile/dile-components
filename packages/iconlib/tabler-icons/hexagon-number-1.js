...
export class DileIconlibHexagonNumber1 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-number-1')) {
  customElements.define('dile-tabler-icon-hexagon-number-1', DileIconlibHexagonNumber1);
}
