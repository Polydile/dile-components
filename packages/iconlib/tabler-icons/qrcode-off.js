...
export class DileIconlibQrcodeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-qrcode-off')) {
  customElements.define('dile-tabler-icon-qrcode-off', DileIconlibQrcodeOff);
}
