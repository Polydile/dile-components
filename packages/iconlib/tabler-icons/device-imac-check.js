...
export class DileIconlibDeviceImacCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-imac-check')) {
  customElements.define('dile-tabler-icon-device-imac-check', DileIconlibDeviceImacCheck);
}
