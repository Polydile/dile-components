...
export class DileIconlibNumber78Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-78-small')) {
  customElements.define('dile-tabler-icon-number-78-small', DileIconlibNumber78Small);
}
