...
export class DileIconlibPuzzleOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-puzzle-off')) {
  customElements.define('dile-tabler-icon-puzzle-off', DileIconlibPuzzleOff);
}
