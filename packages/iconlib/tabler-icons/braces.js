...
export class DileIconlibBraces extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-braces')) {
  customElements.define('dile-tabler-icon-braces', DileIconlibBraces);
}
