...
export class DileIconlibBrowserX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-browser-x')) {
  customElements.define('dile-tabler-icon-browser-x', DileIconlibBrowserX);
}
