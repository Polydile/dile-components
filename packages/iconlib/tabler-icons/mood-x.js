...
export class DileIconlibMoodX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-x')) {
  customElements.define('dile-tabler-icon-mood-x', DileIconlibMoodX);
}
