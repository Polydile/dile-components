...
export class DileIconlibCloudPin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cloud-pin')) {
  customElements.define('dile-tabler-icon-cloud-pin', DileIconlibCloudPin);
}
