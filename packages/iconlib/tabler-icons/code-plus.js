...
export class DileIconlibCodePlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-code-plus')) {
  customElements.define('dile-tabler-icon-code-plus', DileIconlibCodePlus);
}
