...
export class DileIconlibDumplingFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-dumpling-filled')) {
  customElements.define('dile-tabler-icon-dumpling-filled', DileIconlibDumplingFilled);
}
