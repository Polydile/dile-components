...
export class DileIconlibSettingsCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-settings-cog')) {
  customElements.define('dile-tabler-icon-settings-cog', DileIconlibSettingsCog);
}
