...
export class DileIconlibCategoryFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-category-filled')) {
  customElements.define('dile-tabler-icon-category-filled', DileIconlibCategoryFilled);
}
