...
export class DileIconlibClothesRackOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-clothes-rack-off')) {
  customElements.define('dile-tabler-icon-clothes-rack-off', DileIconlibClothesRackOff);
}
