...
export class DileIconlibHandFingerOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hand-finger-off')) {
  customElements.define('dile-tabler-icon-hand-finger-off', DileIconlibHandFingerOff);
}
