...
export class DileIconlibGlassFull extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-glass-full')) {
  customElements.define('dile-tabler-icon-glass-full', DileIconlibGlassFull);
}
