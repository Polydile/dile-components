...
export class DileIconlibExchangeFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-exchange-filled')) {
  customElements.define('dile-tabler-icon-exchange-filled', DileIconlibExchangeFilled);
}
