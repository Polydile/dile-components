...
export class DileIconlibChalkboardOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-chalkboard-off')) {
  customElements.define('dile-tabler-icon-chalkboard-off', DileIconlibChalkboardOff);
}
