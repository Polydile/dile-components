...
export class DileIconlibLayout2Filled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-layout-2-filled')) {
  customElements.define('dile-tabler-icon-layout-2-filled', DileIconlibLayout2Filled);
}
