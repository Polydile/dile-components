...
export class DileIconlibDeviceImacHeart extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-device-imac-heart')) {
  customElements.define('dile-tabler-icon-device-imac-heart', DileIconlibDeviceImacHeart);
}
