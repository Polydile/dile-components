...
export class DileIconlibCameraAi extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-camera-ai')) {
  customElements.define('dile-tabler-icon-camera-ai', DileIconlibCameraAi);
}
