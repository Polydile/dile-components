...
export class DileIconlibProgressX extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-progress-x')) {
  customElements.define('dile-tabler-icon-progress-x', DileIconlibProgressX);
}
