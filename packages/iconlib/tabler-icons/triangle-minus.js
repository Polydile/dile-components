...
export class DileIconlibTriangleMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-triangle-minus')) {
  customElements.define('dile-tabler-icon-triangle-minus', DileIconlibTriangleMinus);
}
