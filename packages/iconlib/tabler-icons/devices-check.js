...
export class DileIconlibDevicesCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-check')) {
  customElements.define('dile-tabler-icon-devices-check', DileIconlibDevicesCheck);
}
