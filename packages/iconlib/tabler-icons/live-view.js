...
export class DileIconlibLiveView extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-live-view')) {
  customElements.define('dile-tabler-icon-live-view', DileIconlibLiveView);
}
