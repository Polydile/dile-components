...
export class DileIconlibBasketDown extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-basket-down')) {
  customElements.define('dile-tabler-icon-basket-down', DileIconlibBasketDown);
}
