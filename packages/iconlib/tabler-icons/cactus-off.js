...
export class DileIconlibCactusOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cactus-off')) {
  customElements.define('dile-tabler-icon-cactus-off', DileIconlibCactusOff);
}
