...
export class DileIconlibPhotoSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-search')) {
  customElements.define('dile-tabler-icon-photo-search', DileIconlibPhotoSearch);
}
