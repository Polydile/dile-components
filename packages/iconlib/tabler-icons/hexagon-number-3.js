...
export class DileIconlibHexagonNumber3 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-number-3')) {
  customElements.define('dile-tabler-icon-hexagon-number-3', DileIconlibHexagonNumber3);
}
