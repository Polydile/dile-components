...
export class DileIconlibProgressCheck extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-progress-check')) {
  customElements.define('dile-tabler-icon-progress-check', DileIconlibProgressCheck);
}
