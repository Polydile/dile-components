...
export class DileIconlibCredits extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-credits')) {
  customElements.define('dile-tabler-icon-credits', DileIconlibCredits);
}
