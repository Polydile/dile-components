...
export class DileIconlibCakeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-cake-off')) {
  customElements.define('dile-tabler-icon-cake-off', DileIconlibCakeOff);
}
