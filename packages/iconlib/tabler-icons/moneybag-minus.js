...
export class DileIconlibMoneybagMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-moneybag-minus')) {
  customElements.define('dile-tabler-icon-moneybag-minus', DileIconlibMoneybagMinus);
}
