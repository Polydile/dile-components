...
export class DileIconlibExchangeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-exchange-off')) {
  customElements.define('dile-tabler-icon-exchange-off', DileIconlibExchangeOff);
}
