...
export class DileIconlibClockCog extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-clock-cog')) {
  customElements.define('dile-tabler-icon-clock-cog', DileIconlibClockCog);
}
