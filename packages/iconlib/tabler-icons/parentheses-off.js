...
export class DileIconlibParenthesesOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-parentheses-off')) {
  customElements.define('dile-tabler-icon-parentheses-off', DileIconlibParenthesesOff);
}
