...
export class DileIconlibMoodBoy extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-mood-boy')) {
  customElements.define('dile-tabler-icon-mood-boy', DileIconlibMoodBoy);
}
