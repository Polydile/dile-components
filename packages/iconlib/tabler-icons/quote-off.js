...
export class DileIconlibQuoteOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-quote-off')) {
  customElements.define('dile-tabler-icon-quote-off', DileIconlibQuoteOff);
}
