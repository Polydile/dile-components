...
export class DileIconlibHexagonLetterQ extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-q')) {
  customElements.define('dile-tabler-icon-hexagon-letter-q', DileIconlibHexagonLetterQ);
}
