...
export class DileIconlibLogs extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-logs')) {
  customElements.define('dile-tabler-icon-logs', DileIconlibLogs);
}
