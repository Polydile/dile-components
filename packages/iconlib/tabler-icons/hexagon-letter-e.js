...
export class DileIconlibHexagonLetterE extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-e')) {
  customElements.define('dile-tabler-icon-hexagon-letter-e', DileIconlibHexagonLetterE);
}
