...
export class DileIconlibGenderEpicene extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-gender-epicene')) {
  customElements.define('dile-tabler-icon-gender-epicene', DileIconlibGenderEpicene);
}
