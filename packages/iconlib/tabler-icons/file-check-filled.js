...
export class DileIconlibFileCheckFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-check-filled')) {
  customElements.define('dile-tabler-icon-file-check-filled', DileIconlibFileCheckFilled);
}
