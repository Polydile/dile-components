...
export class DileIconlibWorldStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-world-star')) {
  customElements.define('dile-tabler-icon-world-star', DileIconlibWorldStar);
}
