...
export class DileIconlibGlobeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-globe-off')) {
  customElements.define('dile-tabler-icon-globe-off', DileIconlibGlobeOff);
}
