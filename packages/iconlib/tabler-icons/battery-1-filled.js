...
export class DileIconlibBattery1Filled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-battery-1-filled')) {
  customElements.define('dile-tabler-icon-battery-1-filled', DileIconlibBattery1Filled);
}
