...
export class DileIconlibMotorbike extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-motorbike')) {
  customElements.define('dile-tabler-icon-motorbike', DileIconlibMotorbike);
}
