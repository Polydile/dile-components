...
export class DileIconlibSettingsCancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-settings-cancel')) {
  customElements.define('dile-tabler-icon-settings-cancel', DileIconlibSettingsCancel);
}
