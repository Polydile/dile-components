...
export class DileIconlibEditCircleOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-edit-circle-off')) {
  customElements.define('dile-tabler-icon-edit-circle-off', DileIconlibEditCircleOff);
}
