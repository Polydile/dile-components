...
export class DileIconlibPlayCardA extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-play-card-a')) {
  customElements.define('dile-tabler-icon-play-card-a', DileIconlibPlayCardA);
}
