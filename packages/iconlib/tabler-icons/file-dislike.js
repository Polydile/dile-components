...
export class DileIconlibFileDislike extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-dislike')) {
  customElements.define('dile-tabler-icon-file-dislike', DileIconlibFileDislike);
}
