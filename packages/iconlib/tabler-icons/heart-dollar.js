...
export class DileIconlibHeartDollar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-heart-dollar')) {
  customElements.define('dile-tabler-icon-heart-dollar', DileIconlibHeartDollar);
}
