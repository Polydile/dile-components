...
export class DileIconlibNumber28Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-28-small')) {
  customElements.define('dile-tabler-icon-number-28-small', DileIconlibNumber28Small);
}
