...
export class DileIconlibMapShield extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-shield')) {
  customElements.define('dile-tabler-icon-map-shield', DileIconlibMapShield);
}
