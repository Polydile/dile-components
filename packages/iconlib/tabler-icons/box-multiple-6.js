...
export class DileIconlibBoxMultiple6 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-box-multiple-6')) {
  customElements.define('dile-tabler-icon-box-multiple-6', DileIconlibBoxMultiple6);
}
