...
export class DileIconlibPhotoPlus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-photo-plus')) {
  customElements.define('dile-tabler-icon-photo-plus', DileIconlibPhotoPlus);
}
