...
export class DileIconlibMusicSearch extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-music-search')) {
  customElements.define('dile-tabler-icon-music-search', DileIconlibMusicSearch);
}
