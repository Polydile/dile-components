...
export class DileIconlibRainbowOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-rainbow-off')) {
  customElements.define('dile-tabler-icon-rainbow-off', DileIconlibRainbowOff);
}
