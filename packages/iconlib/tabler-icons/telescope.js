...
export class DileIconlibTelescope extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-telescope')) {
  customElements.define('dile-tabler-icon-telescope', DileIconlibTelescope);
}
