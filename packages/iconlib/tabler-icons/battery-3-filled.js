...
export class DileIconlibBattery3Filled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-battery-3-filled')) {
  customElements.define('dile-tabler-icon-battery-3-filled', DileIconlibBattery3Filled);
}
