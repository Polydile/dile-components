...
export class DileIconlibNoCopyright extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-no-copyright')) {
  customElements.define('dile-tabler-icon-no-copyright', DileIconlibNoCopyright);
}
