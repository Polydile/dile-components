...
export class DileIconlibHandOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hand-off')) {
  customElements.define('dile-tabler-icon-hand-off', DileIconlibHandOff);
}
