...
export class DileIconlibPacman extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-pacman')) {
  customElements.define('dile-tabler-icon-pacman', DileIconlibPacman);
}
