...
export class DileIconlibHexagonNumber2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-number-2')) {
  customElements.define('dile-tabler-icon-hexagon-number-2', DileIconlibHexagonNumber2);
}
