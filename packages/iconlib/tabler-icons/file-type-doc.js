...
export class DileIconlibFileTypeDoc extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-file-type-doc')) {
  customElements.define('dile-tabler-icon-file-type-doc', DileIconlibFileTypeDoc);
}
