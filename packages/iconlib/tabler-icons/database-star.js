...
export class DileIconlibDatabaseStar extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-database-star')) {
  customElements.define('dile-tabler-icon-database-star', DileIconlibDatabaseStar);
}
