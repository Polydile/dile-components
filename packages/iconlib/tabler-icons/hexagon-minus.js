...
export class DileIconlibHexagonMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-minus')) {
  customElements.define('dile-tabler-icon-hexagon-minus', DileIconlibHexagonMinus);
}
