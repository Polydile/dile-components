...
export class DileIconlibHandFingerRight extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hand-finger-right')) {
  customElements.define('dile-tabler-icon-hand-finger-right', DileIconlibHandFingerRight);
}
