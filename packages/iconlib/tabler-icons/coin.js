...
export class DileIconlibCoin extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-coin')) {
  customElements.define('dile-tabler-icon-coin', DileIconlibCoin);
}
