...
export class DileIconlibNumber33Small extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-number-33-small')) {
  customElements.define('dile-tabler-icon-number-33-small', DileIconlibNumber33Small);
}
