...
export class DileIconlibDropletCode extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-code')) {
  customElements.define('dile-tabler-icon-droplet-code', DileIconlibDropletCode);
}
