...
export class DileIconlibDropletMinus extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-droplet-minus')) {
  customElements.define('dile-tabler-icon-droplet-minus', DileIconlibDropletMinus);
}
