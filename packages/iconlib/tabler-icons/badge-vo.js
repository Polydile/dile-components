...
export class DileIconlibBadgeVo extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-badge-vo')) {
  customElements.define('dile-tabler-icon-badge-vo', DileIconlibBadgeVo);
}
