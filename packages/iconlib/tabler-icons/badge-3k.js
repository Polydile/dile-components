...
export class DileIconlibBadge3k extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-badge-3k')) {
  customElements.define('dile-tabler-icon-badge-3k', DileIconlibBadge3k);
}
