...
export class DileIconlibZoomReplace extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-zoom-replace')) {
  customElements.define('dile-tabler-icon-zoom-replace', DileIconlibZoomReplace);
}
