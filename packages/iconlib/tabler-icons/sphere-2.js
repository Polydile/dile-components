...
export class DileIconlibSphere2 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-sphere-2')) {
  customElements.define('dile-tabler-icon-sphere-2', DileIconlibSphere2);
}
