...
export class DileIconlibDevicesCancel extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-devices-cancel')) {
  customElements.define('dile-tabler-icon-devices-cancel', DileIconlibDevicesCancel);
}
