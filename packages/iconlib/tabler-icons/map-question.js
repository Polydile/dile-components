...
export class DileIconlibMapQuestion extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-map-question')) {
  customElements.define('dile-tabler-icon-map-question', DileIconlibMapQuestion);
}
