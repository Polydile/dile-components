...
export class DileIconlibBombFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-bomb-filled')) {
  customElements.define('dile-tabler-icon-bomb-filled', DileIconlibBombFilled);
}
