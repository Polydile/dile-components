...
export class DileIconlibHexagonLetterP extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-hexagon-letter-p')) {
  customElements.define('dile-tabler-icon-hexagon-letter-p', DileIconlibHexagonLetterP);
}
