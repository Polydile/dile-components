...
export class DileIconlibBoxMultiple4 extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-box-multiple-4')) {
  customElements.define('dile-tabler-icon-box-multiple-4', DileIconlibBoxMultiple4);
}
