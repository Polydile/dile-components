...
export class DileIconlibTrashOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-trash-off')) {
  customElements.define('dile-tabler-icon-trash-off', DileIconlibTrashOff);
}
