...
export class DileIconlibCopyOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-copy-off')) {
  customElements.define('dile-tabler-icon-copy-off', DileIconlibCopyOff);
}
