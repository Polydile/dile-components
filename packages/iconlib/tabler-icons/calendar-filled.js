...
export class DileIconlibCalendarFilled extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-calendar-filled')) {
  customElements.define('dile-tabler-icon-calendar-filled', DileIconlibCalendarFilled);
}
