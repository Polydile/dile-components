...
export class DileIconlibTestPipeOff extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-test-pipe-off')) {
  customElements.define('dile-tabler-icon-test-pipe-off', DileIconlibTestPipeOff);
}
