...
export class DileIconlibDeer extends DileBaseIcon {
  getSvgIcon() {
...
if (!customElements.get('dile-tabler-icon-deer')) {
  customElements.define('dile-tabler-icon-deer', DileIconlibDeer);
}
