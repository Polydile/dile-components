...
**Dile Icons** is a Web Components implementation of the [Lucide Icons](https://lucide.dev) library — a beautiful, consistent set of open-source icons.
...
```html
<dile-lucide-icon-house></dile-lucide-icon-house>
```
